# Coppy Code Development Guide

Welcome to the Coppy Code development guide! This document will help you set up your development environment and understand how to work with the codebase. Whether you're fixing bugs, adding features, or just exploring the code, this guide will get you started.
...
1. **Fork and Clone the Repository**:
    ...
    - **Fork the Repository**:
        - Visit the [Coppy Code GitHub repository](https://github.com/Kilo-Org/kilocode)
...
2. This will open a new VSCode window with Coppy Code loaded
...
Coppy Code uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "Coppy Code" from the dropdown
- For webview issues, use the browser developer tools in the webview (right-click > "Inspect Element")

### Testing with Local Backend

To test the extension against a local Coppy Code backend:
...
We welcome contributions to Coppy Code! Here's how you can help:
