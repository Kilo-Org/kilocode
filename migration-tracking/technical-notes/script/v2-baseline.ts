#!/usr/bin/env bun
// Reproduces the pinned-baseline evidence in migration-tracking/technical-notes/baseline/pinned-v2-baseline.md.
...
// migration-tracking/technical-notes/baseline/logs (gitignored).
...
const LOGS = path.join(ROOT, "migration-tracking/technical-notes/baseline/logs")
...
// Known-red checks are reported, never suppressed: see migration-tracking/technical-notes/baseline/pinned-v2-baseline.md
// for the failures that pristine upstream v2 already has at this SHA.
console.log(
  "\ncompare failures against migration-tracking/technical-notes/baseline/pinned-v2-baseline.md before attributing them to Kilo changes",
)
