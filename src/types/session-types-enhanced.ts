...
import { SessionState, SessionSettings } from "./session-types"
...
export class SessionStateEntity {
	 ...
	 */
	static addFileState(session: SessionState, filePath: string, fileState: any): SessionState {
	 ...
	 */
	static removeFileState(session: SessionState, filePath: string): SessionState {
		const newFileStates = new Map(session.fileStates)
	 ...
	 */
	static updateFileState(session: SessionState, filePath: string, updates: any): SessionState {
		const newFileStates = new Map(session.fileStates)
	 ...
	 */
	static addShadowBuffer(session: SessionState, shadowBufferId: string): SessionState {
	 ...
	 */
	static removeShadowBuffer(session: SessionState, shadowBufferId: string): SessionState {
	 ...
	 */
	static updateGlobalSettings(session: SessionState, settings: Partial<SessionSettings>): SessionState {
		return {
			...session,
			globalSettings: {
	 ...
	 */
	static merge(baseSession: SessionState, updateSession: Partial<SessionState>): SessionState {
