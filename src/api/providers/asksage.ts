...
export class AskSageHandler extends BaseProvider implements SingleCompletionHandler {
	...
	public async fetchModel() {
		this.models = await getModels({ provider: "asksage", baseUrl: this.baseURL })
		return this.getModel()
	}

	override getModel() {
		const id = this.options.askSageModelId ?? askSageDefaultModelId
		const cachedInfo = this.models[id] ?? askSageDefaultModelInfo
	...
	override async *createMessage(
		...
		// Map extended efforts to OpenAI Chat Completions-accepted values
