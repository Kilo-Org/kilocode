...
Parameters:
- branch_name: (required) The name of the new branch to create. Should follow conventional commits (e.g., feature/add-login, fix/validation-bug, docs/update-readme)
