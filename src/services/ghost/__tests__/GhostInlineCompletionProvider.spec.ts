...
describe("GhostInlineCompletionProvider", () => {
	...
	describe("provideInlineCompletionItems", () => {
		...
		it("should show inline completion for comment prefix scenario", async () => {
			// Test from comment-prefix spec: deletion+addition pattern where added content starts with deleted
			...
			const items = await provider.provideInlineCompletionItems(mockDocument, position, context, {
