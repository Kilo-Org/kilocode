...
describe("SVGDecorationBuilder", () => {
	let svgBuilder: SVGDecorationBuilder
	...
	beforeEach(() => {
		svgBuilder = new SVGDecorationBuilder()
		mockDocument = {
	...
	describe("createDecorationType", () => {
		it("should create decoration type with simple text content", async () => {
			...
			const decorationType = await svgBuilder.createDecorationType(content, mockDocument)
		...
		it("should apply custom options", async () => {
			...
			const decorationType = await svgBuilder.createDecorationType(content, mockDocument, options)
			expect(vscode.window.createTextEditorDecorationType).toHaveBeenCalledWith(
				expect.objectContaining({
					after: expect.objectContaining({
