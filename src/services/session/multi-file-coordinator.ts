...
export class MultiFileStateCoordinator {
   ...
   */
  async applyMultiFileDiff(diffOperations: Array<{
    filePath: string;
    shadowBuffer: ShadowBuffer;
    diffOverlay: DiffOverlay;
  }>): Promise<void> {
    try {
      Logger.debug('MultiFileStateCoordinator.applyMultiFileDiff', 
      ...
      Logger.info('MultiFileStateCoordinator.applyMultiFileDiff', 
  ...
  private async applySingleFileDiff(
    ...
    try {
      ...
      Logger.error('MultiFileStateCoordinator.applySingleFileDiff', 
        `Failed to apply diff to file: ${filePath}`, error);
      throw error;
    }
  }
  ...
  async acceptAllDiffs(filePath: string): Promise<void> {
    try {
      ...
      Logger.error('MultiFileStateCoordinator.acceptAllDiffs', 
        `Failed to accept diffs for file: ${filePath}`, error);
      throw error;
    }
  }
  ...
  async rejectAllDiffs(filePath: string): Promise<void> {
    try {
      ...
      Logger.error('MultiFileStateCoordinator.rejectAllDiffs', 
        `Failed to reject diffs for file: ${filePath}`, error);
      throw error;
    }
  }
  ...
  async acceptAllDiffsAllFiles(): Promise<void> {
    try {
      ...
      Logger.info('MultiFileStateCoordinator.acceptAllDiffsAllFiles', 
        `Accepted all diffs across ${filePaths.length} files`);
    } catch (error) {
      Logger.error('MultiFileStateCoordinator.acceptAllDiffsAllFiles', 
        'Failed to accept all diffs across all files', error);
      throw error;
    }
  }
  ...
  async rejectAllDiffsAllFiles(): Promise<void> {
    try {
      ...
      Logger.info('MultiFileStateCoordinator.rejectAllDiffsAllFiles', 
        `Rejected all diffs across ${filePaths.length} files`);
    } catch (error) {
      Logger.error('MultiFileStateCoordinator.rejectAllDiffsAllFiles', 
        'Failed to reject all diffs across all files', error);
      throw error;
    }
  }
  ...
  private async restoreCoordinationState(): Promise<void> {
    try {
      ...
      Logger.info('MultiFileStateCoordinator.restoreCoordinationState', 
        `Restored coordination state for ${this.currentState.files.size} files`);
    } catch (error) {
      Logger.error('MultiFileStateCoordinator.restoreCoordinationState', 
        'Failed to restore coordination state', error);
    }
  }
  ...
  private async cleanupAcceptedDiff(filePath: string, diffOverlay: DiffOverlay): Promise<void> {
    try {
      ...
      Logger.error('MultiFileStateCoordinator.cleanupAcceptedDiff', 
        `Failed to cleanup accepted diff for: ${filePath}`, error);
    }
  }
  ...
  private async cleanupRejectedDiff(filePath: string, diffOverlay: DiffOverlay): Promise<void> {
    try {
      ...
      Logger.error('MultiFileStateCoordinator.cleanupRejectedDiff', 
        `Failed to cleanup rejected diff for: ${filePath}`, error);
    }
  }
