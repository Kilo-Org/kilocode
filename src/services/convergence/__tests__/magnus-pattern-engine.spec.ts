// tests/services/convergence/magnus-pattern-engine.spec.ts
// Comprehensive tests for MagnusPatternEngine

import { MagnusPatternEngine, MAGNUS_15_PATTERNS } from "../magnus-pattern-engine"

// Mock the logging module
vi.mock("../../../../utils/logging/CompactLogger", () => ({
