...
import { AutocompleteSnippetType } from "../../../ghost/continuedev/core/autocomplete/types"
...
vi.mock("../../../ghost/continuedev/core/autocomplete/context/ContextRetrievalService", () => ({
	ContextRetrievalService: vi.fn().mockImplementation(() => ({
		initializeForFile: vi.fn().mockResolvedValue(undefined),
	})),
}))

vi.mock("../../../ghost/continuedev/core/vscode-test-harness/src/VSCodeIde", () => ({
	VsCodeIde: vi.fn().mockImplementation(() => ({
		getWorkspaceDirs: vi.fn().mockResolvedValue(["file:///workspace"]),
	})),
}))

vi.mock("../../../ghost/continuedev/core/autocomplete/util/HelperVars", () => ({
	HelperVars: {
...
vi.mock("../../../ghost/continuedev/core/autocomplete/snippets/getAllSnippets", () => ({
...
vi.mock("../../../ghost/continuedev/core/autocomplete/templating/filtering", () => ({
	getSnippets: vi
		.fn()
...
describe("AutocompleteContextProvider", () => {
	...
	describe("getProcessedSnippets", () => {
		...
		it("should return processed snippets when snippets are available", async () => {
			const { getAllSnippetsWithoutRace } = await import(
				"../../../ghost/continuedev/core/autocomplete/snippets/getAllSnippets"
			)
	...
	describe("with RooIgnoreController", () => {
		...
		it("should keep snippets without file paths", async () => {
			...
			const { getSnippets } = await import("../../../ghost/continuedev/core/autocomplete/templating/filtering")
