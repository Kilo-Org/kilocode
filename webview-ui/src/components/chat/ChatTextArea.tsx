...
export const ChatTextArea = forwardRef<HTMLTextAreaElement, ChatTextAreaProps>(
	(
		...
		const updateHighlights = useCallback(() => {
			...
			if (/^\s*\//.test(processedText)) {
				...
				if (matchedCommand) {
					...
					if (matchedCommand.argumentHint && !textAfterCommand && !ghostText) {
		...
		}, [customModes, localWorkflows, globalWorkflows, skills, ghostText, inputValue, isRecording, previewRanges]) // kilocode_change - merged dependencies
