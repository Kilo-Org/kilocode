...
export const IntelligentProvider = memo(
	({ apiConfiguration, setApiConfigurationField, onValidationChange }: IntelligentProviderProps) => {
...
IntelligentProvider.displayName = "IntelligentProvider"
