...
export const SettingsFooter = ({ version, className, ...props }: SettingsFooterProps) => (
	<div className={cn("text-vscode-descriptionForeground p-5", className)} {...props}>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="https://github.com/Kilo-Org/codefluxai" style={{ display: "inline" }}>
				github.com/Kilo-Org/codefluxai
			</VSCodeLink>{" "}
			or join{" "}
			<VSCodeLink href="https://www.reddit.com/r/CodeFluxAI/" style={{ display: "inline" }}>
				reddit.com/r/CodeFluxAI
			</VSCodeLink>
		</p>
		<p className="italic">CodeFlux AI v{version}</p>
