...
The expandable per-model detail path is component code, but this fixture does not yet mouse-click a row; it is not represented as separate end-to-end interaction coverage.
