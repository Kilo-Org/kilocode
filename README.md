...
- 🤖 Latest AI models
- 🎁 API keys optional
- 💡 **Get $20 in bonus credits when you top-up for the first time** These credits can be used with 400+ models like Gemini 2.5 Pro, Claude 4 Sonnet & Opus, and GPT-5
...
- **Task Automation:** Automate boring repetitive coding tasks.
...
2. Create an account to access 400+ cutting-edge AI models including Gemini 2.5 Pro, Claude 4 Sonnet & Opus, and GPT-5 – with transparent pricing that matches provider rates exactly.
...
For details on building and contributing the extension, see [DEVELOPMENT.md](/DEVELOPMENT.md)
