...
import { getAvailableUpstreamVersions, getCurrentDevilVersion } from "./utils/version"
...
async function main() {
  ...
  const kiloVersion = await getCurrentDevilVersion()

  console.log()
  success(`Current Devil version: ${kiloVersion}`)
  console.log()
