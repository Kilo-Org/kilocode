 ...
 * merge run (merge, rebase, cherry-pick, pull --rebase, stash pop, ...) writes
 * conflicts with a ||||||| base block. Makes manual resolution much easier and
 * gives mergiraf the base it needs for structural heuristics.
 */
