...
当选中“**通过差异启用编辑**”时：
    ...
    <img src="/docs/img/fast-edits/fast-edits-5.png" alt="Axon Code 设置显示通过差异启用编辑" width="500" />
...
此滑块控制 AI 识别的代码部分在应用更改之前必须与文件中实际代码匹配的紧密程度。
    ...
    <img src="/docs/img/fast-edits/fast-edits-4.png" alt="Axon Code 设置显示通过差异启用编辑复选框和匹配精度滑块" width="500" />
