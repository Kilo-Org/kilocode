...
<Image src="/docs/img/kilogif.gif" alt="GIF showing some of the capabilities of Axon Code" width="600" />
...
- **YouTube:** <a href={YOUTUBE_URL} target="_blank">Check out our YouTube</a> to learn hands on skills when using Axon Code
