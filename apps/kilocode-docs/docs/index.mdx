...
title: "Kilo Code - Open Source AI Coding Assistant"
description: "Kilo Code is an open-source AI coding assistant for VS Code and JetBrains. Plan, build, and fix code with powerful AI models."
---
