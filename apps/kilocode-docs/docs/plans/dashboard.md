...
The Kilo seats dashboard is the first screen that comes up when you visit [the Coppy Code web app](https://app.kilocode.ai). It provides complete visibility into your team's AI usage, costs, and management.
