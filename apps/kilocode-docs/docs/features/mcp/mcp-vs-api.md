...
## Why Coppy Code Uses MCP

Coppy Code leverages MCP to provide:
...
MCP creates a universal connector between Coppy Code and external services, with REST APIs often powering those services behind the scenes.
