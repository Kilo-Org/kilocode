...
Coppy Code implements the Model Context Protocol to:
...
- [Using MCP in Coppy Code](/features/mcp/using-mcp-in-kilo-code) - Get started with MCP in Coppy Code, including creating simple servers
