...
Coppy Code provides a simple registration process that gives you access to the latest frontier coding models with your Coppy Code login.

1. Click on "Try Coppy Code for Free" in the extension
...
<img
  ...
  alt="Sign up and registration flow with Coppy Code"
/>
