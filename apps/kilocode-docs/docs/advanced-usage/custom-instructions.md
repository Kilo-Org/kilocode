...
<img src="/docs/img/custom-instructions/custom-instructions.png" alt="Axon Code Modes tab showing global custom instructions interface" width="600" />
1.  **Open Modes Tab:** Click the <Codicon name="organization" /> icon in the Axon Code top menu bar
...
Mode-specific instructions can be set using the Modes Tab
    ...
    <img src="/docs/img/custom-instructions/custom-instructions-3.png" alt="Axon Code Modes tab showing mode-specific custom instructions interface" width="600" />
    * **Open Tab:** Click the <Codicon name="organization" /> icon in the Axon Code top menu bar
