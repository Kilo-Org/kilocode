...
# Using Mistral AI With Coppy Code

Coppy Code supports accessing models through the Mistral AI API, including both standard Mistral models and the code-specialized Codestral model.
...
Coppy Code supports the following Mistral models:
...
The default model temperature in Coppy Code is 0.0, so you should consider experimenting with [temperature adjustments](/features/model-temperature)!
