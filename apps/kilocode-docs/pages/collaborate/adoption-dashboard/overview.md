...
{#
{% image src="/docs/img/ai-adoption/adoption-dashboard.png" alt="Monthly view of the AI Adoption Dashboard" /%}
#}
...
{#
{% image src="/docs/img/ai-adoption/stacked-chart.png" alt="Monthly view of the AI Adoption Dashboard" width="300" /%}
#}
