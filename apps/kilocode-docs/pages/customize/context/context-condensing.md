            ...
            - - **Chat Command**: Type `/condense` in the chat
              - - **Settings**: Access condensing options through the Context Condensing settings
                ...
                - 1. **Analysis**: Kilo Code analyzes the entire conversation history
                  2. 2. **Summarization**: A summary is generated using the configured API, capturing essential context
                     3. 3. **Replacement**: The detailed history is replaced with the condensed summary
                        4. 4. **Continuation**: You can continue working with the freed-up context space
                          
                           5. ## Configuration Options
                          
                           6. ### API Configuration
                          
                           7. Context Condensing uses an AI model to generate summaries. You can configure which API to use for condensing operations:
                          
                           8. - Use the same API as your main coding assistant
