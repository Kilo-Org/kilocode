	...
	return (
		<>
			<Head>
				...
				<link rel="icon" href="/docs/favicon.ico" sizes="48x48" type="image/x-icon" />
				...
				<link rel="icon" href="/docs/favicon/android-chrome-192x192.png" type="image/png" sizes="192x192" />
				<link rel="icon" href="/docs/favicon/android-chrome-512x512.png" type="image/png" sizes="512x512" />
