...
ux_file: "{planning_artifacts}/_ux_.md" # Fallback for UX requirements (if not in epics file)
...
whole: "{planning_artifacts}/_ux_.md"
sharded: "{planning_artifacts}/_ux_/*.md"
load_strategy: "SELECTIVE_LOAD" # Only load if needed
epics:
