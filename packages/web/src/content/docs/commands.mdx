...
Create `.kilo/commands/test.md`:

```md title=".kilo/commands/test.md"
---
...
- Per-project: `.kilo/commands/`

```markdown title="~/.config/kilo/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".kilo/commands/component.md" FIXME
---
...
```md title=".kilo/commands/create-file.md" FIXME
---
...
```md title=".kilo/commands/analyze-coverage.md" FIXME
---
...
```md title=".kilo/commands/review-changes.md"
---
...
```md title=".kilo/commands/review-component.md"
---
