...
Configure agents in your `kilo.json` config file:
...
- Per-project: `.kilo/agents/`

```markdown title="~/.config/kilo/agents/review.md"
---
...
The model ID in your Kilo CLI config uses the format `provider/model-id`. For example, if you're using [kilo Zen](/docs/zen), you would use `kilo/gpt-5.1-codex` for GPT 5.1 Codex.
...
```markdown title="~/.config/kilo/agents/review.md" FIXME
---
...
:::tip
Run `kilo models` to see a list of the available models.
:::
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/anomalyco/kilo) FIXME.
:::
...
```markdown title="~/.config/kilo/agents/docs-writer.md" FIXME
---
...
```markdown title="~/.config/kilo/agents/security-auditor.md"
---
