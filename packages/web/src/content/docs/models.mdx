...
Here the full ID is `provider_id/model_id`. For example, if you're using [Kilo CLI Zen](/docs/zen), you would use `kilo/gpt-5.1-codex` for GPT 5.1 Codex.
...
```jsonc title="kilo.jsonc" {7-12,19-24}
{
  "$schema": "https://kilo.ai/config.json" FIXME,
  "provider": {
    "openai": {
