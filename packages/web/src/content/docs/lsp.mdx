...
:::note
You can disable automatic LSP server downloads by setting the `KILO_DISABLE_LSP_DOWNLOAD` environment variable to `true`.
:::
...
You can customize LSP servers through the `lsp` section in your kilo config.
