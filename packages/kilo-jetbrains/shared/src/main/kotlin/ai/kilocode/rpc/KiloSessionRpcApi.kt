...
interface KiloSessionRpcApi : RemoteApi<Unit> {
    ...
    /** Revert a session to a message boundary. */
    suspend fun revert(id: String, directory: String, messageID: String, partID: String?): SessionDto

    /** Clear all reverted messages. */
    suspend fun unrevert(id: String, directory: String): SessionDto
