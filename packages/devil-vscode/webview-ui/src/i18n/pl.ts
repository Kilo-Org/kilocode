export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Devil",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Devil.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Devil.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Devil.",
  ...
  "dialog.server.description": "Przełącz serwer Devil, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Devil ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Devil",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Devil nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Devil zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Devil",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Devil na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Devil.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Devil",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Devil.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę Devil Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości Devil, bez lock-inu.",
  ...
  "deviceAuth.title": "Zaloguj się do Devil Code",
  ...
  "profile.action.login": "Zaloguj się przez Devil Code",
  ...
  "settings.aboutDevilCode.title": "O Devil Code",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Devil Code to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutDevilCode.status.connected": "Połączono",
  "settings.aboutDevilCode.status.connecting": "Łączenie...",
  "settings.aboutDevilCode.status.disconnected": "Rozłączono",
  "settings.aboutDevilCode.status.error": "Błąd",
  "settings.aboutDevilCode.cliServer": "Serwer CLI",
  "settings.aboutDevilCode.status.label": "Status:",
  "settings.aboutDevilCode.port.label": "Port:",
  "settings.aboutDevilCode.versionInfo": "Informacje o wersji",
  "settings.aboutDevilCode.version.label": "Wersja:",
  "settings.aboutDevilCode.extensionName": "Rozszerzenie Devil Code",
  "settings.aboutDevilCode.community": "Społeczność i wsparcie",
  "settings.aboutDevilCode.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutDevilCode.feedback.or": "lub",
  "settings.aboutDevilCode.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutDevilCode.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutDevilCode.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutDevilCode.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutDevilCode.exportSettings": "Eksportuj",
  "settings.aboutDevilCode.importSettings": "Importuj",
  "settings.aboutDevilCode.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutDevilCode.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Devil.",
  "settings.aboutDevilCode.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutDevilCode.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Devil. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutDevilCode.telemetry.title": "Telemetria",
  ...
  "settings.aboutDevilCode.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu Devil Code. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Devil korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.aboutDevilCode.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutDevilCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Devil Code, w tym klucze API dostawców i domyślny model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Devil Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Devil. Znajome doświadczenie niezależnie od sposobu pracy.",
