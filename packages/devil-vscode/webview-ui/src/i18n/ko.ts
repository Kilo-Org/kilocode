...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Devil에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Devil에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Devil에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Devil에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 Devil 서버를 전환합니다.",
  ...
  "toast.update.description": "Devil의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Devil 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Devil는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Devil에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "Devil 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Devil가 보이는 방식 사용자 지정",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Devil 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Devil를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Devil를 사용 중입니다.",
  ...
  "settings.providers.betaNotice":
    "현재 설정 인터페이스에서는 Devil Gateway 제공자만 설정할 수 있습니다. 다른 제공자 설정에 대한 지원은 베타 기간 동안 곧 제공될 예정입니다. 그동안에는 CLI 또는 설정 파일을 사용하여 제공자를 설정할 수 있습니다. 우리는 종속(lock-in) 없이 Devil를 개방적으로 유지하기 위해 최선을 다하고 있습니다.",
  ...
  "deviceAuth.title": "Devil Code에 로그인",
  ...
  "profile.action.login": "Devil Code로 로그인",
  ...
  "settings.aboutDevilCode.title": "Devil Code 정보",

  "session.messages.empty": "아래에 메시지를 입력하여 대화를 시작하세요.",
  "session.messages.welcome":
    "Devil Code는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutDevilCode.status.connected": "연결됨",
  "settings.aboutDevilCode.status.connecting": "연결 중...",
  "settings.aboutDevilCode.status.disconnected": "연결 끊김",
  "settings.aboutDevilCode.status.error": "오류",
  "settings.aboutDevilCode.cliServer": "CLI 서버",
  "settings.aboutDevilCode.status.label": "상태:",
  "settings.aboutDevilCode.port.label": "포트:",
  "settings.aboutDevilCode.versionInfo": "버전 정보",
  "settings.aboutDevilCode.version.label": "버전:",
  "settings.aboutDevilCode.extensionName": "Devil Code 확장 프로그램",
  "settings.aboutDevilCode.community": "커뮤니티 및 지원",
  "settings.aboutDevilCode.feedback.prefix": "질문이나 피드백이 있으시면 다음에서 이슈를 열어주세요",
  "settings.aboutDevilCode.feedback.or": "또는",
  "settings.aboutDevilCode.support.prefix": "결제 또는 계정 관련 문의는 고객 지원팀에 문의하세요",
  "settings.aboutDevilCode.resetSettings.title": "설정 초기화",
  ...
  "settings.aboutDevilCode.resetSettings.button": "모든 설정 초기화",
  "settings.aboutDevilCode.settingsTransfer.title": "설정 이전",
  "settings.aboutDevilCode.settingsTransfer.description":
    "VS Code 인스턴스 간에 설정을 전송하려면 내보내기 또는 가져오기하세요.",
  "settings.aboutDevilCode.exportSettings": "내보내기",
  "settings.aboutDevilCode.importSettings": "가져오기",
  "settings.aboutDevilCode.importSettings.invalidJson":
    "유효하지 않은 JSON 파일입니다. 올바른 설정 파일을 선택해 주세요.",
  "settings.aboutDevilCode.importSettings.invalidConfig": "파일에 유효한 Devil 설정이 포함되어 있지 않습니다.",
  ...
  "settings.aboutDevilCode.telemetry.openSettings": "원격 측정 설정 열기",
  ...
  "settings.language.description": 'Devil Code UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code 설정 디렉터리에서 세션으로 CLAUDE.md 지침 및 스킬을 로드합니다. Devil가 Claude Code 지침 및 스킬을 사용하게 하려면 활성화하세요. 다시 시작해야 합니다.",
  ...
  "settings.aboutDevilCode.legacyMigration.title": "레거시 마이그레이션",
  "settings.aboutDevilCode.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 Devil Code 설치에서 설정을 마이그레이션합니다.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Devil Code의 새로운 기능",
  ...
  "migration.whatsNew.features.foundation.detail":
    "모든 Devil 제품에 걸쳐 하나의 작고 효율적인 코어. 어떤 방식으로 작업하든 익숙한 경험을 제공합니다.",
