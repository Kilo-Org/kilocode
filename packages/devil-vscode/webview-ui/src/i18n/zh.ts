...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Devil 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Devil 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Devil 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Devil 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Devil 服务器。",
  ...
  "toast.update.description": "Devil 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Devil 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Devil 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Devil 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Devil 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Devil 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Devil 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Devil 启动时自动检查更新",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Devil Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Devil 开放，无锁定。",
  ...
  "deviceAuth.title": "登录 Devil Code",
  ...
  "profile.action.login": "使用 Devil Code 登录",
  ...
  "settings.aboutDevilCode.title": "关于 Devil Code",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Devil Code 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutDevilCode.status.connected": "已连接",
  "settings.aboutDevilCode.status.connecting": "连接中...",
  "settings.aboutDevilCode.status.disconnected": "已断开",
  "settings.aboutDevilCode.status.error": "错误",
  "settings.aboutDevilCode.cliServer": "CLI 服务器",
  "settings.aboutDevilCode.status.label": "状态：",
  "settings.aboutDevilCode.port.label": "端口：",
  "settings.aboutDevilCode.versionInfo": "版本信息",
  "settings.aboutDevilCode.version.label": "版本：",
  "settings.aboutDevilCode.extensionName": "Devil Code 扩展",
  "settings.aboutDevilCode.community": "社区与支持",
  "settings.aboutDevilCode.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutDevilCode.feedback.or": "或",
  "settings.aboutDevilCode.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutDevilCode.resetSettings.title": "重置设置",
  "settings.aboutDevilCode.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutDevilCode.resetSettings.button": "重置所有设置",
  "settings.aboutDevilCode.settingsTransfer.title": "设置迁移",
  "settings.aboutDevilCode.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutDevilCode.exportSettings": "导出",
  "settings.aboutDevilCode.importSettings": "导入",
  "settings.aboutDevilCode.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutDevilCode.importSettings.invalidConfig": "文件不包含有效的 Devil 设置。",
  "settings.aboutDevilCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutDevilCode.importSettings.newerVersion": "此文件由较新版本的 Devil 导出。部分设置可能会被忽略。",
  "settings.aboutDevilCode.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutDevilCode.telemetry.title": "遥测",
  "settings.aboutDevilCode.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutDevilCode.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Devil Code 界面的语言。',
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Devil 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.aboutDevilCode.legacyMigration.title": "旧版迁移",
  "settings.aboutDevilCode.legacyMigration.description":
    "从旧版 Devil Code 安装迁移设置，包括提供商 API 密钥和默认模型。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Devil 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
