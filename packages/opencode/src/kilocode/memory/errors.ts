  ...
  export function toHttp(err: MemoryError): MemoryApiClientError | MemoryApiServerError {
    ...
    switch (err._tag) {
      case "MemoryDisabledError":
        return new MemoryApiClientError({ name: "MemoryApiClientError", data: { code: "memory_disabled", message: msg } })
      case "MemoryInvalidInputError":
        return new MemoryApiClientError({ name: "MemoryApiClientError", data: { code: "memory_invalid_input", message: msg } })
      case "MemoryRootError":
        return new MemoryApiClientError({ name: "MemoryApiClientError", data: { code: "memory_root_error", message: msg } })
      case "MemoryStorageError":
        return new MemoryApiServerError({ name: "MemoryApiServerError", data: { code: "memory_storage_error", message: msg } })
      case "MemoryCorruptStateError":
        return new MemoryApiServerError({ name: "MemoryApiServerError", data: { code: "memory_corrupt_state", message: msg } })
      default:
