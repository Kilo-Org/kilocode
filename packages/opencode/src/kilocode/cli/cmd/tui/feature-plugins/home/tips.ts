...
export const KILO_TIPS: Tip[] = [
  ...
  "Use {highlight}/auto-approve{/highlight} ({highlight}/yolo{/highlight}) to skip tool permission prompts in the current session, or {highlight}/auto-approve-all{/highlight} for global auto-approve",
