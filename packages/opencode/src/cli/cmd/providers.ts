...
export const ProvidersListCommand = effectCmd({
  ...
  // kilocode_change start - ModelsDev.get reads Kilo Config, so this needs instance context
  // instance: false,
  // kilocode_change end
...
export const ProvidersLoginCommand = effectCmd({
  ...
  handler: Effect.fn("Cli.providers.login")(function* (args) {
    ...
    // kilocode_change start - kilo first, then opencode and the rest
    ...
    const pluginProviders = resolvePluginProviders({
      ...
      disabled,
      enabled,
      // kilocode_change - flatMap+filter to defend against undefined provider entries
