      ...
      return {
        cost: safe(
          new Decimal(0)
            ...
            // devilcode_change - audit H42: reasoning tokens billed at the output rate.
            // models.dev does not currently expose a separate reasoning rate. Revisit when
            // the upstream schema gains `pricing.reasoning`; until then output is the most
            // accurate proxy because providers charge reasoning at output rates today.
