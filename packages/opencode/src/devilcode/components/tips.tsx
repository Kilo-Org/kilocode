...
const TIPS = [
  ...
  "Devil can {highlight}configure itself{/highlight} if you ask it",
  "Ask Devil to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Devil to {highlight}create a review agent for this project{/highlight}",
  "Ask Devil to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Devil to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Devil to {highlight}make my review agent read-only{/highlight}",
  "Ask Devil to {highlight}require approval before git push{/highlight}",
  "Ask Devil to {highlight}turn off auto-formatting{/highlight}",
  "Ask Devil to {highlight}block access to .env files{/highlight}",
  "Ask Devil to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Devil to {highlight}match my terminal theme{/highlight}",
  "Ask Devil to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Devil to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Devil to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Devil to {highlight}save this workflow as a /command{/highlight}",
  "Devil auto-handles OAuth for remote MCP servers requiring auth",
  "Devil auto-formats files using prettier, gofmt, ruff, and more",
  "Devil uses LSP servers for intelligent code analysis",
  ...
  "Run {highlight}kilo serve{/highlight} for headless API access to Devil",
