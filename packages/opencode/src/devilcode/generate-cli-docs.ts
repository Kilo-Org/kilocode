...
const TABLE_PATH = root + "packages/devil-docs/markdoc/partials/cli-commands-table.md"
const REFERENCE_PATH = root + "packages/devil-docs/pages/code-with-ai/platforms/cli-reference.md"
