...
export function parameterSchema(description: string) {
  return Schema.Struct({
    ...
    description: Schema.optional(Schema.String).annotate({ description }), // kilocode_change - optional with "Recommended:" prefix
  })
}
