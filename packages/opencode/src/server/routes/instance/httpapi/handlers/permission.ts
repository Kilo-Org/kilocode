...
import type { SaveAlwaysRulesPayload } from "../groups/permission" // kilocode_change
...
export const permissionHandlers = HttpApiBuilder.group(InstanceHttpApi, "permission", (handlers) =>
  Effect.gen(function* () {
    ...
    // kilocode_change start - return 404 when request is gone
    ...
    const saveAlwaysRules = Effect.fn("PermissionHttpApi.saveAlwaysRules")(function* (ctx: {
      params: { requestID: PermissionID }
      payload: SaveAlwaysRulesPayload
    }) {
