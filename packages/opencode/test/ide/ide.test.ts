...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DEVIL_CALLER", () => {
    process.env["DEVIL_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DEVIL_CALLER", () => {
    process.env["DEVIL_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DEVIL_CALLER", () => {
    process.env["DEVIL_CALLER"] = "unknown"
