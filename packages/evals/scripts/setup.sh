...
build_extension() {
  echo "🔨 Building the Coppy Code extension..."
...
echo -n "🗄️ Syncing Coppy Code evals database... "
...
read -p "💻 Do you want to build a new version of the Coppy Code extension? [currently $current_version] (y/N): " build_extension
