...
build_extension() {
  echo "🔨 Building the Axon Code extension..."
...
echo -n "🗄️ Syncing Axon Code evals database... "
...
read -p "💻 Do you want to build a new version of the Axon Code extension? [currently $current_version] (y/N): " build_extension
