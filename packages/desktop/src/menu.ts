    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://devil.ai/docs"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/Devil-Org/devilcode/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/Devil-Org/devilcode/issues/new?template=bug_report.yml"),
