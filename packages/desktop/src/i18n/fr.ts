export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Devil",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Devil a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'Devil",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Devil est manquant. Essayez de réinstaller l'application de bureau.",
