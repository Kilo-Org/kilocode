export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Devil",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Devil wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.menu.help.documentation": "Devil-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Das Devil CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
