export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 Devil",
  ...
  "desktop.updater.downloaded.prompt": "已下載 Devil {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.menu.help.documentation": "Devil 文件",
  ...
  "desktop.cli.error.sidecarMissing": "Devil CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
