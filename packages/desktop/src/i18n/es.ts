export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Devil",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Devil. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Devil",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Devil. Intenta reinstalar la aplicación de escritorio.",
