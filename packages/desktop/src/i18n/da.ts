export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Devil",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Devil er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.error.sidecarMissing": "Devil CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
