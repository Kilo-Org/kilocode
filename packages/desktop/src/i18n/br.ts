export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Devil",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Devil foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Devil",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Devil está ausente. Tente reinstalar o aplicativo de desktop.",
