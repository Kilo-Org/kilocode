export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 Devil",
  ...
  "desktop.updater.downloaded.prompt": "已下载 Devil {{version}} 版本，是否安装并重启？",
  ...
  "desktop.menu.help.documentation": "Devil 文档",
  ...
  "desktop.cli.error.sidecarMissing": "Devil CLI 二进制文件缺失。请尝试重新安装桌面应用程序。",
