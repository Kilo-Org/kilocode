export const dict = {
  ...
  "desktop.menu.help.documentation": "Devil Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Devil",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Devil has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "Devil CLI binary is missing. Try reinstalling the desktop app.",
