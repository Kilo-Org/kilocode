...
- To grant models to specific sets of members instead of the whole organization, use [Groups](/docs/collaborate/enterprise/groups). Group policies are additive on top of this organization-wide baseline — a group can grant its members access to models or providers blocked here.
