...
To make a rule path-scoped, add `paths` frontmatter to the Markdown file. The Settings UI can be used to manage additional instruction file paths and globs.
