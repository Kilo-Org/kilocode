...
- **Export**: Saves your global config (excluding API keys and secrets) as a `kilo-settings.json` file. This is safe to share — sensitive credentials are automatically stripped.
