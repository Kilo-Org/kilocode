...
{% callout type="tip" %}
Available free models change over time as Kilo partners with different inference providers. Subscribe to our blog or join our [Discord](https://kilo.codes/discord) for updates.
{% /callout %}
