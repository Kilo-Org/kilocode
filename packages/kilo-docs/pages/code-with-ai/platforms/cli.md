...
| Scope       | Path                                                                                              |
| ----------- | ------------------------------------------------------------------------------------------------- |
| **Global**  | `~/.config/kilo/kilo.json` or `kilo.jsonc` (Windows: config dir may vary; same filenames). Legacy `opencode.json` / `opencode.jsonc` files are still read if `kilo.json` is absent. |
