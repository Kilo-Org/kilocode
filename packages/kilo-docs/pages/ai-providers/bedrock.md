---
title: Use AWS Bedrock Models with Kilo Code
description: Configure Kilo Code to use AWS Bedrock for access to Claude, Llama, and other foundation models through your AWS account.
