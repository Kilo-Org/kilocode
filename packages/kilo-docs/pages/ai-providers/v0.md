---
title: Use Vercel v0 with Kilo Code
description: Configure Vercel's v0 models in Kilo Code using the OpenAI-compatible API for AI-powered code generation.
sidebar_label: v0
---
