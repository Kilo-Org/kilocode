---
title: Use VS Code Language Model API with Kilo Code
description: Use GitHub Copilot and other models via the VS Code Language Model API inside Kilo Code.
