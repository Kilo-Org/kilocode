...
Open **Settings** (gear icon) inside the Kilo Code extenstion and go to the **Providers** tab to add Requesty and enter your API key.  If you don't see Requesty listed, click **Show more providers**
