...
| [Marketplace](non-agent-features/marketplace.md)                                                        | ❌ Not started | Catalog browsing, install/uninstall flows, org integration ([full spec](non-agent-features/marketplace-specification.md)) | CLI for config writes; extension for UI + API client                 | P2       |
