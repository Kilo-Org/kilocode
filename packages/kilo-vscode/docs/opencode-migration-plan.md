...
| [Marketplace](non-agent-features/marketplace.md)                                                        | ❌ Not started | Catalog browsing, install/uninstall flows, org integration ([full spec](non-agent-features/marketplace-specification.md)) | Extension-side (direct CLI config file writes + UI + API client)     | P2       |
