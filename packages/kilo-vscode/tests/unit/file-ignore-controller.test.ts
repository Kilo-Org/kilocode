...
describe("FileIgnoreController", () => {
  describe("when .kilocodeignore exists", () => {
    ...
    it("always blocks Kilo-managed dependency files", async () => {
      ...
      expect(controller.validateAccess(path.join(workspace, ".kilo", "pnpm-lock.yaml"))).toBe(false)
      expect(controller.validateAccess(path.join(workspace, ".kilo", "bun.lock"))).toBe(false)
      expect(controller.validateAccess(path.join(workspace, ".kilo", "bun.lockb"))).toBe(false)
      expect(controller.validateAccess(path.join(workspace, ".kilo", "yarn.lock"))).toBe(false)
      ...
      expect(controller.validateAccess(path.join(workspace, ".kilocode", "pnpm-lock.yaml"))).toBe(false)
      expect(controller.validateAccess(path.join(workspace, ".kilocode", "bun.lock"))).toBe(false)
      expect(controller.validateAccess(path.join(workspace, ".kilocode", "bun.lockb"))).toBe(false)
      expect(controller.validateAccess(path.join(workspace, ".kilocode", "yarn.lock"))).toBe(false)
      expect(controller.validateAccess(path.join(workspace, "src", "main.ts"))).toBe(true)
    })
  })
