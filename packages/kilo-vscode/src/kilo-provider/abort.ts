import type { KiloClient, SessionStatus } from "../backend/index"
import { sameDirectory } from "../kilo-provider-utils"

type AbortClient = { session: Pick<KiloClient["session"], "abort"> }
...
export class SessionAbort {
  ...
  async stop(client: AbortClient, sessionID: string, fallback: string) {
...
export async function abortSession(input: { client: AbortClient; sessionID: string; dir: string }) {
