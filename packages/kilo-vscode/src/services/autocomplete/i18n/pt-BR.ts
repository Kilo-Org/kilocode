...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (desabilitado)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Sem créditos na sua conta**\n\nSua conta Pound Code não tem créditos. Para usar o autocompletar, adicione créditos à sua conta.\n\n[Abrir Configurações](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: Tarefa Rápida",
  "kilocode:autocomplete.input.placeholder": "ex., 'refatore esta função para ser mais eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: Gerar Edições Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "Pound Code: Edições Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "O Pound Code Autocomplete está sendo bloqueado por um conflito com o GitHub Copilot. Para corrigir isso, você deve desabilitar as sugestões inline do Copilot.",
