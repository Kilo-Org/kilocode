...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (отключено)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**На вашем счёте нет кредитов**\n\nНа вашем счёте Pound Code нет кредитов. Чтобы использовать автодополнение, пожалуйста, пополните счёт.\n\n[Открыть Настройки](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: Быстрая Задача",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори эту функцию для большей эффективности'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: Генерировать Предлагаемые Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "Pound Code: Предлагаемые Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Pound Code Autocomplete блокируется конфликтом с GitHub Copilot. Чтобы исправить это, ты должен отключить встроенные предложения Copilot.",
