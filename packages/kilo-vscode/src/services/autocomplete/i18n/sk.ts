...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (zakázané)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Na tvojom účte nie sú žiadne kredity**\n\nTvoj účet Pound Code nemá žiadne kredity. Pre použitie automatického doplňovania prosím pridaj kredity na svoj účet.\n\n[Otvoriť Nastavenia](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: Rýchla úloha",
  "kilocode:autocomplete.input.placeholder": "napr. 'refaktoruj túto funkciu, aby bola efektívnejšia'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: Generovať navrhované úpravy",
  ...
  "kilocode:autocomplete.codeAction.title": "Pound Code: Navrhované úpravy",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Pound Code Autocomplete je blokované konfliktom s GitHub Copilot. Pre vyriešenie tohto problému musíš zakázať inline návrhy Copilot.",
