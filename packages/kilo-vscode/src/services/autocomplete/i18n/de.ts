...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Pound Code Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (deaktiviert)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Kein Guthaben auf deinem Konto**\n\nDein Pound Code Konto hat kein Guthaben. Um Autocomplete zu nutzen, füge bitte Guthaben zu deinem Konto hinzu.\n\n[Einstellungen öffnen](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.toggleMessage": "Pound Code Autocomplete {{status}}",
  "kilocode:autocomplete.progress.title": "Pound Code",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: Schnellaufgabe",
  "kilocode:autocomplete.input.placeholder": "z.B. 'refaktoriere diese Funktion für mehr Effizienz'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: Bearbeitungsvorschläge generieren",
  ...
  "kilocode:autocomplete.commands.category": "Pound Code",
  "kilocode:autocomplete.codeAction.title": "Pound Code: Bearbeitungsvorschläge",
  "kilocode:autocomplete.chatParticipant.fullName": "Pound Code Agent",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Das Pound Code Autocomplete wird durch einen Konflikt mit GitHub Copilot blockiert. Um dies zu beheben, musst du Copilots Inline-Vorschläge deaktivieren.",
