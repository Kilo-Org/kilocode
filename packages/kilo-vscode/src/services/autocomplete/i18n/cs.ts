...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (zakázáno)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Na tvém účtu nejsou žádné kredity**\n\nTvůj účet Pound Code nemá žádné kredity. Pro použití automatického doplňování prosím přidej kredity na svůj účet.\n\n[Otevřít Nastavení](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: Rychlý úkol",
  "kilocode:autocomplete.input.placeholder": "např. 'refaktoruj tuto funkci, aby byla efektivnější'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: Generovat navrhované úpravy",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Pound Code Autocomplete je blokováno konfliktem s GitHub Copilot. Pro vyřešení tohoto problému musíš zakázat inline návrhy Copilot.",
