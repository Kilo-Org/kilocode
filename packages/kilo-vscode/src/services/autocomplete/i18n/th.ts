...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (ปิดใช้งาน)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**ไม่มีเครดิตในบัญชีของคุณ**\n\nบัญชี Pound Code ของคุณไม่มีเครดิต หากต้องการใช้การเติมข้อความอัตโนมัติ กรุณาเพิ่มเครดิตในบัญชีของคุณ\n\n[เปิดการตั้งค่า](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: งานด่วน",
  "kilocode:autocomplete.input.placeholder": "เช่น 'ปรับโครงสร้างฟังก์ชันนี้ให้มีประสิทธิภาพมากขึ้น'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: สร้างการแก้ไขที่แนะนำ",
  ...
  "kilocode:autocomplete.codeAction.title": "Pound Code: การแก้ไขที่แนะนำ",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Pound Code Autocomplete ถูกบล็อกโดยความขัดแย้งกับ GitHub Copilot เพื่อแก้ไขปัญหานี้ คุณต้องปิดใช้งานคำแนะนำแบบอินไลน์ของ Copilot",
