...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (disabilitato)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Nessun credito nel tuo account**\n\nIl tuo account Pound Code non ha crediti. Per usare l'autocompletamento, aggiungi crediti al tuo account.\n\n[Apri Impostazioni](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: Attività Rapida",
  "kilocode:autocomplete.input.placeholder": "es., 'refactorizza questa funzione per renderla più efficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: Genera Modifiche Suggerite",
  ...
  "kilocode:autocomplete.codeAction.title": "Pound Code: Modifiche Suggerite",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Il Pound Code Autocomplete è bloccato da un conflitto con GitHub Copilot. Per risolvere questo problema, devi disabilitare i suggerimenti in linea di Copilot.",
