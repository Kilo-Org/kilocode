...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (dinonaktifkan)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Tidak ada kredit di akun kamu**\n\nAkun Pound Code kamu tidak memiliki kredit. Untuk menggunakan autocomplete, silakan tambahkan kredit ke akun kamu.\n\n[Buka Pengaturan](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: Tugas Cepat",
  "kilocode:autocomplete.input.placeholder": "mis., 'refaktor fungsi ini agar lebih efisien'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: Hasilkan Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.codeAction.title": "Pound Code: Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Pound Code Autocomplete diblokir oleh konflik dengan GitHub Copilot. Untuk memperbaiki ini, Anda harus menonaktifkan saran inline Copilot.",
