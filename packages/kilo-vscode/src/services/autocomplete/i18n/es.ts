...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Pound Code Autocomplete (deshabilitado)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**No hay créditos en tu cuenta**\n\nTu cuenta de Pound Code no tiene créditos. Para usar el autocompletado, por favor añade créditos a tu cuenta.\n\n[Abrir Configuración](command:kilo-code.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "Pound Code: Tarea Rápida",
  "kilocode:autocomplete.input.placeholder": "ej., 'refactoriza esta función para que sea más eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "Pound Code: Generar Ediciones Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "Pound Code: Ediciones Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El Pound Code Autocomplete está siendo bloqueado por un conflicto con GitHub Copilot. Para solucionarlo, debes desactivar las sugerencias en línea de Copilot.",
