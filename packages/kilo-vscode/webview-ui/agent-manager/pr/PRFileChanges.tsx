      ...
      <div class="am-pr-panel-section">
        <div class="am-pr-panel-section-heading am-pr-row">
          ...
          <span class="am-pr-panel-section-count am-pr-panel-diff am-pr-row">
            <Show when={props.files > 0}><span class="am-stat-files">{props.files}f</span></Show>
            <Show when={props.additions > 0}><span class="am-stat-additions">+{props.additions}</span></Show>
            <Show when={props.deletions > 0}><span class="am-stat-deletions">−{props.deletions}</span></Show>
          </span>
        </div>
      </div>
    </>
