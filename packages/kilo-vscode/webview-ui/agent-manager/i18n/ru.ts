export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Подключение к вашей облачной сессии...",
  "agentManager.cloud.empty": "Cloud Agents не найдены.",
  "agentManager.cloud.emptyRepository": "Сеансы Cloud Agent для {{repository}} не найдены.",
  "agentManager.cloud.failed": "Не удалось загрузить Cloud Agents.",
  "agentManager.cloud.retry": "Повторить",
  "agentManager.cloud.signedOut": "Войдите, чтобы просмотреть Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Это действие не поддерживается для Cloud Agents.",
  "agentManager.cloud.status.preparing": "Подготовка облачного агента...",
  "agentManager.cloud.status.finalizing": "Завершение настройки облачного агента...",
  "agentManager.cloud.status.diskCheck": "Проверка места на диске...",
  "agentManager.cloud.status.workspaceSetup": "Настройка рабочего пространства...",
  "agentManager.cloud.status.cloning": "Клонирование репозитория...",
  "agentManager.cloud.status.branch": "Подготовка ветки...",
  "agentManager.cloud.status.devcontainerSetup": "Настройка контейнера разработки...",
  "agentManager.cloud.status.setupCommands": "Выполнение команд настройки...",
  "agentManager.cloud.status.kiloServer": "Запуск сервера Kilo...",
  "agentManager.cloud.status.kiloSession": "Запуск сеанса Kilo...",
  "agentManager.cloud.status.ready": "Облачный агент готов",
  "agentManager.cloud.status.failed": "Не удалось настроить облачный агент",
  "agentManager.cloud.message.failed": "Не удалось доставить сообщение",
  "agentManager.cloud.message.interrupted": "Сообщение в очереди было прервано",
