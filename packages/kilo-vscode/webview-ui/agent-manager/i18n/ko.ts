export const dict = {
  ...
  "agentManager.cloud.connectingSession": "클라우드 세션에 연결하는 중...",
  "agentManager.cloud.empty": "Cloud Agents가 없습니다.",
  "agentManager.cloud.emptyRepository": "{{repository}}의 Cloud Agent 세션이 없습니다.",
  "agentManager.cloud.failed": "Cloud Agents를 로드하지 못했습니다.",
  "agentManager.cloud.retry": "다시 시도",
  "agentManager.cloud.signedOut": "Cloud Agents를 보려면 로그인하세요.",
  "agentManager.cloud.unsupportedAction": "Cloud Agents에서는 이 작업을 지원하지 않습니다.",
  "agentManager.cloud.status.preparing": "클라우드 에이전트를 준비하는 중...",
  "agentManager.cloud.status.finalizing": "클라우드 에이전트 설정을 마무리하는 중...",
  "agentManager.cloud.status.diskCheck": "디스크 공간을 확인하는 중...",
  "agentManager.cloud.status.workspaceSetup": "작업 공간을 설정하는 중...",
  "agentManager.cloud.status.cloning": "저장소를 복제하는 중...",
  "agentManager.cloud.status.branch": "브랜치를 준비하는 중...",
  "agentManager.cloud.status.devcontainerSetup": "개발 컨테이너를 설정하는 중...",
  "agentManager.cloud.status.setupCommands": "설정 명령을 실행하는 중...",
  "agentManager.cloud.status.kiloServer": "Kilo 서버를 시작하는 중...",
  "agentManager.cloud.status.kiloSession": "Kilo 세션을 시작하는 중...",
  "agentManager.cloud.status.ready": "클라우드 에이전트 준비 완료",
  "agentManager.cloud.status.failed": "클라우드 에이전트 설정 실패",
  "agentManager.cloud.message.failed": "메시지를 전달하지 못했습니다",
  "agentManager.cloud.message.interrupted": "대기 중인 메시지가 중단되었습니다",
