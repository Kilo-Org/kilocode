export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Verbindung zu Ihrer Cloud-Sitzung wird hergestellt...",
  "agentManager.cloud.empty": "Keine Cloud Agents gefunden.",
  "agentManager.cloud.emptyRepository": "Keine Cloud-Agent-Sitzungen für {{repository}} gefunden.",
  "agentManager.cloud.failed": "Cloud Agents konnten nicht geladen werden.",
  "agentManager.cloud.retry": "Erneut versuchen",
  "agentManager.cloud.signedOut": "Melden Sie sich an, um Cloud Agents anzuzeigen.",
  "agentManager.cloud.unsupportedAction": "Diese Aktion wird für Cloud Agents nicht unterstützt.",
  "agentManager.cloud.status.preparing": "Cloud-Agent wird vorbereitet...",
  "agentManager.cloud.status.finalizing": "Cloud-Agent wird abgeschlossen...",
  "agentManager.cloud.status.diskCheck": "Speicherplatz wird geprüft...",
  "agentManager.cloud.status.workspaceSetup": "Arbeitsbereich wird eingerichtet...",
  "agentManager.cloud.status.cloning": "Repository wird geklont...",
  "agentManager.cloud.status.branch": "Branch wird vorbereitet...",
  "agentManager.cloud.status.devcontainerSetup": "Entwicklungscontainer wird eingerichtet...",
  "agentManager.cloud.status.setupCommands": "Einrichtungsbefehle werden ausgeführt...",
  "agentManager.cloud.status.kiloServer": "Kilo-Server wird gestartet...",
  "agentManager.cloud.status.kiloSession": "Kilo-Sitzung wird gestartet...",
  "agentManager.cloud.status.ready": "Cloud-Agent ist bereit",
  "agentManager.cloud.status.failed": "Einrichtung des Cloud-Agents fehlgeschlagen",
  "agentManager.cloud.message.failed": "Nachricht konnte nicht zugestellt werden",
  "agentManager.cloud.message.interrupted": "Nachricht in der Warteschlange wurde unterbrochen",
