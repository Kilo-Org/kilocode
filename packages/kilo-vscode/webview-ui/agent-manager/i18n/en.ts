export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Connecting to your cloud session...",
  "agentManager.cloud.empty": "No cloud agents found.",
  "agentManager.cloud.emptyRepository": "No Cloud Agent sessions for {{repository}}.",
  ...
  "agentManager.cloud.status.preparing": "Preparing cloud agent...",
  "agentManager.cloud.status.finalizing": "Finalizing cloud agent...",
  "agentManager.cloud.status.diskCheck": "Checking disk space...",
  "agentManager.cloud.status.workspaceSetup": "Setting up workspace...",
  "agentManager.cloud.status.cloning": "Cloning repository...",
  "agentManager.cloud.status.branch": "Preparing branch...",
  "agentManager.cloud.status.devcontainerSetup": "Setting up development container...",
  "agentManager.cloud.status.setupCommands": "Running setup commands...",
  "agentManager.cloud.status.kiloServer": "Starting Kilo server...",
  "agentManager.cloud.status.kiloSession": "Starting Kilo session...",
  "agentManager.cloud.status.ready": "Cloud agent ready",
  "agentManager.cloud.status.failed": "Cloud agent setup failed",
  "agentManager.cloud.message.failed": "Message failed to deliver",
  "agentManager.cloud.message.interrupted": "Queued message interrupted",
