export const dict = {
  ...
  "agentManager.browser.devtools": "Open developer tools",
  ...
  "agentManager.browser.hide": "Hide",
  ...
  "agentManager.browser.notStarted": "not started",
  "agentManager.browser.localOnly": "HTTP loopback URLs only; external requests are blocked",
