export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Opretter forbindelse til din cloudsession...",
  "agentManager.cloud.empty": "Ingen Cloud Agents fundet.",
  "agentManager.cloud.emptyRepository": "Ingen Cloud Agent-sessioner fundet for {{repository}}.",
  "agentManager.cloud.failed": "Cloud Agents kunne ikke indlæses.",
  "agentManager.cloud.retry": "Prøv igen",
  "agentManager.cloud.signedOut": "Log ind for at se Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Denne handling understøttes ikke for Cloud Agents.",
  "agentManager.cloud.status.preparing": "Forbereder cloud-agent...",
  "agentManager.cloud.status.finalizing": "Færdiggør cloud-agent...",
  "agentManager.cloud.status.diskCheck": "Kontrollerer diskplads...",
  "agentManager.cloud.status.workspaceSetup": "Opsætter arbejdsområde...",
  "agentManager.cloud.status.cloning": "Kloner repository...",
  "agentManager.cloud.status.branch": "Forbereder branch...",
  "agentManager.cloud.status.devcontainerSetup": "Opsætter udviklingscontainer...",
  "agentManager.cloud.status.setupCommands": "Kører opsætningskommandoer...",
  "agentManager.cloud.status.kiloServer": "Starter Kilo-server...",
  "agentManager.cloud.status.kiloSession": "Starter Kilo-session...",
  "agentManager.cloud.status.ready": "Cloud-agent er klar",
  "agentManager.cloud.status.failed": "Opsætning af cloud-agent mislykkedes",
  "agentManager.cloud.message.failed": "Beskeden kunne ikke leveres",
  "agentManager.cloud.message.interrupted": "Besked i kø blev afbrudt",
