export const dict = {
  ...
  "agentManager.cloud.connectingSession": "正在连接到您的云端会话...",
  "agentManager.cloud.empty": "未找到 Cloud Agents。",
  "agentManager.cloud.emptyRepository": "未找到 {{repository}} 的 Cloud Agent 会话。",
  "agentManager.cloud.failed": "无法加载 Cloud Agents。",
  "agentManager.cloud.retry": "重试",
  "agentManager.cloud.signedOut": "登录以查看 Cloud Agents。",
  "agentManager.cloud.unsupportedAction": "Cloud Agents 不支持此操作。",
  "agentManager.cloud.status.preparing": "正在准备云端智能体...",
  "agentManager.cloud.status.finalizing": "正在完成云端智能体设置...",
  "agentManager.cloud.status.diskCheck": "正在检查磁盘空间...",
  "agentManager.cloud.status.workspaceSetup": "正在设置工作区...",
  "agentManager.cloud.status.cloning": "正在克隆仓库...",
  "agentManager.cloud.status.branch": "正在准备分支...",
  "agentManager.cloud.status.devcontainerSetup": "正在设置开发容器...",
  "agentManager.cloud.status.setupCommands": "正在运行设置命令...",
  "agentManager.cloud.status.kiloServer": "正在启动 Kilo 服务器...",
  "agentManager.cloud.status.kiloSession": "正在启动 Kilo 会话...",
  "agentManager.cloud.status.ready": "云端智能体已就绪",
  "agentManager.cloud.status.failed": "云端智能体设置失败",
  "agentManager.cloud.message.failed": "消息发送失败",
  "agentManager.cloud.message.interrupted": "队列中的消息已中断",
