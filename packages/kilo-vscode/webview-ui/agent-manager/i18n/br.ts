export const dict = {
  ...
  "agentManager.browser.devtools": "Abrir DevTools",
  ...
  "agentManager.browser.notStarted": "não iniciado",
  "agentManager.browser.localOnly": "Somente URL de loopback HTTP; as solicitações externas estão bloqueadas",
