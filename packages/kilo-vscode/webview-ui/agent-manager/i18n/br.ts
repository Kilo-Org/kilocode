export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Conectando à sua sessão na nuvem...",
  "agentManager.cloud.empty": "Nenhum Cloud Agent encontrado.",
  "agentManager.cloud.emptyRepository": "Nenhuma sessão do Cloud Agent encontrada para {{repository}}.",
  "agentManager.cloud.failed": "Falha ao carregar Cloud Agents.",
  "agentManager.cloud.retry": "Tentar novamente",
  "agentManager.cloud.signedOut": "Entre para ver os Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Esta ação não é compatível com Cloud Agents.",
  "agentManager.cloud.status.preparing": "Preparando o agente na nuvem...",
  "agentManager.cloud.status.finalizing": "Finalizando o agente na nuvem...",
  "agentManager.cloud.status.diskCheck": "Verificando o espaço em disco...",
  "agentManager.cloud.status.workspaceSetup": "Configurando o espaço de trabalho...",
  "agentManager.cloud.status.cloning": "Clonando o repositório...",
  "agentManager.cloud.status.branch": "Preparando a branch...",
  "agentManager.cloud.status.devcontainerSetup": "Configurando o contêiner de desenvolvimento...",
  "agentManager.cloud.status.setupCommands": "Executando comandos de configuração...",
  "agentManager.cloud.status.kiloServer": "Iniciando o servidor Kilo...",
  "agentManager.cloud.status.kiloSession": "Iniciando a sessão do Kilo...",
  "agentManager.cloud.status.ready": "Agente na nuvem pronto",
  "agentManager.cloud.status.failed": "Falha na configuração do agente na nuvem",
  "agentManager.cloud.message.failed": "Falha ao entregar a mensagem",
  "agentManager.cloud.message.interrupted": "Mensagem na fila interrompida",
