export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Conectando con tu sesión en la nube...",
  "agentManager.cloud.empty": "No se encontraron Cloud Agents.",
  "agentManager.cloud.emptyRepository": "No se encontraron sesiones de Cloud Agent para {{repository}}.",
  "agentManager.cloud.failed": "No se pudieron cargar los Cloud Agents.",
  "agentManager.cloud.retry": "Reintentar",
  "agentManager.cloud.signedOut": "Inicia sesión para ver los Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Esta acción no es compatible con Cloud Agents.",
  "agentManager.cloud.status.preparing": "Preparando el agente en la nube...",
  "agentManager.cloud.status.finalizing": "Finalizando el agente en la nube...",
  "agentManager.cloud.status.diskCheck": "Comprobando el espacio en disco...",
  "agentManager.cloud.status.workspaceSetup": "Configurando el espacio de trabajo...",
  "agentManager.cloud.status.cloning": "Clonando el repositorio...",
  "agentManager.cloud.status.branch": "Preparando la rama...",
  "agentManager.cloud.status.devcontainerSetup": "Configurando el contenedor de desarrollo...",
  "agentManager.cloud.status.setupCommands": "Ejecutando comandos de configuración...",
  "agentManager.cloud.status.kiloServer": "Iniciando el servidor Kilo...",
  "agentManager.cloud.status.kiloSession": "Iniciando la sesión de Kilo...",
  "agentManager.cloud.status.ready": "Agente en la nube listo",
  "agentManager.cloud.status.failed": "Falló la configuración del agente en la nube",
  "agentManager.cloud.message.failed": "No se pudo entregar el mensaje",
  "agentManager.cloud.message.interrupted": "Mensaje en cola interrumpido",
