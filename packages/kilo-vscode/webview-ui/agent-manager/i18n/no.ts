export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Kobler til skyøkten din...",
  "agentManager.cloud.empty": "Ingen Cloud Agents funnet.",
  "agentManager.cloud.emptyRepository": "Ingen Cloud Agent-økter funnet for {{repository}}.",
  "agentManager.cloud.failed": "Kunne ikke laste Cloud Agents.",
  "agentManager.cloud.retry": "Prøv igjen",
  "agentManager.cloud.signedOut": "Logg inn for å se Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Denne handlingen støttes ikke for Cloud Agents.",
  "agentManager.cloud.status.preparing": "Forbereder skyagent...",
  "agentManager.cloud.status.finalizing": "Fullfører skyagent...",
  "agentManager.cloud.status.diskCheck": "Kontrollerer diskplass...",
  "agentManager.cloud.status.workspaceSetup": "Setter opp arbeidsområde...",
  "agentManager.cloud.status.cloning": "Kloner repositorium...",
  "agentManager.cloud.status.branch": "Forbereder gren...",
  "agentManager.cloud.status.devcontainerSetup": "Setter opp utviklingscontainer...",
  "agentManager.cloud.status.setupCommands": "Kjører oppsettkommandoer...",
  "agentManager.cloud.status.kiloServer": "Starter Kilo-server...",
  "agentManager.cloud.status.kiloSession": "Starter Kilo-økt...",
  "agentManager.cloud.status.ready": "Skyagenten er klar",
  "agentManager.cloud.status.failed": "Oppsett av skyagent mislyktes",
  "agentManager.cloud.message.failed": "Meldingen kunne ikke leveres",
  "agentManager.cloud.message.interrupted": "Melding i kø ble avbrutt",
