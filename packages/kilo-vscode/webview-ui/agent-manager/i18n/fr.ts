export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Connexion à votre session cloud...",
  "agentManager.cloud.empty": "Aucun Cloud Agent trouvé.",
  "agentManager.cloud.emptyRepository": "Aucune session Cloud Agent trouvée pour {{repository}}.",
  "agentManager.cloud.failed": "Échec du chargement des Cloud Agents.",
  "agentManager.cloud.retry": "Réessayer",
  "agentManager.cloud.signedOut": "Connectez-vous pour afficher les Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Cette action n'est pas prise en charge pour les Cloud Agents.",
  "agentManager.cloud.status.preparing": "Préparation de l'agent cloud...",
  "agentManager.cloud.status.finalizing": "Finalisation de l'agent cloud...",
  "agentManager.cloud.status.diskCheck": "Vérification de l'espace disque...",
  "agentManager.cloud.status.workspaceSetup": "Configuration de l'espace de travail...",
  "agentManager.cloud.status.cloning": "Clonage du dépôt...",
  "agentManager.cloud.status.branch": "Préparation de la branche...",
  "agentManager.cloud.status.devcontainerSetup": "Configuration du conteneur de développement...",
  "agentManager.cloud.status.setupCommands": "Exécution des commandes de configuration...",
  "agentManager.cloud.status.kiloServer": "Démarrage du serveur Kilo...",
  "agentManager.cloud.status.kiloSession": "Démarrage de la session Kilo...",
  "agentManager.cloud.status.ready": "Agent cloud prêt",
  "agentManager.cloud.status.failed": "Échec de la configuration de l'agent cloud",
  "agentManager.cloud.message.failed": "Échec de l'envoi du message",
  "agentManager.cloud.message.interrupted": "Message en file d'attente interrompu",
