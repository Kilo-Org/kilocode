export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Povezivanje s vašom cloud sesijom...",
  "agentManager.cloud.empty": "No cloud agents found.",
  "agentManager.cloud.emptyRepository": "Nisu pronađene Cloud Agent sesije za {{repository}}.",
  "agentManager.cloud.failed": "Failed to load cloud agents.",
  "agentManager.cloud.retry": "Retry",
  "agentManager.cloud.signedOut": "Sign in to view cloud agents.",
  "agentManager.cloud.unsupportedAction": "This action is not supported for cloud agents.",
  "agentManager.cloud.status.preparing": "Priprema cloud agenta...",
  "agentManager.cloud.status.finalizing": "Završavanje cloud agenta...",
  "agentManager.cloud.status.diskCheck": "Provjera prostora na disku...",
  "agentManager.cloud.status.workspaceSetup": "Postavljanje radnog prostora...",
  "agentManager.cloud.status.cloning": "Kloniranje repozitorija...",
  "agentManager.cloud.status.branch": "Priprema grane...",
  "agentManager.cloud.status.devcontainerSetup": "Postavljanje razvojnog kontejnera...",
  "agentManager.cloud.status.setupCommands": "Pokretanje naredbi za postavljanje...",
  "agentManager.cloud.status.kiloServer": "Pokretanje Kilo servera...",
  "agentManager.cloud.status.kiloSession": "Pokretanje Kilo sesije...",
  "agentManager.cloud.status.ready": "Cloud agent je spreman",
  "agentManager.cloud.status.failed": "Postavljanje cloud agenta nije uspjelo",
  "agentManager.cloud.message.failed": "Isporuka poruke nije uspjela",
  "agentManager.cloud.message.interrupted": "Poruka u redu čekanja je prekinuta",
