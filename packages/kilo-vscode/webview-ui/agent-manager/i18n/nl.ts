export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Verbinding maken met je cloudsessie...",
  "agentManager.cloud.empty": "Geen Cloud Agents gevonden.",
  "agentManager.cloud.emptyRepository": "Geen Cloud Agent-sessies gevonden voor {{repository}}.",
  "agentManager.cloud.failed": "Cloud Agents laden mislukt.",
  "agentManager.cloud.retry": "Opnieuw proberen",
  "agentManager.cloud.signedOut": "Meld je aan om Cloud Agents te bekijken.",
  "agentManager.cloud.unsupportedAction": "Deze actie wordt niet ondersteund voor Cloud Agents.",
  "agentManager.cloud.status.preparing": "Cloudagent voorbereiden...",
  "agentManager.cloud.status.finalizing": "Cloudagent afronden...",
  "agentManager.cloud.status.diskCheck": "Schijfruimte controleren...",
  "agentManager.cloud.status.workspaceSetup": "Werkruimte instellen...",
  "agentManager.cloud.status.cloning": "Repository klonen...",
  "agentManager.cloud.status.branch": "Branch voorbereiden...",
  "agentManager.cloud.status.devcontainerSetup": "Ontwikkelcontainer instellen...",
  "agentManager.cloud.status.setupCommands": "Installatieopdrachten uitvoeren...",
  "agentManager.cloud.status.kiloServer": "Kilo-server starten...",
  "agentManager.cloud.status.kiloSession": "Kilo-sessie starten...",
  "agentManager.cloud.status.ready": "Cloudagent gereed",
  "agentManager.cloud.status.failed": "Instellen van cloudagent mislukt",
  "agentManager.cloud.message.failed": "Bericht kon niet worden afgeleverd",
  "agentManager.cloud.message.interrupted": "Bericht in wachtrij onderbroken",
