export const dict = {
  ...
  "agentManager.cloud.connectingSession": "جارٍ الاتصال بجلستك السحابية...",
  "agentManager.cloud.empty": "No cloud agents found.",
  "agentManager.cloud.emptyRepository": "لم يتم العثور على جلسات Cloud Agent للمستودع {{repository}}.",
  ...
  "agentManager.cloud.status.preparing": "جارٍ تحضير الوكيل السحابي...",
  "agentManager.cloud.status.finalizing": "جارٍ إنهاء إعداد الوكيل السحابي...",
  "agentManager.cloud.status.diskCheck": "جارٍ التحقق من مساحة القرص...",
  "agentManager.cloud.status.workspaceSetup": "جارٍ إعداد مساحة العمل...",
  "agentManager.cloud.status.cloning": "جارٍ استنساخ المستودع...",
  "agentManager.cloud.status.branch": "جارٍ تحضير الفرع...",
  "agentManager.cloud.status.devcontainerSetup": "جارٍ إعداد حاوية التطوير...",
  "agentManager.cloud.status.setupCommands": "جارٍ تشغيل أوامر الإعداد...",
  "agentManager.cloud.status.kiloServer": "جارٍ تشغيل خادم Kilo...",
  "agentManager.cloud.status.kiloSession": "جارٍ بدء جلسة Kilo...",
  "agentManager.cloud.status.ready": "الوكيل السحابي جاهز",
  "agentManager.cloud.status.failed": "فشل إعداد الوكيل السحابي",
  "agentManager.cloud.message.failed": "فشل تسليم الرسالة",
  "agentManager.cloud.message.interrupted": "تمت مقاطعة الرسالة الموضوعة في قائمة الانتظار",
