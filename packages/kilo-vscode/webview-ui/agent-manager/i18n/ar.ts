export const dict = {
  ...
  "agentManager.intro.title": "شغّل الوكلاء بالتوازي، كل واحد على فرعه الخاص",
  "agentManager.intro.subtitle":
    "كل worktree هو نسخة منفصلة من هذا المستودع على فرعه الخاص. يعمل الوكلاء هناك في الوقت نفسه، ويبقى مجلدك المحلي دون تغيير.",
  "agentManager.intro.graph.agent": "وكيل",
  ...
  "agentManager.intro.stage1.title": "فرعك",
  "agentManager.intro.stage1.text":
    '"محلي" هو مجلد مساحة العمل العادي لديك على the base branch. الـ worktree هو checkout ثانٍ لنفس المستودع في .kilo/worktrees/<name>، على فرعه الخاص. التغييرات في worktree لا تمس ملفاتك المحلية أو فرعك الحالي.',
  "agentManager.intro.stage2.title": "وزّع المهام",
  "agentManager.intro.stage2.text":
    "أنشئ worktree واحدًا لكل مهمة. يحصل كل worktree على فرعه الخاص وجلسة وكيل خاصة به. استخدم النسخ في مربع حوار شجرة عمل جديدة لتشغيل موجّه واحد بما يصل إلى 4 طرق والاحتفاظ بأفضل نتيجة.",
  "agentManager.intro.stage3.title": "الوكلاء بالتوازي",
  "agentManager.intro.stage3.text":
    "يعمل الوكلاء في الوقت نفسه ولا يمكنهم الكتابة فوق ملفات بعضهم. تابع كل واحد من علامة تبويبه، وتحقق من الفرق، وشغّل التطبيق من طرفية الـ worktree.",
  "agentManager.intro.stage4.title": "أعد العمل",
  "agentManager.intro.stage4.text":
    "افتح لوحة الفرق واستخدم Apply لنسخ تغييرات worktree إلى فرعك المحلي. أو ادفع الفرع وافتح PR من طرفية الجلسة. إذا غيّر worktree اثنان نفس الكود، فسيواجه الثاني عند الدمج تعارضات: اطلب من الوكيل في ذلك الـ worktree دمج the base branch أولًا. لا تستخدم git stash داخل worktree أبدًا.",
  ...
  "agentManager.intro.create": "أنشئ أول worktree لك",
  "agentManager.intro.guide": "اقرأ الدليل",
  "agentManager.intro.dismiss": "فهمت",
