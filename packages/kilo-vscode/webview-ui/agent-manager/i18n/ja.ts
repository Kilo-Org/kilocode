export const dict = {
  ...
  "agentManager.cloud.connectingSession": "クラウドセッションに接続しています...",
  "agentManager.cloud.empty": "Cloud Agents が見つかりません。",
  "agentManager.cloud.emptyRepository": "{{repository}} の Cloud Agent セッションが見つかりません。",
  "agentManager.cloud.failed": "Cloud Agents を読み込めませんでした。",
  "agentManager.cloud.retry": "再試行",
  "agentManager.cloud.signedOut": "Cloud Agents を表示するにはサインインしてください。",
  "agentManager.cloud.unsupportedAction": "Cloud Agents ではこの操作はサポートされていません。",
  "agentManager.cloud.status.preparing": "クラウドエージェントを準備しています...",
  "agentManager.cloud.status.finalizing": "クラウドエージェントを仕上げています...",
  "agentManager.cloud.status.diskCheck": "ディスク容量を確認しています...",
  "agentManager.cloud.status.workspaceSetup": "ワークスペースを設定しています...",
  "agentManager.cloud.status.cloning": "リポジトリをクローンしています...",
  "agentManager.cloud.status.branch": "ブランチを準備しています...",
  "agentManager.cloud.status.devcontainerSetup": "開発コンテナーを設定しています...",
  "agentManager.cloud.status.setupCommands": "セットアップコマンドを実行しています...",
  "agentManager.cloud.status.kiloServer": "Kilo サーバーを起動しています...",
  "agentManager.cloud.status.kiloSession": "Kilo セッションを開始しています...",
  "agentManager.cloud.status.ready": "クラウドエージェントの準備ができました",
  "agentManager.cloud.status.failed": "クラウドエージェントの設定に失敗しました",
  "agentManager.cloud.message.failed": "メッセージを配信できませんでした",
  "agentManager.cloud.message.interrupted": "キュー内のメッセージが中断されました",
