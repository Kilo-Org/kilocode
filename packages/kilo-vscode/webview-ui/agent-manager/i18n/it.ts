export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Connessione alla sessione cloud...",
  "agentManager.cloud.empty": "Nessun Cloud Agent trovato.",
  "agentManager.cloud.emptyRepository": "Nessuna sessione Cloud Agent trovata per {{repository}}.",
  "agentManager.cloud.failed": "Caricamento dei Cloud Agents non riuscito.",
  "agentManager.cloud.retry": "Riprova",
  "agentManager.cloud.signedOut": "Accedi per visualizzare i Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Questa azione non è supportata per i Cloud Agents.",
  "agentManager.cloud.status.preparing": "Preparazione dell'agente cloud...",
  "agentManager.cloud.status.finalizing": "Finalizzazione dell'agente cloud...",
  "agentManager.cloud.status.diskCheck": "Controllo dello spazio su disco...",
  "agentManager.cloud.status.workspaceSetup": "Configurazione dell'area di lavoro...",
  "agentManager.cloud.status.cloning": "Clonazione del repository...",
  "agentManager.cloud.status.branch": "Preparazione del branch...",
  "agentManager.cloud.status.devcontainerSetup": "Configurazione del contenitore di sviluppo...",
  "agentManager.cloud.status.setupCommands": "Esecuzione dei comandi di configurazione...",
  "agentManager.cloud.status.kiloServer": "Avvio del server Kilo...",
  "agentManager.cloud.status.kiloSession": "Avvio della sessione Kilo...",
  "agentManager.cloud.status.ready": "Agente cloud pronto",
  "agentManager.cloud.status.failed": "Configurazione dell'agente cloud non riuscita",
  "agentManager.cloud.message.failed": "Impossibile recapitare il messaggio",
  "agentManager.cloud.message.interrupted": "Messaggio in coda interrotto",
