export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Łączenie z sesją w chmurze...",
  "agentManager.cloud.empty": "Nie znaleziono Cloud Agents.",
  "agentManager.cloud.emptyRepository": "Nie znaleziono sesji Cloud Agent dla {{repository}}.",
  "agentManager.cloud.failed": "Nie udało się załadować Cloud Agents.",
  "agentManager.cloud.retry": "Ponów próbę",
  "agentManager.cloud.signedOut": "Zaloguj się, aby wyświetlić Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Ta akcja nie jest obsługiwana dla Cloud Agents.",
  "agentManager.cloud.status.preparing": "Przygotowywanie agenta w chmurze...",
  "agentManager.cloud.status.finalizing": "Finalizowanie agenta w chmurze...",
  "agentManager.cloud.status.diskCheck": "Sprawdzanie miejsca na dysku...",
  "agentManager.cloud.status.workspaceSetup": "Konfigurowanie obszaru roboczego...",
  "agentManager.cloud.status.cloning": "Klonowanie repozytorium...",
  "agentManager.cloud.status.branch": "Przygotowywanie gałęzi...",
  "agentManager.cloud.status.devcontainerSetup": "Konfigurowanie kontenera deweloperskiego...",
  "agentManager.cloud.status.setupCommands": "Uruchamianie poleceń konfiguracji...",
  "agentManager.cloud.status.kiloServer": "Uruchamianie serwera Kilo...",
  "agentManager.cloud.status.kiloSession": "Uruchamianie sesji Kilo...",
  "agentManager.cloud.status.ready": "Agent w chmurze jest gotowy",
  "agentManager.cloud.status.failed": "Konfiguracja agenta w chmurze nie powiodła się",
  "agentManager.cloud.message.failed": "Nie udało się dostarczyć wiadomości",
  "agentManager.cloud.message.interrupted": "Wiadomość w kolejce została przerwana",
