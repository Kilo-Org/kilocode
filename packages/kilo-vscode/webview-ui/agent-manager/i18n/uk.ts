export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Підключення до вашого хмарного сеансу...",
  "agentManager.cloud.empty": "Cloud Agents не знайдено.",
  "agentManager.cloud.emptyRepository": "Сеанси Cloud Agent для {{repository}} не знайдено.",
  "agentManager.cloud.failed": "Не вдалося завантажити Cloud Agents.",
  "agentManager.cloud.retry": "Повторити",
  "agentManager.cloud.signedOut": "Увійдіть, щоб переглянути Cloud Agents.",
  "agentManager.cloud.unsupportedAction": "Ця дія не підтримується для Cloud Agents.",
  "agentManager.cloud.status.preparing": "Підготовка хмарного агента...",
  "agentManager.cloud.status.finalizing": "Завершення налаштування хмарного агента...",
  "agentManager.cloud.status.diskCheck": "Перевірка місця на диску...",
  "agentManager.cloud.status.workspaceSetup": "Налаштування робочого простору...",
  "agentManager.cloud.status.cloning": "Клонування репозиторію...",
  "agentManager.cloud.status.branch": "Підготовка гілки...",
  "agentManager.cloud.status.devcontainerSetup": "Налаштування контейнера розробки...",
  "agentManager.cloud.status.setupCommands": "Виконання команд налаштування...",
  "agentManager.cloud.status.kiloServer": "Запуск сервера Kilo...",
  "agentManager.cloud.status.kiloSession": "Запуск сеансу Kilo...",
  "agentManager.cloud.status.ready": "Хмарний агент готовий",
  "agentManager.cloud.status.failed": "Не вдалося налаштувати хмарний агент",
  "agentManager.cloud.message.failed": "Не вдалося доставити повідомлення",
  "agentManager.cloud.message.interrupted": "Повідомлення в черзі було перервано",
