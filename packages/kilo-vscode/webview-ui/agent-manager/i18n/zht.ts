export const dict = {
  ...
  "agentManager.cloud.connectingSession": "正在連線至您的雲端工作階段...",
  "agentManager.cloud.empty": "找不到 Cloud Agents。",
  "agentManager.cloud.emptyRepository": "找不到 {{repository}} 的 Cloud Agent 工作階段。",
  "agentManager.cloud.failed": "無法載入 Cloud Agents。",
  "agentManager.cloud.retry": "重試",
  "agentManager.cloud.signedOut": "登入以檢視 Cloud Agents。",
  "agentManager.cloud.unsupportedAction": "Cloud Agents 不支援此操作。",
  "agentManager.cloud.status.preparing": "正在準備雲端代理...",
  "agentManager.cloud.status.finalizing": "正在完成雲端代理設定...",
  "agentManager.cloud.status.diskCheck": "正在檢查磁碟空間...",
  "agentManager.cloud.status.workspaceSetup": "正在設定工作區...",
  "agentManager.cloud.status.cloning": "正在複製儲存庫...",
  "agentManager.cloud.status.branch": "正在準備分支...",
  "agentManager.cloud.status.devcontainerSetup": "正在設定開發容器...",
  "agentManager.cloud.status.setupCommands": "正在執行設定命令...",
  "agentManager.cloud.status.kiloServer": "正在啟動 Kilo 伺服器...",
  "agentManager.cloud.status.kiloSession": "正在啟動 Kilo 工作階段...",
  "agentManager.cloud.status.ready": "雲端代理已就緒",
  "agentManager.cloud.status.failed": "雲端代理設定失敗",
  "agentManager.cloud.message.failed": "訊息傳送失敗",
  "agentManager.cloud.message.interrupted": "佇列中的訊息已中斷",
