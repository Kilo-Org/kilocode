export const dict = {
  ...
  "agentManager.intro.title": "並行執行代理，每個代理都在自己的分支上",
  "agentManager.intro.subtitle":
    "每個 worktree 都是此儲存庫在獨立分支上的個別副本。代理在其中同時工作，你的本機資料夾保持不變。",
  "agentManager.intro.graph.agent": "代理",
  "agentManager.intro.graph.pr": "PR",
  "agentManager.intro.graph.conflict": "衝突",
  "agentManager.intro.conflictText":
    "請讓 worktree 中的代理程式合併其原始基礎分支並解決衝突，然後檢查結果。請避免使用 git stash，因為 stash 會在 worktree 之間共用。",
  "agentManager.intro.stage1.title": "你的分支",
  "agentManager.intro.stage1.text":
    '"本機"是你在 the base branch 上的一般工作區資料夾。worktree 是同一儲存庫在 .kilo/worktrees/<name> 中的第二個簽出，位於自己的分支上。worktree 中的變更不會影響你的本機檔案或目前分支。',
  "agentManager.intro.stage2.title": "分派任務",
  "agentManager.intro.stage2.text":
    "為每個任務建立一個 worktree。每個 worktree 都有自己的分支和代理工作階段。在新建工作樹對話方塊中使用版本，可將同一個提示最多以 4 種方式執行，並保留最佳結果。",
  "agentManager.intro.stage3.title": "代理並行執行",
  "agentManager.intro.stage3.text":
    "代理同時執行，不會互相覆寫檔案。在各自的分頁中追蹤每個代理，檢查差異，並從 worktree 的終端機執行應用程式。",
  "agentManager.intro.stage4.title": "合併回來",
  "agentManager.intro.stage4.text":
    "開啟差異面板，使用 Apply 將 worktree 的變更複製到你的本機分支。或者在工作階段終端機中推送分支並開啟 PR。如果兩個 worktree 修改了同一段程式碼，後合併的那個會有衝突：請讓該 worktree 中的代理先合併 the base branch。切勿在 worktree 中使用 git stash。",
  ...
  "agentManager.intro.create": "建立你的第一個 worktree",
  "agentManager.intro.guide": "閱讀指南",
  "agentManager.intro.dismiss": "知道了",
