export const dict = {
  ...
  "agentManager.cloud.connectingSession": "กำลังเชื่อมต่อกับเซสชันคลาวด์ของคุณ...",
  "agentManager.cloud.empty": "No cloud agents found.",
  "agentManager.cloud.emptyRepository": "ไม่พบเซสชัน Cloud Agent สำหรับ {{repository}}",
  ...
  "agentManager.cloud.status.preparing": "กำลังเตรียมคลาวด์เอเจนต์...",
  "agentManager.cloud.status.finalizing": "กำลังดำเนินการคลาวด์เอเจนต์ให้เสร็จ...",
  "agentManager.cloud.status.diskCheck": "กำลังตรวจสอบพื้นที่ดิสก์...",
  "agentManager.cloud.status.workspaceSetup": "กำลังตั้งค่าพื้นที่ทำงาน...",
  "agentManager.cloud.status.cloning": "กำลังโคลนที่เก็บโค้ด...",
  "agentManager.cloud.status.branch": "กำลังเตรียมสาขา...",
  "agentManager.cloud.status.devcontainerSetup": "กำลังตั้งค่าคอนเทนเนอร์สำหรับพัฒนา...",
  "agentManager.cloud.status.setupCommands": "กำลังเรียกใช้คำสั่งตั้งค่า...",
  "agentManager.cloud.status.kiloServer": "กำลังเริ่มเซิร์ฟเวอร์ Kilo...",
  "agentManager.cloud.status.kiloSession": "กำลังเริ่มเซสชัน Kilo...",
  "agentManager.cloud.status.ready": "คลาวด์เอเจนต์พร้อมแล้ว",
  "agentManager.cloud.status.failed": "ตั้งค่าคลาวด์เอเจนต์ไม่สำเร็จ",
  "agentManager.cloud.message.failed": "ส่งข้อความไม่สำเร็จ",
  "agentManager.cloud.message.interrupted": "ข้อความในคิวถูกขัดจังหวะ",
