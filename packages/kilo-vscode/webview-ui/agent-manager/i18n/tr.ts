export const dict = {
  ...
  "agentManager.cloud.connectingSession": "Bulut oturumunuza bağlanılıyor...",
  "agentManager.cloud.empty": "Cloud Agents bulunamadı.",
  "agentManager.cloud.emptyRepository": "{{repository}} için Cloud Agent oturumu bulunamadı.",
  "agentManager.cloud.failed": "Cloud Agents yüklenemedi.",
  "agentManager.cloud.retry": "Yeniden dene",
  "agentManager.cloud.signedOut": "Cloud Agents'ı görüntülemek için oturum açın.",
  "agentManager.cloud.unsupportedAction": "Bu işlem Cloud Agents için desteklenmiyor.",
  "agentManager.cloud.status.preparing": "Bulut aracısı hazırlanıyor...",
  "agentManager.cloud.status.finalizing": "Bulut aracısı tamamlanıyor...",
  "agentManager.cloud.status.diskCheck": "Disk alanı kontrol ediliyor...",
  "agentManager.cloud.status.workspaceSetup": "Çalışma alanı ayarlanıyor...",
  "agentManager.cloud.status.cloning": "Depo klonlanıyor...",
  "agentManager.cloud.status.branch": "Dal hazırlanıyor...",
  "agentManager.cloud.status.devcontainerSetup": "Geliştirme kapsayıcısı ayarlanıyor...",
  "agentManager.cloud.status.setupCommands": "Kurulum komutları çalıştırılıyor...",
  "agentManager.cloud.status.kiloServer": "Kilo sunucusu başlatılıyor...",
  "agentManager.cloud.status.kiloSession": "Kilo oturumu başlatılıyor...",
  "agentManager.cloud.status.ready": "Bulut aracısı hazır",
  "agentManager.cloud.status.failed": "Bulut aracısı kurulumu başarısız oldu",
  "agentManager.cloud.message.failed": "Mesaj teslim edilemedi",
  "agentManager.cloud.message.interrupted": "Kuyruktaki mesaj kesintiye uğradı",
  "agentManager.cloud.create.open": "New cloud agent",
  "agentManager.cloud.create.title": "New Cloud Agent",
  "agentManager.cloud.create.loading": "Loading workspace context...",
  "agentManager.cloud.create.repository": "Repository",
  "agentManager.cloud.create.account": "Account",
  "agentManager.cloud.create.unavailable": "Unavailable",
  "agentManager.cloud.create.contextUnavailable": "Cloud Agent creation is unavailable for this workspace.",
  "agentManager.cloud.create.prompt": "Initial prompt",
  "agentManager.cloud.create.promptPlaceholder": "Describe the task for your cloud agent",
  "agentManager.cloud.create.mode": "Mode",
  "agentManager.cloud.create.model": "Model",
  "agentManager.cloud.create.creating": "Starting cloud agent...",
  "agentManager.cloud.create.note": "Cloud Agent creates an isolated remote branch for this session.",
  "agentManager.cloud.create.cancel": "Cancel",
  "agentManager.cloud.create.start": "Start session",
