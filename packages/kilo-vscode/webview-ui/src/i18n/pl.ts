export const dict = {
  ...
  "provider.anaconda.state.unsupported": "Anaconda Desktop nie jest obsługiwany na {{platform}}.",
  "provider.anaconda.state.notInstalled":
    "Zainstaluj Anaconda Desktop na tym komputerze, a następnie wróć tutaj. Kilo nie uruchomi instalatora za ciebie.",
  "provider.anaconda.state.notRunning":
    "Otwórz Anaconda Desktop, dokończ konfigurację i zaloguj się, a następnie wybierz Sprawdź ponownie.",
  "provider.anaconda.state.invalidConfig":
    "Konfiguracja Anaconda Desktop jest niekompletna. Otwórz Desktop, dokończ konfigurację i uruchom ponownie, jeśli potrzeba.",
  "provider.anaconda.state.signedOut": "Otwórz Anaconda Desktop i zaloguj się przed połączeniem Kilo.",
  "provider.anaconda.state.unauthorized":
    "Kilo nie mogło uzyskać dostępu do Anaconda Desktop. Otwórz Desktop, zaloguj się ponownie i uruchom ponownie, jeśli potrzeba.",
  "provider.anaconda.state.unavailable":
    "Anaconda Desktop jeszcze nie odpowiada. Otwórz go i poczekaj, aż aplikacja zakończy uruchamianie.",
  "provider.anaconda.state.noModel":
    "W Anaconda Desktop pobierz model generowania tekstu. Wybierz taki, który obsługuje wywoływanie narzędzi, jeśli to możliwe, a następnie uruchom jego serwer.",
  ...
  "provider.anaconda.state.unhealthy":
    "Aktywny serwer wnioskowania nie jest jeszcze sprawny. Sprawdź go w Anaconda Desktop i uruchom ponownie, jeśli potrzeba.",
  ...
  "provider.anaconda.tools.unsupported": "Nieaktywne",
  ...
  "provider.anaconda.warning.description":
    "Ten serwer nie potwierdza wywoływania narzędzi. Działania agenta kodowania mogą nie działać lub być niedostępne. Kontynuuj tylko jeśli akceptujesz te ograniczenia.",
