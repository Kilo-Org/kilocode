export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Wybierz domyślnego agenta",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Domyślny agent",
  "workStyle.agent.code.tasks": "Najlepszy do zadań programistycznych",
  "workStyle.agent.code.changes": "Odczytuje, pisze i modyfikuje kod",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Najlepszy do analizy danych",
  "workStyle.agent.data.notebooks": "Uruchamia zapytania i tworzy wizualizacje w notatnikach Jupyter",
  "workStyle.agent.data.requirement": "Wymaga rozszerzenia Jupyter",
