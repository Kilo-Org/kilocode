...
export const dict = {
  ...
  "settings.autoCleanup.enable.description":
    "Automatycznie usuwa starą historię zadań po określonej liczbie dni — we wszystkich projektach i we wszystkich klientach Kilo na tym komputerze, nie tylko w tym oknie. Uruchomione zadania i zadania z niedawnym forkiem nigdy nie są usuwane. Usunięcie jest trwałe.",
  ...
  "settings.autoCleanup.runNow.confirm":
    "Trwale usunąć wygasłe zadania we wszystkich projektach i we wszystkich klientach Kilo na tym komputerze?",
