export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.permissions": "Prosi o pozwolenie przed edycją plików.",
  "workStyle.choice.human-in-the-loop.bash": "Prosi o pozwolenie na każde polecenie terminala.",
  "workStyle.choice.human-in-the-loop.visibility": "Wyświetla szczegóły rozmowy, w tym polecenia i tok rozumowania.",
