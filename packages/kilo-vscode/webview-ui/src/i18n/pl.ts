...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Dodaj środki",
  "profile.usage.action.manageBilling": "Zarządzaj rozliczeniami",
  ...
  "profile.usage.topups.title": "Doładowania osobiste",
  "profile.usage.topups.auto": "Automatyczne doładowanie",
  "profile.usage.topups.on": "Wł.",
  "profile.usage.topups.off": "Wył.",
  "profile.usage.topups.rule": "Dodaj ${{amount}}, gdy saldo osiągnie ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} z końcówką {{last4}}",
  "profile.usage.balance.breakdown": "Przyznano {{granted}} | Doładowano {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "niedostępne",
  "profile.usage.credits.resets": "{{count}} resetów",
