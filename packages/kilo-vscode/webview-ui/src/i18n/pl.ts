export const dict = {
  ...
  "migration.progress.sessions": "Sesje czatu",
  "migration.progress.defaultModel": "Model domyślny",
  "migration.progress.commandRules": "Reguły poleceń",
  "migration.progress.readPermission": "Uprawnienie odczytu",
  "migration.progress.writePermission": "Uprawnienie zapisu",
  "migration.progress.executePermission": "Uprawnienie wykonania",
  "migration.progress.mcpPermission": "Uprawnienie MCP",
  "migration.progress.taskPermission": "Uprawnienie zadań",
  "migration.progress.language": "Preferencja języka",
  "migration.progress.autocomplete": "Ustawienia autouzupełniania",
