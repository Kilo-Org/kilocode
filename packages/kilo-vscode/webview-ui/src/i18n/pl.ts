export const dict = {
  ...
  "workStyle.onboarding.title": "Wybierz, jak chcesz pracować z agentami AI",
  ...
  "workStyle.toast.saved.title": "Preferencje zapisane",
  ...
  "workStyle.choice.human.eyebrow": "Człowiek w pętli",
  "workStyle.choice.human.title": "Najpierw przejrzyj",
  "workStyle.choice.human.description":
    "Kilo często wstrzymuje pracę i pokazuje, co zamierza zrobić w trakcie jej wykonywania.",
  "workStyle.choice.human.permissions": "Prosi o pozwolenie przed edycją plików.",
  "workStyle.choice.human.bash": "Prosi o pozwolenie na każde polecenie terminala.",
  "workStyle.choice.human.visibility": "Wyświetla szczegóły rozmowy, w tym polecenia i tok rozumowania.",
  "workStyle.choice.autonomous.eyebrow": "Mniej przerw",
  "workStyle.choice.autonomous.title": "Wysoka autonomia",
  "workStyle.choice.autonomous.description": "Pracuj z mniejszą liczbą przerw i uproszczonym interfejsem.",
  "workStyle.choice.autonomous.permissions": "Może automatycznie edytować pliki w przestrzeni roboczej.",
  "workStyle.choice.autonomous.bash": "Może uruchamiać polecenia terminala w przestrzeni roboczej bez zatwierdzenia.",
  "workStyle.choice.autonomous.visibility": "Szczegóły rozmowy pozostają ukryte, dopóki ich nie rozwiniesz.",
