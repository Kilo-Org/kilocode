...
export const dict = {
  ...
  "settings.autoCleanup.starting": "Rozpoczynanie czyszczenia sesji...",
  "settings.autoCleanup.error.status": "Status czyszczenia sesji jest tymczasowo niedostępny. Ponawianie próby...",
  "settings.autoCleanup.error.timeout": "Oczekiwanie na status czyszczenia. Backend odpowiada dłużej niż oczekiwano.",
