...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Adres Milvus",
  "settings.indexing.milvusAddress.description": "Adres instancji Milvus Standalone lub Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Token Milvus",
  "settings.indexing.milvusToken.description": "Opcjonalny token dla uwierzytelnionego Milvus lub Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Opcjonalny token",
  "settings.indexing.milvusDatabase.title": "Baza danych Milvus",
  "settings.indexing.milvusDatabase.description": "Opcjonalna nazwa bazy danych Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "Pozostaw puste, aby użyć wartości domyślnej",
