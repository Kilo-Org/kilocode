export const dict = {
  ...
  "agentManager.diff.changes": "Zmiany",
  "agentManager.diff.close": "Zamknij",
  "agentManager.diff.loading": "Obliczanie diff...",
  "agentManager.diff.empty": "Nie wykryto zmian",
  "agentManager.diff.added": "Dodano",
  "agentManager.diff.removed": "Usunięto",
  "agentManager.diff.commentOnLine": "Komentarz do linii {{line}}",
  "agentManager.diff.editCommentOnLine": "Edytuj komentarz do linii {{line}}",
  "agentManager.diff.placeholder": "Zostaw komentarz...",
  "agentManager.diff.cancel": "Anuluj",
  "agentManager.diff.comment": "Komentarz",
  "agentManager.diff.save": "Zapisz",
  "agentManager.diff.send": "Wyślij",
  "agentManager.diff.sendTooltip": "Wyślij bezpośrednio do LLM",
  "agentManager.diff.commentTooltip": "Zapisz komentarz ({{shortcut}})",
  "agentManager.diff.sendToChat": "Wyślij do czatu",
  "agentManager.diff.edit": "Edytuj",
  "agentManager.diff.delete": "Usuń",
  "agentManager.diff.commentsCount": "{{count}} komentarz",
  "agentManager.diff.commentsCountPlural": "{{count}} komentarzy",
  "agentManager.diff.sendAllToChat": "Wyślij wszystko do czatu",
  "agentManager.shortcuts.sendAllComments": "Wyślij wszystkie komentarze do LLM",
