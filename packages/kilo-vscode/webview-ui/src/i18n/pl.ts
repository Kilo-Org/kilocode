export const dict = {
  ...
  "agentRequirements.skill.installing": "Instalowanie z Marketplace...",
  "agentRequirements.skill.verifying": "Zainstalowano. Sprawdzanie, czy umiejętność została wykryta...",
  "agentRequirements.skill.installed": "Zainstalowana",
  "agentRequirements.skill.installFailed": "Instalacja nie powiodła się",
  "agentRequirements.skill.checkFailed": "Weryfikacja umiejętności nie powiodła się",
  "agentRequirements.group.skills": "Umiejętności",
  "agentRequirements.group.mcps": "MCP",
  "agentRequirements.group.extensions": "Rozszerzenia",
  "agentRequirements.skill.missing": "Wymagana umiejętność nie została zainstalowana",
  "agentRequirements.checking.title": "Sprawdzanie wymagań agenta",
  "agentRequirements.checking.description": "Sprawdzanie umiejętności dostępnych w tym projekcie.",
  "agentRequirements.ready.title": "Gotowe",
  "agentRequirements.ready.description": "Wszystkie wymagane umiejętności są dostępne.",
  "agentRequirements.blocked.title": "Wykonaj wymagane kontrole",
  "agentRequirements.blocked.description":
    "Ten agent wymaga następujących umiejętności, zanim będzie można go uruchomić.",
  "agentRequirements.action.installing": "Instalowanie umiejętności...",
  "agentRequirements.action.installAll": "Zainstaluj wszystkie brakujące umiejętności / MCP",
  "agentRequirements.install.partialFailure":
    "Nie udało się zainstalować niektórych umiejętności. Napraw błędy i spróbuj ponownie.",
  "agentRequirements.prompt.blocked": "Najpierw wykonaj wymagane kontrole, aby użyć tego agenta",
  "agentRequirements.error.unknownAgent": "Nie znaleziono wybranego agenta.",
  "agentRequirements.error.malformedDeclaration": "Ten agent ma nieprawidłową deklarację wymaganych umiejętności.",
  "agentRequirements.error.discoveryFailed": "Kilo nie mogło sprawdzić dostępnych umiejętności.",
  "agentRequirements.error.scopeMismatch": "Ta kontrola wymagań agenta nie jest już aktywna.",
  "agentRequirements.error.requestFailed": "Kilo nie mogło sprawdzić wymagań agenta.",
  "agentRequirements.install.error.skillNotFound": "Nie znaleziono wymaganej umiejętności w Marketplace.",
  "agentRequirements.install.error.itemNotSkill": "Element Marketplace nie jest umiejętnością.",
  "agentRequirements.install.error.unavailable": "Instalacja umiejętności jest niedostępna w tym widoku.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo nie mogło wczytać umiejętności z Marketplace.",
