...
export const dict = {
  ...
  "tool.board.read": "Przeczytaj wiadomości",
  "tool.board.post": "Opublikuj wiadomość",
  "tool.board.message": "Przeczytano 1 wiadomość",
  "tool.board.messages": "Przeczytano {{count}} wiadomości",
  "tool.board.empty": "Brak wiadomości do przeczytania",
  "tool.board.posted": "Opublikowano dla: {{recipient}}",
  "tool.board.saved": "Zapisano dla: {{recipient}}",
  "tool.board.channel": "Kilo Swarm (wspólna tablica)",
  "tool.board.details": "Szczegóły",
  "tool.board.unavailable": "Dane wiadomości są niedostępne. Otwórz szczegóły, aby je sprawdzić.",
  "tool.board.from": "Od: {{sender}}",
  "tool.board.status": "Dostarczenie: {{status}}",
  "tool.board.inactive": "Zapisano, gdy odbiorca był nieaktywny",
  "tool.board.audience": "Zapisano; nie było innych aktywnych odbiorców",
  "tool.board.unknown": "Zapisano; aktywność odbiorców była nieznana",
  "tool.board.receipt": "Potwierdzenie odczytu niedostępne",
  "tool.board.agent": "Agent {{id}}",
  "tool.board.more": "Na tablicy są dostępne kolejne wiadomości.",
  "tool.board.showMore": "Pokaż jeszcze {{count}}",
  "tool.board.showLess": "Pokaż mniej",
  "tool.board.main": "Główny",
  "tool.board.all": "Wszyscy agenci",
  "tool.board.to": "Do: {{recipient}}",
