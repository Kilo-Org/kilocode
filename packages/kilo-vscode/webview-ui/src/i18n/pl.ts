export const dict = {
  ...
  "settings.display.codeEdit.title": "Bloki kodu",
  "settings.display.codeEdit.description": "Wybierz, czy bloki edycji kodu mają domyślnie być rozwinięte czy zwinięte",
