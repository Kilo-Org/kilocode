export const dict = {
  ...
  "revert.banner.step": "Krok agenta cofnięty",
  "checkpoint.label": "Punkt kontrolny",
  "checkpoint.viewChanges": "Wyświetl zmiany od tego punktu kontrolnego",
  "checkpoint.parallel": "Punkt kontrolny przed {{count}} równoległymi narzędziami",
  "checkpoint.stopRewind": "Zatrzymaj i cofnij",
  "checkpoint.unavailable": "Punkt kontrolny niedostępny, ponieważ nie przechwycono migawki",
  "checkpoint.sharedDirectory": "Inna aktywna sesja używa tego katalogu. Cofnięcie może przywrócić również jej zmiany.",
  "checkpoint.sharedDirectory.confirm": "Cofnij mimo to",
  "checkpoint.failed": "Nie udało się cofnąć do punktu kontrolnego.",
