export const dict = {
  ...
  "migration.progress.sessions": "เซสชันแชต",
  "migration.progress.defaultModel": "โมเดลเริ่มต้น",
  "migration.progress.commandRules": "กฎคำสั่ง",
  "migration.progress.readPermission": "สิทธิ์การอ่าน",
  "migration.progress.writePermission": "สิทธิ์การเขียน",
  "migration.progress.executePermission": "สิทธิ์การรัน",
  "migration.progress.mcpPermission": "สิทธิ์ MCP",
  "migration.progress.taskPermission": "สิทธิ์งาน",
  "migration.progress.language": "การตั้งค่าภาษา",
  "migration.progress.autocomplete": "การตั้งค่าการเติมข้อความอัตโนมัติ",
