export const dict = {
  ...
  "agentManager.diff.changes": "การเปลี่ยนแปลง",
  "agentManager.diff.close": "ปิด",
  "agentManager.diff.loading": "กำลังคำนวณ diff...",
  "agentManager.diff.empty": "ไม่พบการเปลี่ยนแปลง",
  "agentManager.diff.added": "เพิ่มแล้ว",
  "agentManager.diff.removed": "ลบแล้ว",
  "agentManager.diff.commentOnLine": "แสดงความคิดเห็นที่บรรทัด {{line}}",
  "agentManager.diff.editCommentOnLine": "แก้ไขความคิดเห็นที่บรรทัด {{line}}",
  "agentManager.diff.placeholder": "แสดงความคิดเห็น...",
  "agentManager.diff.cancel": "ยกเลิก",
  "agentManager.diff.comment": "ความคิดเห็น",
  "agentManager.diff.save": "บันทึก",
  "agentManager.diff.send": "ส่ง",
  "agentManager.diff.sendTooltip": "ส่งตรงไปยัง LLM",
  "agentManager.diff.commentTooltip": "บันทึกความคิดเห็น ({{shortcut}})",
  "agentManager.diff.sendToChat": "ส่งไปที่แชท",
  "agentManager.diff.edit": "แก้ไข",
  "agentManager.diff.delete": "ลบ",
  "agentManager.diff.commentsCount": "{{count}} ความคิดเห็น",
  "agentManager.diff.commentsCountPlural": "{{count}} ความคิดเห็น",
  "agentManager.diff.sendAllToChat": "ส่งทั้งหมดไปที่แชท",
  "agentManager.shortcuts.sendAllComments": "ส่งความคิดเห็นทั้งหมดไปยัง LLM",
