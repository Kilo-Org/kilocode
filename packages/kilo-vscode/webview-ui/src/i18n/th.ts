export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "เลือกเอเจนต์เริ่มต้นของคุณ",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "เอเจนต์เริ่มต้น",
  "workStyle.agent.code.tasks": "เหมาะที่สุดสำหรับงานเขียนโค้ด",
  "workStyle.agent.code.changes": "อ่าน เขียน และแก้ไขโค้ด",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "เหมาะที่สุดสำหรับการวิเคราะห์ข้อมูล",
  "workStyle.agent.data.notebooks": "เรียกใช้คิวรีและสร้างภาพข้อมูลใน Jupyter Notebook",
  "workStyle.agent.data.requirement": "ต้องใช้ส่วนขยาย Jupyter",
