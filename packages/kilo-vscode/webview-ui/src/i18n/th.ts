export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "ควรใช้เมื่อใด",
  "settings.agentBehaviour.editMode.whenToUse.help": "บอกตัวจัดการงานว่าควรมอบหมายงานให้เอเจนต์นี้เมื่อใด",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "เช่น ใช้เอเจนต์นี้เมื่อผู้ใช้ขอให้รีวิวโค้ดหรือวิเคราะห์คุณภาพ",
  "settings.agentBehaviour.editMode.whenToUse.none": "ไม่มีคำอธิบายสำหรับเอเจนต์ในตัวนี้",
