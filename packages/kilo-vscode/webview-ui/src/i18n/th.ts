...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "ที่อยู่ Milvus",
  "settings.indexing.milvusAddress.description": "ที่อยู่สำหรับ Milvus Standalone หรือ Zilliz Cloud",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "โทเค็น Milvus",
  "settings.indexing.milvusToken.description": "โทเค็นเสริมสำหรับ Milvus ที่มีการยืนยันตัวตนหรือ Zilliz Cloud",
  "settings.indexing.milvusToken.placeholder": "โทเค็นเสริม",
  "settings.indexing.milvusDatabase.title": "ฐานข้อมูล Milvus",
  "settings.indexing.milvusDatabase.description": "ชื่อฐานข้อมูล Milvus แบบไม่บังคับ",
  "settings.indexing.milvusDatabase.placeholder": "เว้นว่างเพื่อใช้ค่าเริ่มต้น",
