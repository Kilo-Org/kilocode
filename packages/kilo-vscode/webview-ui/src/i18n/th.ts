export const dict = {
  ...
  "workStyle.onboarding.title": "เลือกวิธีที่คุณต้องการทำงานร่วมกับเอเจนต์ AI",
  ...
  "workStyle.toast.saved.title": "บันทึกการตั้งค่าแล้ว",
  ...
  "workStyle.choice.human.eyebrow": "มีผู้ใช้ร่วมตรวจสอบ",
  "workStyle.choice.human.title": "ตรวจสอบก่อน",
  "workStyle.choice.human.description": "Kilo จะหยุดบ่อยครั้งและแสดงแผนการทำงานขณะดำเนินการ",
  "workStyle.choice.human.permissions": "ขออนุญาตก่อนแก้ไขไฟล์",
  "workStyle.choice.human.bash": "ขออนุญาตเมื่อเรียกใช้คำสั่งเทอร์มินัลทุกคำสั่ง",
  "workStyle.choice.human.visibility": "แสดงรายละเอียดการสนทนา รวมถึงคำสั่งและการให้เหตุผล",
  "workStyle.choice.autonomous.eyebrow": "รบกวนน้อยลง",
  "workStyle.choice.autonomous.title": "ทำงานอัตโนมัติสูง",
  "workStyle.choice.autonomous.description": "ทำงานโดยมีการขัดจังหวะน้อยลงและใช้อินเทอร์เฟซที่เรียบง่ายขึ้น",
  "workStyle.choice.autonomous.permissions": "แก้ไขไฟล์ในพื้นที่ทำงานได้โดยอัตโนมัติ",
  "workStyle.choice.autonomous.bash": "เรียกใช้คำสั่งเทอร์มินัลในพื้นที่ทำงานได้โดยไม่ต้องขออนุมัติ",
  "workStyle.choice.autonomous.visibility": "รายละเอียดการสนทนาจะถูกซ่อนไว้จนกว่าคุณจะขยายดู",
