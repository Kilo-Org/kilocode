...
export const dict = {
  ...
  "tool.board.read": "อ่านข้อความ",
  "tool.board.post": "โพสต์ข้อความ",
  "tool.board.message": "อ่านแล้ว 1 ข้อความ",
  "tool.board.messages": "อ่านแล้ว {{count}} ข้อความ",
  "tool.board.empty": "ไม่มีข้อความให้อ่าน",
  "tool.board.posted": "โพสต์สำหรับ {{recipient}} แล้ว",
  "tool.board.saved": "บันทึกไว้สำหรับ {{recipient}} แล้ว",
  "tool.board.channel": "Kilo Swarm (กระดานที่ใช้ร่วมกัน)",
  "tool.board.details": "รายละเอียด",
  "tool.board.unavailable": "ข้อมูลข้อความไม่พร้อมใช้งาน เปิดรายละเอียดเพื่อตรวจสอบ",
  "tool.board.from": "จาก {{sender}}",
  "tool.board.status": "การนำส่ง: {{status}}",
  "tool.board.inactive": "บันทึกไว้เมื่อผู้รับไม่ได้ใช้งานในขณะนั้น",
  "tool.board.audience": "บันทึกไว้แล้ว ไม่มีผู้รับรายอื่นที่ใช้งานอยู่ในขณะโพสต์",
  "tool.board.unknown": "บันทึกไว้แล้ว ไม่ทราบว่าผู้รับใช้งานอยู่หรือไม่ในขณะโพสต์",
  "tool.board.receipt": "การยืนยันการอ่านไม่พร้อมใช้งาน",
  "tool.board.agent": "เอเจนต์ {{id}}",
  "tool.board.more": "ยังมีข้อความเพิ่มเติมบนกระดาน",
  "tool.board.showMore": "แสดงอีก {{count}} ข้อความ",
  "tool.board.showLess": "แสดงน้อยลง",
  "tool.board.main": "เอเจนต์หลัก",
  "tool.board.all": "เอเจนต์ทั้งหมด",
  "tool.board.to": "ถึง {{recipient}}",
