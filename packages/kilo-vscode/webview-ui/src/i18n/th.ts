...
export const dict = {
  ...
  "profile.usage.action.manageBilling": "จัดการการเรียกเก็บเงิน",
  ...
  "profile.usage.topups.title": "การเติมเงินส่วนบุคคล",
  "profile.usage.topups.auto": "เติมเงินอัตโนมัติ",
  "profile.usage.topups.on": "เปิด",
  "profile.usage.topups.off": "ปิด",
  "profile.usage.topups.rule": "เพิ่ม ${{amount}} เมื่อยอดคงเหลือถึง ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} ลงท้ายด้วย {{last4}}",
  "profile.usage.balance.breakdown": "ได้รับ {{granted}} | เติมเงินแล้ว {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "ไม่พร้อมใช้งาน",
  "profile.usage.credits.resets": "รีเซ็ต {{count}} ครั้ง",
