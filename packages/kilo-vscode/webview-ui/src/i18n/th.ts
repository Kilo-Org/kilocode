...
export const dict = {
  ...
  "chat.search.label": "ค้นหาในแชท",
  "chat.search.placeholder": "ค้นหาในแชท",
  "chat.search.count": "{{ current }} จาก {{ total }}",
  "chat.search.noResults": "ไม่พบผลลัพธ์",
  "chat.search.previous": "ผลลัพธ์ก่อนหน้า",
  "chat.search.next": "ผลลัพธ์ถัดไป",
