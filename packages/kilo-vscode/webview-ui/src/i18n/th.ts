export const dict = {
  ...
  "revert.banner.step": "ยกเลิกขั้นตอนของเอเจนต์แล้ว",
  "checkpoint.label": "จุดตรวจสอบ",
  "checkpoint.viewChanges": "ดูการเปลี่ยนแปลงหลังจากเช็กพอยต์นี้",
  "checkpoint.parallel": "จุดตรวจสอบก่อนเครื่องมือคู่ขนาน {{count}} รายการ",
  "checkpoint.stopRewind": "หยุดและย้อนกลับ",
  "checkpoint.unavailable": "จุดตรวจสอบไม่พร้อมใช้งานเนื่องจากไม่มีการสร้างสแนปชอต",
  "checkpoint.sharedDirectory":
    "เซสชันที่ทำงานอยู่อื่นกำลังใช้ไดเรกทอรีนี้ การย้อนกลับอาจคืนค่าการเปลี่ยนแปลงของเซสชันนั้นด้วย",
  "checkpoint.sharedDirectory.confirm": "ย้อนกลับอยู่ดี",
  "checkpoint.failed": "ล้มเหลวในการย้อนกลับจุดตรวจสอบ",
