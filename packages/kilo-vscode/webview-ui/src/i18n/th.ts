export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description": "Kilo จะหยุดบ่อยครั้งและแสดงแผนการทำงานขณะดำเนินการ",
  "workStyle.choice.human-in-the-loop.permissions": "ขออนุญาตก่อนแก้ไขไฟล์",
  "workStyle.choice.human-in-the-loop.bash": "ขออนุญาตเมื่อเรียกใช้คำสั่งเทอร์มินัลทุกคำสั่ง",
  "workStyle.choice.human-in-the-loop.visibility": "แสดงรายละเอียดการสนทนา รวมถึงคำสั่งและการให้เหตุผล",
