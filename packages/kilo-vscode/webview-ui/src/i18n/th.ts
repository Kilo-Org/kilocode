export const dict = {
  ...
  "agentRequirements.skill.installing": "กำลังติดตั้งจาก Marketplace...",
  "agentRequirements.skill.verifying": "ติดตั้งแล้ว กำลังตรวจสอบว่าพบทักษะหรือไม่...",
  "agentRequirements.skill.installed": "ติดตั้งแล้ว",
  "agentRequirements.skill.installFailed": "การติดตั้งล้มเหลว",
  "agentRequirements.skill.checkFailed": "การตรวจสอบทักษะล้มเหลว",
  "agentRequirements.group.skills": "ทักษะ",
  "agentRequirements.group.mcps": "MCP",
  "agentRequirements.group.extensions": "ส่วนขยาย",
  "agentRequirements.skill.missing": "ยังไม่ได้ติดตั้งทักษะที่จำเป็น",
  "agentRequirements.checking.title": "กำลังตรวจสอบข้อกำหนดของเอเจนต์",
  "agentRequirements.checking.description": "กำลังตรวจสอบทักษะที่พร้อมใช้งานในโปรเจกต์นี้",
  "agentRequirements.ready.title": "พร้อมใช้งาน",
  "agentRequirements.ready.description": "ทักษะที่จำเป็นทั้งหมดพร้อมใช้งาน",
  "agentRequirements.blocked.title": "ดำเนินการตรวจสอบที่จำเป็นให้เสร็จสิ้น",
  "agentRequirements.blocked.description": "เอเจนต์นี้ต้องใช้ทักษะต่อไปนี้ก่อนจึงจะทำงานได้",
  "agentRequirements.action.installing": "กำลังติดตั้งทักษะ...",
  "agentRequirements.action.installAll": "ติดตั้งทักษะ / MCP ที่ขาดทั้งหมด",
  "agentRequirements.install.partialFailure": "ไม่สามารถติดตั้งทักษะบางรายการได้ โปรดแก้ไขข้อผิดพลาดแล้วลองอีกครั้ง",
  "agentRequirements.prompt.blocked": "ดำเนินการตรวจสอบที่จำเป็นให้เสร็จก่อนจึงจะใช้เอเจนต์นี้ได้",
  "agentRequirements.error.unknownAgent": "ไม่พบเอเจนต์ที่เลือก",
  "agentRequirements.error.malformedDeclaration": "เอเจนต์นี้มีการประกาศข้อกำหนดทักษะที่ไม่ถูกต้อง",
  "agentRequirements.error.discoveryFailed": "Kilo ไม่สามารถตรวจสอบทักษะที่พร้อมใช้งานได้",
  "agentRequirements.error.scopeMismatch": "การตรวจสอบข้อกำหนดของเอเจนต์นี้ไม่ได้ใช้งานแล้ว",
  "agentRequirements.error.requestFailed": "Kilo ไม่สามารถตรวจสอบข้อกำหนดของเอเจนต์ได้",
  "agentRequirements.install.error.skillNotFound": "ไม่พบทักษะ Marketplace ที่จำเป็น",
  "agentRequirements.install.error.itemNotSkill": "รายการ Marketplace นี้ไม่ใช่ทักษะ",
  "agentRequirements.install.error.unavailable": "มุมมองนี้ไม่รองรับการติดตั้งทักษะ",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo ไม่สามารถโหลดทักษะจาก Marketplace ได้",
