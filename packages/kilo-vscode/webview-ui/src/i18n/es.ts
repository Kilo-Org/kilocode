...
export const dict = {
  ...
  "tool.board.read": "Leer mensajes",
  "tool.board.post": "Publicar mensaje",
  "tool.board.message": "1 mensaje leído",
  "tool.board.messages": "{{count}} mensajes leídos",
  "tool.board.empty": "No hay mensajes para leer",
  "tool.board.posted": "Publicado para {{recipient}}",
  "tool.board.saved": "Guardado para {{recipient}}",
  "tool.board.channel": "Kilo Swarm (tablero compartido)",
  "tool.board.details": "Detalles",
  "tool.board.unavailable": "Datos del mensaje no disponibles. Abre los detalles para revisarlos.",
  "tool.board.from": "De {{sender}}",
  "tool.board.status": "Entrega: {{status}}",
  "tool.board.inactive": "Guardado mientras el destinatario estaba inactivo",
  "tool.board.audience": "Guardado; no había otros destinatarios activos",
  "tool.board.unknown": "Guardado; la actividad de los destinatarios era desconocida",
  "tool.board.receipt": "Confirmación de lectura no disponible",
  "tool.board.agent": "Agente {{id}}",
  "tool.board.more": "Hay más mensajes disponibles en el tablero.",
  "tool.board.showMore": "Mostrar {{count}} más",
  "tool.board.showLess": "Mostrar menos",
  "tool.board.main": "Principal",
  "tool.board.all": "Todos los agentes",
  "tool.board.to": "Para {{recipient}}",
