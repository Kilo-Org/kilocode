export const dict = {
  ...
  "revert.banner.step": "Paso del agente revertido",
  "checkpoint.label": "Punto de control",
  "checkpoint.viewChanges": "Ver cambios desde este punto de control",
  "checkpoint.parallel": "Punto de control antes de {{count}} herramientas paralelas",
  "checkpoint.stopRewind": "Detener y retroceder",
  "checkpoint.unavailable": "Punto de control no disponible porque no se capturó una instantánea",
  "checkpoint.sharedDirectory":
    "Otra sesión activa está usando este directorio. Retroceder también puede restaurar sus cambios.",
  "checkpoint.sharedDirectory.confirm": "Retroceder de todos modos",
  "checkpoint.failed": "Error al retroceder al punto de control.",
