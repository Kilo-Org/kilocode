...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Añadir créditos",
  "profile.usage.action.manageBilling": "Gestionar facturación",
  ...
  "profile.usage.topups.title": "Recargas personales",
  "profile.usage.topups.auto": "Recarga automática",
  "profile.usage.topups.on": "Activada",
  "profile.usage.topups.off": "Desactivada",
  "profile.usage.topups.rule": "Añadir ${{amount}} cuando el saldo llegue a ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} terminada en {{last4}}",
  "profile.usage.balance.breakdown": "Concedido {{granted}} | Recargado {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "no disponible",
  "profile.usage.credits.resets": "{{count}} restablecimientos",
