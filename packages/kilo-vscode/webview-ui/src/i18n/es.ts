export const dict = {
  ...
  "agentManager.diff.changes": "Cambios",
  "agentManager.diff.close": "Cerrar",
  "agentManager.diff.loading": "Calculando diff...",
  "agentManager.diff.empty": "No se detectaron cambios",
  "agentManager.diff.added": "Añadido",
  "agentManager.diff.removed": "Eliminado",
  "agentManager.diff.commentOnLine": "Comentar en la línea {{line}}",
  "agentManager.diff.editCommentOnLine": "Editar comentario en la línea {{line}}",
  "agentManager.diff.placeholder": "Dejar un comentario...",
  "agentManager.diff.cancel": "Cancelar",
  "agentManager.diff.comment": "Comentar",
  "agentManager.diff.save": "Guardar",
  "agentManager.diff.send": "Enviar",
  "agentManager.diff.sendTooltip": "Enviar directamente al LLM",
  "agentManager.diff.commentTooltip": "Guardar comentario ({{shortcut}})",
  "agentManager.diff.sendToChat": "Enviar al chat",
  "agentManager.diff.edit": "Editar",
  "agentManager.diff.delete": "Eliminar",
  "agentManager.diff.commentsCount": "{{count}} comentario",
  "agentManager.diff.commentsCountPlural": "{{count}} comentarios",
  "agentManager.diff.sendAllToChat": "Enviar todo al chat",
  "agentManager.shortcuts.sendAllComments": "Enviar todos los comentarios al LLM",
