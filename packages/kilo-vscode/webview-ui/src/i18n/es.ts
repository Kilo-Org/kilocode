export const dict = {
  ...
  "migration.progress.sessions": "Sesiones de chat",
  "migration.progress.defaultModel": "Modelo predeterminado",
  "migration.progress.commandRules": "Reglas de comandos",
  "migration.progress.readPermission": "Permiso de lectura",
  "migration.progress.writePermission": "Permiso de escritura",
  "migration.progress.executePermission": "Permiso de ejecución",
  "migration.progress.mcpPermission": "Permiso de MCP",
  "migration.progress.taskPermission": "Permiso de tareas",
  "migration.progress.language": "Preferencia de idioma",
  "migration.progress.autocomplete": "Configuración de autocompletado",
