export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Elige tu agente predeterminado",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Agente predeterminado",
  "workStyle.agent.code.tasks": "Ideal para tareas de programación",
  "workStyle.agent.code.changes": "Lee, escribe y modifica código",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Ideal para el análisis de datos",
