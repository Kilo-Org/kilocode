export const dict = {
  ...
  "agentRequirements.skill.installing": "Instalando desde Marketplace...",
  "agentRequirements.skill.verifying": "Instalación completada. Verificando la detección de la habilidad...",
  "agentRequirements.skill.installed": "Instalada",
  "agentRequirements.skill.installFailed": "La instalación ha fallado",
  "agentRequirements.skill.checkFailed": "La comprobación de la habilidad ha fallado",
  "agentRequirements.group.skills": "Habilidades",
  "agentRequirements.group.mcps": "MCP",
  "agentRequirements.group.extensions": "Extensiones",
  "agentRequirements.skill.missing": "La habilidad requerida no está instalada",
  "agentRequirements.checking.title": "Comprobando los requisitos del agente",
  "agentRequirements.checking.description": "Verificando las habilidades disponibles en este proyecto.",
  "agentRequirements.ready.title": "Todo listo",
  "agentRequirements.ready.description": "Todas las habilidades requeridas están disponibles.",
  "agentRequirements.blocked.title": "Completa las comprobaciones requeridas",
  "agentRequirements.blocked.description": "Este agente necesita las siguientes habilidades antes de poder ejecutarse.",
  "agentRequirements.action.installing": "Instalando habilidades...",
  "agentRequirements.action.installAll": "Instalar todas las habilidades / MCP que faltan",
  "agentRequirements.install.partialFailure":
    "No se han podido instalar algunas habilidades. Corrige los errores y vuelve a intentarlo.",
  "agentRequirements.prompt.blocked": "Completa primero las comprobaciones requeridas para usar este agente",
  "agentRequirements.error.unknownAgent": "No se ha podido encontrar el agente seleccionado.",
  "agentRequirements.error.malformedDeclaration":
    "Este agente tiene una declaración de requisitos de habilidades no válida.",
  "agentRequirements.error.discoveryFailed": "Kilo no ha podido comprobar las habilidades disponibles.",
  "agentRequirements.error.scopeMismatch": "Esta comprobación de requisitos del agente ya no está activa.",
  "agentRequirements.error.requestFailed": "Kilo no ha podido comprobar los requisitos del agente.",
  "agentRequirements.install.error.skillNotFound": "No se ha podido encontrar la habilidad requerida en Marketplace.",
  "agentRequirements.install.error.itemNotSkill": "El elemento de Marketplace no es una habilidad.",
  "agentRequirements.install.error.unavailable": "La instalación de habilidades no está disponible en esta vista.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo no ha podido cargar las habilidades de Marketplace.",
