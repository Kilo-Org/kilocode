export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "p. ej., usa este agente cuando el usuario pida revisión de código o análisis de calidad",
  "settings.agentBehaviour.editMode.whenToUse.none": "No hay una descripción definida para este agente integrado.",
