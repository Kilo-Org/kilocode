export const dict = {
  ...
  "workStyle.onboarding.title": "Elige cómo quieres trabajar con tus agentes de IA",
  ...
  "workStyle.choice.autonomous.permissions": "Puede editar automáticamente los archivos del espacio de trabajo.",
  ...
  "workStyle.choice.autonomous.visibility":
    "Los detalles de la conversación permanecen ocultos hasta que los despliegues.",
