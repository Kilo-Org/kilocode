...
export const dict = {
  ...
  "revert.banner.workspace.legacy": "Conversación revertida. El estado de restauración del espacio de trabajo no está disponible para esta reversión anterior.",
