export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Pound",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Pound.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Pound.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Pound.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Pound se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Pound ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Pound",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Pound no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Pound incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Pound",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Pound en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Pound.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Pound",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Pound.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Pound Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Pound abierto, sin ataduras.",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando pound import",
  ...
  "deviceAuth.title": "Iniciar sesión en Pound Code",
  ...
  "profile.action.login": "Iniciar sesión con Pound Code",
  ...
  "settings.aboutKiloCode.title": "Acerca de Pound Code",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Pound Code es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensión Pound Code",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Restablecer todas las configuraciones de la extensión Pound Code a sus valores predeterminados. Esto no afecta la configuración del CLI o del backend.",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Pound Code. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Pound Code, incluyendo las claves API de proveedores y el modelo predeterminado.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Pound Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Pound. Una experiencia familiar sin importar cómo elijas trabajar.",
