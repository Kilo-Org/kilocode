...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Dirección de Milvus",
  "settings.indexing.milvusAddress.description": "Dirección de Milvus Standalone o Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Token de Milvus",
  "settings.indexing.milvusToken.description": "Token opcional para Milvus autenticado o Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Token opcional",
  "settings.indexing.milvusDatabase.title": "Base de datos de Milvus",
  "settings.indexing.milvusDatabase.description": "Nombre opcional de la base de datos de Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "Dejar vacío para usar el valor predeterminado",
