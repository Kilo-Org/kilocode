export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description": "Kilo često zastaje i prikazuje šta planira uraditi tokom rada.",
  "workStyle.choice.human-in-the-loop.permissions": "Traži dozvolu prije uređivanja datoteka.",
  "workStyle.choice.human-in-the-loop.bash": "Traži dozvolu za svaku terminalsku komandu.",
  "workStyle.choice.human-in-the-loop.visibility": "Prikazuje detalje razgovora, uključujući komande i zaključivanje.",
