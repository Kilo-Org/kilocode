export const dict = {
  ...
  "agentRequirements.skill.installing": "Instaliranje iz Marketplacea...",
  "agentRequirements.skill.verifying": "Instalirana. Provjerava se je li vještina otkrivena...",
  "agentRequirements.skill.installed": "Instalirana",
  "agentRequirements.skill.installFailed": "Instalacija nije uspjela",
  ...
  "agentRequirements.group.extensions": "Ekstenzije",
  "agentRequirements.skill.missing": "Potrebna vještina nije instalirana",
  "agentRequirements.checking.title": "Provjera zahtjeva agenta",
  "agentRequirements.checking.description": "Provjeravaju se vještine dostupne u ovom projektu.",
  "agentRequirements.ready.title": "Spremno za rad",
  "agentRequirements.ready.description": "Sve potrebne vještine su dostupne.",
  "agentRequirements.blocked.title": "Dovršite potrebne provjere",
  "agentRequirements.blocked.description":
    "Ovom agentu su potrebne sljedeće vještine prije nego što se može pokrenuti.",
  "agentRequirements.action.installing": "Instaliranje vještina...",
  "agentRequirements.action.installAll": "Instaliraj sve vještine / MCP-ove koji nedostaju",
  "agentRequirements.install.partialFailure":
    "Neke vještine nije bilo moguće instalirati. Ispravite greške i pokušajte ponovo.",
  ...
  "agentRequirements.error.malformedDeclaration": "Ovaj agent ima nevažeću deklaraciju zahtjeva za vještinama.",
  ...
  "agentRequirements.install.error.skillNotFound": "Potrebna vještina nije pronađena na Marketplaceu.",
  "agentRequirements.install.error.itemNotSkill": "Stavka na Marketplaceu nije vještina.",
  "agentRequirements.install.error.unavailable": "Instaliranje vještina nije dostupno u ovom prikazu.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo nije mogao učitati vještine s Marketplacea.",
