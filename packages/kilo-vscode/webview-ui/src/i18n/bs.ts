...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Milvus adresa",
  "settings.indexing.milvusAddress.description": "Adresa za Milvus Standalone ili Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Milvus token",
  "settings.indexing.milvusToken.description": "Opcionalni token za autentificirani Milvus ili Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Opcionalni token",
  "settings.indexing.milvusDatabase.title": "Milvus baza podataka",
  "settings.indexing.milvusDatabase.description": "Opcionalni naziv Milvus baze podataka.",
  "settings.indexing.milvusDatabase.placeholder": "Ostavite prazno za zadanu vrijednost",
