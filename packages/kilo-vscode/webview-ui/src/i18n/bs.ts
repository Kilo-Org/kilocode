...
export const dict = {
  ...
  "tool.board.read": "Pročitaj poruke",
  "tool.board.post": "Objavi poruku",
  "tool.board.message": "Pročitana 1 poruka",
  "tool.board.messages": "Pročitane poruke: {{count}}",
  "tool.board.empty": "Nema poruka za čitanje",
  "tool.board.posted": "Objavljeno za: {{recipient}}",
  "tool.board.saved": "Sačuvano za: {{recipient}}",
  "tool.board.channel": "Kilo Swarm (zajednička ploča)",
  "tool.board.details": "Detalji",
  "tool.board.unavailable": "Podaci o poruci nisu dostupni. Otvorite detalje za pregled.",
  "tool.board.from": "Od: {{sender}}",
  "tool.board.status": "Isporuka: {{status}}",
  "tool.board.inactive": "Sačuvano dok je primalac bio neaktivan",
  "tool.board.audience": "Sačuvano; nije bilo drugih aktivnih primalaca",
  "tool.board.unknown": "Sačuvano; aktivnost primalaca je bila nepoznata",
  "tool.board.receipt": "Potvrda o čitanju nije dostupna",
  "tool.board.agent": "Agent {{id}}",
  "tool.board.more": "Na ploči ima još poruka.",
  "tool.board.showMore": "Prikaži još {{count}}",
  "tool.board.showLess": "Prikaži manje",
  "tool.board.main": "Glavni",
  "tool.board.all": "Svi agenti",
  "tool.board.to": "Za: {{recipient}}",
