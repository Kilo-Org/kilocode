export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "npr. Koristite ovog agenta kada korisnik traži pregled koda ili analizu kvaliteta",
  "settings.agentBehaviour.editMode.whenToUse.none": "Nema definisanog opisa za ovog ugrađenog agenta.",
