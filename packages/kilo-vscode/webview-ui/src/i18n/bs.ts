export const dict = {
  ...
  "workStyle.onboarding.title": "Odaberite kako želite raditi sa svojim AI agentima",
  ...
  "workStyle.choice.human.eyebrow": "Čovjek nadzire proces",
  "workStyle.choice.human.title": "Prvo pregledajte",
  "workStyle.choice.human.description": "Kilo često zastaje i prikazuje šta planira uraditi tokom rada.",
  "workStyle.choice.human.permissions": "Traži dozvolu prije uređivanja datoteka.",
  "workStyle.choice.human.bash": "Traži dozvolu za svaku terminalsku komandu.",
  "workStyle.choice.human.visibility": "Prikazuje detalje razgovora, uključujući komande i zaključivanje.",
  "workStyle.choice.autonomous.eyebrow": "Manje prekida",
  "workStyle.choice.autonomous.title": "Visoka autonomija",
  "workStyle.choice.autonomous.description": "Radite uz manje prekida i pojednostavljen interfejs.",
  "workStyle.choice.autonomous.permissions": "Može automatski uređivati datoteke u radnom prostoru.",
  "workStyle.choice.autonomous.bash": "Može pokretati terminalske komande u radnom prostoru bez odobrenja.",
  "workStyle.choice.autonomous.visibility": "Detalji razgovora ostaju skriveni dok ih ne proširite.",
