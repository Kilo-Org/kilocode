export const dict = {
  ...
  "migration.progress.sessions": "Sesije razgovora",
  "migration.progress.defaultModel": "Podrazumijevani model",
  "migration.progress.commandRules": "Pravila komandi",
  "migration.progress.readPermission": "Dozvola za čitanje",
  "migration.progress.writePermission": "Dozvola za pisanje",
  "migration.progress.executePermission": "Dozvola za izvršavanje",
  "migration.progress.mcpPermission": "MCP dozvola",
  "migration.progress.taskPermission": "Dozvola za zadatke",
  "migration.progress.language": "Jezička postavka",
  "migration.progress.autocomplete": "Postavke automatskog dovršavanja",
