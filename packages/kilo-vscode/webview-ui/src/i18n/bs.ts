export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Odaberite zadanog agenta",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Zadani agent",
  "workStyle.agent.code.tasks": "Najbolji za programske zadatke",
  "workStyle.agent.code.changes": "Čita, piše i mijenja kôd",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Najbolji za analizu podataka",
