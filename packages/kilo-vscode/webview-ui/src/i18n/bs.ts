...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Dodaj kredit",
  "profile.usage.action.manageBilling": "Upravljaj naplatom",
  ...
  "profile.usage.topups.title": "Lične dopune",
  "profile.usage.topups.auto": "Automatska dopuna",
  "profile.usage.topups.on": "Uključeno",
  "profile.usage.topups.off": "Isključeno",
  "profile.usage.topups.rule": "Dodaj ${{amount}} kada stanje dostigne ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} s posljednje četiri cifre {{last4}}",
  "profile.usage.balance.breakdown": "Dodijeljeno {{granted}} | Dopunjeno {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "nedostupno",
  "profile.usage.credits.resets": "{{count}} obnavljanja",
