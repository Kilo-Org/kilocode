export const dict = {
  ...
  "revert.banner.step": "Korak agenta je vraćen",
  "checkpoint.label": "Kontrolna tačka",
  "checkpoint.viewChanges": "Prikaži promjene nakon ove kontrolne tačke",
  "checkpoint.parallel": "Kontrolna tačka prije {{count}} paralelnih alata",
  "checkpoint.stopRewind": "Zaustavi i vrati",
  "checkpoint.unavailable": "Kontrolna tačka nije dostupna jer snimak stanja nije napravljen",
  "checkpoint.sharedDirectory": "Druga aktivna sesija koristi ovaj direktorij. Vraćanje može vratiti i njene promjene.",
  "checkpoint.sharedDirectory.confirm": "Ipak vrati",
  "checkpoint.failed": "Vraćanje na kontrolnu tačku nije uspjelo.",
