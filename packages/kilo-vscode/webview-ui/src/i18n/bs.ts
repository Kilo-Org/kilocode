export const dict = {
  ...
  "agentManager.diff.changes": "Promjene",
  "agentManager.diff.close": "Zatvori",
  "agentManager.diff.loading": "Izračunavanje diff-a...",
  "agentManager.diff.empty": "Nisu otkrivene promjene",
  "agentManager.diff.added": "Dodano",
  "agentManager.diff.removed": "Uklonjeno",
  "agentManager.diff.commentOnLine": "Komentar na liniji {{line}}",
  "agentManager.diff.editCommentOnLine": "Uredi komentar na liniji {{line}}",
  "agentManager.diff.placeholder": "Ostavite komentar...",
  "agentManager.diff.cancel": "Otkaži",
  "agentManager.diff.comment": "Komentiraj",
  "agentManager.diff.save": "Spremi",
  "agentManager.diff.send": "Pošalji",
  "agentManager.diff.sendTooltip": "Pošalji direktno u LLM",
  "agentManager.diff.commentTooltip": "Spremi komentar ({{shortcut}})",
  "agentManager.diff.sendToChat": "Pošalji u chat",
  "agentManager.diff.edit": "Uredi",
  "agentManager.diff.delete": "Obriši",
  "agentManager.diff.commentsCount": "{{count}} komentar",
  "agentManager.diff.commentsCountPlural": "{{count}} komentara",
  "agentManager.diff.sendAllToChat": "Pošalji sve u chat",
  "agentManager.shortcuts.sendAllComments": "Pošalji sve komentare u LLM",
