...
export const dict = {
  ...
  "profile.usage.action.addCredits": "クレジットを追加",
  "profile.usage.action.manageBilling": "請求を管理",
  ...
  "profile.usage.topups.title": "個人チャージ",
  "profile.usage.topups.auto": "自動チャージ",
  "profile.usage.topups.on": "オン",
  "profile.usage.topups.off": "オフ",
  "profile.usage.topups.rule": "残高が${{threshold}}に達したら${{amount}}を追加",
  "profile.usage.topups.payment": "{{brand}}（末尾{{last4}}）",
  "profile.usage.balance.breakdown": "付与分 {{granted}} | チャージ分 {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "利用不可",
  "profile.usage.credits.resets": "{{count}} 回リセット",
