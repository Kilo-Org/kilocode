export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "デフォルトのエージェントを選択",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "デフォルトエージェント",
  "workStyle.agent.code.tasks": "コーディングタスクに最適",
  "workStyle.agent.code.changes": "コードの読み取り、作成、変更を行います",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "データ分析に最適",
  "workStyle.agent.data.notebooks": "Jupyter Notebook でクエリを実行し、可視化を作成します",
  "workStyle.agent.data.requirement": "Jupyter 拡張機能が必要です",
