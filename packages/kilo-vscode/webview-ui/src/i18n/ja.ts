export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Kiloは頻繁に一時停止し、作業を進めながら次に行うことを表示します。",
  "workStyle.choice.human-in-the-loop.permissions": "ファイル編集前に許可を求める",
  "workStyle.choice.human-in-the-loop.bash": "すべてのターミナルコマンド実行時に許可を求める",
  "workStyle.choice.human-in-the-loop.visibility": "コマンドや推論を含む会話の詳細を表示",
