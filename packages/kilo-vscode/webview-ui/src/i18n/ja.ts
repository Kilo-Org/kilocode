export const dict = {
  ...
  "revert.banner.step": "エージェントのステップを元に戻しました",
  "checkpoint.label": "チェックポイント",
  "checkpoint.viewChanges": "このチェックポイント以降の変更を表示",
  "checkpoint.parallel": "{{count}} 個の並列ツールの前のチェックポイント",
  "checkpoint.stopRewind": "停止して巻き戻す",
  "checkpoint.unavailable": "スナップショットがキャプチャされていないため、チェックポイントを利用できません",
  "checkpoint.sharedDirectory":
    "別のアクティブなセッションがこのディレクトリを使用しています。巻き戻すと、その変更も復元される可能性があります。",
  "checkpoint.sharedDirectory.confirm": "とにかく巻き戻す",
  "checkpoint.failed": "チェックポイントの巻き戻しに失敗しました。",
