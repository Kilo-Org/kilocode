export const dict = {
  ...
  "agentManager.diff.changes": "変更",
  "agentManager.diff.close": "閉じる",
  "agentManager.diff.loading": "差分を計算中...",
  "agentManager.diff.empty": "変更は検出されませんでした",
  "agentManager.diff.added": "追加",
  "agentManager.diff.removed": "削除",
  "agentManager.diff.commentOnLine": "{{line}} 行目にコメント",
  "agentManager.diff.editCommentOnLine": "{{line}} 行目のコメントを編集",
  "agentManager.diff.placeholder": "コメントを残す...",
  "agentManager.diff.cancel": "キャンセル",
  "agentManager.diff.comment": "コメント",
  "agentManager.diff.save": "保存",
  "agentManager.diff.send": "送信",
  "agentManager.diff.sendTooltip": "LLM に直接送信",
  "agentManager.diff.commentTooltip": "コメントを保存 ({{shortcut}})",
  "agentManager.diff.sendToChat": "チャットに送信",
  "agentManager.diff.edit": "編集",
  "agentManager.diff.delete": "削除",
  "agentManager.diff.commentsCount": "{{count}} 件のコメント",
  "agentManager.diff.commentsCountPlural": "{{count}} 件のコメント",
  "agentManager.diff.sendAllToChat": "すべてチャットに送信",
  "agentManager.shortcuts.sendAllComments": "すべてのコメントを LLM に送信",
