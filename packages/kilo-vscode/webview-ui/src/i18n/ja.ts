...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Milvus アドレス",
  "settings.indexing.milvusAddress.description": "Milvus Standalone または Zilliz Cloud のアドレスです。",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Milvus トークン",
  "settings.indexing.milvusToken.description": "認証済み Milvus または Zilliz Cloud 用の任意のトークンです。",
  "settings.indexing.milvusToken.placeholder": "任意のトークン",
  "settings.indexing.milvusDatabase.title": "Milvus データベース",
  "settings.indexing.milvusDatabase.description": "任意の Milvus データベース名です。",
  "settings.indexing.milvusDatabase.placeholder": "既定値を使用するには空欄にします",
