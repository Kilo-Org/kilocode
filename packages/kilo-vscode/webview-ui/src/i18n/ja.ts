...
export const dict = {
  ...
  "tool.board.read": "メッセージを読む",
  "tool.board.post": "メッセージを投稿",
  "tool.board.message": "1 件のメッセージを読みました",
  "tool.board.messages": "{{count}} 件のメッセージを読みました",
  "tool.board.empty": "読むメッセージはありません",
  "tool.board.posted": "{{recipient}} 宛てに投稿済み",
  "tool.board.saved": "{{recipient}} 宛てに保存済み",
  "tool.board.channel": "Kilo Swarm (共有ボード)",
  "tool.board.details": "詳細",
  "tool.board.unavailable": "メッセージデータは利用できません。詳細を開いて確認してください。",
  "tool.board.from": "{{sender}} から",
  "tool.board.status": "配信状況: {{status}}",
  "tool.board.inactive": "受信者が非アクティブだったときに保存されました",
  "tool.board.audience": "保存済み。投稿時にアクティブな他の受信者はいませんでした",
  "tool.board.unknown": "保存済み。投稿時に受信者がアクティブだったかは不明でした",
  "tool.board.receipt": "既読通知は利用できません",
  "tool.board.agent": "エージェント {{id}}",
  "tool.board.more": "ボードには他にもメッセージがあります。",
  "tool.board.showMore": "さらに {{count}} 件表示",
  "tool.board.showLess": "表示を減らす",
  "tool.board.main": "メイン",
  "tool.board.all": "すべてのエージェント",
  "tool.board.to": "{{recipient}} 宛て",
