export const dict = {
  ...
  "migration.progress.sessions": "チャットセッション",
  "migration.progress.defaultModel": "デフォルトモデル",
  "migration.progress.commandRules": "コマンドルール",
  "migration.progress.readPermission": "読み取り権限",
  "migration.progress.writePermission": "書き込み権限",
  "migration.progress.executePermission": "実行権限",
  "migration.progress.mcpPermission": "MCP 権限",
  "migration.progress.taskPermission": "タスク権限",
  "migration.progress.language": "言語設定",
  "migration.progress.autocomplete": "自動補完設定",
