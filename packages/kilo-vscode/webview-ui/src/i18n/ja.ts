export const dict = {
  ...
  "workStyle.onboarding.title": "AIエージェントとの作業スタイルを選択",
  ...
  "workStyle.choice.human.eyebrow": "人間による確認",
  "workStyle.choice.human.title": "まず確認",
  "workStyle.choice.human.description": "Kiloは頻繁に一時停止し、作業を進めながら次に行うことを表示します。",
  "workStyle.choice.human.permissions": "ファイル編集前に許可を求める",
  "workStyle.choice.human.bash": "すべてのターミナルコマンド実行時に許可を求める",
  "workStyle.choice.human.visibility": "コマンドや推論を含む会話の詳細を表示",
  "workStyle.choice.autonomous.eyebrow": "中断を少なく",
  "workStyle.choice.autonomous.title": "高い自律性",
  "workStyle.choice.autonomous.description": "中断を減らし、シンプルなインターフェースで作業できます。",
  "workStyle.choice.autonomous.permissions": "ワークスペース内のファイルを自動的に編集できます。",
  "workStyle.choice.autonomous.bash": "ワークスペース内で承認なしにターミナルコマンドを実行できます。",
  "workStyle.choice.autonomous.visibility": "会話の詳細は、展開するまで非表示になります。",
