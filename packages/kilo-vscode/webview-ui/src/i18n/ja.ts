export const dict = {
  ...
  "agentRequirements.skill.installing": "Marketplaceからインストール中...",
  "agentRequirements.skill.verifying": "インストール完了。スキルが検出されたか確認中...",
  "agentRequirements.skill.installed": "インストール済み",
  "agentRequirements.skill.installFailed": "インストールに失敗しました",
  "agentRequirements.skill.checkFailed": "スキルのチェックに失敗しました",
  "agentRequirements.group.skills": "スキル",
  "agentRequirements.group.mcps": "MCP",
  "agentRequirements.group.extensions": "拡張機能",
  "agentRequirements.skill.missing": "必要なスキルがインストールされていません",
  "agentRequirements.checking.title": "エージェント要件を確認中",
  "agentRequirements.checking.description": "このプロジェクトで利用可能なスキルを確認しています。",
  "agentRequirements.ready.title": "準備完了",
  "agentRequirements.ready.description": "必要なスキルはすべて利用可能です。",
  "agentRequirements.blocked.title": "必要なチェックを完了してください",
  "agentRequirements.blocked.description": "このエージェントを実行するには、次のスキルが必要です。",
  "agentRequirements.action.installing": "スキルをインストール中...",
  "agentRequirements.action.installAll": "不足しているスキル / MCP をすべてインストール",
  "agentRequirements.install.partialFailure":
    "一部のスキルをインストールできませんでした。エラーを修正して再試行してください。",
  "agentRequirements.prompt.blocked": "このエージェントを使用するには、先に必要なチェックを完了してください",
  "agentRequirements.error.unknownAgent": "選択したエージェントが見つかりません。",
  "agentRequirements.error.malformedDeclaration": "このエージェントのスキル要件の宣言は無効です。",
  "agentRequirements.error.discoveryFailed": "Kiloは利用可能なスキルを確認できませんでした。",
  "agentRequirements.error.scopeMismatch": "このエージェント要件のチェックはすでに無効です。",
  "agentRequirements.error.requestFailed": "Kiloはエージェント要件を確認できませんでした。",
  "agentRequirements.install.error.skillNotFound": "必要なMarketplaceスキルが見つかりません。",
  "agentRequirements.install.error.itemNotSkill": "このMarketplaceアイテムはスキルではありません。",
  "agentRequirements.install.error.unavailable": "このビューではスキルをインストールできません。",
  "agentRequirements.install.error.marketplaceUnavailable": "KiloはMarketplaceのスキルを読み込めませんでした。",
