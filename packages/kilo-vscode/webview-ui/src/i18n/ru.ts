export const dict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Установите Anaconda Desktop на этот компьютер, затем вернитесь сюда. Kilo не запустит установщик за вас.",
  "provider.anaconda.state.notRunning":
    "Откройте Anaconda Desktop, завершите настройку и войдите в систему, затем выберите Проверить снова.",
  "provider.anaconda.state.invalidConfig":
    "Настройка Anaconda Desktop не завершена. Откройте Desktop, завершите настройку и перезапустите при необходимости.",
  "provider.anaconda.state.signedOut": "Откройте Anaconda Desktop и войдите в систему перед подключением Kilo.",
  "provider.anaconda.state.unauthorized":
    "Kilo не смог получить доступ к Anaconda Desktop. Откройте Desktop, войдите снова и перезапустите при необходимости.",
  "provider.anaconda.state.unavailable":
    "Anaconda Desktop ещё не отвечает. Откройте его и подождите, пока приложение завершит запуск.",
  ...
  "provider.anaconda.state.unhealthy":
    "Активный сервер вывода ещё не в порядке. Проверьте его в Anaconda Desktop и перезапустите сервер при необходимости.",
  ...
  "provider.anaconda.context": "Окно контекста",
  ...
  "provider.anaconda.warning.description":
    "Этот сервер не подтверждает вызов инструментов. Действия агента кодирования могут завершаться ошибкой или быть недоступными. Продолжайте только если принимаете эти ограничения.",
  ...
  "provider.anaconda.action.continue": "Продолжить в любом случае",
  "provider.anaconda.action.manage": "Управление / Обновление",
  ...
  "settings.providers.note.anacondaDesktop": "Запустите модель, обслуживаемую локально Anaconda Desktop.",
  "settings.providers.tag.local": "Локальный",
