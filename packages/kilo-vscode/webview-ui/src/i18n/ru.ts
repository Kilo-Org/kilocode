...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Пополнить баланс",
  "profile.usage.action.manageBilling": "Управлять оплатой",
  ...
  "profile.usage.topups.title": "Личные пополнения",
  "profile.usage.topups.auto": "Автопополнение",
  "profile.usage.topups.on": "Включено",
  "profile.usage.topups.off": "Выключено",
  "profile.usage.topups.rule": "Пополнять на ${{amount}}, когда баланс достигает ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}}, последние цифры: {{last4}}",
  "profile.usage.balance.breakdown": "Выдано {{granted}} | Пополнено {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "недоступно",
  "profile.usage.credits.resets": "{{count}} сбросов",
