...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Адрес Milvus",
  "settings.indexing.milvusAddress.description": "Адрес Milvus Standalone или Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Токен Milvus",
  "settings.indexing.milvusToken.description": "Необязательный токен для Milvus с аутентификацией или Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Необязательный токен",
  "settings.indexing.milvusDatabase.title": "База данных Milvus",
  "settings.indexing.milvusDatabase.description": "Необязательное имя базы данных Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "Оставьте пустым для значения по умолчанию",
