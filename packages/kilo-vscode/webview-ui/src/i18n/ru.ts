export const dict = {
  ...
  "agentManager.diff.changes": "Изменения",
  "agentManager.diff.close": "Закрыть",
  "agentManager.diff.loading": "Вычисление diff...",
  "agentManager.diff.empty": "Изменения не обнаружены",
  "agentManager.diff.added": "Добавлено",
  "agentManager.diff.removed": "Удалено",
  "agentManager.diff.commentOnLine": "Комментарий к строке {{line}}",
  "agentManager.diff.editCommentOnLine": "Редактировать комментарий к строке {{line}}",
  "agentManager.diff.placeholder": "Оставить комментарий...",
  "agentManager.diff.cancel": "Отмена",
  "agentManager.diff.comment": "Комментарий",
  "agentManager.diff.save": "Сохранить",
  "agentManager.diff.send": "Отправить",
  "agentManager.diff.sendTooltip": "Отправить напрямую в LLM",
  "agentManager.diff.commentTooltip": "Сохранить комментарий ({{shortcut}})",
  "agentManager.diff.sendToChat": "Отправить в чат",
  "agentManager.diff.edit": "Редактировать",
  "agentManager.diff.delete": "Удалить",
  "agentManager.diff.commentsCount": "{{count}} комментарий",
  "agentManager.diff.commentsCountPlural": "{{count}} комментариев",
  "agentManager.diff.sendAllToChat": "Отправить всё в чат",
  "agentManager.shortcuts.sendAllComments": "Отправить все комментарии в LLM",
