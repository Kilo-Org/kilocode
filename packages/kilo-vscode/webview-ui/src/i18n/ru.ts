export const dict = {
  ...
  "agentRequirements.skill.installing": "Установка из Marketplace...",
  "agentRequirements.skill.verifying": "Установлено. Проверяем, найден ли навык...",
  "agentRequirements.skill.installed": "Установлен",
  "agentRequirements.skill.installFailed": "Не удалось установить",
  ...
  "agentRequirements.group.extensions": "Расширения",
  "agentRequirements.skill.missing": "Необходимый навык не установлен",
  "agentRequirements.checking.title": "Проверка требований агента",
  "agentRequirements.checking.description": "Проверяем навыки, доступные в этом проекте.",
  "agentRequirements.ready.title": "Всё готово",
  "agentRequirements.ready.description": "Все необходимые навыки доступны.",
  "agentRequirements.blocked.title": "Выполните необходимые проверки",
  "agentRequirements.blocked.description": "Для запуска этому агенту нужны следующие навыки.",
  "agentRequirements.action.installing": "Установка навыков...",
  "agentRequirements.action.installAll": "Установить все недостающие навыки / MCP",
  "agentRequirements.install.partialFailure":
    "Некоторые навыки не удалось установить. Исправьте ошибки и повторите попытку.",
  "agentRequirements.prompt.blocked": "Сначала выполните необходимые проверки, чтобы использовать этого агента",
  "agentRequirements.error.unknownAgent": "Не удалось найти выбранного агента.",
  "agentRequirements.error.malformedDeclaration": "У этого агента некорректно указаны требования к навыкам.",
  "agentRequirements.error.discoveryFailed": "Kilo не удалось проверить доступные навыки.",
  "agentRequirements.error.scopeMismatch": "Эта проверка требований агента больше не активна.",
  "agentRequirements.error.requestFailed": "Kilo не удалось проверить требования агента.",
  "agentRequirements.install.error.skillNotFound": "Не удалось найти необходимый навык в Marketplace.",
  "agentRequirements.install.error.itemNotSkill": "Элемент Marketplace не является навыком.",
  "agentRequirements.install.error.unavailable": "Установка навыков недоступна в этом представлении.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo не удалось загрузить навыки из Marketplace.",
