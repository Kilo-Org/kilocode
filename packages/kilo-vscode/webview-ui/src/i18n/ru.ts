export const dict = {
  ...
  "migration.progress.sessions": "Сеансы чата",
  "migration.progress.defaultModel": "Модель по умолчанию",
  "migration.progress.commandRules": "Правила команд",
  "migration.progress.readPermission": "Разрешение на чтение",
  "migration.progress.writePermission": "Разрешение на запись",
  "migration.progress.executePermission": "Разрешение на выполнение",
  "migration.progress.mcpPermission": "Разрешение MCP",
  "migration.progress.taskPermission": "Разрешение задач",
  "migration.progress.language": "Языковая настройка",
  "migration.progress.autocomplete": "Настройки автодополнения",
