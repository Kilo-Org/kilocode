export const dict = {
  ...
  "revert.banner.step": "Шаг агента отменен",
  "checkpoint.label": "Контрольная точка",
  "checkpoint.viewChanges": "Просмотреть изменения после этой контрольной точки",
  "checkpoint.parallel": "Контрольная точка перед {{count}} параллельными инструментами",
  "checkpoint.stopRewind": "Остановить и откатить",
  "checkpoint.unavailable": "Контрольная точка недоступна, так как снимок состояния не был сделан",
  "checkpoint.sharedDirectory":
    "Этот каталог используется другой активной сессией. Откат может восстановить и её изменения.",
  "checkpoint.sharedDirectory.confirm": "Всё равно откатить",
  "checkpoint.failed": "Не удалось откатить к контрольной точке.",
