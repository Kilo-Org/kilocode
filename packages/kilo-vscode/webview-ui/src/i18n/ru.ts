export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.permissions": "Запрашивает разрешение перед редактированием файлов.",
  "workStyle.choice.human-in-the-loop.bash": "Запрашивает разрешение на каждую команду терминала.",
  "workStyle.choice.human-in-the-loop.visibility": "Показывает детали разговора, включая команды и ход рассуждений.",
