export const dict = {
  ...
  "workStyle.onboarding.title": "Выберите, как вы хотите работать с ИИ-агентами",
  ...
  "workStyle.choice.human.eyebrow": "Человек контролирует процесс",
  "workStyle.choice.human.title": "Сначала проверка",
  "workStyle.choice.human.description":
    "Kilo часто приостанавливается и по ходу работы показывает, что планирует сделать.",
  "workStyle.choice.human.permissions": "Запрашивает разрешение перед редактированием файлов.",
  "workStyle.choice.human.bash": "Запрашивает разрешение на каждую команду терминала.",
  "workStyle.choice.human.visibility": "Показывает детали разговора, включая команды и ход рассуждений.",
  "workStyle.choice.autonomous.eyebrow": "Меньше прерываний",
  "workStyle.choice.autonomous.title": "Высокая автономность",
  "workStyle.choice.autonomous.description": "Работайте с меньшим количеством прерываний и в упрощённом интерфейсе.",
  "workStyle.choice.autonomous.permissions": "Может автоматически редактировать файлы в рабочем пространстве.",
  "workStyle.choice.autonomous.bash": "Может выполнять команды терминала в рабочем пространстве без подтверждения.",
  "workStyle.choice.autonomous.visibility": "Детали разговора остаются скрытыми, пока вы их не развернёте.",
