export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "например: используйте этого агента, когда пользователь просит провести ревью кода или анализ качества",
  "settings.agentBehaviour.editMode.whenToUse.none": "Для этого встроенного агента не задано описание.",
