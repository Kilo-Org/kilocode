...
export const dict = {
  ...
  "tool.board.read": "Прочитать сообщения",
  "tool.board.post": "Опубликовать сообщение",
  "tool.board.message": "Прочитано 1 сообщение",
  "tool.board.messages": "Прочитано сообщений: {{count}}",
  "tool.board.empty": "Нет сообщений для чтения",
  "tool.board.posted": "Опубликовано для: {{recipient}}",
  "tool.board.saved": "Сохранено для: {{recipient}}",
  "tool.board.channel": "Kilo Swarm (общая доска)",
  "tool.board.details": "Подробности",
  "tool.board.unavailable": "Данные сообщения недоступны. Откройте подробности для просмотра.",
  "tool.board.from": "От: {{sender}}",
  "tool.board.status": "Доставка: {{status}}",
  "tool.board.inactive": "Сохранено, когда получатель был неактивен",
  "tool.board.audience": "Сохранено; других активных получателей не было",
  "tool.board.unknown": "Сохранено; активность получателей была неизвестна",
  "tool.board.receipt": "Подтверждение прочтения недоступно",
  "tool.board.agent": "Агент {{id}}",
  "tool.board.more": "На доске есть ещё сообщения.",
  "tool.board.showMore": "Показать ещё {{count}}",
  "tool.board.showLess": "Показать меньше",
  "tool.board.main": "Главный",
  "tool.board.all": "Все агенты",
