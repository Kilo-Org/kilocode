...
export const dict = {
  ...
  "provider.custom.models.allReasoning": "Все рассуждения",
  "provider.custom.models.noReasoning": "Без рассуждений",
  "provider.custom.models.allImages": "Все изображения",
  "provider.custom.models.noImages": "Без изображений",
