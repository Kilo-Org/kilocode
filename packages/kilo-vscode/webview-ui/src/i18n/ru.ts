export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Выберите агента по умолчанию",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Агент по умолчанию",
  "workStyle.agent.code.tasks": "Лучше всего подходит для задач программирования",
  "workStyle.agent.code.changes": "Читает, пишет и изменяет код",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Лучше всего подходит для анализа данных",
  "workStyle.agent.data.notebooks": "Выполняет запросы и создает визуализации в блокнотах Jupyter",
  "workStyle.agent.data.requirement": "Требуется расширение Jupyter",
