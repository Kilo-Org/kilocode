...
export const dict = {
  ...
  "tool.board.read": "Berichten lezen",
  "tool.board.post": "Bericht plaatsen",
  "tool.board.message": "1 bericht gelezen",
  "tool.board.messages": "{{count}} berichten gelezen",
  "tool.board.empty": "Geen berichten om te lezen",
  "tool.board.posted": "Geplaatst voor {{recipient}}",
  "tool.board.saved": "Opgeslagen voor {{recipient}}",
  "tool.board.channel": "Kilo Swarm (gedeeld bord)",
  "tool.board.details": "Details",
  "tool.board.unavailable": "Berichtgegevens niet beschikbaar. Open de details om ze te bekijken.",
  "tool.board.from": "Van {{sender}}",
  "tool.board.status": "Aflevering: {{status}}",
  "tool.board.inactive": "Opgeslagen terwijl de ontvanger inactief was",
  "tool.board.audience": "Opgeslagen; er waren geen andere actieve ontvangers",
  "tool.board.unknown": "Opgeslagen; de activiteit van de ontvangers was onbekend",
  "tool.board.receipt": "Leesbevestiging niet beschikbaar",
  "tool.board.agent": "Agent {{id}}",
  "tool.board.more": "Er zijn meer berichten beschikbaar op het bord.",
  "tool.board.showMore": "Nog {{count}} tonen",
  "tool.board.showLess": "Minder tonen",
  "tool.board.main": "Hoofdagent",
  "tool.board.all": "Alle agenten",
  "tool.board.to": "Aan {{recipient}}",
