export const dict = {
  ...
  "migration.progress.sessions": "Chatsessies",
  "migration.progress.defaultModel": "Standaardmodel",
  "migration.progress.commandRules": "Opdrachtregels",
  "migration.progress.readPermission": "Leesrechten",
  "migration.progress.writePermission": "Schrijfrechten",
  "migration.progress.executePermission": "Uitvoerrechten",
  "migration.progress.mcpPermission": "MCP-rechten",
  "migration.progress.taskPermission": "Taakrechten",
  "migration.progress.language": "Taalvoorkeur",
  "migration.progress.autocomplete": "Autocompleet-instellingen",
