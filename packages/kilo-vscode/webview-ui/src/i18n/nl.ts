export const dict = {
  ...
  "revert.banner.step": "Agentstap teruggedraaid",
  "checkpoint.label": "Checkpoint",
  "checkpoint.viewChanges": "Wijzigingen sinds dit controlepunt bekijken",
  "checkpoint.parallel": "Checkpoint voor {{count}} parallelle tools",
  "checkpoint.stopRewind": "Stoppen en terugdraaien",
  "checkpoint.unavailable": "Checkpoint niet beschikbaar omdat er geen snapshot is gemaakt",
  "checkpoint.sharedDirectory":
    "Een andere actieve sessie gebruikt deze map. Terugdraaien kan ook de wijzigingen daarvan herstellen.",
  "checkpoint.sharedDirectory.confirm": "Toch terugdraaien",
  "checkpoint.failed": "Kan checkpoint niet terugdraaien.",
