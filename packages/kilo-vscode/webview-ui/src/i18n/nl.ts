...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Tegoed toevoegen",
  "profile.usage.action.manageBilling": "Facturering beheren",
  ...
  "profile.usage.topups.title": "Persoonlijke opwaarderingen",
  "profile.usage.topups.auto": "Automatisch opwaarderen",
  "profile.usage.topups.on": "Aan",
  "profile.usage.topups.off": "Uit",
  "profile.usage.topups.rule": "Voeg ${{amount}} toe wanneer het saldo ${{threshold}} bereikt",
  "profile.usage.topups.payment": "{{brand}} eindigend op {{last4}}",
  "profile.usage.balance.breakdown": "Toegekend {{granted}} | Opgewaardeerd {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "niet beschikbaar",
