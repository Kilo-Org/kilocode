export const dict = {
  ...
  "settings.experimental.cloudAgent.title": "Cloudagents",
  "settings.experimental.cloudAgent.description": "Experimentele Cloud Agent-sessies inschakelen in Agent Manager",
