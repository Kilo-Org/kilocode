export const dict = {
  ...
  "workStyle.onboarding.title": "Kies hoe je met je AI-agents wilt werken",
  ...
  "workStyle.choice.human.eyebrow": "Menselijke controle",
  "workStyle.choice.human.title": "Eerst controleren",
  "workStyle.choice.human.description": "Kilo pauzeert regelmatig en laat tijdens het werk zien wat het van plan is.",
  "workStyle.choice.human.permissions": "Vraagt toestemming voordat bestanden worden bewerkt.",
  "workStyle.choice.human.bash": "Vraagt toestemming voor elke terminalopdracht.",
  "workStyle.choice.human.visibility": "Toont gespreksdetails, waaronder opdrachten en redeneringen.",
  "workStyle.choice.autonomous.eyebrow": "Minder onderbrekingen",
  "workStyle.choice.autonomous.title": "Hoge autonomie",
  "workStyle.choice.autonomous.description": "Werk met minder onderbrekingen en een gestroomlijnde interface.",
  "workStyle.choice.autonomous.permissions": "Kan bestanden in de werkruimte automatisch bewerken.",
  "workStyle.choice.autonomous.bash": "Kan terminalopdrachten in de werkruimte zonder goedkeuring uitvoeren.",
  "workStyle.choice.autonomous.visibility": "Gespreksdetails blijven verborgen totdat je ze uitvouwt.",
