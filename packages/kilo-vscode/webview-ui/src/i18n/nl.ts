export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Kies je standaardagent",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Standaardagent",
  "workStyle.agent.code.tasks": "Ideaal voor programmeertaken",
  "workStyle.agent.code.changes": "Leest, schrijft en wijzigt code",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Ideaal voor data-analyse",
  "workStyle.agent.data.notebooks": "Voert query’s uit en maakt visualisaties in Jupyter-notebooks",
  "workStyle.agent.data.requirement": "Vereist de Jupyter-extensie",
