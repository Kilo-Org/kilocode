export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Kilo pauzeert regelmatig en laat tijdens het werk zien wat het van plan is.",
  "workStyle.choice.human-in-the-loop.permissions": "Vraagt toestemming voordat bestanden worden bewerkt.",
  "workStyle.choice.human-in-the-loop.bash": "Vraagt toestemming voor elke terminalopdracht.",
  "workStyle.choice.human-in-the-loop.visibility": "Toont gespreksdetails, waaronder opdrachten en redeneringen.",
