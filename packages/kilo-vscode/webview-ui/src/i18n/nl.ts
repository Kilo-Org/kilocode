...
export const dict = {
  ...
  "settings.autoCleanup.error.status":
    "De status van sessieopschoning is tijdelijk niet beschikbaar. Opnieuw proberen...",
  "settings.autoCleanup.error.timeout": "Wachten op opschoningsstatus. De backend duurt langer dan verwacht.",
