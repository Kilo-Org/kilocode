...
export const dict = {
  ...
  "session.costNotice.idle":
    "{{minutes}} min inactief: het volgende verzoek gebruikt mogelijk geen cache ({{tokens}} tokens, ongeveer {{cost}}).",
  ...
  "settings.autoApprove.cacheIdle.title": "Melding inactieve cache",
  "settings.autoApprove.cacheIdle.description":
    "Waarschuw vóór het volgende verzoek na zoveel minuten inactiviteit, omdat de promptcache mogelijk is verlopen. De waarschuwing verschijnt alleen als de schatting het bedrag van de melding verzoekkosten bereikt. 0 schakelt dit uit.",
