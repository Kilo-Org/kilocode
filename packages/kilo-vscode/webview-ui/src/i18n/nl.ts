export const dict = {
  ...
  "agentRequirements.skill.installing": "Installeren vanuit Marketplace...",
  "agentRequirements.skill.verifying": "Geïnstalleerd. Controleren of de skill wordt gedetecteerd...",
  "agentRequirements.skill.installed": "Geïnstalleerd",
  "agentRequirements.skill.installFailed": "Installatie mislukt",
  ...
  "agentRequirements.group.extensions": "Extensies",
  "agentRequirements.skill.missing": "De vereiste skill is niet geïnstalleerd",
  "agentRequirements.checking.title": "Agentvereisten controleren",
  "agentRequirements.checking.description": "De beschikbare skills in dit project worden gecontroleerd.",
  "agentRequirements.ready.title": "Klaar voor gebruik",
  "agentRequirements.ready.description": "Alle vereiste skills zijn beschikbaar.",
  "agentRequirements.blocked.title": "Voltooi de vereiste controles",
  "agentRequirements.blocked.description":
    "Deze agent heeft de volgende skills nodig voordat de agent kan worden uitgevoerd.",
  "agentRequirements.action.installing": "Skills installeren...",
  "agentRequirements.action.installAll": "Alle ontbrekende skills / MCP's installeren",
  "agentRequirements.install.partialFailure":
    "Sommige skills konden niet worden geïnstalleerd. Los de fouten op en probeer het opnieuw.",
  "agentRequirements.prompt.blocked": "Voltooi eerst de vereiste controles om deze agent te gebruiken",
  "agentRequirements.error.unknownAgent": "De geselecteerde agent is niet gevonden.",
  "agentRequirements.error.malformedDeclaration": "Deze agent heeft een ongeldige declaratie voor vereiste skills.",
  "agentRequirements.error.discoveryFailed": "Kilo kon de beschikbare skills niet controleren.",
  "agentRequirements.error.scopeMismatch": "Deze controle van de agentvereisten is niet meer actief.",
  "agentRequirements.error.requestFailed": "Kilo kon de agentvereisten niet controleren.",
  "agentRequirements.install.error.skillNotFound": "De vereiste Marketplace-skill is niet gevonden.",
  "agentRequirements.install.error.itemNotSkill": "Het Marketplace-item is geen skill.",
  "agentRequirements.install.error.unavailable": "Installatie van skills is niet beschikbaar in deze weergave.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo kon de skills uit Marketplace niet laden.",
