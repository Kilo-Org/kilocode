...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Milvus-adres",
  "settings.indexing.milvusAddress.description": "Adres voor Milvus Standalone of Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Milvus-token",
  "settings.indexing.milvusToken.description": "Optioneel token voor geverifieerde Milvus of Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Optioneel token",
  "settings.indexing.milvusDatabase.title": "Milvus-database",
  "settings.indexing.milvusDatabase.description": "Optionele naam van de Milvus-database.",
  "settings.indexing.milvusDatabase.placeholder": "Laat leeg voor de standaardwaarde",
