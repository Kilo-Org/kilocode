...
export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "选择默认智能体",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "默认代理",
  "workStyle.agent.code.tasks": "最适合编码任务",
  "workStyle.agent.code.changes": "读取、编写和修改代码",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "最适合数据分析",
  "workStyle.agent.data.notebooks": "在 Jupyter Notebook 中运行查询并创建可视化",
  "workStyle.agent.data.requirement": "需要安装 Jupyter 扩展",
