...
export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description": "Kilo 会频繁暂停，并在工作过程中显示接下来的操作计划。",
  "workStyle.choice.human-in-the-loop.permissions": "编辑文件前请求权限",
  "workStyle.choice.human-in-the-loop.bash": "运行所有终端命令时请求权限",
  "workStyle.choice.human-in-the-loop.visibility": "显示对话详情，包括命令和推理过程",
