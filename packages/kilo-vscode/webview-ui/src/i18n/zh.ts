...
export const dict = {
  ...
  "model.routing.label": "提供商路由",
  "model.routing.auto": "自动",
  "model.routing.loading": "正在加载提供商…",
  "model.routing.empty": "此模型暂无可用的提供商列表",
  ...
  "settings.models.providerRouting.title": "提供商路由",
  "settings.models.providerRouting.description":
    "通过 Kilo Gateway 路由时，将默认模型固定到特定的上游推理提供商。“自动”模式由网关选择提供商。",
