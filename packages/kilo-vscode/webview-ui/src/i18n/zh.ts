...
export const dict = {
  ...
  "settings.indexing.valkeyUrl.description": "Valkey 向量存储的连接 URL。",
  "settings.indexing.valkeyPassword.title": "Valkey 密码",
  "settings.indexing.valkeyPassword.description": "Valkey 的可选身份验证密码。",
  "settings.indexing.valkeyPassword.placeholder": "可选密码",
