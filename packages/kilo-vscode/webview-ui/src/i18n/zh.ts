...
export const dict = {
  ...
  "workStyle.onboarding.title": "选择你希望与 AI 智能体协作的方式",
  ...
  "workStyle.choice.human.eyebrow": "人工参与",
  "workStyle.choice.human.title": "先审查",
  "workStyle.choice.human.description": "Kilo 会频繁暂停，并在工作过程中显示接下来的操作计划。",
  "workStyle.choice.human.permissions": "编辑文件前请求权限",
  "workStyle.choice.human.bash": "运行所有终端命令时请求权限",
  "workStyle.choice.human.visibility": "显示对话详情，包括命令和推理过程",
  "workStyle.choice.autonomous.eyebrow": "减少打扰",
  "workStyle.choice.autonomous.title": "高度自主",
  "workStyle.choice.autonomous.description": "减少打断，并使用更简洁的界面工作。",
  "workStyle.choice.autonomous.permissions": "可以自动编辑工作区中的文件。",
  "workStyle.choice.autonomous.bash": "可以在工作区中无需批准即可运行终端命令。",
  "workStyle.choice.autonomous.visibility": "对话详情会保持隐藏，直到你将其展开。",
