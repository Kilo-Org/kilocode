...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "LLMAPI 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 LLMAPI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 LLMAPI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 LLMAPI 中使用 {{provider}} 模型。",
  ...
  "speechToText.tooltip.start": "使用 LLMAPI Gateway 开始语音输入",
  ...
  "speechToText.error.loginRequired": "登录 LLMAPI 以使用语音输入。",
  ...
  "dialog.server.description": "切换此应用连接的 LLMAPI 服务器。",
  ...
  "toast.update.description": "LLMAPI 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 LLMAPI 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: LLMAPI 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "LLMAPI 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 LLMAPI 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 LLMAPI 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 LLMAPI 的主题。",
  ...
  "settings.updates.row.startup.description": "在 LLMAPI 启动时自动检查更新",
  ...
  "settings.indexing.kiloModel.title": "LLMAPI 模型预设",
  "settings.indexing.kiloModel.description": "选择受支持的 LLMAPI 托管嵌入模型。",
  "settings.indexing.kiloSignIn.title": "需要登录 LLMAPI",
  "settings.indexing.kiloSignIn.description": "登录 LLMAPI 以使用托管嵌入。",
  ...
  "settings.config.title": "打开 {{scope}} LLMAPI 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 LLMAPI 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} LLMAPI 配置文件：{{message}}",
  ...
  "profile.action.login": "使用 LLMAPI 登录",
  ...
  "settings.aboutKiloCode.title": "关于 LLMAPI",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "LLMAPI 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutKiloCode.extensionName": "LLMAPI 扩展",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "文件不包含有效的 LLMAPI 设置。",
  "settings.aboutKiloCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此文件由较新版本的 LLMAPI 导出。部分设置可能会被忽略。",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 LLMAPI 界面的语言。',
  ...
  "settings.experimental.speechToText.description": "通过 LLMAPI Gateway 使用您的 LLMAPI 帐户在提示词字段中启用语音输入。",
  "settings.experimental.speechToText.disabledDescription":
    "启用并登录 LLMAPI 提供商以使用 Speech to Text。Speech to Text 目前仅支持通过 LLMAPI Gateway 使用。",
  "settings.experimental.speechToTextModel.title": "语音转文本模型",
  "settings.experimental.speechToTextModel.description": "选择用于语音输入的 LLMAPI Gateway 转录模型。",
  ...
  "settings.experimental.remote.description": "通过 LLMAPI Cloud 启用会话的 Remote 控制。这也会影响此计算机上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 LLMAPI 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 LLMAPI webview UI 的字体大小。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "从旧版 LLMAPI 安装迁移设置，包括提供商 API 密钥和默认模型。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 LLMAPI 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "diffViewer.source.session.tooltip": "LLMAPI 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
