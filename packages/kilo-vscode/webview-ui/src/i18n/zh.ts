...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Pound 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Pound 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Pound 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Pound 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Pound 服务器。",
  ...
  "toast.update.description": "Pound 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Pound 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Pound 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Pound 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Pound 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Pound 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Pound 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Pound 启动时自动检查更新",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Pound Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Pound 开放，无锁定。",
  ...
  "session.cloud.import.placeholder": "会话 ID、URL 或 pound import 命令",
  ...
  "deviceAuth.title": "登录 Pound Code",
  ...
  "profile.action.login": "使用 Pound Code 登录",
  ...
  "settings.aboutKiloCode.title": "关于 Pound Code",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Pound Code 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutKiloCode.extensionName": "Pound Code 扩展",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "将所有 Pound Code 扩展设置重置为默认值。这不会影响 CLI 或后端配置。",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Pound Code 界面的语言。',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "从旧版 Pound Code 安装迁移设置，包括提供商 API 密钥和默认模型。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Pound 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
