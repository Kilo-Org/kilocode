...
export const dict = {
  ...
  "agentRequirements.skill.installing": "正在从 Marketplace 安装...",
  "agentRequirements.skill.verifying": "安装完成。正在确认是否已识别该技能...",
  "agentRequirements.skill.installed": "已安装",
  "agentRequirements.skill.installFailed": "安装失败",
  "agentRequirements.skill.checkFailed": "技能检查失败",
  "agentRequirements.group.skills": "技能",
  "agentRequirements.group.mcps": "MCP",
  "agentRequirements.group.extensions": "扩展",
  "agentRequirements.skill.missing": "尚未安装所需技能",
  "agentRequirements.checking.title": "正在检查智能体要求",
  "agentRequirements.checking.description": "正在验证此项目中可用的技能。",
  "agentRequirements.ready.title": "已准备就绪",
  "agentRequirements.ready.description": "所有所需技能均可用。",
  "agentRequirements.blocked.title": "完成必要检查",
  "agentRequirements.blocked.description": "此智能体需要以下技能才能运行。",
  "agentRequirements.action.installing": "正在安装技能...",
  "agentRequirements.action.installAll": "安装所有缺失的技能 / MCP",
  "agentRequirements.install.partialFailure": "部分技能无法安装。请修复错误后重试。",
  "agentRequirements.prompt.blocked": "请先完成必要检查，才能使用此智能体",
  "agentRequirements.error.unknownAgent": "找不到所选智能体。",
  "agentRequirements.error.malformedDeclaration": "此智能体的技能要求声明无效。",
  "agentRequirements.error.discoveryFailed": "Kilo 无法检查可用技能。",
  "agentRequirements.error.scopeMismatch": "此智能体要求检查已失效。",
  "agentRequirements.error.requestFailed": "Kilo 无法检查智能体要求。",
  "agentRequirements.install.error.skillNotFound": "找不到所需的 Marketplace 技能。",
  "agentRequirements.install.error.itemNotSkill": "此 Marketplace 项目不是技能。",
  "agentRequirements.install.error.unavailable": "此视图不支持安装技能。",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo 无法加载 Marketplace 技能。",
