...
export const dict = {
  ...
  "settings.enterprise.title": "企业私有化",
  "settings.enterprise.license.title": "License 授权",
  "settings.enterprise.license.description": "私有化部署的 License 校验（在线或离线文件）。",
  "settings.enterprise.license.disabled": "未启用",
  "settings.enterprise.license.valid": "有效",
  "settings.enterprise.license.invalid": "无效或已过期",
  "settings.enterprise.refresh": "刷新状态",
  "settings.enterprise.openSettings": "打开 VS Code 设置",
  "settings.enterprise.engine.title": "Kilo Engine",
  "settings.enterprise.engine.description": "Docker 或 APISIX 部署时的远端 Engine 连接。",
  "settings.enterprise.engine.remote": "模式",
  "settings.enterprise.engine.enabled": "远端",
  "settings.enterprise.engine.local": "本地（内置 CLI）",
  "settings.enterprise.engine.gateway": "网关",
  "settings.enterprise.about.title": "开源声明",
  "settings.enterprise.about.action": "查看 Apache 2.0 声明",
