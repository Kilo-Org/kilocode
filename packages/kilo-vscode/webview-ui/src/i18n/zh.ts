...
export const dict = {
  ...
  "settings.models.refreshCatalog.title": "更新模型目录",
  "settings.models.refreshCatalog.description": "立即从 models.dev 和 Kilo Gateway 获取最新模型。",
  "settings.models.refreshCatalog.button": "立即更新",
  "settings.models.refreshCatalog.refreshing": "正在更新…",
  "settings.models.refreshCatalog.toast.success": "模型目录已更新",
  "settings.models.refreshCatalog.toast.error": "无法完全刷新模型目录，请重试。",
