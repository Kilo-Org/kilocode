...
export const dict = {
  ...
  "revert.banner.step": "智能体步骤已还原",
  "checkpoint.label": "检查点",
  "checkpoint.viewChanges": "查看此检查点之后的更改",
  "checkpoint.parallel": "{{count}} 个并行工具之前的检查点",
  "checkpoint.stopRewind": "停止并回退",
  "checkpoint.unavailable": "由于未捕获快照，检查点不可用",
  "checkpoint.sharedDirectory": "另一个活动会话正在使用此目录。回退可能也会还原其更改。",
  "checkpoint.sharedDirectory.confirm": "仍然回退",
  "checkpoint.failed": "回退检查点失败。",
