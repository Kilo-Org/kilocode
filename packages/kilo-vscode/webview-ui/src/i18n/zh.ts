...
export const dict = {
  ...
  "tool.board.read": "阅读消息",
  "tool.board.post": "发布消息",
  "tool.board.message": "已阅读 1 条消息",
  "tool.board.messages": "已阅读 {{count}} 条消息",
  "tool.board.empty": "暂无消息可读",
  "tool.board.posted": "已为 {{recipient}} 发布",
  "tool.board.saved": "已为 {{recipient}} 保存",
  "tool.board.channel": "Kilo Swarm (共享看板)",
  "tool.board.details": "详细信息",
  "tool.board.unavailable": "消息数据不可用。请打开详细信息查看。",
  "tool.board.from": "来自 {{sender}}",
  "tool.board.status": "送达状态：{{status}}",
  "tool.board.inactive": "已保存，接收方当时处于非活动状态",
  "tool.board.audience": "已保存；发布时没有其他处于活动状态的接收方",
  "tool.board.unknown": "已保存；发布时接收方是否处于活动状态未知",
  "tool.board.receipt": "已读回执不可用",
  "tool.board.agent": "智能体 {{id}}",
  "tool.board.more": "看板上还有更多消息。",
  "tool.board.showMore": "再显示 {{count}} 条",
  "tool.board.showLess": "收起",
  "tool.board.main": "主智能体",
  "tool.board.all": "所有智能体",
  "tool.board.to": "发送给 {{recipient}}",
