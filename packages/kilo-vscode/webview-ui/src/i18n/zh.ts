...
export const dict = {
  ...
  "provider.anaconda.state.notInstalled":
    "在此设备上安装 Anaconda Desktop，然后返回此处。Kilo 不会替您运行安装程序。",
  "provider.anaconda.state.notRunning":
    "打开 Anaconda Desktop，完成设置并登录，然后选择重新检查。",
  "provider.anaconda.state.invalidConfig":
    "Anaconda Desktop 设置不完整。打开 Desktop，完成设置，如有需要请重新启动。",
  "provider.anaconda.state.signedOut": "在连接 Kilo 之前，请打开 Anaconda Desktop 并登录。",
  "provider.anaconda.state.unauthorized":
    "Kilo 无法访问 Anaconda Desktop。打开 Desktop，重新登录，如有需要请重新启动。",
  "provider.anaconda.state.unavailable":
    "Anaconda Desktop 尚未响应。请打开它并等待应用程序完成启动。",
  "provider.anaconda.state.noModel":
    "在 Anaconda Desktop 中下载文本生成模型。尽可能选择支持工具调用的模型，然后启动其服务器。",
  ...
  "provider.anaconda.state.unhealthy":
    "活跃推理服务器尚不健康。在 Anaconda Desktop 中检查并根据需要重启服务器。",
  "provider.anaconda.state.ready":
    "Kilo 找到了一个健康的本地文本生成服务器，可以导入其当前连接设置。",
  "provider.anaconda.server": "活跃推理服务器",
  ...
  "provider.anaconda.toast.refreshed.description": "活跃的本地服务器和模型在 Kilo 中已是最新状态。",
  "settings.providers.note.anacondaDesktop": "运行由 Anaconda Desktop 本地提供的模型。",
