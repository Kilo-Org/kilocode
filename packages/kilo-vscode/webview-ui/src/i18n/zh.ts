...
export const dict = {
  ...
  "provider.custom.models.allReasoning": "全部启用推理",
  "provider.custom.models.noReasoning": "全部关闭推理",
  "provider.custom.models.allImages": "全部启用图片",
  "provider.custom.models.noImages": "全部关闭图片",
