...
export const dict = {
  ...
  "agentManager.diff.changes": "更改",
  "agentManager.diff.close": "关闭",
  "agentManager.diff.loading": "正在计算差异...",
  "agentManager.diff.empty": "未检测到更改",
  "agentManager.diff.added": "已添加",
  "agentManager.diff.removed": "已移除",
  "agentManager.diff.commentOnLine": "在第 {{line}} 行评论",
  "agentManager.diff.editCommentOnLine": "编辑第 {{line}} 行的评论",
  "agentManager.diff.placeholder": "留下评论...",
  "agentManager.diff.cancel": "取消",
  "agentManager.diff.comment": "评论",
  "agentManager.diff.save": "保存",
  "agentManager.diff.send": "发送",
  "agentManager.diff.sendTooltip": "直接发送给 LLM",
  "agentManager.diff.commentTooltip": "保存评论 ({{shortcut}})",
  "agentManager.diff.sendToChat": "发送到聊天",
  "agentManager.diff.edit": "编辑",
  "agentManager.diff.delete": "删除",
  "agentManager.diff.commentsCount": "{{count}} 条评论",
  "agentManager.diff.commentsCountPlural": "{{count}} 条评论",
  "agentManager.diff.sendAllToChat": "全部发送到聊天",
  "agentManager.shortcuts.sendAllComments": "发送所有评论给 LLM",
