...
export const dict = {
  ...
  "prompt.suggestions.files": "文件提及建议",
  "prompt.suggestions.commands": "命令建议",
  "prompt.suggestions.mentionSelected": "已选提及 {{value}}",
  "prompt.suggestions.commandSelected": "已选命令 {{value}}",
