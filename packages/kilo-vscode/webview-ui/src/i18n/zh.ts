...
export const dict = {
  ...
  "migration.progress.sessions": "聊天会话",
  "migration.progress.defaultModel": "默认模型",
  "migration.progress.commandRules": "命令规则",
  "migration.progress.readPermission": "读取权限",
  "migration.progress.writePermission": "写入权限",
  "migration.progress.executePermission": "执行权限",
  "migration.progress.mcpPermission": "MCP 权限",
  "migration.progress.taskPermission": "任务权限",
  "migration.progress.language": "语言偏好",
  "migration.progress.autocomplete": "自动补全设置",
