...
export const dict = {
  ...
  "settings.indexing.milvusDatabase.title": "Milvus 数据库",
  "settings.indexing.milvusDatabase.description": "可选的 Milvus 数据库名称。",
  "settings.indexing.milvusDatabase.placeholder": "留空使用默认值",
