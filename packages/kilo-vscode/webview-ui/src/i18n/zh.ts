...
export const dict = {
  ...
  "profile.usage.action.addCredits": "添加额度",
  "profile.usage.action.manageBilling": "管理账单",
  ...
  "profile.usage.topups.title": "个人充值",
  "profile.usage.topups.auto": "自动充值",
  "profile.usage.topups.on": "开启",
  "profile.usage.topups.off": "关闭",
  "profile.usage.topups.rule": "余额达到 ${{threshold}} 时充值 ${{amount}}",
  "profile.usage.topups.payment": "{{brand}} 尾号 {{last4}}",
  "profile.usage.balance.breakdown": "赠送 {{granted}} | 充值 {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "不可用",
  "profile.usage.credits.resets": "{{count}} 次重置",
