...
export const dict = {
  ...
  "workStyle.onboarding.title": "Velg hvordan du vil arbeide med AI-agentene dine",
  ...
  "workStyle.toast.saved.title": "Innstillingene er lagret",
  ...
  "workStyle.choice.human.eyebrow": "Menneskelig kontroll",
  "workStyle.choice.human.title": "Gjennomgå først",
  "workStyle.choice.human.description": "Kilo tar ofte pause og viser deg hva den planlegger å gjøre underveis.",
  "workStyle.choice.human.permissions": "Ber om tillatelse før filredigering.",
  "workStyle.choice.human.bash": "Ber om tillatelse til alle terminalkommandoer.",
  "workStyle.choice.human.visibility": "Viser samtaledetaljer, inkludert kommandoer og resonnering.",
  "workStyle.choice.autonomous.eyebrow": "Færre avbrudd",
  "workStyle.choice.autonomous.title": "Høy autonomi",
  "workStyle.choice.autonomous.description": "Arbeid med færre avbrudd og et strømlinjeformet grensesnitt.",
  "workStyle.choice.autonomous.permissions": "Kan redigere filer i arbeidsområdet automatisk.",
  "workStyle.choice.autonomous.bash": "Kan kjøre terminalkommandoer i arbeidsområdet uten godkjenning.",
  "workStyle.choice.autonomous.visibility": "Samtaledetaljer forblir skjult til du utvider dem.",
