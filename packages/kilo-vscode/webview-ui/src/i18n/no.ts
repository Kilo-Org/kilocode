...
export const dict = {
  ...
  "migration.progress.sessions": "Chatøkter",
  "migration.progress.defaultModel": "Standardmodell",
  "migration.progress.commandRules": "Kommandoregler",
  "migration.progress.readPermission": "Lesetillatelse",
  "migration.progress.writePermission": "Skrivetillatelse",
  "migration.progress.executePermission": "Kjøretillatelse",
  "migration.progress.mcpPermission": "MCP-tillatelse",
  "migration.progress.taskPermission": "Oppgavetillatelse",
  "migration.progress.language": "Språkvalg",
  "migration.progress.autocomplete": "Innstillinger for autofullføring",
