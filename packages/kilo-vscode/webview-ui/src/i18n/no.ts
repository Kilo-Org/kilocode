...
export const dict = {
  ...
  "tool.board.read": "Les meldinger",
  "tool.board.post": "Publiser melding",
  "tool.board.message": "Lest 1 melding",
  "tool.board.messages": "Lest {{count}} meldinger",
  "tool.board.empty": "Ingen meldinger å lese",
  "tool.board.posted": "Publisert for {{recipient}}",
  "tool.board.saved": "Lagret for {{recipient}}",
  "tool.board.channel": "Kilo Swarm (delt tavle)",
  "tool.board.details": "Detaljer",
  "tool.board.unavailable": "Meldingsdata er ikke tilgjengelige. Åpne detaljene for å undersøke dem.",
  "tool.board.from": "Fra {{sender}}",
  "tool.board.status": "Levering: {{status}}",
  "tool.board.inactive": "Lagret mens mottakeren var inaktiv",
  "tool.board.audience": "Lagret; ingen andre mottakere var aktive",
  "tool.board.unknown": "Lagret; mottakernes aktivitet var ukjent",
  "tool.board.receipt": "Lesebekreftelse er ikke tilgjengelig",
  "tool.board.agent": "Agent {{id}}",
  "tool.board.more": "Det er flere meldinger på tavlen.",
  "tool.board.showMore": "Vis {{count}} til",
  "tool.board.showLess": "Vis færre",
  "tool.board.main": "Hovedagent",
  "tool.board.all": "Alle agenter",
  "tool.board.to": "Til {{recipient}}",
