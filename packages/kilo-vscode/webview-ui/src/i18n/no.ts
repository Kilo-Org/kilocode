...
export const dict = {
  ...
  "agentManager.diff.changes": "Endringer",
  "agentManager.diff.close": "Lukk",
  "agentManager.diff.loading": "Beregner diff...",
  "agentManager.diff.empty": "Ingen endringer oppdaget",
  "agentManager.diff.added": "Lagt til",
  "agentManager.diff.removed": "Fjernet",
  "agentManager.diff.commentOnLine": "Kommenter linje {{line}}",
  "agentManager.diff.editCommentOnLine": "Rediger kommentar på linje {{line}}",
  "agentManager.diff.placeholder": "Legg igjen en kommentar...",
  "agentManager.diff.cancel": "Avbryt",
  "agentManager.diff.comment": "Kommenter",
  "agentManager.diff.save": "Lagre",
  "agentManager.diff.send": "Send",
  "agentManager.diff.sendTooltip": "Send direkte til LLM",
  "agentManager.diff.commentTooltip": "Lagre kommentar ({{shortcut}})",
  "agentManager.diff.sendToChat": "Send til chat",
  "agentManager.diff.edit": "Rediger",
  "agentManager.diff.delete": "Slett",
  "agentManager.diff.commentsCount": "{{count}} kommentar",
  "agentManager.diff.commentsCountPlural": "{{count}} kommentarer",
  "agentManager.diff.sendAllToChat": "Send alle til chat",
  "agentManager.shortcuts.sendAllComments": "Send alle kommentarer til LLM",
