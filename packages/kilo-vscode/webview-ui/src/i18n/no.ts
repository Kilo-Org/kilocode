...
export const dict = {
  ...
  "revert.banner.step": "Agenttrinn tilbakestilt",
  "checkpoint.label": "Sjekkpunkt",
  "checkpoint.viewChanges": "Vis endringer siden dette kontrollpunktet",
  "checkpoint.parallel": "Sjekkpunkt før {{count}} parallelle verktøy",
  "checkpoint.stopRewind": "Stopp og spol tilbake",
  "checkpoint.unavailable": "Sjekkpunkt er utilgjengelig fordi det ikke ble tatt noe øyeblikksbilde",
  "checkpoint.sharedDirectory":
    "En annen aktiv økt bruker denne mappen. Tilbakespoling kan også gjenopprette dens endringer.",
  "checkpoint.sharedDirectory.confirm": "Spol tilbake likevel",
  "checkpoint.failed": "Klarte ikke å spole tilbake sjekkpunkt.",
