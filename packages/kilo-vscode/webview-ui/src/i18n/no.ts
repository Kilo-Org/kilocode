...
export const dict = {
  ...
  "settings.indexing.milvusAddress.description": "Adresse for Milvus Standalone eller Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Milvus-token",
  "settings.indexing.milvusToken.description": "Valgfritt token for autentisert Milvus eller Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Valgfritt token",
  "settings.indexing.milvusDatabase.title": "Milvus-database",
  "settings.indexing.milvusDatabase.description": "Valgfritt navn på Milvus-databasen.",
  "settings.indexing.milvusDatabase.placeholder": "La stå tomt for standardverdien",
