...
export const dict = {
  ...
  "agentRequirements.skill.installing": "Installerer fra Marketplace...",
  "agentRequirements.skill.verifying": "Installert. Kontrollerer om ferdigheten er tilgjengelig...",
  "agentRequirements.skill.installed": "Installert",
  "agentRequirements.skill.installFailed": "Installasjonen mislyktes",
  "agentRequirements.skill.checkFailed": "Kontrollen av ferdigheten mislyktes",
  "agentRequirements.group.skills": "Ferdigheter",
  "agentRequirements.group.mcps": "MCP-er",
  "agentRequirements.group.extensions": "Utvidelser",
  "agentRequirements.skill.missing": "Den nødvendige ferdigheten er ikke installert",
  "agentRequirements.checking.title": "Kontrollerer agentkrav",
  "agentRequirements.checking.description": "Kontrollerer ferdighetene som er tilgjengelige i dette prosjektet.",
  "agentRequirements.ready.title": "Klar til bruk",
  "agentRequirements.ready.description": "Alle nødvendige ferdigheter er tilgjengelige.",
  "agentRequirements.blocked.title": "Fullfør nødvendige kontroller",
  "agentRequirements.blocked.description": "Denne agenten trenger følgende ferdigheter før den kan kjøre.",
  "agentRequirements.action.installing": "Installerer ferdigheter...",
  "agentRequirements.action.installAll": "Installer alle manglende ferdigheter / MCP-er",
  "agentRequirements.install.partialFailure": "Noen ferdigheter kunne ikke installeres. Rett feilene og prøv på nytt.",
  "agentRequirements.prompt.blocked": "Fullfør først de nødvendige kontrollene for å bruke denne agenten",
  "agentRequirements.error.unknownAgent": "Den valgte agenten ble ikke funnet.",
  "agentRequirements.error.malformedDeclaration": "Denne agenten har en ugyldig angivelse av nødvendige ferdigheter.",
  "agentRequirements.error.discoveryFailed": "Kilo kunne ikke kontrollere de tilgjengelige ferdighetene.",
  "agentRequirements.error.scopeMismatch": "Denne kontrollen av agentkrav er ikke lenger aktiv.",
  "agentRequirements.error.requestFailed": "Kilo kunne ikke kontrollere agentkravene.",
  "agentRequirements.install.error.skillNotFound": "Den nødvendige Marketplace-ferdigheten ble ikke funnet.",
  "agentRequirements.install.error.itemNotSkill": "Marketplace-elementet er ikke en ferdighet.",
  "agentRequirements.install.error.unavailable": "Installasjon av ferdigheter er ikke tilgjengelig i denne visningen.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo kunne ikke laste inn ferdigheter fra Marketplace.",
