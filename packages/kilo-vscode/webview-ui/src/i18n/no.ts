...
export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Velg standardagenten din",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Standardagent",
  "workStyle.agent.code.tasks": "Best for kodeoppgaver",
  "workStyle.agent.code.changes": "Leser, skriver og endrer kode",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Best for dataanalyse",
  "workStyle.agent.data.notebooks": "Kjører spørringer og lager visualiseringer i Jupyter-notatbøker",
  "workStyle.agent.data.requirement": "Krever Jupyter-utvidelsen",
