...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Pound",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Pound.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Pound.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Pound.",
  ...
  "dialog.server.description": "Bytt hvilken Pound-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Pound ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Pound-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Pound ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Pound inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Pound",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Pound ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Pound er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Pound starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Pound.",
  ...
  "settings.providers.betaNotice":
    "For øyeblikket kan kun Pound Gateway-leverandøren konfigureres i innstillingsgrensesnittet. Støtte for konfigurering av andre leverandører kommer snart i løpet av betaperioden. I mellomtiden kan du konfigurere leverandører via CLI eller konfigurasjonsfilen. Vi er forpliktet til å holde Pound åpent, ingen lock-in.",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller pound import-kommando",
  ...
  "deviceAuth.title": "Logg inn på Pound Code",
  ...
  "profile.action.login": "Logg inn med Pound Code",
  ...
  "settings.aboutKiloCode.title": "Om Pound Code",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "Pound Code er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutKiloCode.extensionName": "Pound Code-utvidelse",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Tilbakestill alle Pound Code-utvidelsesinnstillinger til standardverdier. Dette påvirker ikke CLI- eller backend-konfigurasjon.",
  ...
  "settings.language.description": 'Velg språket for Pound Code-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Pound Code, inkludert API-nøkler for leverandører og standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Pound Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle Pound-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
