...
export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Kilo tar ofte pause og viser deg hva den planlegger å gjøre underveis.",
  "workStyle.choice.human-in-the-loop.permissions": "Ber om tillatelse før filredigering.",
  "workStyle.choice.human-in-the-loop.bash": "Ber om tillatelse til alle terminalkommandoer.",
  "workStyle.choice.human-in-the-loop.visibility": "Viser samtaledetaljer, inkludert kommandoer og resonnering.",
