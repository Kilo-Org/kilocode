...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Legg til kreditt",
  ...
  "profile.usage.topups.title": "Personlige påfyll",
  "profile.usage.topups.auto": "Automatisk påfyll",
  "profile.usage.topups.on": "På",
  "profile.usage.topups.off": "Av",
  "profile.usage.topups.rule": "Legg til ${{amount}} når saldoen når ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} som slutter på {{last4}}",
  "profile.usage.balance.breakdown": "Tildelt {{granted}} | Fylt på {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "utilgjengelig",
  "profile.usage.credits.resets": "{{count}} tilbakestillinger",
