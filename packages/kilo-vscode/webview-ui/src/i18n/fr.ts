export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "Quand l’utiliser",
  ...
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "p. ex. utilisez cet agent lorsque l’utilisateur demande une revue de code ou une analyse de qualité",
  "settings.agentBehaviour.editMode.whenToUse.none": "Aucune description n’est définie pour cet agent intégré.",
