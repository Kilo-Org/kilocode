export const dict = {
  ...
  "migration.progress.sessions": "Sessions de chat",
  "migration.progress.defaultModel": "Modèle par défaut",
  "migration.progress.commandRules": "Règles de commande",
  "migration.progress.readPermission": "Autorisation de lecture",
  "migration.progress.writePermission": "Autorisation d'écriture",
  "migration.progress.executePermission": "Autorisation d'exécution",
  "migration.progress.mcpPermission": "Autorisation MCP",
  "migration.progress.taskPermission": "Autorisation de tâche",
  "migration.progress.language": "Préférence de langue",
  "migration.progress.autocomplete": "Paramètres d'autocomplétion",
