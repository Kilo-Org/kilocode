...
export const dict = {
  ...
  "tool.board.read": "Lire les messages",
  "tool.board.post": "Publier un message",
  "tool.board.message": "1 message lu",
  "tool.board.messages": "{{count}} messages lus",
  "tool.board.empty": "Aucun message à lire",
  "tool.board.posted": "Publié pour {{recipient}}",
  "tool.board.saved": "Enregistré pour {{recipient}}",
  "tool.board.channel": "Kilo Swarm (tableau partagé)",
  "tool.board.details": "Détails",
  "tool.board.unavailable": "Données du message indisponibles. Ouvrez les détails pour les examiner.",
  "tool.board.from": "De {{sender}}",
  "tool.board.status": "Remise : {{status}}",
  "tool.board.inactive": "Enregistré alors que le destinataire était inactif",
  "tool.board.audience": "Enregistré ; aucun autre destinataire n'était actif",
  "tool.board.unknown": "Enregistré ; l'activité des destinataires était inconnue",
  "tool.board.receipt": "Confirmation de lecture indisponible",
  "tool.board.agent": "Agent {{id}}",
  "tool.board.more": "D'autres messages sont disponibles sur le tableau.",
  "tool.board.showMore": "Afficher {{count}} de plus",
  "tool.board.showLess": "Afficher moins",
  "tool.board.main": "Principal",
  "tool.board.all": "Tous les agents",
  "tool.board.to": "À {{recipient}}",
