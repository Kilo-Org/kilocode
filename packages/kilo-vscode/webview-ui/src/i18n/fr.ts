export const dict = {
  ...
  "revert.banner.step": "Étape de l'agent annulée",
  "checkpoint.label": "Point de contrôle",
  "checkpoint.viewChanges": "Afficher les modifications depuis ce point de contrôle",
  "checkpoint.parallel": "Point de contrôle avant {{count}} outils en parallèle",
  "checkpoint.stopRewind": "Arrêter et revenir en arrière",
  "checkpoint.unavailable": "Point de contrôle indisponible car aucun instantané n'a été capturé",
  "checkpoint.sharedDirectory":
    "Une autre session active utilise ce répertoire. Revenir en arrière peut également restaurer ses modifications.",
  "checkpoint.sharedDirectory.confirm": "Revenir en arrière quand même",
  "checkpoint.failed": "Échec du retour au point de contrôle.",
