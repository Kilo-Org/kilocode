export const dict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installez Anaconda Desktop sur cette machine, puis revenez ici. Kilo n'exécute pas le programme d'installation à votre place.",
  ...
  "provider.anaconda.state.ready":
    "Kilo a trouvé un serveur local de génération de texte en bonne santé et peut importer ses paramètres de connexion actuels.",
