...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Ajouter des crédits",
  "profile.usage.action.manageBilling": "Gérer la facturation",
  ...
  "profile.usage.topups.title": "Recharges personnelles",
  "profile.usage.topups.auto": "Recharge automatique",
  "profile.usage.topups.on": "Activée",
  "profile.usage.topups.off": "Désactivée",
  "profile.usage.topups.rule": "Ajouter ${{amount}} lorsque le solde atteint ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} se terminant par {{last4}}",
  "profile.usage.balance.breakdown": "Accordé {{granted}} | Rechargé {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "indisponible",
  "profile.usage.credits.resets": "{{count}} réinitialisations",
