export const dict = {
  ...
  "agentManager.diff.changes": "Modifications",
  "agentManager.diff.close": "Fermer",
  "agentManager.diff.loading": "Calcul du diff...",
  "agentManager.diff.empty": "Aucune modification détectée",
  "agentManager.diff.added": "Ajouté",
  "agentManager.diff.removed": "Supprimé",
  "agentManager.diff.commentOnLine": "Commenter la ligne {{line}}",
  "agentManager.diff.editCommentOnLine": "Modifier le commentaire de la ligne {{line}}",
  "agentManager.diff.placeholder": "Laisser un commentaire...",
  "agentManager.diff.cancel": "Annuler",
  "agentManager.diff.comment": "Commenter",
  "agentManager.diff.save": "Enregistrer",
  "agentManager.diff.send": "Envoyer",
  "agentManager.diff.sendTooltip": "Envoyer directement au LLM",
  "agentManager.diff.commentTooltip": "Enregistrer le commentaire ({{shortcut}})",
  "agentManager.diff.sendToChat": "Envoyer au chat",
  "agentManager.diff.edit": "Modifier",
  "agentManager.diff.delete": "Supprimer",
  "agentManager.diff.commentsCount": "{{count}} commentaire",
  "agentManager.diff.commentsCountPlural": "{{count}} commentaires",
  "agentManager.diff.sendAllToChat": "Tout envoyer au chat",
  "agentManager.shortcuts.sendAllComments": "Envoyer tous les commentaires au LLM",
