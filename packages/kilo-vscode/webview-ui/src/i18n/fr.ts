export const dict = {
  ...
  "agentRequirements.skill.installing": "Installation depuis le Marketplace...",
  "agentRequirements.skill.verifying": "Installation terminée. Vérification de la détection de la compétence...",
  "agentRequirements.skill.installed": "Installée",
  "agentRequirements.skill.installFailed": "Échec de l'installation",
  ...
  "agentRequirements.group.extensions": "Extensions",
  "agentRequirements.skill.missing": "La compétence requise n'est pas installée",
  "agentRequirements.checking.title": "Vérification des exigences de l'agent",
  "agentRequirements.checking.description": "Vérification des compétences disponibles dans ce projet.",
  "agentRequirements.ready.title": "Prêt à démarrer",
  "agentRequirements.ready.description": "Toutes les compétences requises sont disponibles.",
  "agentRequirements.blocked.title": "Effectuer les vérifications requises",
  "agentRequirements.blocked.description": "Cet agent a besoin des compétences suivantes avant de pouvoir s'exécuter.",
  "agentRequirements.action.installing": "Installation des compétences...",
  "agentRequirements.action.installAll": "Installer toutes les compétences / MCP manquants",
  "agentRequirements.install.partialFailure":
    "Certaines compétences n'ont pas pu être installées. Corrigez les erreurs et réessayez.",
  "agentRequirements.prompt.blocked": "Effectuez d'abord les vérifications requises pour utiliser cet agent",
  "agentRequirements.error.unknownAgent": "L'agent sélectionné est introuvable.",
  "agentRequirements.error.malformedDeclaration":
    "La déclaration des compétences requises pour cet agent n'est pas valide.",
  "agentRequirements.error.discoveryFailed": "Kilo n'a pas pu vérifier les compétences disponibles.",
  "agentRequirements.error.scopeMismatch": "Cette vérification des exigences de l'agent n'est plus active.",
  "agentRequirements.error.requestFailed": "Kilo n'a pas pu vérifier les exigences de l'agent.",
  "agentRequirements.install.error.skillNotFound": "La compétence requise est introuvable sur le Marketplace.",
  "agentRequirements.install.error.itemNotSkill": "L'élément du Marketplace n'est pas une compétence.",
  "agentRequirements.install.error.unavailable": "L'installation de compétences n'est pas disponible dans cette vue.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo n'a pas pu charger les compétences du Marketplace.",
