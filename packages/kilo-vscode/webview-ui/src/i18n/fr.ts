export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Choisissez votre agent par défaut",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Agent par défaut",
  "workStyle.agent.code.tasks": "Idéal pour les tâches de programmation",
  "workStyle.agent.code.changes": "Lit, écrit et modifie le code",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Idéal pour l’analyse de données",
  "workStyle.agent.data.notebooks": "Exécute des requêtes et crée des visualisations dans des notebooks Jupyter",
  "workStyle.agent.data.requirement": "Nécessite l’extension Jupyter",
  "workStyle.onboarding.settingsNote": "Vous pouvez modifier ces options à tout moment dans les",
  "workStyle.onboarding.agentSettingsNote": "Vous pouvez modifier l’agent par défaut à tout moment dans les",
