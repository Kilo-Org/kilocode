...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Adresse Milvus",
  "settings.indexing.milvusAddress.description": "Adresse de Milvus Standalone ou Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Jeton Milvus",
  "settings.indexing.milvusToken.description": "Jeton facultatif pour Milvus authentifié ou Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Jeton facultatif",
  "settings.indexing.milvusDatabase.title": "Base de données Milvus",
  "settings.indexing.milvusDatabase.description": "Nom facultatif de la base de données Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "Laisser vide pour la valeur par défaut",
