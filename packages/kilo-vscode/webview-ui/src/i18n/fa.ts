...
export const dict = {
  ...
  "settings.autoCleanup.enable.description":
    "تاریخچه وظایف قدیمی را پس از تعداد روز مشخصی به‌صورت خودکار حذف می‌کند — در همهٔ پروژه‌ها و همهٔ سرویس‌گیرنده‌های Kilo روی این رایانه، نه فقط همین پنجره. وظایف در حال اجرا و وظایف دارای انشعاب اخیر هرگز حذف نمی‌شوند. حذف دائمی است.",
  ...
  "settings.autoCleanup.runNow.confirm":
    "حذف دائمی وظایف منقضی‌شده در همهٔ پروژه‌ها و همهٔ سرویس‌گیرنده‌های Kilo روی این رایانه؟",
