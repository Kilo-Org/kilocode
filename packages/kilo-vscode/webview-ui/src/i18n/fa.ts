...
export const dict = {
  ...
  "tool.board.read": "خواندن پیام‌ها",
  "tool.board.post": "انتشار پیام",
  "tool.board.message": "1 پیام خوانده شد",
  "tool.board.messages": "{{count}} پیام خوانده شد",
  "tool.board.empty": "پیامی برای خواندن نیست",
  "tool.board.posted": "برای {{recipient}} منتشر شد",
  "tool.board.saved": "برای {{recipient}} ذخیره شد",
  "tool.board.channel": "Kilo Swarm (برد مشترک)",
  "tool.board.details": "جزئیات",
  "tool.board.unavailable": "داده‌های پیام در دسترس نیست. برای بررسی، جزئیات را باز کنید.",
  "tool.board.from": "از {{sender}}",
  "tool.board.status": "تحویل: {{status}}",
  "tool.board.inactive": "زمانی ذخیره شد که گیرنده غیرفعال بود",
  "tool.board.audience": "ذخیره شد؛ هیچ گیرندهٔ دیگری فعال نبود",
  "tool.board.unknown": "ذخیره شد؛ وضعیت فعالیت گیرندگان نامشخص بود",
  "tool.board.receipt": "رسید خواندن در دسترس نیست",
  "tool.board.agent": "عامل {{id}}",
  "tool.board.more": "پیام‌های بیشتری در برد موجود است.",
  "tool.board.showMore": "نمایش {{count}} مورد دیگر",
  "tool.board.showLess": "نمایش کمتر",
  "tool.board.main": "اصلی",
  "tool.board.all": "همهٔ عامل‌ها",
  "tool.board.to": "به {{recipient}}",
