...
export const dict = {
  ...
  "profile.usage.action.addCredits": "افزودن اعتبار",
  "profile.usage.action.manageBilling": "مدیریت صورتحساب",
  ...
  "profile.usage.topups.title": "شارژهای شخصی",
  "profile.usage.topups.auto": "شارژ خودکار",
  "profile.usage.topups.on": "روشن",
  "profile.usage.topups.off": "خاموش",
  "profile.usage.topups.rule": "افزودن ${{amount}} وقتی موجودی به ${{threshold}} می‌رسد",
  "profile.usage.topups.payment": "{{brand}} با پایان {{last4}}",
