...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "نشانی Milvus",
  "settings.indexing.milvusAddress.description": "نشانی Milvus Standalone یا Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "توکن Milvus",
  "settings.indexing.milvusToken.description": "توکن اختیاری برای Milvus احراز هویت‌شده یا Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "توکن اختیاری",
  "settings.indexing.milvusDatabase.title": "پایگاه داده Milvus",
  "settings.indexing.milvusDatabase.description": "نام اختیاری پایگاه داده Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "برای مقدار پیش‌فرض خالی بگذارید",
