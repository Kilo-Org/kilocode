...
export const dict = {
  ...
  "provider.custom.reasoning.model.label": "نسخه‌های متغیر",
  "provider.custom.reasoning.effort.none": "هیچ",
  "provider.custom.reasoning.effort.minimal": "حداقل",
  "provider.custom.reasoning.effort.low": "کم",
  "provider.custom.reasoning.effort.medium": "متوسط",
  "provider.custom.reasoning.effort.high": "زیاد",
  "provider.custom.reasoning.effort.xhigh": "xhigh",
  "provider.custom.reasoning.effort.max": "حداکثر",
  ...anacondaDesktopDict,
