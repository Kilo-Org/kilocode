...
export const dict = {
  ...
  "context.breakdown.note": "تقریب توزیع توکن‌های ورودی. «سایر» شامل تعاریف ابزار و سربار است.",
  ...
  "error.chain.mcpFailed":
    "سرور MCP «{{name}}» با خطا مواجه شد. توجه داشته باشید که Kilo هنوز از احراز هویت MCP پشتیبانی نمی‌کند.",
  "error.chain.providerAuthFailed": "احراز هویت provider ناموفق بود ({{provider}}): {{message}}",
  "error.chain.providerInitFailed":
    "راه‌اندازی ارائه‌دهنده «{{provider}}» ناموفق بود. اعتبارنامه‌ها و پیکربندی را بررسی کنید.",
  ...
  "error.chain.configDirectoryTypo":
    "پوشه «{{dir}}» در {{path}} معتبر نیست. نام پوشه را به «{{suggestion}}» تغییر دهید یا آن را حذف کنید. این یک اشتباه تایپی رایج است.",
  ...
  "workspace.delete.confirm": "حذف فضای کاری «{{name}}»؟",
  "workspace.delete.button": "حذف فضای کاری",
  "workspace.reset.title": "بازنشانی فضای کاری",
  "workspace.reset.confirm": "بازنشانی فضای کاری «{{name}}»؟",
  ...
  "settings.agentBehaviour.removeAgent.confirm":
    "حذف عامل «{{name}}»؟ این کار با به‌روزرسانی پیکربندی شما، عامل را غیرفعال می‌کند.",
  ...
  "settings.agentBehaviour.removeSkill.confirm": "حذف مهارت «{{name}}»؟ این کار فایل‌های مهارت را از دیسک حذف می‌کند.",
  ...
  "settings.agentBehaviour.removeMcp.confirm": "حذف سرور MCP «{{name}}»؟ این کار آن را از پیکربندی شما حذف می‌کند.",
  ...
  "chat.memory.rebuild": "فهرست حافظه بازسازی شد",
