...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Indirizzo Milvus",
  "settings.indexing.milvusAddress.description": "Indirizzo per Milvus Standalone o Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Token Milvus",
  "settings.indexing.milvusToken.description": "Token facoltativo per Milvus autenticato o Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Token facoltativo",
  "settings.indexing.milvusDatabase.title": "Database Milvus",
  "settings.indexing.milvusDatabase.description": "Nome facoltativo del database Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "Lascia vuoto per il valore predefinito",
