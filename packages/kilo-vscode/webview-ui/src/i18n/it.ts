export const dict = {
  ...
  "revert.banner.step": "Passaggio dell'agente annullato",
  "checkpoint.label": "Checkpoint",
  "checkpoint.viewChanges": "Visualizza le modifiche da questo punto di controllo",
  "checkpoint.parallel": "Checkpoint prima di {{count}} strumenti in parallelo",
  "checkpoint.stopRewind": "Ferma e ripristina",
  "checkpoint.unavailable": "Checkpoint non disponibile perché non è stato acquisito alcuno snapshot",
  "checkpoint.sharedDirectory":
    "Un'altra sessione attiva sta utilizzando questa directory. Il ripristino potrebbe annullare anche le sue modifiche.",
  "checkpoint.sharedDirectory.confirm": "Ripristina comunque",
  "checkpoint.failed": "Impossibile ripristinare il checkpoint.",
