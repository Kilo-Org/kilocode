export const dict = {
  ...
  "prompt.input.label": "Prompt della chat",
  "prompt.suggestions.files": "Suggerimenti per le menzioni di file",
  "prompt.suggestions.commands": "Suggerimenti per i comandi",
  "prompt.suggestions.mentionSelected": "Menzione selezionata {{value}}",
  "prompt.suggestions.commandSelected": "Comando selezionato {{value}}",
