export const dict = {
  ...
  "provider.connect.apiKey.description.local":
    "Connettiti al server {{provider}} locale. Lascia vuota la chiave API se il server non ne richiede una (impostazione predefinita per localhost).",
  "provider.connect.atomicChat.description":
    "Connettiti ad Atomic Chat sul tuo computer (indirizzo predefinito http://127.0.0.1:1337). Il server locale non richiede una chiave API: avvia Atomic Chat, carica un modello, quindi connettiti.",
  "provider.connect.apiKey.label": "API key {{provider}}",
  "provider.connect.apiKey.label.optional": "Chiave API di {{provider}} (facoltativa)",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.placeholder.optional": "Lascia vuoto per il server locale",
  ...
  "ui.permission.toolLabel.todoRead": "Leggi attività",
  "ui.permission.toolLabel.todoWrite": "Scrivi attività",
  ...
  "provider.custom.models.variants.splitReasoning.label": "Ragionamento separato (necessario ad es. per MiniMax)",
  ...
  "provider.custom.models.variants.chatTemplateArgs.label":
    "Abilita il ragionamento tramite gli argomenti del modello di chat (ad es. Hugging Face)",
  ...
  "provider.custom.models.variants.outputEffort.label": "Impegno di output (ad es. Anthropic)",
  ...
  "workspace.reset.button": "Ripristina area di lavoro",
  ...
  "settings.aboutKiloCode.resetSettings.notificationsButton": "Reimposta notifiche lette",
