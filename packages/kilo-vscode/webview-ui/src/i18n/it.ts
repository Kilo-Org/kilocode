export const dict = {
  ...
  "workStyle.onboarding.title": "Scegli come lavorare con i tuoi agenti IA",
  ...
  "workStyle.toast.saved.title": "Preferenze salvate",
  ...
  "workStyle.choice.human.eyebrow": "Supervisione umana",
  "workStyle.choice.human.title": "Prima la revisione",
  "workStyle.choice.human.description": "Kilo si ferma spesso e ti mostra cosa intende fare mentre lavora.",
  "workStyle.choice.human.permissions": "Chiede l'autorizzazione prima di modificare i file.",
  "workStyle.choice.human.bash": "Chiede l'autorizzazione per ogni comando del terminale.",
  "workStyle.choice.human.visibility": "Mostra i dettagli della conversazione, inclusi comandi e ragionamento.",
  "workStyle.choice.autonomous.eyebrow": "Meno interruzioni",
  "workStyle.choice.autonomous.title": "Autonomia elevata",
  "workStyle.choice.autonomous.description": "Lavora con meno interruzioni e un'interfaccia semplificata.",
  "workStyle.choice.autonomous.permissions": "Può modificare automaticamente i file nel workspace.",
  "workStyle.choice.autonomous.bash": "Può eseguire comandi nel terminale del workspace senza approvazione.",
  "workStyle.choice.autonomous.visibility": "I dettagli della conversazione restano nascosti finché non li espandi.",
