export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da LLMAPI",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la tua API key {{provider}} per connettere l'account e usare i modelli {{provider}} in LLMAPI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere l'account e usare i modelli {{provider}} in LLMAPI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere l'account e usare i modelli {{provider}} in LLMAPI.",
  ...
  "dialog.server.description": "Cambia il server LLMAPI a cui si connette questa app.",
  ...
  "toast.update.description": "Una nuova versione di LLMAPI ({{version}}) è disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team LLMAPI",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" non riuscito. Nota: LLMAPI non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "LLMAPI include modelli gratuiti, così puoi iniziare subito.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione di LLMAPI",
  "settings.general.row.appearance.title": "Aspetto",
  "settings.general.row.appearance.description": "Personalizza l'aspetto di LLMAPI sul tuo dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di LLMAPI.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti quando LLMAPI si avvia",
  ...
  "settings.updates.toast.latest.description": "Stai usando la versione più recente di LLMAPI.",
  ...
  "settings.providers.betaNotice":
    "Al momento solo il provider LLMAPI Gateway può essere configurato dall'interfaccia delle impostazioni. Il supporto per altri provider arriverà durante il periodo beta. Nel frattempo puoi configurare i provider con la CLI o il file di configurazione. Ci impegniamo a mantenere LLMAPI aperto, senza lock-in.",
  ...
  "settings.config.title": "Apri file config LLMAPI {{scope}}",
  "settings.config.placeholder":
    "I file config vengono uniti in ordine; i file marcati come caricati influenzano attualmente le impostazioni.",
  "settings.config.noWorkspace": "Apri una cartella workspace per modificare il file config LLMAPI locale.",
  "settings.config.openFailed": "Apertura file config LLMAPI {{scope}} non riuscita: {{message}}",
  ...
  "deviceAuth.title": "Accedi a LLMAPI",
  ...
  "profile.action.login": "Accedi con LLMAPI",
  ...
  "settings.aboutKiloCode.title": "Informazioni su LLMAPI",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "LLMAPI è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Estensione LLMAPI",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Il file non contiene impostazioni LLMAPI valide.",
  "settings.aboutKiloCode.importSettings.tooLarge": "File troppo grande. I file impostazioni devono essere sotto 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Questo file è stato esportato da una versione più recente di LLMAPI. Alcune impostazioni potrebbero essere ignorate.",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia LLMAPI. "Auto" usa la lingua di VS Code.',
  ...
  "settings.experimental.remote.description":
    "Abilita controllo remoto delle sessioni tramite LLMAPI Cloud. Influenzerà anche le CLI su questa macchina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carica istruzioni CLAUDE.md e skill dalla directory di configurazione Claude Code nelle sessioni. Abilitalo se vuoi che LLMAPI usi istruzioni e skill di Claude Code. Richiede riavvio.",
  ...
  "settings.display.fontSize.description":
    "Regola la dimensione del font della webview LLMAPI indipendentemente da VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di LLMAPI, incluse API key dei provider e modello predefinito.",
  "migration.whatsNew.title": "Novità in LLMAPI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un core piccolo ed efficiente per ogni prodotto LLMAPI. Un'esperienza familiare comunque tu scelga di lavorare.",
  ...
  "diffViewer.source.session.tooltip":
    "File modificati da LLMAPI durante la sessione corrente, basati su snapshot per turno. Si resetta quando inizi una nuova sessione.",
  ...
  "settings.experimental.speechToText.description":
    "Abilita input vocale nei campi prompt usando il tuo account LLMAPI tramite LLMAPI Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Abilita e accedi al provider LLMAPI per usare Da voce a testo. Da voce a testo è attualmente supportato solo tramite LLMAPI Gateway.",
  "settings.experimental.speechToTextModel.title": "Modello Da voce a testo",
  "settings.experimental.speechToTextModel.description":
    "Scegli il modello di trascrizione LLMAPI Gateway per l'input vocale.",
  ...
  "settings.indexing.kiloModel.title": "Preset modello LLMAPI",
  "settings.indexing.kiloModel.description": "Scegli un modello embedding ospitato da LLMAPI.",
  "settings.indexing.kiloSignIn.title": "Accesso LLMAPI richiesto",
  "settings.indexing.kiloSignIn.description": "Accedi a LLMAPI per usare gli embedding ospitati.",
  ...
  "speechToText.tooltip.start": "Avvia input vocale con LLMAPI Gateway",
  ...
  "speechToText.error.loginRequired": "Accedi a LLMAPI per usare l'input vocale.",
