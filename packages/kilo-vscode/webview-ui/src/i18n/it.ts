...
export const dict = {
  ...
  "tool.board.read": "Leggi i messaggi",
  "tool.board.post": "Pubblica un messaggio",
  "tool.board.message": "1 messaggio letto",
  "tool.board.messages": "{{count}} messaggi letti",
  "tool.board.empty": "Nessun messaggio da leggere",
  "tool.board.posted": "Pubblicato per {{recipient}}",
  "tool.board.saved": "Salvato per {{recipient}}",
  "tool.board.channel": "Kilo Swarm (board condivisa)",
  "tool.board.details": "Dettagli",
  "tool.board.unavailable": "Dati del messaggio non disponibili. Apri i dettagli per esaminarli.",
  "tool.board.from": "Da {{sender}}",
  "tool.board.status": "Consegna: {{status}}",
  "tool.board.inactive": "Salvato mentre il destinatario era inattivo",
  "tool.board.audience": "Salvato; non c'erano altri destinatari attivi",
  "tool.board.unknown": "Salvato; l'attività dei destinatari era sconosciuta",
  "tool.board.receipt": "Conferma di lettura non disponibile",
  "tool.board.agent": "Agente {{id}}",
  "tool.board.more": "Altri messaggi sono disponibili sulla board.",
  "tool.board.showMore": "Mostra altri {{count}}",
  "tool.board.showLess": "Mostra meno",
  "tool.board.main": "Principale",
  "tool.board.all": "Tutti gli agenti",
  "tool.board.to": "A {{recipient}}",
