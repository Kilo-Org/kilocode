export const dict = {
  ...
  "agentRequirements.skill.installing": "Installazione dal Marketplace...",
  "agentRequirements.skill.verifying": "Skill installata. Verifica del rilevamento in corso...",
  "agentRequirements.skill.installed": "Installata",
  "agentRequirements.skill.installFailed": "Installazione non riuscita",
  "agentRequirements.skill.checkFailed": "Verifica della skill non riuscita",
  "agentRequirements.group.skills": "Skill",
  "agentRequirements.group.mcps": "MCP",
  "agentRequirements.group.extensions": "Estensioni",
  "agentRequirements.skill.missing": "La skill richiesta non è installata",
  "agentRequirements.checking.title": "Verifica dei requisiti dell'agente",
  "agentRequirements.checking.description": "Verifica delle skill disponibili in questo progetto.",
  "agentRequirements.ready.title": "Pronto per iniziare",
  "agentRequirements.ready.description": "Tutte le skill richieste sono disponibili.",
  "agentRequirements.blocked.title": "Completa le verifiche richieste",
  "agentRequirements.blocked.description": "Questo agente richiede le seguenti skill prima di poter essere eseguito.",
  "agentRequirements.action.installing": "Installazione delle skill...",
  "agentRequirements.action.installAll": "Installa tutte le skill / MCP mancanti",
  "agentRequirements.install.partialFailure":
    "Non è stato possibile installare alcune skill. Correggi gli errori e riprova.",
  "agentRequirements.prompt.blocked": "Completa prima le verifiche richieste per usare questo agente",
  "agentRequirements.error.unknownAgent": "L'agente selezionato non è stato trovato.",
  "agentRequirements.error.malformedDeclaration":
    "Questo agente contiene una dichiarazione non valida relativa alle skill richieste.",
  "agentRequirements.error.discoveryFailed": "Kilo non è riuscito a verificare le skill disponibili.",
  "agentRequirements.error.scopeMismatch": "Questa verifica dei requisiti dell'agente non è più attiva.",
  "agentRequirements.error.requestFailed": "Kilo non è riuscito a verificare i requisiti dell'agente.",
  "agentRequirements.install.error.skillNotFound": "Impossibile trovare la skill richiesta nel Marketplace.",
  "agentRequirements.install.error.itemNotSkill": "L'elemento del Marketplace non è una skill.",
  "agentRequirements.install.error.unavailable": "L'installazione delle skill non è disponibile in questa vista.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo non è riuscito a caricare le skill dal Marketplace.",
  "agentRequirements.error.detail": "{{message}}: {{error}}",
