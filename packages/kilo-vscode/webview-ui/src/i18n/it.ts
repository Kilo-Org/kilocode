export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Scegli l’agente predefinito",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Agente predefinito",
  "workStyle.agent.code.tasks": "Ideale per le attività di programmazione",
  "workStyle.agent.code.changes": "Legge, scrive e modifica il codice",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Ideale per l’analisi dei dati",
  "workStyle.agent.data.notebooks": "Esegue query e crea visualizzazioni nei notebook Jupyter",
  "workStyle.agent.data.requirement": "Richiede l’estensione Jupyter",
