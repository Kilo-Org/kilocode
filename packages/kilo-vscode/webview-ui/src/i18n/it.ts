export const dict = {
  ...
  "settings.experimental.projectStack.description": "Show a Project Stack icon in the chat prompt that summarizes your configured technologies, MCP servers, and skills.",
} as const
