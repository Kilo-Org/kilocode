import { customProviderReasoning } from "./custom-provider-reasoning"
...
export const dict = {
  ...
  "provider.custom.reasoning.model.label": "Variants",
  ...
  "provider.custom.reasoning.effort.xhigh": "xhigh",
