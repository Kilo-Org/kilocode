...
export const dict = {
  ...
  "dialog.plugins.empty": "Plugin configurati in kilo.jsonc",
  ...
  "error.chain.checkConfig": "Controlla i nomi provider/modello nella configurazione (kilo.jsonc)",
  ...
  "settings.agentBehaviour.workflows.description":
    "I workflow sono comandi slash personalizzati definiti nella configurazione. Scrivi /nome-comando nella chat per invocarli. I comandi sono configurati in kilo.jsonc nella sezione 'command'.",
  "settings.agentBehaviour.workflows.empty":
    "Nessun comando personalizzato configurato. Aggiungi comandi a kilo.jsonc per vederli qui.",
