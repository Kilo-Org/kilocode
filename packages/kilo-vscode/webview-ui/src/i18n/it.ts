...
export const dict = {
  ...
  "settings.autoCleanup.error.status": "Lo stato della pulizia delle sessioni è temporaneamente non disponibile. Nuovo tentativo...",
  "settings.autoCleanup.error.timeout": "In attesa dello stato della pulizia. Il backend sta impiegando più tempo del previsto.",
