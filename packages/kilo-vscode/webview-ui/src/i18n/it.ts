...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Aggiungi crediti",
  "profile.usage.action.manageBilling": "Gestisci fatturazione",
  ...
  "profile.usage.topups.title": "Ricariche personali",
  "profile.usage.topups.auto": "Ricarica automatica",
  "profile.usage.topups.on": "Attiva",
  "profile.usage.topups.off": "Disattiva",
  "profile.usage.topups.rule": "Aggiungi ${{amount}} quando il saldo raggiunge ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} con finale {{last4}}",
  "profile.usage.balance.breakdown": "Concessi {{granted}} | Ricaricati {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "non disponibile",
  "profile.usage.credits.resets": "{{count}} azzeramenti",
