export const dict = {
  ...
  "prompt.action.autoApprove.disabled": "L'approvazione automatica è disabilitata. Clicca per approvare automaticamente le richieste di autorizzazione.",
  "prompt.action.resetModel": "Ripristina modello predefinito",
  "prompt.action.enhanceDescription": "Il pulsante 'Migliora prompt' aiuta a migliorare il prompt aggiungendo contesto, chiarimenti o riformulazioni. Prova a scrivere un prompt qui e a cliccare di nuovo il pulsante per vedere come funziona.",
  ...
  "ui.permission.toggleWrap": "Attiva/disattiva a capo automatico",
  ...
  "settings.general.notifications.agent.description": "Mostra una notifica di sistema quando l'agent ha completato o richiede attenzione",
  ...
  "session.empty": "Ancora nessuna sessione. Clicca + per avviare una nuova conversazione.",
  ...
  "deviceAuth.action.clickToCopy": "Clicca per copiare",
  ...
  "settings.indexing.model.description": "Sovrascrivi il modello embedding predefinito per il provider selezionato.",
  ...
  "settings.aboutKiloCode.importSettings.success": "Impostazioni importate. Controlla le modifiche sopra, poi clicca Salva.",
  ...
  "settings.browser.description": "Quando è abilitato, l'agente AI può interagire con pagine web: navigare, cliccare, scrivere e acquisire screenshot. Si aprirà una finestra Chrome così puoi osservare il lavoro dell'agente.",
  ...
  "settings.experimental.toolToggles": "Toggle tool",
  ...
  "settings.agentBehaviour.modelOverride.title": "Override modello",
  "settings.agentBehaviour.modelOverride.description": "Sovrascrivi il modello predefinito per questo agente",
  ...
  "settings.providers.smallModel.title": "Modello piccolo",
