...
export const dict = {
  ...
  "settings.display.limitContentWidth.title": "Limita la larghezza del contenuto della chat",
  "settings.display.limitContentWidth.description":
    "Mantiene il contenuto della chat e il prompt in una colonna centrata di larghezza leggibile. Disattiva per usare l'intera larghezza del pannello nella barra laterale, nelle schede dell'editor e in Agent Manager.",
