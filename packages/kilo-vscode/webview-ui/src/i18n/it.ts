...
export const dict = {
  ...
  "provider.connect.bedrock.description":
    "Configure Amazon Bedrock with a Bedrock API key, IAM access keys, or an AWS profile. Region is required.",
  "provider.connect.bedrock.mode.label": "Authentication method",
  "provider.connect.bedrock.mode.apiKey.label": "Bedrock API key",
  "provider.connect.bedrock.mode.apiKey.hint": "Use a Bedrock bearer token",
  "provider.connect.bedrock.mode.accessKeys.label": "IAM access keys",
  "provider.connect.bedrock.mode.accessKeys.hint": "Use an access key and secret",
  "provider.connect.bedrock.mode.profile.label": "AWS profile",
  "provider.connect.bedrock.mode.profile.hint": "Use a local AWS CLI profile",
  "provider.connect.bedrock.region.label": "AWS region",
  "provider.connect.bedrock.region.placeholder": "e.g. us-east-1",
  "provider.connect.bedrock.apiKey.label": "Bedrock API key",
  ...
  "provider.connect.bedrock.sessionToken.placeholder": "Leave empty unless using temporary credentials",
  ...
  "provider.connect.vertex.project.placeholder": "e.g. my-gcp-project",
  "provider.connect.vertex.location.label": "Location",
  "provider.connect.vertex.location.placeholder": "e.g. us-central1",
  "provider.connect.vertex.credentials.label": "Service account JSON (optional)",
  "provider.connect.vertex.credentials.placeholder": "Paste the service account JSON, or leave empty to use ADC",
  "provider.connect.vertex.credentials.invalid": "Service account credentials must be a JSON object",
