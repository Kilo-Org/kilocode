export const dict = {
  ...
  "workStyle.onboarding.title": "Choose how you want to work with your AI agents",
  ...
  "workStyle.choice.human.eyebrow": "Human in the Loop",
  "workStyle.choice.human.title": "Review first",
  "workStyle.choice.human.description": "Kilo pauses frequently and shows you what it plans to do as it works.",
  "workStyle.choice.human.permissions": "Asks for permission before editing files.",
  "workStyle.choice.human.bash": "Asks for permission when running all terminal commands.",
  "workStyle.choice.human.visibility": "Displays conversation details, including commands and reasoning.",
  "workStyle.choice.autonomous.eyebrow": "Fewer interruptions",
  "workStyle.choice.autonomous.title": "High autonomy",
  "workStyle.choice.autonomous.description": "Work with fewer interruptions and a streamlined interface.",
  "workStyle.choice.autonomous.permissions": "Can edit files in the workspace automatically.",
  "workStyle.choice.autonomous.bash": "Can run terminal commands in the workspace without approval.",
  "workStyle.choice.autonomous.visibility": "Conversation details stay hidden until you expand them.",
