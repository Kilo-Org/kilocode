...
export const dict = {
  ...
  "ui.permission.submitting": "Waiting for confirmation...",
  "ui.permission.failed": "The request is still pending. You can try again.",
  "ui.permission.unknown": "The response could not be confirmed. Check its status before trying again.",
  "ui.permission.checkStatus": "Check status",
