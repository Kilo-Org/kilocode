export const dict = {
  ...
  "settings.providers.custom.title": "OpenAI-Compatible Provider",
  "settings.providers.custom.description": "Add any provider with an OpenAI-compatible API",
  "settings.providers.custom.add": "Add Provider",
  "settings.providers.models.title": "Model Selection",
