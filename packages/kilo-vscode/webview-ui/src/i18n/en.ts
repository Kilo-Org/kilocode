export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Pound",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Pound.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Pound.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Pound.",
  ...
  "dialog.server.description": "Switch which Pound server this app connects to.",
  ...
  "toast.update.description": "A new version of Pound ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Pound team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Pound does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Pound includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Pound",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Pound looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Pound is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Pound launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Pound.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Pound Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Pound open, no lock-in.",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or pound import command",
  ...
  "deviceAuth.title": "Sign in to Pound Code",
  ...
  "profile.action.login": "Login with Pound Code",
  ...
  "settings.aboutKiloCode.title": "About Pound Code",

  "session.messages.empty": "Start a conversation by typing a message below.",
  "session.messages.welcome":
    "Pound Code is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Pound Code Extension",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Reset all Pound Code extension settings to their default values. This does not affect CLI or backend configuration.",
  ...
  "settings.language.description":
    'Choose the language for the Pound Code UI. "Auto" uses your VS Code display language.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrate settings from a previous installation of Pound Code, including provider API keys and default model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Pound Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Pound product. A familiar experience however you choose to work.",
