export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Choose your default agent",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Default agent",
  "workStyle.agent.code.tasks": "Best for coding tasks",
  "workStyle.agent.code.changes": "Reads, writes, and modifies code",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Best for data analysis",
  "workStyle.agent.data.notebooks": "Runs queries and creates visualizations in Jupyter notebooks",
  "workStyle.agent.data.requirement": "Requires the Jupyter extension",
