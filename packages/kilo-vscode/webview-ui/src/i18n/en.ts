export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Kilo pauses frequently and shows you what it plans to do as it works.",
  "workStyle.choice.human-in-the-loop.permissions": "Asks for permission before editing files.",
  "workStyle.choice.human-in-the-loop.bash": "Asks for permission when running all terminal commands.",
  "workStyle.choice.human-in-the-loop.visibility": "Displays conversation details, including commands and reasoning.",
