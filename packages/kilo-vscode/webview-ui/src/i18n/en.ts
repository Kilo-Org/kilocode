export const dict = {
  ...
  "settings.experimental.share.description": "Controls when sessions are published to the web. Manual: share only when you click Share. Auto: publish all sessions automatically. Disabled: sharing is turned off.",
  ...
  "settings.experimental.lsp.description": "Use your editor's language server to give the agent real-time code diagnostics (errors, warnings, and type information)",
  ...
  "settings.experimental.batch.description": "Let the agent run multiple tool calls in parallel in a single step, which can speed up tasks that involve reading many files at once",
  ...
  "settings.agentBehaviour.temperature.description": "Controls randomness in responses. Lower values (e.g. 0.2) produce more focused, predictable output. Higher values (e.g. 1.5) produce more varied, creative output. Leave empty to use the model default.",
  "settings.agentBehaviour.topP.title": "Top P",
  "settings.agentBehaviour.topP.description": "Limits token selection to the most probable options. Lower values (e.g. 0.1) make responses more focused; higher values (e.g. 0.9) allow more variety. Leave empty to use the model default.",
