export const dict = {
  ...
  "agentRequirements.skill.installing": "Installing from Marketplace...",
  "agentRequirements.skill.verifying": "Installed. Verifying skill discovery...",
  "agentRequirements.skill.installFailed": "Installation failed",
  "agentRequirements.skill.installed": "Installed",
  "agentRequirements.skill.checkFailed": "The skill check failed",
  "agentRequirements.skill.missing": "Required skill is not installed",
  "agentRequirements.extension.available": "VS Code extension is installed",
  "agentRequirements.extension.checkFailed": "The VS Code extension check failed",
  "agentRequirements.extension.missing": "Install this VS Code extension, then retry.",
  "agentRequirements.group.skills": "Skills",
  "agentRequirements.group.mcps": "MCPs",
  "agentRequirements.group.extensions": "Extensions",
  "agentRequirements.checking.title": "Checking agent requirements",
  "agentRequirements.checking.description": "Verifying the requirements available in this project.",
  "agentRequirements.ready.title": "Ready to go",
  "agentRequirements.ready.description": "All required checks passed.",
  "agentRequirements.blocked.title": "Complete required checks",
  "agentRequirements.blocked.description": "This agent needs the following requirements before it can run.",
  "agentRequirements.action.installing": "Installing skills...",
  "agentRequirements.action.installAll": "Install all missing Skills / MCPs",
  "agentRequirements.install.partialFailure": "Some skills could not be installed. Fix the errors and retry.",
  ...
  "agentRequirements.error.malformedDeclaration": "This agent has an invalid skill requirement declaration.",
  ...
  "agentRequirements.install.error.skillNotFound": "The required Marketplace skill could not be found.",
  "agentRequirements.install.error.itemNotSkill": "The Marketplace item is not a skill.",
  "agentRequirements.install.error.unavailable": "Skill installation is unavailable in this view.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo could not load Marketplace skills.",
