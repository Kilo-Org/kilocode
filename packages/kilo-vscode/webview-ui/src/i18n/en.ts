export const dict = {
  ...
  "settings.enterprise.license.title": "License",
  "settings.enterprise.license.description": "Private deployment license verification (online or offline file).",
  "settings.enterprise.license.disabled": "Not required",
  "settings.enterprise.license.valid": "Valid",
  "settings.enterprise.license.invalid": "Invalid or expired",
  "settings.enterprise.refresh": "Refresh",
  "settings.enterprise.openSettings": "Open VS Code settings",
  "settings.enterprise.engine.title": "Kilo Engine",
  "settings.enterprise.engine.description": "Remote engine connection for Docker or APISIX deployments.",
  "settings.enterprise.engine.remote": "Mode",
  "settings.enterprise.engine.enabled": "Remote",
  "settings.enterprise.engine.local": "Local (bundled CLI)",
  "settings.enterprise.engine.gateway": "Gateway",
  "settings.enterprise.about.title": "Open source notice",
  "settings.enterprise.about.action": "View Apache 2.0 notice",
