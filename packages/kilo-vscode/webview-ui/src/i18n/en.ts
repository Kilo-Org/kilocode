...
export const dict = {
  ...
  "tool.board.read": "Read messages",
  "tool.board.post": "Post message",
  "tool.board.message": "Read 1 message",
  "tool.board.messages": "Read {{count}} messages",
  "tool.board.empty": "No messages to read",
  "tool.board.posted": "Posted for {{recipient}}",
  "tool.board.saved": "Saved for {{recipient}}",
  "tool.board.channel": "Kilo Swarm (shared board)",
  "tool.board.details": "Details",
  "tool.board.unavailable": "Message data unavailable. Open details to inspect.",
  "tool.board.from": "From {{sender}}",
  "tool.board.status": "Delivery: {{status}}",
  "tool.board.inactive": "Saved while recipient was inactive",
  "tool.board.audience": "Stored; no other recipients were active",
  "tool.board.unknown": "Stored; recipient activity was unknown",
  "tool.board.receipt": "Read receipt unavailable",
  "tool.board.agent": "Agent {{id}}",
  "tool.board.more": "More messages are available on the board.",
  "tool.board.showMore": "Show {{count}} more",
  "tool.board.showLess": "Show less",
  "tool.board.main": "Main",
  "tool.board.all": "All agents",
  "tool.board.to": "To {{recipient}}",
