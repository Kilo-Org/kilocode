export const dict = {
  ...
  "profile.usage.detailsUnavailable": "No usage details reported by provider.",
  ...
  "profile.usage.action.addCredits": "Add credits",
  "profile.usage.action.manageBilling": "Manage billing",
  ...
  "profile.usage.topups.title": "Personal top-ups",
  "profile.usage.topups.auto": "Auto-top-up",
  "profile.usage.topups.on": "On",
  "profile.usage.topups.off": "Off",
  "profile.usage.topups.rule": "Add ${{amount}} when balance reaches ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} ending {{last4}}",
  "profile.usage.balance.breakdown": "Granted {{granted}} | Topped up {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "unavailable",
  "profile.usage.credits.resets": "{{count}} resets",
