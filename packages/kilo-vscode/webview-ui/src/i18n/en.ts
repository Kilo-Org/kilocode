export const dict = {
  ...
  "settings.agentBehaviour.ruleFiles.title": "Rule Files",
  "settings.agentBehaviour.ruleFiles.empty": "No rule files found.",
  "settings.agentBehaviour.workflowFiles.title": "Workflow Files",
  "settings.agentBehaviour.workflowFiles.empty": "No workflow files found.",
  "settings.agentBehaviour.workflowCommands.title": "Available Slash Commands",
  "settings.agentBehaviour.workflowCommands.empty": "No slash commands found.",
