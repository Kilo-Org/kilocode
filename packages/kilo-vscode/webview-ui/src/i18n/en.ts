export const dict = {
  ...
  "revert.banner.step": "Agent step reverted",
  "revert.disabled.agentBusy": "Wait for agent to finish",
  "checkpoint.label": "Checkpoint",
  "checkpoint.viewChanges": "View changes from this checkpoint",
  "checkpoint.parallel": "Checkpoint before {{count}} parallel tools",
  "checkpoint.stopRewind": "Stop and rewind",
  "checkpoint.unavailable": "Checkpoint unavailable because no snapshot was captured",
  "checkpoint.sharedDirectory":
    "Another active session is using this directory. Rewinding may also restore its changes.",
  "checkpoint.sharedDirectory.confirm": "Rewind anyway",
  "checkpoint.failed": "Failed to rewind checkpoint",
