export const dict = {
  ...
  "agentManager.diff.changes": "Changes",
  "agentManager.diff.close": "Close",
  "agentManager.diff.loading": "Computing diff...",
  "agentManager.diff.empty": "No changes detected",
  "agentManager.diff.added": "Added",
  "agentManager.diff.removed": "Removed",
  "agentManager.diff.commentOnLine": "Comment on line {{line}}",
  "agentManager.diff.editCommentOnLine": "Edit comment on line {{line}}",
  "agentManager.diff.placeholder": "Leave a comment...",
  "agentManager.diff.cancel": "Cancel",
  ...
  "agentManager.diff.delete": "Delete",
  "agentManager.diff.commentsCount": "{{count}} comment",
  "agentManager.diff.commentsCountPlural": "{{count}} comments",
  "agentManager.diff.sendAllToChat": "Send all to chat",
  "agentManager.shortcuts.toggleDiff": "Toggle diff panel",
  "agentManager.shortcuts.sendAllComments": "Send all comments to LLM",
