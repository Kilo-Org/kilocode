...
export const dict = {
  ...
  "annotations.saving": "Saving annotation numbers...",
  "annotations.storageFailed": "Annotation storage unavailable",
  "annotations.sourceLabel": "Annotation #{{number}}",
  "responseLens.explain": "Explain Briefly",
  "responseLens.unavailable": "Response Lens is unavailable. Your chat and draft are unchanged.",
  "responseLens.enabled": "Response Lens enabled",
  "responseLens.description":
    "Annotate or briefly explain selected assistant text. Disabling keeps pending annotations visible and does not delete drafts.",
  "responseLens.level": "Explanation level",
  "responseLens.level.simple": "Simple",
  "responseLens.level.school": "School",
  "responseLens.level.high-school": "High school",
  "responseLens.level.university": "University",
  "responseLens.activeModel": "Active chat model",
  "responseLens.model": "Explanation model",
  "responseLens.reset": "Reset defaults",
  "responseLens.close": "Close",
  "responseLens.retry": "Retry explanation",
  "responseLens.loading": "Explaining...",
  "responseLens.readingSources": "Reading selected sources and explaining...",
  "responseLens.referenceLimit": "Select at most two files or links for one explanation.",
  "responseLens.sources": "Sources used",
  "responseLens.excerpt": "Bounded excerpt",
  "responseLens.truncated": "The explanation reached its output limit. Retry if it is incomplete.",
  "responseLens.insufficient":
    "Limited context: the nearby paragraph or preceding request is unavailable. The explanation may need more context.",
  "responseLens.privacy":
    "Uses the selection, nearby chat, and bounded excerpts from selected files or public links. Outside-project files require approval. No tools, hidden sessions, or prompt changes.",
  "responseLens.selectionLimit": "Select between 1 and 4,000 characters to explain.",
  "responseLens.noModel":
    "Choose an explanation model or select a model in the original chat, then select the text again.",
  "responseLens.settingsChanged": "Settings changed. Retry the explanation to use them.",
  "annotations.commentPlaceholder": "Add a comment on the selected text…",
  "annotations.commentLabel": "Annotation comment",
  "annotations.selectedText": "Selected assistant text",
  "annotations.hint": "Enter to save · Shift+Enter for newline · Escape to cancel",
  "annotations.pendingCount": "Annotations ({{count}})",
  "annotations.clearAll": "Clear all",
  "annotations.toggleHint": "Click to view, edit, or remove pending annotations",
  "annotations.toolbarLabel": "Selected text actions",
  "annotations.copyFailed": "Could not copy the selection. Use Ctrl+C instead.",
  "annotations.commandBlocked": "Send or clear pending annotations before running a command",
  "annotations.limitReached": "Annotation limit reached ({{count}})",
  "annotations.commentRequired": "Add an annotation comment or cancel it before sending",
  "annotations.saveFailed": "This annotation exceeds the pending annotation limits",
