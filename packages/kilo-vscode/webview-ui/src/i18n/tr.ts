export const dict = {
  ...
  "workStyle.onboarding.title": "Yapay zeka ajanlarınızla nasıl çalışmak istediğinizi seçin",
  ...
  "workStyle.choice.human.eyebrow": "İnsan denetimli",
  "workStyle.choice.human.title": "Önce inceleyin",
  "workStyle.choice.human.description": "Kilo sık sık durur ve çalışırken ne yapmayı planladığını gösterir.",
  "workStyle.choice.human.permissions": "Dosyaları düzenlemeden önce izin ister.",
  "workStyle.choice.human.bash": "Her terminal komutunu çalıştırmadan önce izin ister.",
  "workStyle.choice.human.visibility": "Komutlar ve akıl yürütme dahil konuşma ayrıntılarını gösterir.",
  "workStyle.choice.autonomous.eyebrow": "Daha az kesinti",
  "workStyle.choice.autonomous.title": "Yüksek özerklik",
  "workStyle.choice.autonomous.description": "Daha az kesinti ve sadeleştirilmiş bir arayüzle çalışın.",
  "workStyle.choice.autonomous.permissions": "Çalışma alanındaki dosyaları otomatik olarak düzenleyebilir.",
  "workStyle.choice.autonomous.bash": "Çalışma alanında terminal komutlarını onay almadan çalıştırabilir.",
  "workStyle.choice.autonomous.visibility": "Konuşma ayrıntıları siz genişletene kadar gizli kalır.",
