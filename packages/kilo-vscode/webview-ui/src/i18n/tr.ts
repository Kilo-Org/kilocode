export const dict = {
  ...
  // v7.0.51 ile Eklenen Yeni Anahtarlar
  "revert.banner.count_one": "{{count}} mesaj geri alındı",
  "revert.banner.count_other": "{{count}} mesaj geri alındı",
  "revert.banner.redo": "İleri Al",
  "revert.banner.redo.all": "Tümünü İleri Al",
  "revert.banner.hint": "Bunu kalıcı yapmak için yeni bir mesaj gönderin",
  "model.group.recommended": "Önerilen",
  "prompt.action.send.blocked": "Önce bekleyen soruyu yanıtlayın veya kapatın",
  "error.startup.title": "Sunucu bağlantısı başarısız oldu",
  "notification.permission.titleSubagent": "İzin gerekiyor (alt ajan)",
  "ui.permission.manageAutoApprove": "Otomatik Onay Kurallarını Yönet",
  "ui.permission.rule.addToAllowed": "İzin verilenler listesine ekle",
  "ui.permission.rule.removeFromAllowed": "İzin verilenler listesinden çıkar",
  "ui.permission.rule.addToDenied": "Reddedilenler listesine ekle",
  "ui.permission.rule.removeFromDenied": "Reddedilenler listesinden çıkar",
  ...
  "ui.permission.toolLabel.globSearch": "Glob Arama",
  "ui.permission.toolLabel.grepSearch": "Grep Arama",
  "ui.permission.toolLabel.webSearch": "Web Arama",
  "ui.permission.toolLabel.list": "Listele",
  "ui.permission.toolLabel.externalDirectory": "Harici Dizini Oku",
  "ui.permission.toolLabel.webFetch": "Web Getir",
  "ui.permission.toolLabel.task": "Görev",
  "ui.permission.toolLabel.skill": "Yetenek",
  ...
  "ui.permission.toolLabel.codeSearch": "Kod Arama",
  "session.status.retry": "Yeniden deneniyor…",
  "prompt.placeholder.error": "Bağlantı başarısız. Çıktı panelini kontrol edin veya eklentiyi yeniden başlatın.",
  "settings.experimental.codebaseSearch.title": "Kod Tabanı Arama",
  "settings.experimental.codebaseSearch.description": "Kod tabanınız genelinde yapay zeka destekli doğal dil aramayı etkinleştir",
  ...
  "settings.agentBehaviour.removeMode.confirm": "\"{{name}}\" modunu kaldır? Bu işlem, yapılandırmanızı güncelleyerek modu devre dışı bırakır.",
  "settings.agentBehaviour.removeMode.button": "Kaldır",
  "settings.agentBehaviour.removeSkill.title": "Yeteneği kaldır",
  "settings.agentBehaviour.removeSkill.confirm": "\"{{name}}\" yeteneği kaldırılsın mı? Bu, yetenek dosyalarını diskten siler.",
