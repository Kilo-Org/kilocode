...
export const dict = {
  ...
  "tool.board.read": "Mesajları oku",
  "tool.board.post": "Mesaj yayımla",
  "tool.board.message": "1 mesaj okundu",
  "tool.board.messages": "{{count}} mesaj okundu",
  "tool.board.empty": "Okunacak mesaj yok",
  "tool.board.posted": "{{recipient}} için yayımlandı",
  "tool.board.saved": "{{recipient}} için kaydedildi",
  "tool.board.channel": "Kilo Swarm (paylaşılan pano)",
  "tool.board.details": "Ayrıntılar",
  "tool.board.unavailable": "Mesaj verileri kullanılamıyor. İncelemek için ayrıntıları açın.",
  "tool.board.from": "Gönderen: {{sender}}",
  "tool.board.status": "Teslimat: {{status}}",
  "tool.board.inactive": "Alıcı pasifken kaydedildi",
  "tool.board.audience": "Kaydedildi; başka hiçbir alıcı aktif değildi",
  "tool.board.unknown": "Kaydedildi; alıcıların aktif olup olmadığı bilinmiyordu",
  "tool.board.receipt": "Okundu bilgisi kullanılamıyor",
  "tool.board.agent": "Ajan {{id}}",
  "tool.board.more": "Panoda daha fazla mesaj var.",
  "tool.board.showMore": "{{count}} tane daha göster",
  "tool.board.showLess": "Daha az göster",
  "tool.board.main": "Ana ajan",
  "tool.board.all": "Tüm ajanlar",
  "tool.board.to": "Alıcı: {{recipient}}",
