...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Milvus adresi",
  "settings.indexing.milvusAddress.description": "Milvus Standalone veya Zilliz Cloud adresi.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Milvus belirteci",
  "settings.indexing.milvusToken.description":
    "Kimliği doğrulanmış Milvus veya Zilliz Cloud için isteğe bağlı belirteç.",
  "settings.indexing.milvusToken.placeholder": "İsteğe bağlı belirteç",
  "settings.indexing.milvusDatabase.title": "Milvus veritabanı",
  "settings.indexing.milvusDatabase.description": "İsteğe bağlı Milvus veritabanı adı.",
  "settings.indexing.milvusDatabase.placeholder": "Varsayılan için boş bırakın",
