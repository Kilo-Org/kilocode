export const dict = {
  ...
  "settings.experimental.cloudAgent.title": "Bulut Ajanları",
  "settings.experimental.cloudAgent.description": "Agent Manager'da deneysel Bulut Ajanı oturumlarını etkinleştirin",
