export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Varsayılan ajanınızı seçin",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Varsayılan ajan",
  "workStyle.agent.code.tasks": "Kodlama görevleri için en uygunu",
  "workStyle.agent.code.changes": "Kodu okur, yazar ve değiştirir",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Veri analizi için en uygunu",
  "workStyle.agent.data.notebooks": "Jupyter not defterlerinde sorgular çalıştırır ve görselleştirmeler oluşturur",
  "workStyle.agent.data.requirement": "Jupyter uzantısını gerektirir",
