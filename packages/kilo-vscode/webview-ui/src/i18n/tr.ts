export const dict = {
  ...
  "revert.banner.step": "Aracı adımı geri alındı",
  "checkpoint.label": "Kontrol noktası",
  "checkpoint.viewChanges": "Bu kontrol noktasından sonraki değişiklikleri görüntüle",
  "checkpoint.parallel": "{{count}} paralel araçtan önceki kontrol noktası",
  "checkpoint.stopRewind": "Durdur ve geri sar",
  "checkpoint.unavailable": "Anlık görüntü alınmadığı için kontrol noktası kullanılamıyor",
  "checkpoint.sharedDirectory":
    "Başka bir aktif oturum bu dizini kullanıyor. Geri sarmak, o oturumun değişikliklerini de geri yükleyebilir.",
  "checkpoint.sharedDirectory.confirm": "Yine de geri sar",
  "checkpoint.failed": "Kontrol noktasına geri sarılamadı.",
