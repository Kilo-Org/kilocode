...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Kredi ekle",
  "profile.usage.action.manageBilling": "Faturalandırmayı yönet",
  ...
  "profile.usage.topups.title": "Kişisel yüklemeler",
  "profile.usage.topups.auto": "Otomatik yükleme",
  "profile.usage.topups.on": "Açık",
  "profile.usage.topups.off": "Kapalı",
  "profile.usage.topups.rule": "Bakiye ${{threshold}} seviyesine geldiğinde ${{amount}} ekle",
  "profile.usage.topups.payment": "Sonu {{last4}} ile biten {{brand}}",
  "profile.usage.balance.breakdown": "Tanımlanan {{granted}} | Yüklenen {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "kullanılamıyor",
  "profile.usage.credits.resets": "{{count}} sıfırlama",
