export const dict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Bu makineye Anaconda Desktop'ı yükleyin, ardından buraya geri dönün. Kilo yükleyiciyi sizin için çalıştırmaz.",
  "provider.anaconda.state.notRunning":
    "Anaconda Desktop'ı açın, kurulumu tamamlayın ve oturum açın, ardından Tekrar kontrol et'i seçin.",
  ...
  "provider.anaconda.state.unavailable":
    "Anaconda Desktop henüz yanıt vermiyor. Açın ve uygulamanın başlatmayı tamamlamasını bekleyin.",
  "provider.anaconda.state.noModel":
    "Anaconda Desktop'ta bir metin oluşturma modeli indirin. Mümkünse araç çağrısını destekleyen bir tane seçin, ardından sunucusunu başlatın.",
  ...
  "provider.anaconda.state.ready":
    "Kilo sağlıklı bir yerel metin oluşturma sunucusu buldu ve mevcut bağlantı ayarlarını içe aktarabilir.",
  ...
  "provider.anaconda.tools": "Araç çağrısı",
  ...
  "provider.anaconda.warning.description":
    "Bu sunucu araç çağrısını onaylamıyor. Kodlama ajanı eylemleri başarısız olabilir veya kullanılamayabilir. Yalnızca bu kısıtlamaları kabul ediyorsanız devam edin.",
