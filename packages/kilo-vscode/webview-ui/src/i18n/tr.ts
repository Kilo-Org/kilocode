export const dict = {
  ...
  "migration.progress.sessions": "Sohbet oturumları",
  "migration.progress.defaultModel": "Varsayılan model",
  "migration.progress.commandRules": "Komut kuralları",
  "migration.progress.readPermission": "Okuma izni",
  "migration.progress.writePermission": "Yazma izni",
  "migration.progress.executePermission": "Çalıştırma izni",
  "migration.progress.mcpPermission": "MCP izni",
  "migration.progress.taskPermission": "Görev izni",
  "migration.progress.language": "Dil tercihi",
  "migration.progress.autocomplete": "Otomatik tamamlama ayarları",
