export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Kilo sık sık durur ve çalışırken ne yapmayı planladığını gösterir.",
  "workStyle.choice.human-in-the-loop.permissions": "Dosyaları düzenlemeden önce izin ister.",
  "workStyle.choice.human-in-the-loop.bash": "Her terminal komutunu çalıştırmadan önce izin ister.",
  "workStyle.choice.human-in-the-loop.visibility": "Komutlar ve akıl yürütme dahil konuşma ayrıntılarını gösterir.",
