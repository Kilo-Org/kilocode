export const dict = {
  ...
  "agentRequirements.skill.installing": "Marketplace'ten yükleniyor...",
  "agentRequirements.skill.verifying": "Yüklendi. Beceri keşfi doğrulanıyor...",
  "agentRequirements.skill.installed": "Yüklendi",
  "agentRequirements.skill.installFailed": "Yükleme başarısız",
  "agentRequirements.skill.checkFailed": "Beceri kontrolü başarısız oldu",
  "agentRequirements.group.skills": "Beceriler",
  "agentRequirements.group.mcps": "MCP'ler",
  "agentRequirements.group.extensions": "Uzantılar",
  "agentRequirements.skill.missing": "Gerekli beceri yüklü değil",
  "agentRequirements.checking.title": "Ajan gereksinimleri kontrol ediliyor",
  "agentRequirements.checking.description": "Bu projede kullanılabilen beceriler doğrulanıyor.",
  "agentRequirements.ready.title": "Başlamaya hazır",
  "agentRequirements.ready.description": "Gerekli tüm beceriler kullanılabilir.",
  "agentRequirements.blocked.title": "Gerekli kontrolleri tamamlayın",
  "agentRequirements.blocked.description": "Bu ajanın çalışabilmesi için aşağıdaki becerilere ihtiyacı var.",
  "agentRequirements.action.installing": "Beceriler yükleniyor...",
  "agentRequirements.action.installAll": "Eksik tüm becerileri / MCP'leri yükle",
  "agentRequirements.install.partialFailure": "Bazı beceriler yüklenemedi. Hataları düzeltip yeniden deneyin.",
  "agentRequirements.prompt.blocked": "Bu ajanı kullanmak için önce gerekli kontrolleri tamamlayın",
  "agentRequirements.error.unknownAgent": "Seçili ajan bulunamadı.",
  "agentRequirements.error.malformedDeclaration": "Bu ajanın beceri gereksinimi tanımı geçersiz.",
  "agentRequirements.error.discoveryFailed": "Kilo kullanılabilir becerileri kontrol edemedi.",
  "agentRequirements.error.scopeMismatch": "Bu ajan gereksinimi kontrolü artık etkin değil.",
  "agentRequirements.error.requestFailed": "Kilo ajan gereksinimlerini kontrol edemedi.",
  "agentRequirements.install.error.skillNotFound": "Gerekli beceri Marketplace'te bulunamadı.",
  "agentRequirements.install.error.itemNotSkill": "Marketplace öğesi bir beceri değil.",
  "agentRequirements.install.error.unavailable": "Beceri yükleme bu görünümde kullanılamıyor.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo Marketplace becerilerini yükleyemedi.",
