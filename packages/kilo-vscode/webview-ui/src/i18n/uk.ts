export const dict = {
  ...
  "agentRequirements.skill.installing": "Встановлення з Marketplace...",
  "agentRequirements.skill.verifying": "Встановлено. Перевіряємо, чи знайдено навичку...",
  "agentRequirements.skill.installed": "Встановлена",
  "agentRequirements.skill.installFailed": "Не вдалося встановити",
  ...
  "agentRequirements.group.extensions": "Розширення",
  "agentRequirements.skill.missing": "Необхідну навичку не встановлено",
  "agentRequirements.checking.title": "Перевірка вимог агента",
  "agentRequirements.checking.description": "Перевіряємо навички, доступні в цьому проєкті.",
  "agentRequirements.ready.title": "Усе готово",
  "agentRequirements.ready.description": "Усі необхідні навички доступні.",
  "agentRequirements.blocked.title": "Виконайте необхідні перевірки",
  "agentRequirements.blocked.description": "Для запуску цьому агенту потрібні такі навички.",
  "agentRequirements.action.installing": "Встановлення навичок...",
  "agentRequirements.action.installAll": "Встановити всі відсутні навички / MCP",
  "agentRequirements.install.partialFailure":
    "Деякі навички не вдалося встановити. Виправте помилки та повторіть спробу.",
  "agentRequirements.prompt.blocked": "Спочатку виконайте необхідні перевірки, щоб використовувати цього агента",
  "agentRequirements.error.unknownAgent": "Не вдалося знайти вибраного агента.",
  "agentRequirements.error.malformedDeclaration": "Для цього агента неправильно вказано вимоги до навичок.",
  "agentRequirements.error.discoveryFailed": "Kilo не вдалося перевірити доступні навички.",
  "agentRequirements.error.scopeMismatch": "Ця перевірка вимог агента більше не активна.",
  "agentRequirements.error.requestFailed": "Kilo не вдалося перевірити вимоги агента.",
  "agentRequirements.install.error.skillNotFound": "Не вдалося знайти необхідну навичку в Marketplace.",
  "agentRequirements.install.error.itemNotSkill": "Елемент Marketplace не є навичкою.",
  "agentRequirements.install.error.unavailable": "Встановлення навичок недоступне в цьому поданні.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo не вдалося завантажити навички з Marketplace.",
