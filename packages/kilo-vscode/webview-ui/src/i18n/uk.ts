export const dict = {
  ...
  "revert.banner.step": "Крок агента скасовано",
  "checkpoint.label": "Контрольна точка",
  "checkpoint.viewChanges": "Переглянути зміни після цієї контрольної точки",
  "checkpoint.parallel": "Контрольна точка до {{count}} паралельних інструментів",
  "checkpoint.stopRewind": "Зупинити та відкотити",
  "checkpoint.unavailable": "Контрольна точка недоступна, оскільки знімок стану не було створено",
  "checkpoint.sharedDirectory": "Інша активна сесія використовує цей каталог. Відкат може відновити також її зміни.",
  "checkpoint.sharedDirectory.confirm": "Все одно відкотити",
  "checkpoint.failed": "Не вдалося відкотити до контрольної точки.",
