...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Адреса Milvus",
  "settings.indexing.milvusAddress.description": "Адреса Milvus Standalone або Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Токен Milvus",
  "settings.indexing.milvusToken.description": "Необов'язковий токен для Milvus з автентифікацією або Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Необов'язковий токен",
  "settings.indexing.milvusDatabase.title": "База даних Milvus",
  "settings.indexing.milvusDatabase.description": "Необов'язкова назва бази даних Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "Залиште порожнім для типового значення",
