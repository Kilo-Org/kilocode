...
export const dict = {
  ...
  "tool.board.read": "Прочитати повідомлення",
  "tool.board.post": "Опублікувати повідомлення",
  "tool.board.message": "Прочитано 1 повідомлення",
  "tool.board.messages": "Прочитано повідомлень: {{count}}",
  "tool.board.empty": "Немає повідомлень для читання",
  "tool.board.posted": "Опубліковано для: {{recipient}}",
  "tool.board.saved": "Збережено для: {{recipient}}",
  "tool.board.channel": "Kilo Swarm (спільна дошка)",
  "tool.board.details": "Деталі",
  "tool.board.unavailable": "Дані повідомлення недоступні. Відкрийте деталі для перегляду.",
  "tool.board.from": "Від: {{sender}}",
  "tool.board.status": "Доставка: {{status}}",
  "tool.board.inactive": "Збережено, коли одержувач був неактивним",
  "tool.board.audience": "Збережено; інших активних одержувачів не було",
  "tool.board.unknown": "Збережено; активність одержувачів була невідома",
  "tool.board.receipt": "Підтвердження прочитання недоступне",
  "tool.board.agent": "Агент {{id}}",
  "tool.board.more": "На дошці є ще повідомлення.",
  "tool.board.showMore": "Показати ще {{count}}",
  "tool.board.showLess": "Показати менше",
  "tool.board.main": "Головний",
  "tool.board.all": "Усі агенти",
  "tool.board.to": "Кому: {{recipient}}",
