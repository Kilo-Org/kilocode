export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Виберіть агента за замовчуванням",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Агент за замовчуванням",
  "workStyle.agent.code.tasks": "Найкраще підходить для завдань програмування",
  "workStyle.agent.code.changes": "Читає, пише та змінює код",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Найкраще підходить для аналізу даних",
  "workStyle.agent.data.notebooks": "Виконує запити та створює візуалізації в блокнотах Jupyter",
  "workStyle.agent.data.requirement": "Потребує розширення Jupyter",
