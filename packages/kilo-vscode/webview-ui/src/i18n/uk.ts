...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Поповнити баланс",
  "profile.usage.action.manageBilling": "Керувати оплатою",
  ...
  "profile.usage.topups.title": "Особисті поповнення",
  "profile.usage.topups.auto": "Автопоповнення",
  "profile.usage.topups.on": "Увімкнено",
  "profile.usage.topups.off": "Вимкнено",
  "profile.usage.topups.rule": "Поповнювати на ${{amount}}, коли баланс досягає ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}}, останні цифри: {{last4}}",
  "profile.usage.balance.breakdown": "Надано {{granted}} | Поповнено {{toppedUp}}",
  ...
  "profile.usage.credits.resets": "{{count}} скидань",
