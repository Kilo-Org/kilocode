export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Kilo часто призупиняється та в процесі роботи показує, що планує зробити.",
  "workStyle.choice.human-in-the-loop.permissions": "Запитує дозвіл перед редагуванням файлів.",
  "workStyle.choice.human-in-the-loop.bash": "Запитує дозвіл на кожну команду термінала.",
  "workStyle.choice.human-in-the-loop.visibility": "Показує деталі розмови, зокрема команди та хід міркувань.",
