export const dict = {
  ...
  "workStyle.onboarding.title": "Виберіть, як ви хочете працювати з ШІ-агентами",
  ...
  "workStyle.choice.human.eyebrow": "Людина контролює процес",
  "workStyle.choice.human.title": "Спочатку перевірка",
  "workStyle.choice.human.description": "Kilo часто призупиняється та в процесі роботи показує, що планує зробити.",
  "workStyle.choice.human.permissions": "Запитує дозвіл перед редагуванням файлів.",
  "workStyle.choice.human.bash": "Запитує дозвіл на кожну команду термінала.",
  "workStyle.choice.human.visibility": "Показує деталі розмови, зокрема команди та хід міркувань.",
  "workStyle.choice.autonomous.eyebrow": "Менше переривань",
  "workStyle.choice.autonomous.title": "Висока автономність",
  "workStyle.choice.autonomous.description": "Працюйте з меншою кількістю переривань і спрощеним інтерфейсом.",
  "workStyle.choice.autonomous.permissions": "Може автоматично редагувати файли в робочому просторі.",
  "workStyle.choice.autonomous.bash": "Може виконувати команди термінала в робочому просторі без схвалення.",
  "workStyle.choice.autonomous.visibility": "Деталі розмови залишаються прихованими, доки ви їх не розгорнете.",
