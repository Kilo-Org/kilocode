...
export const dict = {
  ...
  "agentManager.diff.changes": "Änderungen",
  "agentManager.diff.close": "Schließen",
  "agentManager.diff.loading": "Diff wird berechnet...",
  "agentManager.diff.empty": "Keine Änderungen erkannt",
  "agentManager.diff.added": "Hinzugefügt",
  "agentManager.diff.removed": "Entfernt",
  "agentManager.diff.commentOnLine": "Kommentar in Zeile {{line}}",
  "agentManager.diff.editCommentOnLine": "Kommentar in Zeile {{line}} bearbeiten",
  "agentManager.diff.placeholder": "Kommentar hinterlassen...",
  "agentManager.diff.cancel": "Abbrechen",
  "agentManager.diff.comment": "Kommentieren",
  "agentManager.diff.save": "Speichern",
  "agentManager.diff.send": "Senden",
  "agentManager.diff.sendTooltip": "Direkt an LLM senden",
  "agentManager.diff.commentTooltip": "Kommentar speichern ({{shortcut}})",
  "agentManager.diff.sendToChat": "An Chat senden",
  "agentManager.diff.edit": "Bearbeiten",
  "agentManager.diff.delete": "Löschen",
  "agentManager.diff.commentsCount": "{{count}} Kommentar",
  "agentManager.diff.commentsCountPlural": "{{count}} Kommentare",
  "agentManager.diff.sendAllToChat": "Alle an Chat senden",
  "agentManager.shortcuts.sendAllComments": "Alle Kommentare an LLM senden",
