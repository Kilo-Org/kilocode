...
export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Wähle deinen Standard-Agenten",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Standardagent",
  "workStyle.agent.code.tasks": "Ideal für Programmieraufgaben",
  "workStyle.agent.code.changes": "Liest, schreibt und ändert Code",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Ideal für Datenanalysen",
