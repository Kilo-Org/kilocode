...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Pound",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Pound zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Pound zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Pound zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Pound-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Pound ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Pound-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Pound unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Pound enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Pound ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Pound auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Pound anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Pound automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Pound.",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder pound import-Befehl",
  ...
  "deviceAuth.title": "Bei Pound Code anmelden",
  ...
  "profile.action.login": "Mit Pound Code anmelden",
  ...
  "settings.aboutKiloCode.title": "Über Pound Code",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Pound Code ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutKiloCode.extensionName": "Pound Code Erweiterung",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Alle Pound Code-Erweiterungseinstellungen auf Standardwerte zurücksetzen. Dies hat keinen Einfluss auf die CLI- oder Backend-Konfiguration.",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Pound Code Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Pound Code, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Pound Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Pound-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
