...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Guthaben hinzufügen",
  "profile.usage.action.manageBilling": "Abrechnung verwalten",
  ...
  "profile.usage.topups.title": "Persönliche Aufladungen",
  "profile.usage.topups.auto": "Automatische Aufladung",
  "profile.usage.topups.on": "An",
  "profile.usage.topups.off": "Aus",
  "profile.usage.topups.rule": "${{amount}} hinzufügen, wenn das Guthaben ${{threshold}} erreicht",
  "profile.usage.topups.payment": "{{brand}} mit Endziffern {{last4}}",
  "profile.usage.balance.breakdown": "Gewährt {{granted}} | Aufgeladen {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "nicht verfügbar",
  "profile.usage.credits.resets": "{{count}} Zurücksetzungen",
