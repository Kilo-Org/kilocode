...
export const dict = {
  ...
  "agentRequirements.skill.installing": "Installation aus dem Marketplace...",
  "agentRequirements.skill.verifying": "Installiert. Erkennung des Skills wird überprüft...",
  "agentRequirements.skill.installed": "Installiert",
  "agentRequirements.skill.installFailed": "Installation fehlgeschlagen",
  "agentRequirements.skill.checkFailed": "Die Skill-Überprüfung ist fehlgeschlagen",
  "agentRequirements.group.skills": "Skills",
  "agentRequirements.group.mcps": "MCPs",
  "agentRequirements.group.extensions": "Erweiterungen",
  "agentRequirements.skill.missing": "Der erforderliche Skill ist nicht installiert",
  "agentRequirements.checking.title": "Agentenanforderungen werden überprüft",
  "agentRequirements.checking.description": "Die in diesem Projekt verfügbaren Skills werden überprüft.",
  "agentRequirements.ready.title": "Einsatzbereit",
  "agentRequirements.ready.description": "Alle erforderlichen Skills sind verfügbar.",
  "agentRequirements.blocked.title": "Erforderliche Überprüfungen abschließen",
  "agentRequirements.blocked.description":
    "Dieser Agent benötigt die folgenden Skills, bevor er ausgeführt werden kann.",
  "agentRequirements.action.installing": "Skills werden installiert...",
  "agentRequirements.action.installAll": "Alle fehlenden Skills / MCPs installieren",
  "agentRequirements.install.partialFailure":
    "Einige Skills konnten nicht installiert werden. Beheben Sie die Fehler und versuchen Sie es erneut.",
  "agentRequirements.prompt.blocked":
    "Schließen Sie zuerst die erforderlichen Überprüfungen ab, um diesen Agenten zu verwenden",
  "agentRequirements.error.unknownAgent": "Der ausgewählte Agent konnte nicht gefunden werden.",
  "agentRequirements.error.malformedDeclaration":
    "Dieser Agent weist eine ungültige Deklaration der Skill-Anforderungen auf.",
  "agentRequirements.error.discoveryFailed": "Kilo konnte die verfügbaren Skills nicht überprüfen.",
  "agentRequirements.error.scopeMismatch": "Diese Überprüfung der Agentenanforderungen ist nicht mehr aktiv.",
  "agentRequirements.error.requestFailed": "Kilo konnte die Agentenanforderungen nicht überprüfen.",
  "agentRequirements.install.error.skillNotFound":
    "Der erforderliche Skill konnte im Marketplace nicht gefunden werden.",
  "agentRequirements.install.error.itemNotSkill": "Das Marketplace-Element ist kein Skill.",
  "agentRequirements.install.error.unavailable": "Die Installation von Skills ist in dieser Ansicht nicht verfügbar.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo konnte die Skills aus dem Marketplace nicht laden.",
