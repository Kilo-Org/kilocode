...
export const dict = {
  ...
  "settings.indexing.milvusAddress.description": "Adresse für Milvus Standalone oder Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Milvus-Token",
  "settings.indexing.milvusToken.description": "Optionales Token für authentifiziertes Milvus oder Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Optionales Token",
  "settings.indexing.milvusDatabase.title": "Milvus-Datenbank",
  "settings.indexing.milvusDatabase.description": "Optionaler Name der Milvus-Datenbank.",
  "settings.indexing.milvusDatabase.placeholder": "Für Standardwert leer lassen",
