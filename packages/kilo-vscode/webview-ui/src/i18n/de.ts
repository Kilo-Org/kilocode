...
export const dict = {
  ...
  "migration.progress.sessions": "Chatsitzungen",
  "migration.progress.defaultModel": "Standardmodell",
  "migration.progress.commandRules": "Befehlsregeln",
  "migration.progress.readPermission": "Leseberechtigung",
  "migration.progress.writePermission": "Schreibberechtigung",
  "migration.progress.executePermission": "Ausführungsberechtigung",
  "migration.progress.mcpPermission": "MCP-Berechtigung",
  "migration.progress.taskPermission": "Aufgabenberechtigung",
  "migration.progress.language": "Spracheinstellung",
  "migration.progress.autocomplete": "Autovervollständigungseinstellungen",
