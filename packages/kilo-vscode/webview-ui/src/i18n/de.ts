...
export const dict = {
  ...
  "tool.board.read": "Nachrichten lesen",
  "tool.board.post": "Nachricht posten",
  "tool.board.message": "1 Nachricht gelesen",
  "tool.board.messages": "{{count}} Nachrichten gelesen",
  "tool.board.empty": "Keine Nachrichten zum Lesen",
  "tool.board.posted": "Für {{recipient}} gepostet",
  "tool.board.saved": "Für {{recipient}} gespeichert",
  "tool.board.channel": "Kilo Swarm (gemeinsames Board)",
  "tool.board.details": "Details",
  "tool.board.unavailable": "Nachrichtendaten nicht verfügbar. Details zur Prüfung öffnen.",
  "tool.board.from": "Von {{sender}}",
  "tool.board.status": "Zustellung: {{status}}",
  "tool.board.inactive": "Gespeichert, während der Empfänger inaktiv war",
  "tool.board.audience": "Gespeichert; keine anderen Empfänger waren aktiv",
  "tool.board.unknown": "Gespeichert; die Aktivität der Empfänger war unbekannt",
  "tool.board.receipt": "Lesebestätigung nicht verfügbar",
  "tool.board.agent": "Agent {{id}}",
  "tool.board.more": "Auf dem Board sind weitere Nachrichten verfügbar.",
  "tool.board.showMore": "{{count}} weitere anzeigen",
  "tool.board.showLess": "Weniger anzeigen",
  "tool.board.main": "Hauptagent",
  "tool.board.all": "Alle Agenten",
  "tool.board.to": "An {{recipient}}",
