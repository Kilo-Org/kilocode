...
export const dict = {
  ...
  "revert.banner.step": "Agenten-Schritt zurückgesetzt",
  "checkpoint.label": "Checkpoint",
  "checkpoint.viewChanges": "Änderungen seit diesem Prüfpunkt anzeigen",
  "checkpoint.parallel": "Checkpoint vor {{count}} parallelen Tools",
  "checkpoint.stopRewind": "Anhalten und zurücksetzen",
  "checkpoint.unavailable": "Checkpoint nicht verfügbar, da kein Snapshot erstellt wurde",
  "checkpoint.sharedDirectory":
    "Eine andere aktive Sitzung verwendet dieses Verzeichnis. Das Zurücksetzen kann auch deren Änderungen wiederherstellen.",
  "checkpoint.sharedDirectory.confirm": "Trotzdem zurücksetzen",
  "checkpoint.failed": "Fehler beim Zurücksetzen des Checkpoints.",
