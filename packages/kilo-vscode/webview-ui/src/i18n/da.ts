export const dict = {
  ...
  "settings.experimental.cloudAgent.title": "Cloudagenter",
  "settings.experimental.cloudAgent.description": "Aktivér eksperimentelle Cloud Agent-sessioner i Agent Manager",
