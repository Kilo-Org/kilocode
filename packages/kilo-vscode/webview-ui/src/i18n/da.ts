export const dict = {
  ...
  "agentManager.diff.changes": "Ændringer",
  "agentManager.diff.close": "Luk",
  "agentManager.diff.loading": "Beregner diff...",
  "agentManager.diff.empty": "Ingen ændringer fundet",
  "agentManager.diff.added": "Tilføjet",
  "agentManager.diff.removed": "Fjernet",
  "agentManager.diff.commentOnLine": "Kommentér linje {{line}}",
  "agentManager.diff.editCommentOnLine": "Rediger kommentar på linje {{line}}",
  "agentManager.diff.placeholder": "Skriv en kommentar...",
  "agentManager.diff.cancel": "Annuller",
  "agentManager.diff.comment": "Kommentér",
  "agentManager.diff.save": "Gem",
  "agentManager.diff.send": "Send",
  "agentManager.diff.sendTooltip": "Send direkte til LLM",
  "agentManager.diff.commentTooltip": "Gem kommentar ({{shortcut}})",
  "agentManager.diff.sendToChat": "Send til chat",
  "agentManager.diff.edit": "Rediger",
  "agentManager.diff.delete": "Slet",
