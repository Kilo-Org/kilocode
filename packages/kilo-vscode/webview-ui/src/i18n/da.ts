export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Vælg din standardagent",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Standardagent",
  "workStyle.agent.code.tasks": "Bedst til kodeopgaver",
  "workStyle.agent.code.changes": "Læser, skriver og ændrer kode",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Bedst til dataanalyse",
