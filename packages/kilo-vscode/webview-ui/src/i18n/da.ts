...
export const dict = {
  ...
  "tool.board.read": "Læs beskeder",
  "tool.board.post": "Slå en besked op",
  "tool.board.message": "Læst 1 besked",
  "tool.board.messages": "Læst {{count}} beskeder",
  "tool.board.empty": "Ingen beskeder at læse",
  "tool.board.posted": "Slået op til {{recipient}}",
  "tool.board.saved": "Gemt til {{recipient}}",
  "tool.board.channel": "Kilo Swarm (delt board)",
  "tool.board.details": "Detaljer",
  "tool.board.unavailable": "Beskeddata er ikke tilgængelige. Åbn detaljerne for at undersøge dem.",
  "tool.board.from": "Fra {{sender}}",
  "tool.board.status": "Levering: {{status}}",
  "tool.board.inactive": "Gemt, mens modtageren var inaktiv",
  "tool.board.audience": "Gemt; ingen andre modtagere var aktive",
  "tool.board.unknown": "Gemt; modtagernes aktivitet var ukendt",
  "tool.board.receipt": "Læsekvittering er ikke tilgængelig",
  "tool.board.agent": "Agent {{id}}",
  "tool.board.more": "Der er flere beskeder på boardet.",
  "tool.board.showMore": "Vis {{count}} flere",
