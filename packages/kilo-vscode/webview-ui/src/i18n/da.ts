export const dict = {
  ...
  "migration.progress.sessions": "Chatsessioner",
  "migration.progress.defaultModel": "Standardmodel",
  "migration.progress.commandRules": "Kommandoregler",
  "migration.progress.readPermission": "Læsetilladelse",
  "migration.progress.writePermission": "Skrivetilladelse",
  "migration.progress.executePermission": "Kørselstilladelse",
  "migration.progress.mcpPermission": "MCP-tilladelse",
  "migration.progress.taskPermission": "Opgavetilladelse",
  "migration.progress.language": "Sprogpræference",
  "migration.progress.autocomplete": "Autofuldførelsesindstillinger",
