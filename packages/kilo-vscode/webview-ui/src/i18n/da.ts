export const dict = {
  ...
  "agentRequirements.skill.verifying": "Installeret. Kontrollerer, om færdigheden kan findes...",
  "agentRequirements.skill.installed": "Installeret",
  "agentRequirements.skill.installFailed": "Installationen mislykkedes",
  "agentRequirements.skill.checkFailed": "Kontrollen af færdigheden mislykkedes",
  "agentRequirements.group.skills": "Færdigheder",
  "agentRequirements.group.mcps": "MCP'er",
  "agentRequirements.group.extensions": "Udvidelser",
  "agentRequirements.skill.missing": "Den påkrævede færdighed er ikke installeret",
  "agentRequirements.checking.title": "Kontrollerer agentkrav",
  "agentRequirements.checking.description": "Kontrollerer de færdigheder, der er tilgængelige i dette projekt.",
  "agentRequirements.ready.title": "Klar til brug",
  "agentRequirements.ready.description": "Alle påkrævede færdigheder er tilgængelige.",
  "agentRequirements.blocked.title": "Fuldfør de påkrævede kontroller",
  "agentRequirements.blocked.description": "Denne agent kræver følgende færdigheder, før den kan køre.",
  "agentRequirements.action.installing": "Installerer færdigheder...",
  "agentRequirements.action.installAll": "Installer alle manglende færdigheder / MCP'er",
  "agentRequirements.install.partialFailure": "Nogle færdigheder kunne ikke installeres. Ret fejlene, og prøv igen.",
  "agentRequirements.prompt.blocked": "Fuldfør først de påkrævede kontroller for at bruge denne agent",
  "agentRequirements.error.unknownAgent": "Den valgte agent blev ikke fundet.",
  "agentRequirements.error.malformedDeclaration": "Denne agent har en ugyldig angivelse af påkrævede færdigheder.",
  "agentRequirements.error.discoveryFailed": "Kilo kunne ikke kontrollere de tilgængelige færdigheder.",
  "agentRequirements.error.scopeMismatch": "Denne kontrol af agentkrav er ikke længere aktiv.",
  "agentRequirements.error.requestFailed": "Kilo kunne ikke kontrollere agentkravene.",
  "agentRequirements.install.error.skillNotFound": "Den påkrævede færdighed blev ikke fundet på Marketplace.",
  "agentRequirements.install.error.itemNotSkill": "Elementet på Marketplace er ikke en færdighed.",
  "agentRequirements.install.error.unavailable": "Installation af færdigheder er ikke tilgængelig i denne visning.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo kunne ikke indlæse færdigheder fra Marketplace.",
