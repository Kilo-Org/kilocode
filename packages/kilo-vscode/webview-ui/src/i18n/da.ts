export const dict = {
  ...
  "workStyle.onboarding.title": "Vælg, hvordan du vil arbejde med dine AI-agenter",
  ...
  "workStyle.choice.human.eyebrow": "Menneskelig kontrol",
  "workStyle.choice.human.title": "Gennemgå først",
  "workStyle.choice.human.description": "Kilo holder ofte pause og viser dig, hvad den planlægger at gøre undervejs.",
  "workStyle.choice.human.permissions": "Spørger om tilladelse før filredigering.",
  "workStyle.choice.human.bash": "Spørger om tilladelse til alle terminalkommandoer.",
  "workStyle.choice.human.visibility": "Viser samtaledetaljer, herunder kommandoer og ræsonnement.",
  "workStyle.choice.autonomous.eyebrow": "Færre afbrydelser",
  "workStyle.choice.autonomous.title": "Høj autonomi",
  "workStyle.choice.autonomous.description": "Arbejd med færre afbrydelser og en strømlinet brugerflade.",
  "workStyle.choice.autonomous.permissions": "Kan automatisk redigere filer i arbejdsområdet.",
  "workStyle.choice.autonomous.bash": "Kan køre terminalkommandoer i arbejdsområdet uden godkendelse.",
  "workStyle.choice.autonomous.visibility": "Samtaledetaljer forbliver skjult, indtil du folder dem ud.",
