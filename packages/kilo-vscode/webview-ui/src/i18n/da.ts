...
export const dict = {
  ...
  "chat.search.label": "Søg i chatten",
  "chat.search.placeholder": "Søg i chatten",
  "chat.search.count": "{{ current }} af {{ total }}",
  "chat.search.noResults": "Ingen resultater",
  "chat.search.previous": "Forrige resultat",
  "chat.search.next": "Næste resultat",
