export const dict = {
  ...
  "revert.banner.step": "Agenttrin tilbageført",
  "checkpoint.label": "Tjekpunkt",
  "checkpoint.viewChanges": "Vis ændringer siden dette kontrolpunkt",
  "checkpoint.parallel": "Tjekpunkt før {{count}} parallelle værktøjer",
  "checkpoint.stopRewind": "Stop og spol tilbage",
  "checkpoint.unavailable": "Tjekpunkt ikke tilgængeligt, fordi der ikke blev taget et øjebliksbillede",
  "checkpoint.sharedDirectory":
    "En anden aktiv session bruger denne mappe. Tilbagespoling kan også gendanne dens ændringer.",
  "checkpoint.sharedDirectory.confirm": "Spol tilbage alligevel",
  "checkpoint.failed": "Kunne ikke spole tjekpunkt tilbage.",
