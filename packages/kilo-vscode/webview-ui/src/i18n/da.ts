export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af LLMAPI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i LLMAPI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i LLMAPI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i LLMAPI.",
  ...
  "speechToText.tooltip.start": "Start stemmeinput med LLMAPI Gateway",
  ...
  "speechToText.error.loginRequired": "Log ind på LLMAPI for at bruge stemmeinput.",
  ...
  "dialog.server.description": "Skift hvilken LLMAPI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af LLMAPI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til LLMAPI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, LLMAPI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "LLMAPI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for LLMAPI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan LLMAPI ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan LLMAPI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når LLMAPI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af LLMAPI.",
  ...
  "settings.indexing.kiloModel.title": "LLMAPI-modelpreset",
  "settings.indexing.kiloModel.description": "Vælg en understøttet LLMAPI-hostet embedding-model.",
  "settings.indexing.kiloSignIn.title": "LLMAPI-login kræves",
  "settings.indexing.kiloSignIn.description": "Log ind på LLMAPI for at bruge hostede embeddings.",
  ...
  "settings.config.title": "Åbn {{scope}} LLMAPI konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale LLMAPI konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} LLMAPI konfigurationsfil: {{message}}",
  ...
  "deviceAuth.title": "Log ind på LLMAPI",
  ...
  "profile.action.login": "Log ind med LLMAPI",
  ...
  "session.messages.welcome":
    "LLMAPI er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutKiloCode.extensionName": "LLMAPI-udvidelse",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Filen indeholder ikke gyldige LLMAPI-indstillinger.",
  "settings.aboutKiloCode.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af LLMAPI. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.language.description": 'Vælg sproget til LLMAPI-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivér stemmeinput i prompt-felter ved hjælp af din LLMAPI-konto gennem LLMAPI Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Aktivér og log ind på LLMAPI-udbyderen for at bruge Speech to Text. Speech to Text understøttes i øjeblikket kun med LLMAPI Gateway.",
  "settings.experimental.speechToTextModel.title": "Model til tale til tekst",
  "settings.experimental.speechToTextModel.description": "Vælg LLMAPI Gateway-transskriptionsmodellen til stemmeinput.",
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via LLMAPI Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have LLMAPI til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for LLMAPI webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af LLMAPI, herunder udbyder API-nøgler og standardmodel.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i LLMAPI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle LLMAPI-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af LLMAPI i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
