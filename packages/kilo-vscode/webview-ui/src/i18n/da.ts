export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Kilo holder ofte pause og viser dig, hvad den planlægger at gøre undervejs.",
  "workStyle.choice.human-in-the-loop.permissions": "Spørger om tilladelse før filredigering.",
  "workStyle.choice.human-in-the-loop.bash": "Spørger om tilladelse til alle terminalkommandoer.",
  "workStyle.choice.human-in-the-loop.visibility": "Viser samtaledetaljer, herunder kommandoer og ræsonnement.",
