...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Tilføj kredit",
  "profile.usage.action.manageBilling": "Administrer fakturering",
  ...
  "profile.usage.topups.title": "Personlige optankninger",
  "profile.usage.topups.auto": "Automatisk optankning",
  "profile.usage.topups.on": "Til",
  "profile.usage.topups.off": "Fra",
  "profile.usage.topups.rule": "Tilføj ${{amount}}, når saldoen når ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}}, der slutter på {{last4}}",
  "profile.usage.balance.breakdown": "Tildelt {{granted}} | Optanket {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "ikke tilgængelig",
  "profile.usage.credits.resets": "{{count}} nulstillinger",
