...
export const dict = {
  ...
  "settings.models.refreshCatalog.title": "更新模型目錄",
  "settings.models.refreshCatalog.description": "立即從 models.dev 和 Kilo Gateway 取得最新模型。",
  "settings.models.refreshCatalog.button": "立即更新",
  "settings.models.refreshCatalog.refreshing": "正在更新…",
  "settings.models.refreshCatalog.toast.success": "模型目錄已更新",
  "settings.models.refreshCatalog.toast.error": "無法完全重新整理模型目錄，請再試一次。",
