...
export const dict = {
  ...
  "tool.board.read": "閱讀訊息",
  "tool.board.post": "張貼訊息",
  "tool.board.message": "已閱讀 1 則訊息",
  "tool.board.messages": "已閱讀 {{count}} 則訊息",
  "tool.board.empty": "沒有可閱讀的訊息",
  "tool.board.posted": "已為 {{recipient}} 張貼",
  "tool.board.saved": "已為 {{recipient}} 儲存",
  "tool.board.channel": "Kilo Swarm (共享看板)",
  "tool.board.details": "詳細資訊",
  "tool.board.unavailable": "訊息資料無法使用。請開啟詳細資訊檢視。",
  "tool.board.from": "來自 {{sender}}",
  "tool.board.status": "送達狀態：{{status}}",
  "tool.board.inactive": "已儲存，收件者當時處於非作用中狀態",
  "tool.board.audience": "已儲存；張貼時沒有其他處於作用中狀態的收件者",
  "tool.board.unknown": "已儲存；張貼時收件者是否處於作用中狀態未知",
  "tool.board.receipt": "無法提供已讀回條",
  "tool.board.agent": "代理 {{id}}",
  "tool.board.more": "看板上還有更多訊息。",
  "tool.board.showMore": "再顯示 {{count}} 則",
  "tool.board.showLess": "收合",
  "tool.board.main": "主要代理",
  "tool.board.all": "所有代理",
  "tool.board.to": "傳送給 {{recipient}}",
