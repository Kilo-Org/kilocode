...
export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description": "Kilo 會頻繁暫停，並在工作過程中顯示接下來的操作計畫。",
  "workStyle.choice.human-in-the-loop.permissions": "編輯檔案前要求權限",
  "workStyle.choice.human-in-the-loop.bash": "執行所有終端機指令時要求權限",
  "workStyle.choice.human-in-the-loop.visibility": "顯示對話詳細資訊，包括指令和推理過程",
