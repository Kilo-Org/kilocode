...
export const dict = {
  ...
  "migration.progress.sessions": "聊天工作階段",
  "migration.progress.defaultModel": "預設模型",
  "migration.progress.commandRules": "命令規則",
  "migration.progress.readPermission": "讀取權限",
  "migration.progress.writePermission": "寫入權限",
  "migration.progress.executePermission": "執行權限",
  "migration.progress.mcpPermission": "MCP 權限",
  "migration.progress.taskPermission": "任務權限",
  "migration.progress.language": "語言偏好",
  "migration.progress.autocomplete": "自動完成設定",
