...
export const dict = {
  ...
  "revert.banner.step": "代理步驟已還原",
  "checkpoint.label": "檢查點",
  "checkpoint.viewChanges": "檢視此檢查點之後的變更",
  "checkpoint.parallel": "{{count}} 個平行工具之前的檢查點",
  "checkpoint.stopRewind": "停止並回退",
  "checkpoint.unavailable": "由於未擷取快照，檢查點無法使用",
  "checkpoint.sharedDirectory": "另一個作用中的工作階段正在使用此目錄。回退可能也會還原其變更。",
  "checkpoint.sharedDirectory.confirm": "仍然回退",
  "checkpoint.failed": "回退檢查點失敗。",
