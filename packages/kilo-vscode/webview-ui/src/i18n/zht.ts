...
export const dict = {
  ...
  "profile.usage.action.addCredits": "新增額度",
  "profile.usage.action.manageBilling": "管理帳單",
  ...
  "profile.usage.topups.title": "個人加值",
  "profile.usage.topups.auto": "自動加值",
  "profile.usage.topups.on": "開啟",
  "profile.usage.topups.off": "關閉",
  "profile.usage.topups.rule": "餘額達到 ${{threshold}} 時加值 ${{amount}}",
  "profile.usage.topups.payment": "{{brand}} 尾號 {{last4}}",
  "profile.usage.balance.breakdown": "贈送 {{granted}} | 加值 {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "無法使用",
  "profile.usage.credits.resets": "{{count}} 次重設",
