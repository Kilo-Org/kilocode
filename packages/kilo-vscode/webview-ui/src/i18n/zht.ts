...
export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "選擇預設代理",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "預設代理",
  "workStyle.agent.code.tasks": "最適合程式設計任務",
  "workStyle.agent.code.changes": "讀取、撰寫及修改程式碼",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "最適合資料分析",
  "workStyle.agent.data.notebooks": "在 Jupyter Notebook 中執行查詢並建立視覺化",
  "workStyle.agent.data.requirement": "需要安裝 Jupyter 擴充功能",
