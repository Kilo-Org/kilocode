...
export const dict = {
  ...
  "settings.indexing.valkeyUrl.description": "Valkey 向量儲存的連線 URL。",
  "settings.indexing.valkeyPassword.title": "Valkey 密碼",
  "settings.indexing.valkeyPassword.description": "Valkey 的可選身分驗證密碼。",
  "settings.indexing.valkeyPassword.placeholder": "可選密碼",
