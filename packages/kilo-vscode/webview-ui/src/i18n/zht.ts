...
export const dict = {
  ...
  "provider.custom.models.allReasoning": "全部啟用推理",
  "provider.custom.models.noReasoning": "全部關閉推理",
  "provider.custom.models.allImages": "全部啟用圖片",
  "provider.custom.models.noImages": "全部關閉圖片",
