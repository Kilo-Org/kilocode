...
export const dict = {
  ...
  "workStyle.choice.human.eyebrow": "人工參與",
  "workStyle.choice.human.title": "先審查",
  "workStyle.choice.human.description": "Kilo 會頻繁暫停，並在工作過程中顯示接下來的操作計畫。",
  "workStyle.choice.human.permissions": "編輯檔案前要求權限",
  "workStyle.choice.human.bash": "執行所有終端機指令時要求權限",
  "workStyle.choice.human.visibility": "顯示對話詳細資訊，包括指令和推理過程",
  "workStyle.choice.autonomous.eyebrow": "減少中斷",
  "workStyle.choice.autonomous.title": "高度自主",
  "workStyle.choice.autonomous.description": "減少中斷，並使用更精簡的介面工作。",
  "workStyle.choice.autonomous.permissions": "可以自動編輯工作區中的檔案。",
  "workStyle.choice.autonomous.bash": "可以在工作區中不經核准執行終端機指令。",
  "workStyle.choice.autonomous.visibility": "對話詳細資訊會保持隱藏，直到你將其展開。",
