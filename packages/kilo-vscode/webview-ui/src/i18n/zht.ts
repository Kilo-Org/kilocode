...
export const dict = {
  ...
  "provider.anaconda.status.syncing": "正在重新整理提供商模型...",
  "provider.anaconda.status.ready": "準備連接",
  ...
  "provider.anaconda.state.notInstalled":
    "在此裝置上安裝 Anaconda Desktop，然後返回此處。Kilo 不會替您執行安裝程式。",
  "provider.anaconda.state.notRunning":
    "開啟 Anaconda Desktop，完成設定並登入，然後選擇重新檢查。",
  "provider.anaconda.state.invalidConfig":
    "Anaconda Desktop 設定不完整。開啟 Desktop，完成設定，如有需要請重新啟動。",
  "provider.anaconda.state.signedOut": "在連接 Kilo 之前，請開啟 Anaconda Desktop 並登入。",
  "provider.anaconda.state.unauthorized":
    "Kilo 無法存取 Anaconda Desktop。開啟 Desktop，重新登入，如有需要請重新啟動。",
  ...
  "provider.anaconda.state.unhealthy":
    "活躍推理伺服器尚不健康。在 Anaconda Desktop 中檢查並根據需要重新啟動伺服器。",
  "provider.anaconda.state.ready":
    "Kilo 找到了一個健康的本地文字生成伺服器，可以匯入其目前連接設定。",
  "provider.anaconda.server": "活躍推理伺服器",
  "provider.anaconda.context": "上下文視窗",
  "provider.anaconda.contextValue": "{{count}} 個 token",
  ...
  "provider.anaconda.toast.refreshed.description": "活躍的本地伺服器和模型在 Kilo 中已是最新狀態。",
  "settings.providers.note.anacondaDesktop": "執行由 Anaconda Desktop 本地提供的模型。",
