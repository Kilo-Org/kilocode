...
export const dict = {
  ...
  "model.routing.label": "供應商路由",
  "model.routing.auto": "自動",
  "model.routing.loading": "正在載入供應商…",
  "model.routing.empty": "此模型目前沒有可用的供應商清單",
  "model.routing.preview.quantization": "量化",
  "model.routing.preview.maxOutput": "最大輸出",
  "model.routing.preview.cacheRead": "快取讀取",
  "model.routing.preview.cacheWrite": "快取寫入",
  ...
  "settings.models.providerRouting.title": "供應商路由",
  "settings.models.providerRouting.description":
    "透過 Kilo Gateway 路由時，將預設模型固定至特定的上游推論供應商。「自動」模式由閘道選擇供應商。",
