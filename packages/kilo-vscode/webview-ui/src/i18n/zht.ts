...
export const dict = {
  ...
  "agentRequirements.skill.installing": "正在從 Marketplace 安裝...",
  "agentRequirements.skill.verifying": "安裝完成。正在確認是否已辨識此技能...",
  "agentRequirements.skill.installed": "已安裝",
  "agentRequirements.skill.installFailed": "安裝失敗",
  "agentRequirements.skill.checkFailed": "技能檢查失敗",
  "agentRequirements.group.skills": "技能",
  "agentRequirements.group.mcps": "MCP",
  "agentRequirements.group.extensions": "擴充功能",
  "agentRequirements.skill.missing": "尚未安裝所需技能",
  "agentRequirements.checking.title": "正在檢查代理程式需求",
  "agentRequirements.checking.description": "正在驗證此專案中可用的技能。",
  "agentRequirements.ready.title": "準備就緒",
  "agentRequirements.ready.description": "所有所需技能皆可用。",
  "agentRequirements.blocked.title": "完成必要檢查",
  "agentRequirements.blocked.description": "此代理程式需要以下技能才能執行。",
  "agentRequirements.action.installing": "正在安裝技能...",
  "agentRequirements.action.installAll": "安裝所有缺少的技能 / MCP",
  "agentRequirements.install.partialFailure": "部分技能無法安裝。請修正錯誤後再試一次。",
  "agentRequirements.prompt.blocked": "請先完成必要檢查，才能使用此代理程式",
  "agentRequirements.error.unknownAgent": "找不到所選的代理程式。",
  "agentRequirements.error.malformedDeclaration": "此代理程式的技能需求宣告無效。",
  "agentRequirements.error.discoveryFailed": "Kilo 無法檢查可用的技能。",
  "agentRequirements.error.scopeMismatch": "此代理程式需求檢查已失效。",
  "agentRequirements.error.requestFailed": "Kilo 無法檢查代理程式需求。",
  "agentRequirements.install.error.skillNotFound": "找不到所需的 Marketplace 技能。",
  "agentRequirements.install.error.itemNotSkill": "此 Marketplace 項目不是技能。",
  "agentRequirements.install.error.unavailable": "此檢視不支援安裝技能。",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo 無法載入 Marketplace 技能。",
