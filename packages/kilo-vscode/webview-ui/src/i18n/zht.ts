...
export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse.help": "告訴協調器何時將任務委派給此代理。",
  "settings.agentBehaviour.editMode.whenToUse.placeholder": "例如：當使用者要求程式碼審查或品質分析時使用此代理",
  "settings.agentBehaviour.editMode.whenToUse.none": "尚未為此內建代理定義說明。",
