...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Milvus 位址",
  "settings.indexing.milvusAddress.description": "Milvus Standalone 或 Zilliz Cloud 的位址。",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Milvus 權杖",
  "settings.indexing.milvusToken.description": "Milvus 或 Zilliz Cloud 的選用驗證權杖。",
  "settings.indexing.milvusToken.placeholder": "選用權杖",
  "settings.indexing.milvusDatabase.title": "Milvus 資料庫",
  "settings.indexing.milvusDatabase.description": "選用的 Milvus 資料庫名稱。",
  "settings.indexing.milvusDatabase.placeholder": "留空以使用預設值",
