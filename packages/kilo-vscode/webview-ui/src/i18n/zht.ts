...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "LLMAPI 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 LLMAPI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 LLMAPI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 LLMAPI 中使用 {{provider}} 模型。",
  ...
  "speechToText.tooltip.start": "使用 LLMAPI Gateway 開始語音輸入",
  ...
  "speechToText.error.loginRequired": "登入 LLMAPI 以使用語音輸入。",
  ...
  "dialog.server.description": "切換此應用程式連線的 LLMAPI 伺服器。",
  ...
  "toast.update.description": "LLMAPI 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 LLMAPI 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：LLMAPI 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "LLMAPI 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 LLMAPI 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 LLMAPI 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 LLMAPI 的主題。",
  ...
  "settings.updates.row.startup.description": "在 LLMAPI 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 LLMAPI。",
  ...
  "settings.config.title": "開啟 {{scope}} LLMAPI 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 LLMAPI 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} LLMAPI 設定檔：{{message}}",
  ...
  "profile.action.login": "使用 LLMAPI 登入",
  ...
  "settings.aboutKiloCode.title": "關於 LLMAPI",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "LLMAPI 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutKiloCode.extensionName": "LLMAPI 擴充功能",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "檔案不包含有效的 LLMAPI 設定。",
  "settings.aboutKiloCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此檔案由較新版本的 LLMAPI 匯出。部分設定可能會被忽略。",
  ...
  "settings.language.description": "選擇 LLMAPI 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.experimental.speechToText.description": "透過 LLMAPI Gateway 使用您的 LLMAPI 帳戶在提示詞欄位中啟用語音輸入。",
  "settings.experimental.speechToText.disabledDescription":
    "啟用並登入 LLMAPI 供應商以使用 Speech to Text。Speech to Text 目前僅支援透過 LLMAPI Gateway 使用。",
  "settings.experimental.speechToTextModel.title": "語音轉文字模型",
  "settings.experimental.speechToTextModel.description": "選擇用於語音輸入的 LLMAPI Gateway 轉錄模型。",
  ...
  "settings.experimental.remote.description": "透過 LLMAPI Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 LLMAPI 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 LLMAPI webview UI 的字體大小。",
  ...
  "settings.indexing.kiloModel.title": "LLMAPI 模型預設",
  "settings.indexing.kiloModel.description": "選擇支援的 LLMAPI 託管嵌入模型。",
  "settings.indexing.kiloSignIn.title": "需要登入 LLMAPI",
  "settings.indexing.kiloSignIn.description": "登入 LLMAPI 以使用託管嵌入。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "從舊版 LLMAPI 安裝遷移設定，包括供應商 API 金鑰和預設模型。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "LLMAPI 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 LLMAPI 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "diffViewer.source.session.tooltip": "LLMAPI 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
