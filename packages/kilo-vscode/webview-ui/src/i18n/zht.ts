...
export const dict = {
  ...
  "agentManager.diff.changes": "變更",
  "agentManager.diff.close": "關閉",
  "agentManager.diff.loading": "正在計算差異...",
  "agentManager.diff.empty": "未偵測到變更",
  "agentManager.diff.added": "已新增",
  "agentManager.diff.removed": "已移除",
  "agentManager.diff.commentOnLine": "在第 {{line}} 行留言",
  "agentManager.diff.editCommentOnLine": "編輯第 {{line}} 行的留言",
  "agentManager.diff.placeholder": "留下留言...",
  "agentManager.diff.cancel": "取消",
  "agentManager.diff.comment": "留言",
  "agentManager.diff.save": "儲存",
  "agentManager.diff.send": "傳送",
  "agentManager.diff.sendTooltip": "直接傳送給 LLM",
  "agentManager.diff.commentTooltip": "儲存留言 ({{shortcut}})",
  "agentManager.diff.sendToChat": "傳送至聊天",
  "agentManager.diff.edit": "編輯",
  "agentManager.diff.delete": "刪除",
  "agentManager.diff.commentsCount": "{{count}} 則留言",
  "agentManager.diff.commentsCountPlural": "{{count}} 則留言",
  "agentManager.diff.sendAllToChat": "全部傳送至聊天",
  "agentManager.shortcuts.sendAllComments": "傳送所有留言給 LLM",
