...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "LLMAPI에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 LLMAPI에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 LLMAPI에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 LLMAPI에서 {{provider}} 모델을 사용하세요.",
  ...
  "speechToText.tooltip.start": "LLMAPI Gateway로 음성 입력 시작",
  ...
  "speechToText.error.loginRequired": "음성 입력을 사용하려면 LLMAPI에 로그인하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 LLMAPI 서버를 전환합니다.",
  ...
  "toast.update.description": "LLMAPI의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 LLMAPI 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: LLMAPI는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "LLMAPI에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "LLMAPI 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 LLMAPI가 보이는 방식 사용자 지정",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "LLMAPI 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "LLMAPI를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 LLMAPI를 사용 중입니다.",
  ...
  "settings.providers.betaNotice":
    "현재 설정 인터페이스에서는 LLMAPI Gateway 제공자만 설정할 수 있습니다. 다른 제공자 설정에 대한 지원은 베타 기간 동안 곧 제공될 예정입니다. 그동안에는 CLI 또는 설정 파일을 사용하여 제공자를 설정할 수 있습니다. 우리는 종속(lock-in) 없이 LLMAPI를 개방적으로 유지하기 위해 최선을 다하고 있습니다.",
  ...
  "settings.config.title": "{{scope}} LLMAPI 구성 파일 열기",
  "settings.config.placeholder":
    "구성 파일은 순서대로 병합됩니다. 로드됨으로 표시된 파일이 현재 설정에 영향을 미칩니다.",
  "settings.config.noWorkspace": "로컬 LLMAPI 구성 파일을 편집하려면 작업 영역 폴더를 엽니다.",
  "settings.config.openFailed": "{{scope}} LLMAPI 구성 파일을 열지 못했습니다: {{message}}",
  ...
  "profile.action.login": "LLMAPI로 로그인",
  ...
  "settings.aboutKiloCode.title": "LLMAPI 정보",
  ...
  "settings.indexing.kiloModel.title": "LLMAPI 모델 프리셋",
  "settings.indexing.kiloModel.description": "지원되는 LLMAPI 호스팅 임베딩 모델을 선택하세요.",
  "settings.indexing.kiloSignIn.title": "LLMAPI 로그인이 필요합니다",
  "settings.indexing.kiloSignIn.description": "호스팅 임베딩을 사용하려면 LLMAPI에 로그인하세요.",
  ...
  "session.messages.welcome":
    "LLMAPI는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutKiloCode.extensionName": "LLMAPI 확장 프로그램",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "파일에 유효한 LLMAPI 설정이 포함되어 있지 않습니다.",
  "settings.aboutKiloCode.importSettings.tooLarge": "파일이 너무 큽니다. 설정 파일은 1 MB 이하여야 합니다.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "이 파일은 더 최신 버전의 LLMAPI에서 내보낸 것입니다. 일부 설정이 무시될 수 있습니다.",
  ...
  "settings.language.description": 'LLMAPI UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.experimental.speechToText.description":
    "LLMAPI Gateway를 통해 LLMAPI 계정을 사용하여 프롬프트 필드에서 음성 입력을 활성화합니다.",
  "settings.experimental.speechToText.disabledDescription":
    "Speech to Text를 사용하려면 LLMAPI 제공자를 활성화하고 로그인하세요. 현재 Speech to Text는 LLMAPI Gateway에서만 지원됩니다.",
  "settings.experimental.speechToTextModel.title": "음성 텍스트 변환 모델",
  "settings.experimental.speechToTextModel.description": "음성 입력에 사용할 LLMAPI Gateway 변환 모델을 선택하세요.",
  ...
  "settings.experimental.remote.description":
    "LLMAPI Cloud를 통한 세션의 Remote 제어를 활성화합니다. 이는 이 컴퓨터의 CLI에도 영향을 미칩니다.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code 설정 디렉터리에서 세션으로 CLAUDE.md 지침 및 스킬을 로드합니다. LLMAPI가 Claude Code 지침 및 스킬을 사용하게 하려면 활성화하세요. 다시 시작해야 합니다.",
  ...
  "settings.display.fontSize.description": "VS Code와 독립적으로 LLMAPI webview UI 글꼴 크기를 조정합니다.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 LLMAPI 설치에서 설정을 마이그레이션합니다.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "LLMAPI의 새로운 기능",
  ...
  "migration.whatsNew.features.foundation.detail":
    "모든 LLMAPI 제품에 걸쳐 하나의 작고 효율적인 코어. 어떤 방식으로 작업하든 익숙한 경험을 제공합니다.",
  ...
  "diffViewer.source.session.tooltip":
    "현재 세션 동안 LLMAPI가 변경한 파일로, 턴별 스냅샷을 기반으로 합니다. 새 세션을 시작하면 초기화됩니다.",
