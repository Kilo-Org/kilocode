...
export const dict = {
  ...
  "settings.autoCleanup.error.status": "세션 정리 상태를 일시적으로 사용할 수 없습니다. 다시 시도하는 중...",
  ...
  "settings.autoCleanup.progress.scanning": "세션 검사 중: {{processed}}/{{total}} 처리됨",
  "settings.autoCleanup.progress.deleting":
    "세션 삭제 중: {{processed}}/{{total}} 처리됨({{deleted}}개 삭제, {{failed}}개 실패)",
