...
export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "기본 에이전트를 선택하세요",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "기본 에이전트",
  "workStyle.agent.code.tasks": "코딩 작업에 가장 적합",
  "workStyle.agent.code.changes": "코드를 읽고, 작성하고, 수정합니다",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "데이터 분석에 가장 적합",
  "workStyle.agent.data.notebooks": "Jupyter 노트북에서 쿼리를 실행하고 시각화를 생성합니다",
  "workStyle.agent.data.requirement": "Jupyter 확장이 필요합니다",
