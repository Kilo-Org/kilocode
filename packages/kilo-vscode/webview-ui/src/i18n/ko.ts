...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Milvus 주소",
  "settings.indexing.milvusAddress.description": "Milvus Standalone 또는 Zilliz Cloud의 주소입니다.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Milvus 토큰",
  "settings.indexing.milvusToken.description": "인증된 Milvus 또는 Zilliz Cloud용 선택적 토큰입니다.",
  "settings.indexing.milvusToken.placeholder": "선택적 토큰",
  "settings.indexing.milvusDatabase.title": "Milvus 데이터베이스",
  "settings.indexing.milvusDatabase.description": "선택적 Milvus 데이터베이스 이름입니다.",
  "settings.indexing.milvusDatabase.placeholder": "기본값을 사용하려면 비워 두세요",
