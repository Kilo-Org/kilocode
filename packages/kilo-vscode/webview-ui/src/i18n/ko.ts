...
export const dict = {
  ...
  "workStyle.onboarding.title": "AI 에이전트와 함께 일할 방식을 선택하세요",
  ...
  "workStyle.choice.human.eyebrow": "사용자 검토 포함",
  "workStyle.choice.human.title": "먼저 검토",
  "workStyle.choice.human.description": "Kilo가 자주 멈추고 작업을 진행하면서 무엇을 할 계획인지 보여줍니다.",
  "workStyle.choice.human.permissions": "파일 편집 전 권한 요청",
  "workStyle.choice.human.bash": "모든 터미널 명령 실행 시 권한 요청",
  "workStyle.choice.human.visibility": "명령과 추론을 포함한 대화 세부 정보 표시",
  "workStyle.choice.autonomous.eyebrow": "중단 최소화",
  "workStyle.choice.autonomous.title": "높은 자율성",
  "workStyle.choice.autonomous.description": "방해를 줄이고 간소화된 인터페이스로 작업합니다.",
  "workStyle.choice.autonomous.permissions": "작업 공간의 파일을 자동으로 편집할 수 있습니다.",
  "workStyle.choice.autonomous.bash": "승인 없이 작업 공간에서 터미널 명령을 실행할 수 있습니다.",
  "workStyle.choice.autonomous.visibility": "대화 세부 정보는 펼칠 때까지 숨겨집니다.",
