...
export const dict = {
  ...
  "profile.usage.action.addCredits": "크레딧 추가",
  "profile.usage.action.manageBilling": "결제 관리",
  ...
  "profile.usage.topups.title": "개인 충전",
  "profile.usage.topups.auto": "자동 충전",
  "profile.usage.topups.on": "켜짐",
  "profile.usage.topups.off": "꺼짐",
  "profile.usage.topups.rule": "잔액이 ${{threshold}}에 도달하면 ${{amount}} 추가",
  "profile.usage.topups.payment": "끝 번호 {{last4}}인 {{brand}}",
  "profile.usage.balance.breakdown": "지급 {{granted}} | 충전 {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "사용 불가",
  "profile.usage.credits.resets": "{{count}}회 초기화",
