...
export const dict = {
  ...
  "revert.banner.step": "에이전트 단계를 되돌렸습니다",
  "checkpoint.label": "체크포인트",
  "checkpoint.viewChanges": "이 체크포인트 이후의 변경 사항 보기",
  "checkpoint.parallel": "{{count}}개의 병렬 도구 이전 체크포인트",
  "checkpoint.stopRewind": "중지하고 되감기",
  "checkpoint.unavailable": "스냅샷이 캡처되지 않아 체크포인트를 사용할 수 없습니다",
  "checkpoint.sharedDirectory":
    "다른 활성 세션이 이 디렉토리를 사용하고 있습니다. 되감기 시 해당 세션의 변경 사항도 복원될 수 있습니다.",
  "checkpoint.sharedDirectory.confirm": "그래도 되감기",
  "checkpoint.failed": "체크포인트를 되감지 못했습니다.",
