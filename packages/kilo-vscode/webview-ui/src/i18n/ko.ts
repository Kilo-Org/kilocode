...
export const dict = {
  ...
  "provider.custom.models.allReasoning": "모든 추론",
  "provider.custom.models.noReasoning": "추론 없음",
  "provider.custom.models.allImages": "모든 이미지",
  "provider.custom.models.noImages": "이미지 없음",
