...
export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "사용 시점",
  "settings.agentBehaviour.editMode.whenToUse.help": "오케스트레이터가 이 에이전트에 작업을 위임할 시점을 알려줍니다.",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "예: 사용자가 코드 리뷰 또는 품질 분석을 요청할 때 이 에이전트를 사용",
  "settings.agentBehaviour.editMode.whenToUse.none": "이 기본 제공 에이전트에 대한 설명이 정의되어 있지 않습니다.",
