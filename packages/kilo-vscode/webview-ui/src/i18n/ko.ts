...
export const dict = {
  ...
  "tool.board.read": "메시지 읽기",
  "tool.board.post": "메시지 게시",
  "tool.board.message": "메시지 1개 읽음",
  "tool.board.messages": "메시지 {{count}}개 읽음",
  "tool.board.empty": "읽을 메시지 없음",
  "tool.board.posted": "{{recipient}}에게 보낼 메시지 게시됨",
  "tool.board.saved": "{{recipient}}에게 보낼 메시지 저장됨",
  "tool.board.channel": "Kilo Swarm (공유 보드)",
  "tool.board.details": "상세 정보",
  "tool.board.unavailable": "메시지 데이터를 사용할 수 없습니다. 상세 정보를 열어 확인하세요.",
  "tool.board.from": "보낸 사람: {{sender}}",
  "tool.board.status": "전달: {{status}}",
  "tool.board.inactive": "수신자가 비활성 상태였을 때 저장됨",
  "tool.board.audience": "저장됨; 게시 당시 활성 상태인 다른 수신자가 없었음",
  "tool.board.unknown": "저장됨; 게시 당시 수신자들의 활성 여부는 알 수 없었음",
  "tool.board.receipt": "읽음 확인을 사용할 수 없음",
  "tool.board.agent": "에이전트 {{id}}",
  "tool.board.more": "보드에 메시지가 더 있습니다.",
  "tool.board.showMore": "{{count}}개 더 보기",
  "tool.board.showLess": "간략히 보기",
  "tool.board.main": "주 에이전트",
  "tool.board.all": "모든 에이전트",
  "tool.board.to": "{{recipient}}에게",
