...
export const dict = {
  ...
  "settings.autoCleanup.enable.description":
    "정해진 일 수가 지나면 오래된 작업 기록을 자동으로 삭제합니다. 이 컴퓨터의 모든 프로젝트와 모든 Kilo 클라이언트가 대상이며 이 창만이 아닙니다. 실행 중인 작업과 최근 분기가 있는 작업은 절대 삭제되지 않습니다. 삭제는 영구적입니다.",
  ...
  "settings.autoCleanup.runNow.confirm":
    "이 컴퓨터의 모든 프로젝트와 모든 Kilo 클라이언트에 걸쳐 만료된 작업을 영구적으로 삭제할까요?",
