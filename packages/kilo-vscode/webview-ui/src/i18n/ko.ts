...
export const dict = {
  ...
  "agentRequirements.skill.installing": "Marketplace에서 설치 중...",
  "agentRequirements.skill.verifying": "설치되었습니다. 스킬이 인식되는지 확인 중...",
  "agentRequirements.skill.installed": "설치됨",
  "agentRequirements.skill.installFailed": "설치 실패",
  "agentRequirements.skill.checkFailed": "스킬 확인 실패",
  "agentRequirements.group.skills": "스킬",
  "agentRequirements.group.mcps": "MCP",
  "agentRequirements.group.extensions": "확장 프로그램",
  "agentRequirements.skill.missing": "필수 스킬이 설치되지 않았습니다",
  "agentRequirements.checking.title": "에이전트 요구 사항 확인 중",
  "agentRequirements.checking.description": "이 프로젝트에서 사용할 수 있는 스킬을 확인하고 있습니다.",
  "agentRequirements.ready.title": "사용 준비 완료",
  "agentRequirements.ready.description": "필수 스킬을 모두 사용할 수 있습니다.",
  "agentRequirements.blocked.title": "필수 확인을 완료하세요",
  "agentRequirements.blocked.description": "이 에이전트를 실행하려면 다음 스킬이 필요합니다.",
  "agentRequirements.action.installing": "스킬 설치 중...",
  "agentRequirements.action.installAll": "누락된 스킬 / MCP 모두 설치",
  "agentRequirements.install.partialFailure": "일부 스킬을 설치할 수 없습니다. 오류를 해결한 후 다시 시도하세요.",
  "agentRequirements.prompt.blocked": "이 에이전트를 사용하려면 먼저 필수 확인을 완료하세요",
  "agentRequirements.error.unknownAgent": "선택한 에이전트를 찾을 수 없습니다.",
  "agentRequirements.error.malformedDeclaration": "이 에이전트의 스킬 요구 사항 선언이 올바르지 않습니다.",
  "agentRequirements.error.discoveryFailed": "Kilo가 사용 가능한 스킬을 확인하지 못했습니다.",
  "agentRequirements.error.scopeMismatch": "이 에이전트 요구 사항 확인은 더 이상 유효하지 않습니다.",
  "agentRequirements.error.requestFailed": "Kilo가 에이전트 요구 사항을 확인하지 못했습니다.",
  "agentRequirements.install.error.skillNotFound": "필수 Marketplace 스킬을 찾을 수 없습니다.",
  "agentRequirements.install.error.itemNotSkill": "이 Marketplace 항목은 스킬이 아닙니다.",
  "agentRequirements.install.error.unavailable": "이 보기에서는 스킬을 설치할 수 없습니다.",
  "agentRequirements.install.error.marketplaceUnavailable": "Kilo가 Marketplace 스킬을 불러오지 못했습니다.",
