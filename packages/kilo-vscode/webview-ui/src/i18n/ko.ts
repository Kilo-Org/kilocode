...
export const dict = {
  ...
  "agentManager.diff.changes": "변경 사항",
  "agentManager.diff.close": "닫기",
  "agentManager.diff.loading": "차이점 계산 중...",
  "agentManager.diff.empty": "변경 사항이 감지되지 않았습니다",
  "agentManager.diff.added": "추가됨",
  "agentManager.diff.removed": "제거됨",
  "agentManager.diff.commentOnLine": "{{line}}번째 줄에 댓글",
  "agentManager.diff.editCommentOnLine": "{{line}}번째 줄 댓글 수정",
  "agentManager.diff.placeholder": "댓글을 남겨주세요...",
  "agentManager.diff.cancel": "취소",
  "agentManager.diff.comment": "댓글",
  "agentManager.diff.save": "저장",
  "agentManager.diff.send": "전송",
  "agentManager.diff.sendTooltip": "LLM에 직접 전송",
  "agentManager.diff.commentTooltip": "댓글 저장 ({{shortcut}})",
  "agentManager.diff.sendToChat": "채팅으로 전송",
  "agentManager.diff.edit": "수정",
  "agentManager.diff.delete": "삭제",
  "agentManager.diff.commentsCount": "댓글 {{count}}개",
  "agentManager.diff.commentsCountPlural": "댓글 {{count}}개",
  "agentManager.diff.sendAllToChat": "모두 채팅으로 전송",
  "agentManager.shortcuts.sendAllComments": "모든 댓글을 LLM에 전송",
