...
export const dict = {
  ...
  "migration.progress.sessions": "채팅 세션",
  "migration.progress.defaultModel": "기본 모델",
  "migration.progress.commandRules": "명령 규칙",
  "migration.progress.readPermission": "읽기 권한",
  "migration.progress.writePermission": "쓰기 권한",
  "migration.progress.executePermission": "실행 권한",
  "migration.progress.mcpPermission": "MCP 권한",
  "migration.progress.taskPermission": "작업 권한",
  "migration.progress.language": "언어 기본 설정",
  "migration.progress.autocomplete": "자동 완성 설정",
