...
export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Kilo가 자주 멈추고 작업을 진행하면서 무엇을 할 계획인지 보여줍니다.",
  "workStyle.choice.human-in-the-loop.permissions": "파일 편집 전 권한 요청",
  "workStyle.choice.human-in-the-loop.bash": "모든 터미널 명령 실행 시 권한 요청",
  "workStyle.choice.human-in-the-loop.visibility": "명령과 추론을 포함한 대화 세부 정보 표시",
