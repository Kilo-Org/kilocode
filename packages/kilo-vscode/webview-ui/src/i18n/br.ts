...
export const dict = {
  ...
  "tool.board.read": "Ler mensagens",
  "tool.board.post": "Publicar mensagem",
  "tool.board.message": "1 mensagem lida",
  "tool.board.messages": "{{count}} mensagens lidas",
  "tool.board.empty": "Nenhuma mensagem para ler",
  "tool.board.posted": "Publicada para {{recipient}}",
  "tool.board.saved": "Salva para {{recipient}}",
  "tool.board.channel": "Kilo Swarm (quadro compartilhado)",
  "tool.board.details": "Detalhes",
  "tool.board.unavailable": "Dados da mensagem indisponíveis. Abra os detalhes para verificar.",
  "tool.board.from": "De {{sender}}",
  "tool.board.status": "Entrega: {{status}}",
  "tool.board.inactive": "Salva enquanto o destinatário estava inativo",
  "tool.board.audience": "Salva; não havia outros destinatários ativos",
  "tool.board.unknown": "Salva; a atividade dos destinatários era desconhecida",
  "tool.board.receipt": "Confirmação de leitura indisponível",
  "tool.board.agent": "Agente {{id}}",
  "tool.board.more": "Há mais mensagens disponíveis no quadro.",
  "tool.board.showMore": "Mostrar mais {{count}}",
  "tool.board.showLess": "Mostrar menos",
  "tool.board.main": "Principal",
  "tool.board.all": "Todos os agentes",
