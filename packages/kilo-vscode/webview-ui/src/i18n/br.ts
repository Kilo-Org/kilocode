export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "Escolha seu agente padrão",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "Agente padrão",
  "workStyle.agent.code.tasks": "Ideal para tarefas de programação",
  "workStyle.agent.code.changes": "Lê, escreve e modifica código",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "Ideal para análise de dados",
  "workStyle.agent.data.notebooks": "Executa consultas e cria visualizações em notebooks Jupyter",
  "workStyle.agent.data.requirement": "Requer a extensão Jupyter",
  "workStyle.onboarding.settingsNote": "Você pode alterar essas opções a qualquer momento em",
  "workStyle.onboarding.agentSettingsNote": "Você pode alterar o agente padrão a qualquer momento em",
