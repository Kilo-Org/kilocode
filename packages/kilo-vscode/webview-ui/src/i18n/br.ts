export const dict = {
  ...
  "workStyle.onboarding.title": "Escolha como você quer trabalhar com seus agentes de IA",
  ...
  "workStyle.toast.saved.title": "Preferências salvas",
  ...
  "workStyle.choice.human.eyebrow": "Supervisão humana",
  "workStyle.choice.human.title": "Revisar primeiro",
  "workStyle.choice.human.description": "O Kilo pausa com frequência e mostra o que planeja fazer enquanto trabalha.",
  "workStyle.choice.human.permissions": "Pede permissão antes de editar arquivos.",
  "workStyle.choice.human.bash": "Pede permissão para executar qualquer comando no terminal.",
  "workStyle.choice.human.visibility": "Exibe detalhes da conversa, incluindo comandos e raciocínio.",
  "workStyle.choice.autonomous.eyebrow": "Menos interrupções",
  "workStyle.choice.autonomous.title": "Alta autonomia",
  "workStyle.choice.autonomous.description": "Trabalhe com menos interrupções e uma interface simplificada.",
  "workStyle.choice.autonomous.permissions": "Pode editar arquivos no espaço de trabalho automaticamente.",
  "workStyle.choice.autonomous.bash": "Pode executar comandos do terminal no espaço de trabalho sem aprovação.",
  "workStyle.choice.autonomous.visibility": "Os detalhes da conversa permanecem ocultos até você expandi-los.",
