export const dict = {
  ...
  "revert.banner.step": "Etapa do agente revertida",
  "checkpoint.label": "Checkpoint",
  "checkpoint.viewChanges": "Ver alterações desde este ponto de verificação",
  "checkpoint.parallel": "Checkpoint antes de {{count}} ferramentas paralelas",
  "checkpoint.stopRewind": "Parar e reverter",
  "checkpoint.unavailable": "Checkpoint indisponível porque nenhum snapshot foi capturado",
  "checkpoint.sharedDirectory":
    "Outra sessão ativa está usando este diretório. Reverter também pode restaurar as alterações dela.",
  "checkpoint.sharedDirectory.confirm": "Reverter mesmo assim",
  "checkpoint.failed": "Falha ao reverter checkpoint.",
