export const dict = {
  ...
  "migration.progress.sessions": "Sessões de chat",
  "migration.progress.defaultModel": "Modelo padrão",
  "migration.progress.commandRules": "Regras de comando",
  "migration.progress.readPermission": "Permissão de leitura",
  "migration.progress.writePermission": "Permissão de escrita",
  "migration.progress.executePermission": "Permissão de execução",
  "migration.progress.mcpPermission": "Permissão de MCP",
  "migration.progress.taskPermission": "Permissão de tarefas",
  "migration.progress.language": "Preferência de idioma",
  "migration.progress.autocomplete": "Configurações de preenchimento automático",
