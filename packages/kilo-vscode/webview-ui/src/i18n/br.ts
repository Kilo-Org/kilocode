...
export const dict = {
  ...
  "profile.usage.action.addCredits": "Adicionar créditos",
  "profile.usage.action.manageBilling": "Gerenciar cobrança",
  ...
  "profile.usage.topups.title": "Recargas pessoais",
  "profile.usage.topups.auto": "Recarga automática",
  "profile.usage.topups.on": "Ativada",
  "profile.usage.topups.off": "Desativada",
  "profile.usage.topups.rule": "Adicionar ${{amount}} quando o saldo chegar a ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} com final {{last4}}",
  "profile.usage.balance.breakdown": "Concedido {{granted}} | Recarregado {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "indisponível",
  "profile.usage.credits.resets": "{{count}} redefinições",
