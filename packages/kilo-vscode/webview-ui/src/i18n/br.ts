export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description":
    "O Kilo pausa com frequência e mostra o que planeja fazer enquanto trabalha.",
  "workStyle.choice.human-in-the-loop.permissions": "Pede permissão antes de editar arquivos.",
  "workStyle.choice.human-in-the-loop.bash": "Pede permissão para executar qualquer comando no terminal.",
  "workStyle.choice.human-in-the-loop.visibility": "Exibe detalhes da conversa, incluindo comandos e raciocínio.",
