...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "Endereço do Milvus",
  "settings.indexing.milvusAddress.description": "Endereço do Milvus Standalone ou Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "Token do Milvus",
  "settings.indexing.milvusToken.description": "Token opcional para Milvus autenticado ou Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "Token opcional",
  "settings.indexing.milvusDatabase.title": "Banco de dados do Milvus",
  "settings.indexing.milvusDatabase.description": "Nome opcional do banco de dados do Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "Deixe em branco para usar o padrão",
