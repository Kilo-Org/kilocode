export const dict = {
  ...
  "agentManager.diff.changes": "Alterações",
  "agentManager.diff.close": "Fechar",
  "agentManager.diff.loading": "Calculando diff...",
  "agentManager.diff.empty": "Nenhuma alteração detectada",
  "agentManager.diff.added": "Adicionado",
  "agentManager.diff.removed": "Removido",
  "agentManager.diff.commentOnLine": "Comentar na linha {{line}}",
  "agentManager.diff.editCommentOnLine": "Editar comentário na linha {{line}}",
  "agentManager.diff.placeholder": "Deixe um comentário...",
  "agentManager.diff.cancel": "Cancelar",
  "agentManager.diff.comment": "Comentar",
  "agentManager.diff.save": "Salvar",
  "agentManager.diff.send": "Enviar",
  "agentManager.diff.sendTooltip": "Enviar diretamente ao LLM",
  "agentManager.diff.commentTooltip": "Salvar comentário ({{shortcut}})",
  "agentManager.diff.sendToChat": "Enviar ao chat",
  "agentManager.diff.edit": "Editar",
  "agentManager.diff.delete": "Excluir",
  "agentManager.diff.commentsCount": "{{count}} comentário",
  "agentManager.diff.commentsCountPlural": "{{count}} comentários",
  "agentManager.diff.sendAllToChat": "Enviar tudo ao chat",
  "agentManager.shortcuts.sendAllComments": "Enviar todos os comentários ao LLM",
