export const dict = {
  ...
  "agentRequirements.skill.installing": "Instalando pelo Marketplace...",
  "agentRequirements.skill.verifying": "Instalada. Verificando se a habilidade foi detectada...",
  "agentRequirements.skill.installed": "Instalada",
  "agentRequirements.skill.installFailed": "Falha na instalação",
  "agentRequirements.skill.checkFailed": "Falha ao verificar a habilidade",
  "agentRequirements.group.skills": "Habilidades",
  "agentRequirements.group.mcps": "MCPs",
  "agentRequirements.group.extensions": "Extensões",
  "agentRequirements.skill.missing": "A habilidade necessária não está instalada",
  "agentRequirements.checking.title": "Verificando os requisitos do agente",
  "agentRequirements.checking.description": "Verificando as habilidades disponíveis neste projeto.",
  "agentRequirements.ready.title": "Tudo pronto",
  "agentRequirements.ready.description": "Todas as habilidades necessárias estão disponíveis.",
  "agentRequirements.blocked.title": "Conclua as verificações necessárias",
  "agentRequirements.blocked.description":
    "Este agente precisa das seguintes habilidades antes de poder ser executado.",
  "agentRequirements.action.installing": "Instalando habilidades...",
  "agentRequirements.action.installAll": "Instalar todas as habilidades / MCPs ausentes",
  "agentRequirements.install.partialFailure":
    "Não foi possível instalar algumas habilidades. Corrija os erros e tente novamente.",
  "agentRequirements.prompt.blocked": "Conclua primeiro as verificações necessárias para usar este agente",
  "agentRequirements.error.unknownAgent": "Não foi possível encontrar o agente selecionado.",
  "agentRequirements.error.malformedDeclaration": "A declaração de habilidades necessárias deste agente é inválida.",
  "agentRequirements.error.discoveryFailed": "O Kilo não conseguiu verificar as habilidades disponíveis.",
  ...
  "agentRequirements.install.error.skillNotFound": "Não foi possível encontrar no Marketplace a habilidade necessária.",
  "agentRequirements.install.error.itemNotSkill": "O item do Marketplace não é uma habilidade.",
  "agentRequirements.install.error.unavailable": "A instalação de habilidades não está disponível nesta visualização.",
  "agentRequirements.install.error.marketplaceUnavailable":
    "O Kilo não conseguiu carregar as habilidades do Marketplace.",
