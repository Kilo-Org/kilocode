export const dict = {
  ...
  "workStyle.choice.human-in-the-loop.description": "يتوقف Kilo كثيرًا ويعرض لك ما يخطط لفعله أثناء العمل.",
  "workStyle.choice.human-in-the-loop.permissions": "يطلب الإذن قبل تعديل الملفات.",
  "workStyle.choice.human-in-the-loop.bash": "يطلب الإذن لتشغيل أي أمر في المحطة الطرفية.",
  "workStyle.choice.human-in-the-loop.visibility": "يعرض تفاصيل المحادثة، بما فيها الأوامر والاستدلال.",
