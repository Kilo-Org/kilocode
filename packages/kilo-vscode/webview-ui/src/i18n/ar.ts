...
export const dict = {
  ...
  "chat.search.label": "البحث في الدردشة",
  "chat.search.placeholder": "البحث في الدردشة",
  "chat.search.count": "{{ current }} من {{ total }}",
  "chat.search.noResults": "لا توجد نتائج",
  "chat.search.previous": "النتيجة السابقة",
  "chat.search.next": "النتيجة التالية",
