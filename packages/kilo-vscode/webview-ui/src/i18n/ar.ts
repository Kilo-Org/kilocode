...
export const dict = {
  ...
  "tool.board.read": "قراءة الرسائل",
  "tool.board.post": "نشر رسالة",
  "tool.board.message": "تمت قراءة رسالة واحدة",
  "tool.board.messages": "الرسائل المقروءة: {{count}}",
  "tool.board.empty": "لا توجد رسائل لقراءتها",
  "tool.board.posted": "تم النشر لـ {{recipient}}",
  "tool.board.saved": "تم الحفظ لـ {{recipient}}",
  "tool.board.channel": "Kilo Swarm (اللوحة المشتركة)",
  "tool.board.details": "التفاصيل",
  "tool.board.unavailable": "بيانات الرسالة غير متاحة. افتح التفاصيل لفحصها.",
  "tool.board.from": "من {{sender}}",
  "tool.board.status": "التسليم: {{status}}",
  "tool.board.inactive": "تم الحفظ عندما كان المستلم غير نشط",
  "tool.board.audience": "تم الحفظ؛ لم يكن هناك مستلمون آخرون نشطون",
  "tool.board.unknown": "تم الحفظ؛ كان نشاط المستلمين غير معروف",
  "tool.board.receipt": "إيصال القراءة غير متاح",
  "tool.board.agent": "الوكيل {{id}}",
  "tool.board.more": "تتوفر رسائل أخرى على اللوحة.",
  "tool.board.showMore": "عرض المزيد ({{count}})",
  "tool.board.showLess": "عرض أقل",
  "tool.board.main": "الرئيسي",
  "tool.board.all": "جميع الوكلاء",
  "tool.board.to": "إلى {{recipient}}",
