export const dict = {
  ...
  "workStyle.onboarding.agentTitle": "اختر الوكيل الافتراضي",
  "workStyle.agent.code.title": "Code",
  "workStyle.agent.code.default": "الوكيل الافتراضي",
  "workStyle.agent.code.tasks": "الأفضل لمهام البرمجة",
  "workStyle.agent.code.changes": "يقرأ التعليمات البرمجية ويكتبها ويعدّلها",
  "workStyle.agent.data.title": "Data",
  "workStyle.agent.data.analysis": "الأفضل لتحليل البيانات",
