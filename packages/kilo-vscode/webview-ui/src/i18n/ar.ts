export const dict = {
  ...
  "revert.banner.step": "تم التراجع عن خطوة الوكيل",
  "checkpoint.label": "نقطة تحقق",
  "checkpoint.viewChanges": "عرض التغييرات منذ نقطة التحقق هذه",
  "checkpoint.parallel": "نقطة تحقق قبل {{count}} أدوات متوازية",
  "checkpoint.stopRewind": "إيقاف وإرجاع",
  "checkpoint.unavailable": "نقطة التحقق غير متوفرة لأنه لم يتم التقاط لقطة",
  "checkpoint.sharedDirectory":
    "هناك جلسة نشطة أخرى تستخدم هذا الدليل. قد يؤدي الإرجاع أيضًا إلى استعادة التغييرات الخاصة بها.",
  "checkpoint.sharedDirectory.confirm": "إرجاع على أي حال",
  "checkpoint.failed": "فشل إرجاع نقطة التحقق.",
