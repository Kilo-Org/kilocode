export const dict = {
  ...
  "agentRequirements.skill.installing": "جارٍ التثبيت من Marketplace...",
  "agentRequirements.skill.verifying": "تم التثبيت. جارٍ التحقق من اكتشاف المهارة...",
  "agentRequirements.skill.installed": "مُثبّتة",
  "agentRequirements.skill.installFailed": "فشل التثبيت",
  "agentRequirements.skill.checkFailed": "فشل التحقق من المهارة",
  "agentRequirements.group.skills": "المهارات",
  "agentRequirements.group.mcps": "MCPs",
  "agentRequirements.group.extensions": "الإضافات",
  "agentRequirements.skill.missing": "المهارة المطلوبة غير مثبّتة",
  "agentRequirements.checking.title": "جارٍ التحقق من متطلبات الوكيل",
  "agentRequirements.checking.description": "جارٍ التحقق من المهارات المتاحة في هذا المشروع.",
  "agentRequirements.ready.title": "جاهز للبدء",
  "agentRequirements.ready.description": "جميع المهارات المطلوبة متاحة.",
  "agentRequirements.blocked.title": "أكمل عمليات التحقق المطلوبة",
  "agentRequirements.blocked.description": "يحتاج هذا الوكيل إلى المهارات التالية قبل أن يتمكن من العمل.",
  "agentRequirements.action.installing": "جارٍ تثبيت المهارات...",
  "agentRequirements.action.installAll": "تثبيت جميع المهارات / MCPs المفقودة",
  "agentRequirements.install.partialFailure": "تعذّر تثبيت بعض المهارات. أصلح الأخطاء وأعد المحاولة.",
  "agentRequirements.prompt.blocked": "أكمل عمليات التحقق المطلوبة أولاً لاستخدام هذا الوكيل",
  "agentRequirements.error.unknownAgent": "تعذّر العثور على الوكيل المحدد.",
  "agentRequirements.error.malformedDeclaration": "تعريف متطلبات مهارات هذا الوكيل غير صالح.",
  "agentRequirements.error.discoveryFailed": "تعذّر على Kilo التحقق من المهارات المتاحة.",
  "agentRequirements.error.scopeMismatch": "لم يعد التحقق من متطلبات هذا الوكيل نشطًا.",
  "agentRequirements.error.requestFailed": "تعذّر على Kilo التحقق من متطلبات الوكيل.",
  "agentRequirements.install.error.skillNotFound": "تعذّر العثور على المهارة المطلوبة في Marketplace.",
  "agentRequirements.install.error.itemNotSkill": "العنصر الموجود في Marketplace ليس مهارة.",
  "agentRequirements.install.error.unavailable": "تثبيت المهارات غير متاح في هذا العرض.",
  "agentRequirements.install.error.marketplaceUnavailable": "تعذّر على Kilo تحميل المهارات من Marketplace.",
