...
export const dict = {
  ...
  "settings.autoCleanup.enable.description":
    "حذف سجل المهام القديم تلقائيًا بعد عدد ثابت من الأيام — عبر جميع المشاريع وكل عميل Kilo على هذا الجهاز، وليس هذه النافذة فقط. لا يتم حذف المهام قيد التشغيل حاليًا، ولا المهام ذات التفرعات الحديثة أبدًا. الحذف نهائي.",
  ...
  "settings.autoCleanup.runNow.confirm":
    "حذف المهام المنتهية الصلاحية نهائيًا عبر جميع المشاريع وكل عميل Kilo على هذا الجهاز؟",
