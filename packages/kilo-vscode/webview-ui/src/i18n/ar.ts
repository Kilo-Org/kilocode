export const dict = {
  ...
  "provider.anaconda.state.notInstalled":
    "قم بتثبيت Anaconda Desktop على هذا الجهاز، ثم عد إلى هنا. لا يُشغّل Kilo برنامج التثبيت نيابةً عنك.",
  "provider.anaconda.state.notRunning":
    "افتح Anaconda Desktop، وأكمل الإعداد وسجّل الدخول، ثم اختر التحقق مرة أخرى.",
  "provider.anaconda.state.invalidConfig":
    "إعداد Anaconda Desktop غير مكتمل. افتح Desktop، وأكمل الإعداد، ثم أعد تشغيله إذا لزم الأمر.",
  "provider.anaconda.state.signedOut": "افتح Anaconda Desktop وسجّل الدخول قبل توصيل Kilo.",
  "provider.anaconda.state.unauthorized":
    "تعذّر على Kilo الوصول إلى Anaconda Desktop. افتح Desktop، وسجّل الدخول مجدداً، ثم أعد تشغيله إذا لزم الأمر.",
  "provider.anaconda.state.unavailable":
    "لم يستجب Anaconda Desktop بعد. افتحه وانتظر حتى ينتهي التطبيق من البدء.",
  ...
  "provider.anaconda.state.unhealthy":
    "خادم الاستدلال النشط غير سليم بعد. تحقق منه في Anaconda Desktop وأعد تشغيل الخادم إذا لزم الأمر.",
  "provider.anaconda.state.ready":
    "عثر Kilo على خادم محلي سليم لتوليد النصوص ويمكنه استيراد إعدادات الاتصال الحالية.",
  "provider.anaconda.server": "خادم الاستدلال النشط",
  "provider.anaconda.context": "نافذة السياق",
  "provider.anaconda.contextValue": "{{count}} رمزاً",
  ...
  "provider.anaconda.warning.description":
    "هذا الخادم لا يؤكد استدعاء الأدوات. قد تفشل إجراءات وكيل البرمجة أو تكون غير متاحة. تابع فقط إذا قبلت هذه القيود.",
  ...
  "settings.providers.note.anacondaDesktop": "تشغيل نموذج محلياً عبر Anaconda Desktop.",
