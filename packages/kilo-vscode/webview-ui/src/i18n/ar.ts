export const dict = {
  ...
  "migration.progress.sessions": "جلسات الدردشة",
  "migration.progress.defaultModel": "النموذج الافتراضي",
  "migration.progress.commandRules": "قواعد الأوامر",
  "migration.progress.readPermission": "إذن القراءة",
  "migration.progress.writePermission": "إذن الكتابة",
  "migration.progress.executePermission": "إذن التنفيذ",
  "migration.progress.mcpPermission": "إذن MCP",
  "migration.progress.taskPermission": "إذن المهام",
  "migration.progress.language": "تفضيل اللغة",
  "migration.progress.autocomplete": "إعدادات الإكمال التلقائي",
