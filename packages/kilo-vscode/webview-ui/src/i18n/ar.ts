...
export const dict = {
  ...
  "settings.indexing.milvusAddress.title": "عنوان Milvus",
  "settings.indexing.milvusAddress.description": "عنوان Milvus Standalone أو Zilliz Cloud.",
  "settings.indexing.milvusAddress.placeholder": "localhost:19530",
  "settings.indexing.milvusToken.title": "رمز Milvus",
  "settings.indexing.milvusToken.description": "رمز اختياري لـ Milvus الموثق أو Zilliz Cloud.",
  "settings.indexing.milvusToken.placeholder": "رمز اختياري",
  "settings.indexing.milvusDatabase.title": "قاعدة بيانات Milvus",
  "settings.indexing.milvusDatabase.description": "اسم اختياري لقاعدة بيانات Milvus.",
  "settings.indexing.milvusDatabase.placeholder": "اتركه فارغًا لاستخدام القيمة الافتراضية",
