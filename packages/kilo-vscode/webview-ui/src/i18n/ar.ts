...
export const dict = {
  ...
  "profile.usage.action.addCredits": "إضافة رصيد",
  "profile.usage.action.manageBilling": "إدارة الفوترة",
  ...
  "profile.usage.topups.title": "عمليات التعبئة الشخصية",
  "profile.usage.topups.auto": "التعبئة التلقائية",
  "profile.usage.topups.on": "تشغيل",
  "profile.usage.topups.off": "إيقاف",
  "profile.usage.topups.rule": "أضف ${{amount}} عندما يصل الرصيد إلى ${{threshold}}",
  "profile.usage.topups.payment": "{{brand}} المنتهي بـ {{last4}}",
  "profile.usage.balance.breakdown": "ممنوح {{granted}} | تمت التعبئة {{toppedUp}}",
  ...
  "profile.usage.balance.unavailable": "غير متاح",
  "profile.usage.credits.resets": "{{count}} عمليات إعادة ضبط",
