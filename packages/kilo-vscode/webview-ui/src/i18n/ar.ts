export const dict = {
  ...
  "agentManager.diff.changes": "التغييرات",
  "agentManager.diff.close": "إغلاق",
  "agentManager.diff.loading": "جارٍ حساب الفرق...",
  "agentManager.diff.empty": "لم يتم اكتشاف أي تغييرات",
  "agentManager.diff.added": "مُضاف",
  "agentManager.diff.removed": "محذوف",
  "agentManager.diff.commentOnLine": "تعليق على السطر {{line}}",
  "agentManager.diff.editCommentOnLine": "تعديل التعليق على السطر {{line}}",
  "agentManager.diff.placeholder": "اترك تعليقاً...",
  "agentManager.diff.cancel": "إلغاء",
  "agentManager.diff.comment": "تعليق",
  "agentManager.diff.save": "حفظ",
  "agentManager.diff.send": "إرسال",
  "agentManager.diff.sendTooltip": "إرسال مباشرة إلى LLM",
  "agentManager.diff.commentTooltip": "حفظ التعليق ({{shortcut}})",
  "agentManager.diff.sendToChat": "إرسال إلى المحادثة",
  "agentManager.diff.edit": "تعديل",
  "agentManager.diff.delete": "حذف",
  "agentManager.diff.commentsCount": "تعليق {{count}}",
  "agentManager.diff.commentsCountPlural": "{{count}} تعليقات",
  "agentManager.diff.sendAllToChat": "إرسال الكل إلى المحادثة",
  "agentManager.shortcuts.sendAllComments": "إرسال جميع التعليقات إلى LLM",
