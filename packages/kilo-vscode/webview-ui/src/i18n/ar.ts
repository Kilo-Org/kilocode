export const dict = {
  ...
  "workStyle.onboarding.title": "اختر كيف تريد العمل مع وكلاء الذكاء الاصطناعي",
  ...
  "workStyle.choice.human.eyebrow": "الإنسان ضمن سير العمل",
  "workStyle.choice.human.title": "راجع أولًا",
  "workStyle.choice.human.description": "يتوقف Kilo كثيرًا ويعرض لك ما يخطط لفعله أثناء العمل.",
  "workStyle.choice.human.permissions": "يطلب الإذن قبل تعديل الملفات.",
  "workStyle.choice.human.bash": "يطلب الإذن لتشغيل أي أمر في المحطة الطرفية.",
  "workStyle.choice.human.visibility": "يعرض تفاصيل المحادثة، بما فيها الأوامر والاستدلال.",
  "workStyle.choice.autonomous.eyebrow": "مقاطعات أقل",
  "workStyle.choice.autonomous.title": "استقلالية عالية",
  "workStyle.choice.autonomous.description": "اعمل مع مقاطعات أقل وواجهة مبسطة.",
  "workStyle.choice.autonomous.permissions": "يمكنه تعديل الملفات في مساحة العمل تلقائيًا.",
  "workStyle.choice.autonomous.bash": "يمكنه تشغيل أوامر المحطة الطرفية في مساحة العمل دون موافقة.",
  "workStyle.choice.autonomous.visibility": "تظل تفاصيل المحادثة مخفية حتى توسّعها.",
