export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse.help": "يوضح للمنسق متى يفوض المهام إلى هذا الوكيل.",
  ...
  "settings.agentBehaviour.editMode.whenToUse.none": "لا يوجد وصف محدد لهذا الوكيل المدمج.",
