      ...
      <div class="kilo-notifications">
        <div class="kilo-notifications-card">
          <div class="kilo-notifications-header">
            ...
            <IconButton size="small" variant="ghost" icon="close" onClick={handleDismiss} title={language.t("notifications.dismiss")} />
          </div>
          ...
          <div class="kilo-notifications-footer">
            <Show when={total() > 1}>
              <div class="kilo-notifications-nav">
                ...
                <button class="kilo-notifications-nav-btn" onClick={next} title={language.t("notifications.next")}>
