        ...
        <Card>
          ...
          >
            <TextField
              ...
              placeholder={language.t("settings.agentBehaviour.modelIdPlaceholder")}
              onChange={(val) =>
          ...
          >
            <TextField
              ...
              placeholder={language.t("settings.agentBehaviour.promptPlaceholder")}
              multiline
              onChange={(val) =>
                updateAgentConfig(selectedAgent(), {
                ...
                >
                  ...
                  >
                    <Show when={mcp.command}>
                      <div>
                        {language.t("settings.agentBehaviour.mcpCommandLabel")} {mcp.command}{" "}
                        {(mcp.args ?? []).join(" ")}
                      </div>
                    </Show>
                    <Show when={mcp.url}>
                      <div>
                        {language.t("settings.agentBehaviour.mcpUrlLabel")} {mcp.url}
                      </div>
                    </Show>
                  </div>
                </div>
      ...
      <Card style={{ "margin-bottom": "16px" }}>
        ...
        >
          <div style={{ flex: 1 }}>
            <TextField
              value={newSkillPath()}
              placeholder={language.t("settings.agentBehaviour.skillsDirPlaceholder")}
      ...
      <Card>
        ...
        >
          <div style={{ flex: 1 }}>
            <TextField
              value={newSkillUrl()}
              placeholder={language.t("settings.agentBehaviour.skillsUrlPlaceholder")}
        ...
        >
          <div style={{ flex: 1 }}>
            <TextField
              ...
              placeholder={language.t("settings.agentBehaviour.instructionsFilePlaceholder")}
