export const dict = {
  ...
  "timeline.menu.goToPart": "الانتقال إلى الجزء",
  "timeline.menu.stepDetails": "تفاصيل الخطوة",
  "timeline.step.label": "الخطوة {{step}}",
  "timeline.step.inProgress": "قيد التنفيذ",
  "timeline.details.title": "التفاصيل - {{step}}",
  "timeline.details.agent": "الوكيل",
  "timeline.details.provider": "المزوّد",
  "timeline.details.model": "النموذج",
  "timeline.details.started": "البداية",
  "timeline.details.finished": "النهاية",
  "timeline.details.duration": "المدة",
  "timeline.details.totalCost": "التكلفة الإجمالية",
  "timeline.details.tokens": "الرموز",
  "timeline.details.tokens.summary": "إدخال {{input}} · إخراج {{output}} · استدلال {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "ذاكرة مؤقتة R {{read}} · W {{write}} · معدل الإصابة {{rate}}",
}
