export const dict = {
  ...
  "timeline.menu.goToPart": "ไปยังส่วน",
  "timeline.menu.stepDetails": "รายละเอียดขั้นตอน",
  "timeline.step.label": "ขั้นตอน {{step}}",
  "timeline.step.inProgress": "กำลังดำเนินการ",
  "timeline.details.title": "รายละเอียด - {{step}}",
  "timeline.details.agent": "เอเจนต์",
  "timeline.details.provider": "ผู้ให้บริการ",
  "timeline.details.model": "โมเดล",
  "timeline.details.started": "เริ่มต้น",
  "timeline.details.finished": "เสร็จสิ้น",
  "timeline.details.duration": "ระยะเวลา",
  "timeline.details.totalCost": "ค่าใช้จ่ายรวม",
  "timeline.details.tokens": "โทเค็น",
  "timeline.details.tokens.summary": "เข้า {{input}} · ออก {{output}} · การให้เหตุผล {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "แคช R {{read}} · W {{write}} · อัตราการเข้าถึง {{rate}}",
}
