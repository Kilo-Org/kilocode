export const dict = {
  ...
  "timeline.menu.goToPart": "Перейти до частини",
  "timeline.menu.stepDetails": "Деталі кроку",
  "timeline.step.label": "Крок {{step}}",
  "timeline.step.inProgress": "в процесі",
  "timeline.details.title": "Деталі - {{step}}",
  "timeline.details.agent": "Агент",
  "timeline.details.provider": "Провайдер",
  "timeline.details.model": "Модель",
  "timeline.details.started": "Початок",
  "timeline.details.finished": "Завершення",
  "timeline.details.duration": "Тривалість",
  "timeline.details.totalCost": "Загальна вартість",
  "timeline.details.tokens": "Токени",
  "timeline.details.tokens.summary": "Вхід {{input}} · Вихід {{output}} · Міркування {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Кеш R {{read}} · W {{write}} · Рівень влучань {{rate}}",
}
