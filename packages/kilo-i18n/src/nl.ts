...
export const dict = {
  ...
  "timeline.menu.goToPart": "Ga naar onderdeel",
  "timeline.menu.stepDetails": "Stapdetails",
  "timeline.step.label": "Stap {{step}}",
  "timeline.step.inProgress": "bezig",
  ...
  "timeline.details.started": "Gestart",
  "timeline.details.finished": "Voltooid",
  "timeline.details.duration": "Duur",
  "timeline.details.totalCost": "Totale kosten",
  "timeline.details.tokens": "Tokens",
  "timeline.details.tokens.summary": "In {{input}} · Uit {{output}} · Redenering {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Cache R {{read}} · W {{write}} · Trefferpercentage {{rate}}",
}
