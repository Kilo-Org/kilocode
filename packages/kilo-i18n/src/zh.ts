export const dict = {
  ...
  "timeline.menu.goToPart": "跳转到片段",
  "timeline.menu.stepDetails": "步骤详情",
  "timeline.step.label": "步骤 {{step}}",
  "timeline.step.inProgress": "进行中",
  "timeline.details.title": "详情 - {{step}}",
  "timeline.details.agent": "代理",
  "timeline.details.provider": "提供商",
  "timeline.details.model": "模型",
  "timeline.details.started": "开始",
  "timeline.details.finished": "结束",
  "timeline.details.duration": "耗时",
  "timeline.details.totalCost": "总费用",
  "timeline.details.tokens": "令牌",
  "timeline.details.tokens.summary": "输入 {{input}} · 输出 {{output}} · 推理 {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "缓存 R {{read}} · W {{write}} · 命中率 {{rate}}",
}
