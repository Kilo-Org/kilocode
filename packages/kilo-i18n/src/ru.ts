export const dict = {
  ...
  "timeline.menu.goToPart": "Перейти к части",
  "timeline.menu.stepDetails": "Детали шага",
  "timeline.step.label": "Шаг {{step}}",
  "timeline.step.inProgress": "в процессе",
  "timeline.details.title": "Детали - {{step}}",
  "timeline.details.agent": "Агент",
  "timeline.details.provider": "Провайдер",
  "timeline.details.model": "Модель",
  "timeline.details.started": "Начато",
  "timeline.details.finished": "Завершено",
  "timeline.details.duration": "Длительность",
  "timeline.details.totalCost": "Общая стоимость",
  "timeline.details.tokens": "Токены",
  "timeline.details.tokens.summary": "Вход {{input}} · Выход {{output}} · Рассуждения {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Кэш R {{read}} · W {{write}} · Доля попаданий {{rate}}",
}
