export const dict = {
  ...
  "timeline.menu.goToPart": "跳至片段",
  "timeline.menu.stepDetails": "步驟詳情",
  "timeline.step.label": "步驟 {{step}}",
  "timeline.step.inProgress": "進行中",
  "timeline.details.title": "詳情 - {{step}}",
  "timeline.details.agent": "代理",
  "timeline.details.provider": "提供者",
  "timeline.details.model": "模型",
  "timeline.details.started": "開始",
  "timeline.details.finished": "結束",
  "timeline.details.duration": "耗時",
  "timeline.details.totalCost": "總成本",
  "timeline.details.tokens": "權杖",
  "timeline.details.tokens.summary": "輸入 {{input}} · 輸出 {{output}} · 推理 {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "快取 R {{read}} · W {{write}} · 命中率 {{rate}}",
}
