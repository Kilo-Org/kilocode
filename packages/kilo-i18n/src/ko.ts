export const dict = {
  ...
  "timeline.menu.goToPart": "파트로 이동",
  "timeline.menu.stepDetails": "단계 상세",
  "timeline.step.label": "단계 {{step}}",
  "timeline.step.inProgress": "진행 중",
  "timeline.details.title": "세부 정보 - {{step}}",
  "timeline.details.agent": "에이전트",
  "timeline.details.provider": "제공자",
  "timeline.details.model": "모델",
  "timeline.details.started": "시작",
  "timeline.details.finished": "종료",
  "timeline.details.duration": "소요 시간",
  "timeline.details.totalCost": "총 비용",
  "timeline.details.tokens": "토큰",
  "timeline.details.tokens.summary": "입력 {{input}} · 출력 {{output}} · 추론 {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "캐시 R {{read}} · W {{write}} · 적중률 {{rate}}",
}
