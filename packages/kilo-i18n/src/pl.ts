export const dict = {
  ...
  "timeline.menu.goToPart": "Przejdź do części",
  "timeline.menu.stepDetails": "Szczegóły kroku",
  "timeline.step.label": "Krok {{step}}",
  "timeline.step.inProgress": "w toku",
  "timeline.details.title": "Szczegóły - {{step}}",
  "timeline.details.agent": "Agent",
  "timeline.details.provider": "Dostawca",
  "timeline.details.model": "Model",
  "timeline.details.started": "Rozpoczęto",
  "timeline.details.finished": "Zakończono",
  "timeline.details.duration": "Czas trwania",
  "timeline.details.totalCost": "Łączny koszt",
  "timeline.details.tokens": "Tokeny",
  "timeline.details.tokens.summary": "Wejście {{input}} · Wyjście {{output}} · Rozumowanie {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Cache R {{read}} · W {{write}} · Współczynnik trafień {{rate}}",
}
