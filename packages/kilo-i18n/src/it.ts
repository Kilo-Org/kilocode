...
export const dict = {
  ...
  "timeline.menu.goToPart": "Vai alla parte",
  "timeline.menu.stepDetails": "Dettagli del passaggio",
  "timeline.step.label": "Passaggio {{step}}",
  "timeline.step.inProgress": "in corso",
  "timeline.details.title": "Dettagli - {{step}}",
  "timeline.details.agent": "Agente",
  "timeline.details.provider": "Provider",
  "timeline.details.model": "Modello",
  "timeline.details.started": "Inizio",
  "timeline.details.finished": "Fine",
  "timeline.details.duration": "Durata",
  "timeline.details.totalCost": "Costo totale",
  "timeline.details.tokens": "Token",
  "timeline.details.tokens.summary": "Input {{input}} · Output {{output}} · Ragionamento {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Cache R {{read}} · W {{write}} · Tasso di hit {{rate}}",
}
