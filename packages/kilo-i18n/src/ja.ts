export const dict = {
  ...
  "timeline.menu.goToPart": "パートへ移動",
  "timeline.menu.stepDetails": "ステップ詳細",
  "timeline.step.label": "ステップ {{step}}",
  "timeline.step.inProgress": "進行中",
  "timeline.details.title": "詳細 - {{step}}",
  "timeline.details.agent": "エージェント",
  "timeline.details.provider": "プロバイダー",
  "timeline.details.model": "モデル",
  "timeline.details.started": "開始",
  "timeline.details.finished": "終了",
  "timeline.details.duration": "所要時間",
  "timeline.details.totalCost": "合計コスト",
  "timeline.details.tokens": "トークン",
  "timeline.details.tokens.summary": "入力 {{input}} · 出力 {{output}} · 推論 {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "キャッシュ R {{read}} · W {{write}} · ヒット率 {{rate}}",
}
