export const dict = {
  ...
  "timeline.menu.goToPart": "Idi na dio",
  "timeline.menu.stepDetails": "Detalji koraka",
  "timeline.step.label": "Korak {{step}}",
  "timeline.step.inProgress": "u toku",
  "timeline.details.title": "Detalji - {{step}}",
  "timeline.details.agent": "Agent",
  "timeline.details.provider": "Pružalac",
  "timeline.details.model": "Model",
  "timeline.details.started": "Početak",
  "timeline.details.finished": "Kraj",
  "timeline.details.duration": "Trajanje",
  "timeline.details.totalCost": "Ukupan trošak",
  "timeline.details.tokens": "Tokeni",
  "timeline.details.tokens.summary": "Ulaz {{input}} · Izlaz {{output}} · Razmišljanje {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Keš R {{read}} · W {{write}} · Stopa pogotka {{rate}}",
}
