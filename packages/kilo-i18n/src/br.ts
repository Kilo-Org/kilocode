export const dict = {
  ...
  "timeline.menu.goToPart": "Ir para parte",
  "timeline.menu.stepDetails": "Detalhes da etapa",
  "timeline.step.label": "Etapa {{step}}",
  "timeline.step.inProgress": "em andamento",
  "timeline.details.title": "Detalhes - {{step}}",
  "timeline.details.agent": "Agente",
  "timeline.details.provider": "Provedor",
  "timeline.details.model": "Modelo",
  "timeline.details.started": "Início",
  "timeline.details.finished": "Fim",
  "timeline.details.duration": "Duração",
  "timeline.details.totalCost": "Custo total",
  "timeline.details.tokens": "Tokens",
  "timeline.details.tokens.summary": "Entrada {{input}} · Saída {{output}} · Raciocínio {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Cache R {{read}} · W {{write}} · Taxa de acerto {{rate}}",
}
