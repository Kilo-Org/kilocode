export const dict = {
  ...
  "timeline.menu.goToPart": "Parçaya git",
  "timeline.menu.stepDetails": "Adım ayrıntıları",
  "timeline.step.label": "Adım {{step}}",
  "timeline.step.inProgress": "devam ediyor",
  "timeline.details.title": "Ayrıntılar - {{step}}",
  "timeline.details.agent": "Ajan",
  "timeline.details.provider": "Sağlayıcı",
  "timeline.details.model": "Model",
  "timeline.details.started": "Başlangıç",
  "timeline.details.finished": "Bitiş",
  "timeline.details.duration": "Süre",
  "timeline.details.totalCost": "Toplam maliyet",
  "timeline.details.tokens": "Jetonlar",
  "timeline.details.tokens.summary": "Girdi {{input}} · Çıktı {{output}} · Akıl yürütme {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Önbellek R {{read}} · W {{write}} · İsabet oranı {{rate}}",
}
