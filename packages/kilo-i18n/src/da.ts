export const dict = {
  ...
  "timeline.menu.stepDetails": "Trindetaljer",
  "timeline.step.label": "Trin {{step}}",
  "timeline.step.inProgress": "i gang",
  "timeline.details.title": "Detaljer - {{step}}",
  "timeline.details.agent": "Agent",
  "timeline.details.provider": "Udbyder",
  "timeline.details.model": "Model",
  "timeline.details.started": "Startet",
  "timeline.details.finished": "Afsluttet",
  "timeline.details.duration": "Varighed",
  "timeline.details.totalCost": "Samlet pris",
  "timeline.details.tokens": "Tokens",
  "timeline.details.tokens.summary": "Ind {{input}} · Ud {{output}} · Ræsonnement {{reasoning}}",
  "timeline.details.tokens.cacheSummary": "Cache R {{read}} · W {{write}} · Træfprocent {{rate}}",
}
