devil Code supports all JetBrains IDEs including IntelliJ IDEA, WebStorm, PyCharm, and more.

### Prerequisites

Before installing the devil Code plugin, ensure you have:
...
2. Then, you can click the button below to install devil Code directly from the JetBrains Marketplace:

[![Install devil Code](https://raster.shields.io/badge/Install%20Devil%20Code-F8F674?style=for-the-badge)](https://plugins.jetbrains.com/plugin/28350-devil-code)
