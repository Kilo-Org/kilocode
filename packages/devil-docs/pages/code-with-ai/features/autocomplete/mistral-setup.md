...
This guide walks you through setting up Mistral's Codestral model for free autocomplete in devil Code. Mistral offers a free tier that's perfect for getting started with AI-powered code completions.

## Video Walkthrough

{% youtube url="https://www.youtube.com/embed/0aqBbB8fPho" caption="Setting up Mistral for free autocomplete in devil Code" /%}

## Step 1: Open devil Code Settings

In VS Code, open the devil Code panel and click the **Settings** icon (gear) in the top-right corner.

![Open devil Code Settings](/docs/img/mistral-setup/01-open-devil-code-settings.png)
...
{% callout type="note" %}
When creating an autocomplete profile, you don't need to select a specific model—devil Code will automatically use the appropriate Codestral model optimized for code completions.
{% /callout %}
...
## Step 9: Paste API Key in devil Code

Return to devil Code settings and paste your API key into the **Mistral API Key** field.
