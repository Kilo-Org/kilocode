...
description: "Connect your DevilClaw agent to 1Password to securely manage credentials"
---

# 1Password Integration Guide

Connect your DevilClaw agent to 1Password to securely manage credentials. This allows your agent to fetch API keys or passwords without ever seeing them in plain text.
...
2. Create a **New Vault** (e.g., name it `devil-Agent-Vault`).
...
## Step 3: Configure DevilClaw

1. Navigate to your DevilClaw dashboard: [app.devil.ai/claw](https://app.devil.ai/claw).
