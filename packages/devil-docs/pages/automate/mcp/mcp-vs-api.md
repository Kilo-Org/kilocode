...
## Why devil Code Uses MCP

devil Code leverages MCP to provide:
...
MCP creates a universal connector between devil Code and external services, with REST APIs often powering those services behind the scenes.
