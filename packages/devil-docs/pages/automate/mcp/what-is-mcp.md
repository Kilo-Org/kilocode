...
devil Code implements the Model Context Protocol to:
...
- [Using MCP in devil Code](using-in-devil-code) - Get started with MCP in devil Code, including creating simple servers
