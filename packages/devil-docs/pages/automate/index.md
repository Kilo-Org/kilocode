---
title: "Automate"
description: "Automate your development workflows with devil Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend devil Code's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect devil Code to external tools and services:
...
- [**Using MCP in devil Code**](/docs/automate/mcp/using-in-devil-code) — Configuration guide
...
Connect devil Code with your development tools:
...
Customize and extend devil Code's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-devil-code) for external integrations
