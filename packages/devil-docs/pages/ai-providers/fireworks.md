---
title: Fireworks AI with devil Code
---

# Using Fireworks AI With devil Code
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "devil Code").
