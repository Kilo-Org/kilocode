...
# Using v0 With devil Code

devil Code supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with devil Code through the familiar OpenAI API interface.

## Prerequisites

To use v0 with devil Code, you'll need:
...
Setting up v0 in devil Code is straightforward:

1. In devil Code settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in devil Code settings" width="600" /> -->
