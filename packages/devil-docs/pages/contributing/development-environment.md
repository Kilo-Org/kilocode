...
{% callout type="info" %}
**New versions of the VS Code extension and CLI are being developed in [Devil-Org/devilcode](https://github.com/Devil-Org/devilcode)** (extension at `packages/devil-vscode`, CLI at `packages/opencode`). For extension and CLI development, please head over to that repository.
{% /callout %}
...
1. **Fork and Clone the Repository**:
   - **Fork the Repository**:
     - Visit the [devil Code GitHub repository](https://github.com/Devil-Org/devilcode)
     - Click the "Fork" button in the top-right corner to create your own copy.
   - **Clone Your Fork**:
     ```bash
     git clone https://github.com/[YOUR-USERNAME]/devilcode.git
     cd devilcode
     ```
...
2. This will open a new VSCode window with devil Code loaded
...
```bash
code --install-extension "$(ls -1v bin/devil-code-*.vsix | tail -n1)"
```
...
devil Code uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "devil Code" from the dropdown
