...
Add your own Mistral Codestral API key via **BYOK (Bring Your Own Key)** on the devil Gateway. Mistral offers a free tier for Codestral, and when you configure a BYOK key, autocomplete requests are routed using your key — billed directly by Mistral at $0 on your devil balance.
