---
title: "Installation"
description: "How to install devil Code on your system"
---

# Installation

Get started with devil Code by installing it on your preferred platform. Choose your development environment below:
...
The current devil Code extension is built on the [devil CLI](https://github.com/Devil-Org/devilcode) and is distributed as the **pre-release version** on the VS Code Marketplace.
...
The legacy extension is the previous version of devil Code for VS Code. It is still available but is no longer actively developed. We recommend installing the current extension (see the **VS Code** tab).
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [devil Code page on Open VSX Registry](https://open-vsx.org/extension/devilcode/devil-Code).
...
4. Search for "devil Code"
5. Select "devil Code" and click **Install**
...
1. **Download the VSIX file:**
   - Find official releases on the [devil Code GitHub Releases page](https://github.com/Devil-Org/devilcode/releases)
   - Download the `.vsix` file from the [latest release](https://github.com/Devil-Org/devilcode/releases/latest)
...
1. Open the [devil Code GitHub Releases page](https://github.com/Devil-Org/devilcode/releases)
...
{% image src="/docs/img/installing-vsix.png" alt="Installing devil Code using VS Code's Install from VSIX dialog" width="600px" caption="Installing devil Code using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify devil Code is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "devil Code")
...
- [Your First Task](/docs/code-with-ai/agents/chat-interface) - Learn the basics of working with devil Code
...
- Submit issues on [GitHub](https://github.com/Devil-Org/devilcode/issues)
