---
title: "Deploy"
description: "Deploy your applications with devil Code"
---

# Deploy

devil Deploy lets you ship **Next.js** and **static sites** directly from devil Code, with:

- **One-click deployment** from the devil Code dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to devil Code
...
- Navigate to your [Organization dashboard](https://app.devil.ai/organizations) or [Profile](https://app.devil.ai/profile)
...
devil Deploy does **not** include built-in database hosting, but you can connect to any external database service.

---

## Environment Variables

devil Deploy supports Environment Variables and Secrets. Add the variable **key** and **value** during the **Create New Deployment** step, and toggle to mark as secrets.
