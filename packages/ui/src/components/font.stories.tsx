...
const docs = `### Overview
Loads Devil typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Devil Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Devil Mono Sample</div>
    </div>
  ),
}
