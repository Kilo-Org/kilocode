export const dict = {
  ...
  "ui.permission.globalHint": '"Toujours autoriser" sera enregistré dans vos paramètres globaux.',
  "ui.permission.confirmRuleHint": "Cette règle sera enregistrée dans vos paramètres globaux.",
