export const dict = {
  ...
  "ui.permission.globalHint": '"Permitir sempre" será salvo nas suas configurações globais.',
  "ui.permission.confirmRuleHint": "Esta regra será salva nas suas configurações globais.",
