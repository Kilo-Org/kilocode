...
export const dict: Record<Keys, string> = {
  ...
  "ui.permission.globalHint": '"Tillat alltid" lagres i dine globale innstillinger.',
  "ui.permission.confirmRuleHint": "Denne regelen lagres i dine globale innstillinger.",
