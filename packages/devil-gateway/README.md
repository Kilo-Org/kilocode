...
```bash
bun add @devilcode/kilo-gateway
```
...
```typescript
import { KiloAuthPlugin } from "@devilcode/kilo-gateway"
...
```typescript
import { createKilo } from "@devilcode/kilo-gateway"
...
```typescript
import { fetchProfile, fetchBalance } from "@devilcode/kilo-gateway"
