...
export const zaiCodingModels = {
	"glm-4.5": {
		...
		description:
			"GLM-4.5 is a model with comprehensive capabilities in reasoning, coding, and agent reach the state-of-the-art (SOTA) level among open-source models, with a context length of up to 128k.",
	},
	"glm-4.5v": {
		maxTokens: 64_000,
