...
export const gptChatByDefaultModelId: GptChatByModelId = "coder"
...
export const gptChatByModels = {
	...
	"turbo-reasoning": {
		...
		supportsPromptCache: false,
		inputPrice: 0.05 * GTP_CHAT_BY_TAKE_PROFIT_USD, // $0.28 per million tokens (cache miss) - Updated Oct 29, 2025
		outputPrice: 0.5 * GTP_CHAT_BY_TAKE_PROFIT_USD, // $0.42 per million tokens - Updated Oct 29, 2025
		cacheWritesPrice: 0,
		cacheReadsPrice: 0,
		description: `Turbo reasoning - Fast model with reasoning model.`,
	},
	"plus": {
		maxTokens: 32_000,
		contextWindow: 1_000_000,
	...
	"plus-reasoning": {
		...
		inputPrice: 0.4 * GTP_CHAT_BY_TAKE_PROFIT_USD, //  Updated Oct 29, 2025
		outputPrice: 4 * GTP_CHAT_BY_TAKE_PROFIT_USD, // Updated Oct 29, 2025
		cacheWritesPrice: 0,
		cacheReadsPrice: 0,
		// kilocode_change end
		description: `Plus - High-performance reasoning model with 1M context window for large requests.`,
	},
	"max": {
		maxTokens: 65_000,
