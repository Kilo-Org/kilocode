...
export const deepSeekModels = {
	...
	"deepseek-v3.1": {
		...
		cacheWritesPrice: 0.27, // $0.27 per million tokens (cache miss)
		cacheReadsPrice: 0.07, // $0.07 per million tokens (cache hit).
		description: `DeepSeek-V3.1 is a hybrid model that supports both thinking mode and non-thinking mode. One model supports both thinking mode and non-thinking mode by changing the chat template.`,
	},
	"deepseek-v3.1-reasoner": {
		...
		cacheWritesPrice: 0.55, // $0.55 per million tokens (cache miss)
		cacheReadsPrice: 0.14, // $0.14 per million tokens (cache hit)
		description: `DeepSeek-V3.1 with thinking mode enabled. Achieves comparable answer quality to DeepSeek-R1-0528, while responding more quickly.`,
	},
