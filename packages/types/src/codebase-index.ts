...
export const CODEBASE_INDEX_DEFAULTS = {
	...
	// Parser chunk size settings
	MIN_PARSER_MIN_CHUNK_SIZE: 1,
	MAX_PARSER_MIN_CHUNK_SIZE: 1000,
	DEFAULT_PARSER_MIN_CHUNK_SIZE: 50,
	PARSER_MIN_CHUNK_SIZE_STEP: 1,
	MIN_PARSER_MAX_CHUNK_SIZE: 100,
	MAX_PARSER_MAX_CHUNK_SIZE: 10000,
	DEFAULT_PARSER_MAX_CHUNK_SIZE: 1000,
	PARSER_MAX_CHUNK_SIZE_STEP: 10,
	// kilocode_change end
} as const
...
export const codebaseIndexConfigSchema = z.object({
	...
	codebaseIndexScannerMaxBatchRetries: z
		...
		.optional(),
	codebaseIndexParserMinChunkSize: z
		.number()
		.min(CODEBASE_INDEX_DEFAULTS.MIN_PARSER_MIN_CHUNK_SIZE)
		.max(CODEBASE_INDEX_DEFAULTS.MAX_PARSER_MIN_CHUNK_SIZE)
		.optional(),
	codebaseIndexParserMaxChunkSize: z
		.number()
		.min(CODEBASE_INDEX_DEFAULTS.MIN_PARSER_MAX_CHUNK_SIZE)
		.max(CODEBASE_INDEX_DEFAULTS.MAX_PARSER_MAX_CHUNK_SIZE)
		.optional(),
	// kilocode_change end
