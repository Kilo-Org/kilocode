...
const kilocodeExperimentIds = ["morphFastApply", "speechToText", "workflowDiscovery"] as const // kilocode_change
...
export const experimentsSchema = z.object({
	...
	workflowDiscovery: z.boolean().optional(), // kilocode_change
