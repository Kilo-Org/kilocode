export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kilo kunde inte läsas in", // kilocode_change
  "desktop.recovery.terminated": "Kilo-fönstret avslutades oväntat", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo svarar inte", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Kilo misslyckades", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo är inte installerat i {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Växla vilken Kilo-server som denna app ansluter till.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Kilo i {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Uppdaterar Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Kilo i {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Kilo i {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Uppdatera Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo är redo i {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo är redo.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Installera Kilo i {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Installera Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo är inte installerat", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Kilo kan lägga till en WSL-server", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Kilo kunde inte verifiera WSL på den här maskinen.", // kilocode_change
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Kilo igen.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop är nu uppbyggt kring flikar.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Kilo ({{version}}) är nu tillgänglig att installera.", // kilocode_change
  ...
  "error.page.report.prefix": "Rapportera det här felet till Kilo-teamet", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Kilo stöder inte MCP-autentisering ännu.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo innehåller gratis modeller så att du kan börja direkt.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Kör Kilo-servern inuti WSL på Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Anpassa hur Kilo ser ut på din enhet", // kilocode_change
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Kilo följer system-, ljus- eller mörktemat", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Kilo startas", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Kilo.", // kilocode_change
