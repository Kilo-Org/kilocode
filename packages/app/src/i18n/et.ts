export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kilo laadimine ebaõnnestus", // kilocode_change
  "desktop.recovery.terminated": "Kilo aken suleti ootamatult", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo ei vasta", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo installimine ebaõnnestus", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo pole installitud asukohta {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Kilo'is.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Lülitage, millise Kilo serveriga see rakendus ühenduse loob.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo kontrollimine...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kilo kontrollimine asukohas {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo värskendamine...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Kilo värskendamine asukohas {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Värskenda Kilo jaotises {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Värskenda Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo on valmis {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo on valmis.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Installige Kilo asukohta {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Installige Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo pole installitud", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Kilo saab lisada WSL serveri", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Kilo ei saanud selles masinas kontrollida WSL.", // kilocode_change
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Töölaud on nüüd üles ehitatud vahekaartide ümber.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Kilo ({{version}}) uus versioon on nüüd installimiseks saadaval.", // kilocode_change
  ...
  "error.page.report.prefix": "Teatage sellest veast Kilo meeskonnale", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Kilo ei toeta veel MCP autentimist.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo sisaldab tasuta mudeleid, nii et saate kohe alustada.", // kilocode_change
  ...
  "app.name.desktop": "Kilo Töölaud", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Käivitage Kilo server sees WSL saidil Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Muutke Kilo kuvakeelt", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Kilo teie seadmes välja näeb", // kilocode_change
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Kilo järgib süsteemi, heledat või tumedat teemat", // kilocode_change
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Kilo on teemastatud.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Kilo käivitub", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Kilo uusimat versiooni.", // kilocode_change
