export const dict = {
  ...
  "desktop.menu.documentation": "Kilo დოკუმენტაცია", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo მენიუ", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo ვერ ჩაიტვირთა", // kilocode_change
  "desktop.recovery.terminated": "Kilo ფანჯარა მოულოდნელად შეწყდა", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo არ პასუხობს", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo ინსტალაცია ვერ მოხერხდა", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo არ არის დაინსტალირებული {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Kilo-ში.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები Kilo-ში.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Kilo-ში.", // kilocode_change
  ...
  "dialog.server.description": "გადართეთ რომელ Kilo სერვერს უკავშირდება ეს აპი.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია Kilo-ში {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "განახლება Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Kilo განახლება ხდება {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "განახლება Kilo {{distro}}-ში.", // kilocode_change
  "wsl.onboarding.updateOpencode": "განახლება Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo მზად არის {{distro}}-ში.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo მზად არის.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ Kilo {{distro}}-ში.", // kilocode_change
  "wsl.onboarding.installOpencode": "დააინსტალირეთ Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo არ არის დაინსტალირებული", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ Kilo შეძლებს WSL სერვერის დამატებას", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "Kilo ვერ დაადასტურა WSL ამ მოწყობილობაზე.", // kilocode_change
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.", // kilocode_change
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა Kilo გუნდს", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, Kilo ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.", // kilocode_change
  ...
  "app.name.desktop": "Kilo სამუშაო მაგიდა", // kilocode_change
  ...
  "settings.desktop.wsl.description": "გაუშვით Kilo სერვერი WSL-ში Windows-ზე.", // kilocode_change
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება Kilo თქვენს მოწყობილობაზე", // kilocode_change
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა Kilo სისტემას, ღია თუ ბნელ თემას", // kilocode_change
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის Kilo თემატური.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც Kilo გაშვება", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ Kilo-ის უახლეს ვერსიას.", // kilocode_change
