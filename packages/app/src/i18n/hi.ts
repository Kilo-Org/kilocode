export const dict = {
  ...
  "desktop.menu.documentation": "Kilo दस्तावेज़", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo मेन्यू", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo लोड नहीं हो सका", // kilocode_change
  "desktop.recovery.terminated": "Kilo विंडो अनपेक्षित रूप से बंद हो गई", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo प्रतिसाद नहीं दे रहा है", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo इंस्टॉल नहीं हो सका", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Kilo इंस्टॉल नहीं है", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo द्वारा उपलब्ध निःशुल्क मॉडल", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Kilo में {{provider}} मॉडल का उपयोग करें।", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Kilo में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Kilo में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।", // kilocode_change
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Kilo सर्वर से कनेक्ट होता है।", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo की जाँच हो रही है...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Kilo की जाँच हो रही है...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo अपडेट हो रहा है...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Kilo अपडेट हो रहा है...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Kilo को अपडेट करें।", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo को अपडेट करें", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo {{distro}} में तैयार है।", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo तैयार है।", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Kilo स्थापित करें।", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo स्थापित करें", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo स्थापित नहीं है", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kilo द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Kilo इस मशीन पर WSL को सत्यापित नहीं कर सका।", // kilocode_change
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Kilo को फिर से खोलें।", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop अब टैब पर आधारित है।", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।", // kilocode_change
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Kilo टीम को करें", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Kilo अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Kilo सर्वर चलाएँ।", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo के लिए प्रदर्शन भाषा बदलें", // kilocode_change
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Kilo आपके डिवाइस पर कैसा दिखता है", // kilocode_change
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Kilo सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे", // kilocode_change
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Kilo की थीम कैसी है।", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo लॉन्च होने पर अपने-आप अपडेट की जाँच करें", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "आप Kilo का नवीनतम संस्करण चला रहे हैं।", // kilocode_change
