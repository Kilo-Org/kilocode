export const dict = {
  ...
  "desktop.menu.documentation": "مستندات Kilo", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "منوی Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo بارگیری نشد", // kilocode_change
  "desktop.recovery.terminated": "پنجره Kilo به طور غیرمنتظره ای خاتمه یافت", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo پاسخ نمی دهد", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "نصب Kilo انجام نشد", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo در {{distro}} نصب نشده است", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "به‌روزرسانی Kilo به پایان رسید، اما {{distro}} همچنان {{installed}} را گزارش می‌کند. مورد انتظار {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "مدل های رایگان ارائه شده توسط Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "کلید API سرویس {{provider}} را وارد کنید تا حساب شما متصل شود و بتوانید از مدل‌های {{provider}} در Kilo استفاده کنید.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " برای جمع آوری کد مجوز برای اتصال حساب خود و استفاده از مدل های {{provider}} در Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " و کد زیر را برای اتصال اکانت خود وارد کنید و از مدل های {{provider}} در Kilo استفاده کنید.", // kilocode_change
  ...
  "dialog.server.description": "این برنامه به کدام سرور Kilo متصل است، تغییر دهید.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "در حال بررسی Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "بررسی Kilo در {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "در حال به روز رسانی Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "به روز رسانی Kilo در {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Kilo را در {{distro}} به روز کنید.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo را به روز کنید", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo در {{distro}} آماده است.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo آماده است.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Kilo را در {{distro}} نصب کنید.", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo را نصب کنید", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo نصب نشده است", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (زیر سیستم Windows برای Linux) قبل از اینکه Kilo بتواند یک سرور WSL اضافه کند لازم است", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL در دسترس نیست",
  "wsl.onboarding.wslUnavailable.description": "Kilo نتوانست WSL را در این دستگاه تأیید کند.", // kilocode_change
  "wsl.onboarding.installWsl": "WSL را نصب کنید",
  "wsl.onboarding.windowsRestartRequired":
    "Windows را مجددا راه اندازی کنید تا نصب WSL به پایان برسد، سپس Kilo را دوباره باز کنید.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop اکنون در اطراف زبانه ها ساخته شده است.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "نسخه جدیدی از Kilo ({{version}}) اکنون برای نصب در دسترس است.", // kilocode_change
  ...
  "error.page.report.prefix": "لطفاً این خطا را به تیم Kilo گزارش دهید", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'سرور MCP "{{name}}" ناموفق بود. توجه داشته باشید، Kilo هنوز از احراز هویت MCP پشتیبانی نمی کند.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo شامل مدل های رایگان است، بنابراین می توانید بلافاصله شروع کنید.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "سرور Kilo را در داخل WSL روی Windows اجرا کنید.", // kilocode_change
  ...
  "settings.general.row.language.description": "زبان نمایش را برای Kilo تغییر دهید", // kilocode_change
  ...
  "settings.general.row.appearance.description": "نحوه ظاهر Kilo را در دستگاه خود سفارشی کنید", // kilocode_change
  "settings.general.row.colorScheme.title": "طرح رنگ",
  "settings.general.row.colorScheme.description": "انتخاب کنید که آیا Kilo از تم سیستمی، روشن یا تیره پیروی می کند", // kilocode_change
  "settings.general.row.theme.title": "موضوع",
  "settings.general.row.theme.description": "نحوه مضمون سازی Kilo را سفارشی کنید.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "هنگام راه‌اندازی Kilo، به‌روزرسانی‌ها را به‌طور خودکار بررسی کنید", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "شما آخرین نسخه Kilo را اجرا می کنید.", // kilocode_change
