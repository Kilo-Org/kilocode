export const dict = {
  ...
  "desktop.menu.documentation": "Документація Kilo", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Меню Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Kilo", // kilocode_change
  "desktop.recovery.terminated": "Роботу вікна Kilo несподівано завершено", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo не відповідає", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Kilo", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo не встановлено в {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Оновлення Kilo завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Перемкніть сервер Kilo, до якого підключається ця програма.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Kilo у {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Оновлення Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Kilo у {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Оновіть Kilo у {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Оновити Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo готовий до роботи у {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo готовий до роботи.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Встановіть Kilo у {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Встановити Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo не встановлено", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Kilo потрібна WSL (Підсистема Windows для Linux)", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Kilo не вдалося перевірити WSL на цьому комп'ютері.", // kilocode_change
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop тепер побудовано навколо вкладок.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Kilo ({{version}}) тепер доступна для встановлення.", // kilocode_change
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Kilo ще не підтримує автентифікацію MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo містить безкоштовні моделі, тому ви можете почати негайно.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Запускати сервер Kilo всередині WSL на Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Kilo на вашому пристрої", // kilocode_change
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Kilo використовує системну, світлу або темну тему", // kilocode_change
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Kilo.", // kilocode_change
