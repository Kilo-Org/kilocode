export const dict = {
  ...
  "desktop.menu.documentation": "Kilo Dokumentacija", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo ni uspelo naložiti", // kilocode_change
  "desktop.recovery.terminated": "Okno Kilo se je nepričakovano končalo", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo se ne odziva", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Kilo ni uspela", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo ni nameščen v {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Posodobitev Kilo je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Kilo se povezuje ta aplikacija.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Kilo ...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Kilo v {{distro}} ...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Posodabljanje Kilo ...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Kilo v {{distro}} ...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Posodobite Kilo v {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Posodobite Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo je pripravljen v {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo je pripravljen.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Namestite Kilo v {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Namestite Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo ni nameščen", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Kilo doda strežnik WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Kilo ni mogel preveriti WSL na tej napravi.", // kilocode_change
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop je zdaj zgrajen okoli zavihkov.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Kilo ({{version}}) je zdaj na voljo za namestitev.", // kilocode_change
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Kilo še ne podpira avtentikacije MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo vključuje brezplačne modele, tako da lahko začnete takoj.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Kilo znotraj WSL na Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Kilo izgleda na vaši napravi", // kilocode_change
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Kilo sledi sistemski, svetli ali temni temi", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Kilo.", // kilocode_change
