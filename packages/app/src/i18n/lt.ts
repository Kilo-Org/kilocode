...
const desktop = [
  ...
  "Suskleisti",
  "Išskleisti",
  "Kilo dokumentacija", // kilocode_change
  "Pagalbos forumas",
  "Pateikti atsiliepimą",
  "Pranešti apie klaidą",
  "Kilo meniu", // kilocode_change
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Kilo įkelti nepavyko", // kilocode_change
  "Kilo langas netikėtai užsidarė", // kilocode_change
  "Kilo neatsako", // kilocode_change
  ...
  "Kilo įdiegti nepavyko", // kilocode_change
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Kilo neįdiegtas distributyve {{distro}}", // kilocode_change
  "Kilo naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}", // kilocode_change
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Kilo modeliai", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Perjunkite, prie kurio Kilo serverio jungiasi ši programa.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Kilo {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Kilo {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Kilo {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Atnaujinkite Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo yra paruoštas {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo yra paruoštas.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Įdiekite Kilo į {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Įdiekite Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo neįdiegtas", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Kilo galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Kilo nepavyko patikrinti WSL šiame įrenginyje.", // kilocode_change
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop dabar sukurtas iš skirtukų.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Kilo ({{version}}) versiją.", // kilocode_change
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Kilo komandai", // kilocode_change
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Kilo dar nepalaiko MCP autentifikavimo.", // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo apima nemokamus modelius, todėl galite pradėti iš karto.", // kilocode_change
  ...
  "app.name.desktop": "Kilo darbalaukis", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Paleiskite Kilo serverį WSL viduje Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Pakeiskite Kilo ekrano kalbą", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Kilo atrodo jūsų įrenginyje", // kilocode_change
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Kilo seka sistemos, šviesios ar tamsios temos", // kilocode_change
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Kilo temą.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Kilo versiją.", // kilocode_change
