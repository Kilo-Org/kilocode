...
export const dict = {
  ...
  "desktop.menu.documentation": "Kilo-dokumentasjon", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo-meny", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo kunne ikke lastes inn", // kilocode_change
  "desktop.recovery.terminated": "Kilo-vinduet ble uventet avsluttet", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo svarer ikke", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Kilo mislyktes", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo er ikke installert i {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Kilo er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Bytt hvilken Kilo-server denne appen kobler til.", // kilocode_change
  ...
  "toast.update.description": "En ny versjon av Kilo ({{version}}) er nå tilgjengelig for installasjon.", // kilocode_change
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Kilo-teamet", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Kilo ikke støtter MCP-autentisering ennå.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo inkluderer gratis modeller så du kan starte umiddelbart.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Kjør Kilo-serveren i WSL på Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Kilo", // kilocode_change
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Kilo ser ut på enheten din", // kilocode_change
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Kilo skal følge systeminnstillingen eller bruke lyst eller mørkt tema", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Kilo starter", // kilocode_change
  ...
  "settings.updates.toast.latest.title": "Kilo er oppdatert", // kilocode_change
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Kilo.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Kilo i {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Oppdaterer Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Kilo i {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Oppdater Kilo i {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Oppdater Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo er klar i {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo er klar.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Installer Kilo i {{distro}}.", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo er ikke installert", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Kilo kan legge til en WSL-server", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Kilo kunne ikke bekrefte WSL på denne maskinen.", // kilocode_change
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Kilo på nytt.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop er nå bygget rundt faner.", // kilocode_change
  "help.tabs.sessions":
