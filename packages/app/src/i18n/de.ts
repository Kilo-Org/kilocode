...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Kilo zu nutzen.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Kilo zu nutzen.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Kilo zu nutzen.", // kilocode_change
  ...
  "dialog.server.description": "Wechseln Sie den Kilo-Server, mit dem sich diese App verbindet.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo wird geprüft…", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kilo in {{distro}} wird geprüft…", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo wird aktualisiert…", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Kilo in {{distro}} wird aktualisiert…", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Kilo in {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo aktualisieren", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo ist in {{distro}} bereit.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo ist bereit.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Kilo in {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo installieren", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo nicht installiert", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Kilo einen WSL-Server hinzufügen kann", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Kilo konnte WSL auf diesem Computer nicht überprüfen.", // kilocode_change
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Kilo erneut.", // kilocode_change
  ...
  "toast.update.description": "Eine neue Version von Kilo ({{version}}) ist zur Installation verfügbar.", // kilocode_change
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Kilo-Team", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Kilo unterstützt noch keine MCP-Authentifizierung.', // kilocode_change
  ...
  "home.providerTip":
    "Kilo mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen", // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo enthält kostenlose Modelle, damit Sie sofort loslegen können.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Kilo-Server innerhalb von WSL unter Windows ausführen.", // kilocode_change
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Kilo ändern", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Kilo auf Ihrem Gerät aussieht", // kilocode_change
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Kilo dem System-, hellen oder dunklen Thema folgt", // kilocode_change
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Kilo anpassen.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Beim Start von Kilo automatisch nach Updates suchen", // kilocode_change
  ...
  "settings.updates.toast.latest.title": "Kilo ist auf dem neuesten Stand", // kilocode_change
  "settings.updates.toast.latest.description": "Die aktuelle Version von Kilo wird verwendet.", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo konnte nicht geladen werden", // kilocode_change
  "desktop.recovery.terminated": "Das Kilo-Fenster wurde unerwartet beendet", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo reagiert nicht", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo-Installation fehlgeschlagen", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo ist in {{distro}} nicht installiert", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Das Kilo-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop basiert jetzt auf Tabs.", // kilocode_change
  "help.tabs.sessions":
