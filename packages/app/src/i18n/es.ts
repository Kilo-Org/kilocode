export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Kilo", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Menú de Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Kilo", // kilocode_change
  "desktop.recovery.terminated": "La ventana de Kilo se cerró de forma inesperada", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo no responde", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Kilo", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo no está instalado en {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "La actualización de Kilo finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Cambiar el servidor de Kilo al que se conecta esta aplicación.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Kilo en {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Actualizando Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Kilo en {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Actualiza Kilo en {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Actualizar Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo está listo en {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo está listo.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Instala Kilo en {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instalar Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo no está instalado", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Kilo pueda añadir un servidor WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Kilo no pudo comprobar WSL en este equipo.", // kilocode_change
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop ahora se organiza en torno a pestañas.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Kilo ({{version}}) está disponible para instalar.", // kilocode_change
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Kilo aún no admite la autenticación MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo incluye modelos gratuitos para que puedas empezar inmediatamente.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Kilo dentro de WSL en Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Kilo en tu dispositivo", // kilocode_change
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Kilo sigue el tema del sistema, claro u oscuro", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Kilo.", // kilocode_change
