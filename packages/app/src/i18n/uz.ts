export const dict = {
  ...
  "desktop.menu.documentation": "Kilo hujjatlari", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo menyusi", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo yuklanmadi", // kilocode_change
  "desktop.recovery.terminated": "Kilo oynasi kutilmaganda tugatildi", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo javob bermayapti", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo oʻrnatilmadi", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo {{distro}} da o'rnatilmagan", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo tomonidan taqdim etilgan bepul modellar", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Kilo’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Kilo da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Kilo da {{provider}} modellaridan foydalaning.", // kilocode_change
  ...
  "dialog.server.description": "Ushbu ilova qaysi Kilo serveriga ulanishini almashtiring.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo tekshirilmoqda...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kilo {{distro}} da tekshirilmoqda...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo yangilanmoqda...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Kilo {{distro}} da yangilanmoqda...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Kilo-ni {{distro}}-da yangilang.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo-ni yangilang", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo {{distro}} da tayyor.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo tayyor.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Kilo-ni {{distro}}-ga o'rnating.", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo-ni o'rnating", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo o'rnatilmagan", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kilo WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Kilo WSL ni ushbu mashinada tasdiqlay olmadi.", // kilocode_change
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Kilo-ni qayta oching.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop endi yorliqlar atrofida qurilgan.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo ({{version}}) yangi versiyasi endi oʻrnatish mumkin.", // kilocode_change
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Kilo jamoasiga xabar bering", // kilocode_change
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Kilo hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.", // kilocode_change
  ...
  "sidebar.gettingStarted.line1":
    "Kilo bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Kilo serverini ishga tushiring.", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo uchun ekran tilini o'zgartiring", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Kilo qurilmangizda qanday koʻrinishini sozlang", // kilocode_change
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Kilo tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang", // kilocode_change
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Kilo mavzusini sozlash.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo ishga tushganda avtomatik ravishda yangilanishlarni tekshiring", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Siz Kilo oxirgi versiyasini ishga tushiryapsiz.", // kilocode_change
