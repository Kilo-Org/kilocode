export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo에서 제공하는 무료 모델", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Kilo에서 {{provider}} 모델을 사용하세요.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Kilo에서 {{provider}} 모델을 사용하세요.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Kilo에서 {{provider}} 모델을 사용하세요.", // kilocode_change
  ...
  "dialog.server.description": "이 앱이 연결할 Kilo 서버를 전환합니다.", // kilocode_change
  ...
  "toast.update.description": "Kilo의 새 버전({{version}})을 설치할 수 있습니다.", // kilocode_change
  ...
  "error.page.report.prefix": "이 오류를 Kilo 팀에 제보해 주세요: ", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Kilo는 아직 MCP 인증을 지원하지 않습니다.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Kilo 서버를 실행합니다.", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo 표시 언어 변경", // kilocode_change
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Kilo가 보이는 방식 사용자 지정", // kilocode_change
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Kilo가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요", // kilocode_change
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Kilo 테마 사용자 지정", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo를 실행할 때 업데이트를 자동으로 확인합니다", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Kilo를 사용 중입니다.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo 확인 중...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Kilo 확인 중...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo 업데이트 중...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Kilo 업데이트 중...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Kilo를 업데이트하세요.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo 업데이트", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 Kilo를 사용할 준비가 되었습니다.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo가 준비되었습니다.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Kilo를 설치하세요.", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo 설치", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo가 설치되지 않음", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kilo에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Kilo에서 이 컴퓨터의 WSL을 확인할 수 없습니다.", // kilocode_change
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Kilo를 다시 여세요.", // kilocode_change
  ...
  "help.tabs.introduction": "이제 Kilo Desktop은 탭을 중심으로 구성됩니다.", // kilocode_change
  "help.tabs.sessions":
  ...
  "desktop.menu.documentation": "Kilo 문서", // kilocode_change
  "desktop.menu.supportForum": "지원 포럼",
  "desktop.menu.shareFeedback": "피드백 보내기",
  "desktop.menu.reportBug": "버그 신고",
  "desktop.menu.ariaLabel": "Kilo 메뉴", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo를 불러오지 못했습니다", // kilocode_change
  "desktop.recovery.terminated": "Kilo 윈도우가 예기치 않게 종료되었습니다", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo가 응답하지 않습니다", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo 설치 실패", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 Kilo가 설치되어 있지 않습니다", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}", // kilocode_change
