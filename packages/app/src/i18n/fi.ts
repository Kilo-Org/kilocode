export const dict = {
  ...
  "dialog.server.description": "Vaihda Kilo-palvelimeen, johon tämä sovellus muodostaa yhteyden.", // kilocode_change
  ...
  "wsl.onboarding.updateOpencodeIn": "Päivitä Kilo jakelussa {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Päivitä Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo on valmis jakelussa {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo on valmis.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Asenna Kilo jakeluun {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Asenna Kilo", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Kilo voi lisätä WSL-palvelimen", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Kilo ei voinut vahvistaa WSL:ää tällä koneella.", // kilocode_change
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Kilo uudelleen.", // kilocode_change
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Kilo-tiimille", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Kilo ei vielä tue MCP-todennusta.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo sisältää ilmaisia malleja, joten voit aloittaa heti.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Suorita Kilo-palvelin WSL:n sisällä Windowsissa.", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Kilo näyttää laitteellasi", // kilocode_change
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Kilo järjestelmän mukaista, vaaleaa vai tummaa teemaa", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Kilo käynnistyy", // kilocode_change
  ...
  "desktop.menu.documentation": "Kilo-dokumentaatio", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo-valikko", // kilocode_change
  ...
  "desktop.recovery.terminated": "Kilo-ikkuna sulkeutui odottamatta", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo ei vastaa", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop perustuu nyt välilehtiin.", // kilocode_change
  "help.tabs.sessions":
