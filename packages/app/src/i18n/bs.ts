export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Kilo", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo meni", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo se nije uspio učitati", // kilocode_change
  "desktop.recovery.terminated": "Prozor Kilo-a neočekivano je zatvoren", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo ne reaguje", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Kilo-a nije uspjela", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo nije instaliran u distribuciji {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Kilo-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Kilo-u.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Kilo-u.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Kilo-u.", // kilocode_change
  ...
  "dialog.server.description": "Promijeni na koji se Kilo server ova aplikacija povezuje.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Provjera Kilo u distribuciji {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Ažuriranje Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Kilo u distribuciji {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Kilo u distribuciji {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Ažuriraj Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo je spreman u distribuciji {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo je spreman.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Instaliraj Kilo u distribuciji {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instaliraj Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo nije instaliran", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Kilo mogao dodati WSL server", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Kilo nije mogao provjeriti WSL na ovom uređaju.", // kilocode_change
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop sada je organizovan oko kartica.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Kilo-a ({{version}}) je dostupna za instalaciju.", // kilocode_change
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Kilo timu", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Kilo još ne podržava MCP autentifikaciju.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo uključuje besplatne modele, tako da možeš odmah početi.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Pokreni Kilo server unutar WSL-a na Windowsu.", // kilocode_change
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Kilo-u", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Kilo izgleda na tvom uređaju", // kilocode_change
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Kilo prati sistemsku, svijetlu ili tamnu temu", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Kilo-a.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Kilo pokrene", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Kilo-a.", // kilocode_change
