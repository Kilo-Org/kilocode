export const dict = {
  ...
  "desktop.menu.documentation": "Kilo Փաստաթղթեր", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo մենյու", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo չհաջողվեց բեռնել", // kilocode_change
  "desktop.recovery.terminated": "Kilo պատուհանն անսպասելիորեն ավարտվեց", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo-ը չի արձագանքում", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo տեղադրումը ձախողվեց", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo տեղադրված չէ {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Kilo-ում {{provider}} մոդելներ օգտագործելու համար։", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Kilo-ում {{provider}} մոդելներ օգտագործելու համար:", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Kilo-ում {{provider}} մոդելներ օգտագործելու համար:", // kilocode_change
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Kilo սերվերին է միանում այս հավելվածը։", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Kilo-ը {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Kilo-ը {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Kilo-ը {{distro}}-ում։", // kilocode_change
  "wsl.onboarding.updateOpencode": "Թարմացնել Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo պատրաստ է {{distro}}-ում։", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo պատրաստ է։", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Kilo-ը {{distro}}-ում։", // kilocode_change
  "wsl.onboarding.installOpencode": "Տեղադրեք Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo տեղադրված չէ", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Kilo-ը կարողանա ավելացնել WSL սերվեր", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Kilo-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։", // kilocode_change
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Kilo։", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop-ն այժմ կառուցված է ներդիրների շուրջ։", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:", // kilocode_change
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Kilo թիմին", // kilocode_change
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Kilo-ը դեռ չի աջակցում MCP նույնականացումը:", // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Գործարկեք Kilo սերվերը WSL-ի ներսում՝ Windows-ում։", // kilocode_change
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Kilo տեսքը ձեր սարքում", // kilocode_change
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Kilo-ը հետևում է համակարգին, թեթև թե մուգ թեմային", // kilocode_change
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Kilo-ի թեմատիկությունը։", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Kilo-ը գործարկվի", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Kilo-ի վերջին տարբերակը։", // kilocode_change
