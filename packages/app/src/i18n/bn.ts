export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Kilo ডকুমেন্টেশন", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo মেনু", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo লোড হতে ব্যর্থ হয়েছে৷", // kilocode_change
  "desktop.recovery.terminated": "Kilo উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo সাড়া দিচ্ছে না", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo ইনস্টলেশন ব্যর্থ হয়েছে৷", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo {{distro}} এ ইনস্টল করা নেই", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি Kilo দ্বারা প্রদত্ত", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং Kilo-এ {{provider}} মডেলগুলি ব্যবহার করুন৷", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি Kilo-এ ব্যবহার করতে।", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি Kilo-এ ব্যবহার করুন৷", // kilocode_change
  ...
  "dialog.server.description": "এই অ্যাপটি কোন Kilo সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo পরীক্ষা করা হচ্ছে...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ Kilo চেক করা হচ্ছে...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ Kilo আপডেট করা হচ্ছে...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ Kilo আপডেট করুন।", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo আপডেট করুন", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo {{distro}}-এ প্রস্তুত।", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo প্রস্তুত।", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ Kilo ইনস্টল করুন।", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo ইনস্টল করুন", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo ইনস্টল করা নেই", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) Kilo একটি WSL সার্ভার যোগ করার আগে প্রয়োজন", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "Kilo এই মেশিনে WSL যাচাই করতে পারেনি।", // kilocode_change
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর Kilo আবার খুলুন।", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷", // kilocode_change
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি Kilo টিমের কাছে রিপোর্ট করুন", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, Kilo এখনও MCP প্রমাণীকরণ সমর্থন করে না।', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।", // kilocode_change
  ...
  "app.name.desktop": "Kilo ডেস্কটপ", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে Kilo সার্ভার চালান।", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন", // kilocode_change
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে Kilo কেমন দেখায় তা কাস্টমাইজ করুন", // kilocode_change
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "Kilo সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন", // kilocode_change
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে Kilo থিম করা হয় তা কাস্টমাইজ করুন।", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "আপনি Kilo এর সর্বশেষ সংস্করণ চালাচ্ছেন।", // kilocode_change
