...
const desktop = [
  ...
  "Kis méret",
  "Teljes méret",
  "Kilo dokumentáció", // kilocode_change
  "Támogatási fórum",
  "Visszajelzés küldése",
  "Hiba jelentése",
  "Kilo menü", // kilocode_change
  ...
  "Kilépés",
  "Az Kilo betöltése sikertelen", // kilocode_change
  "Az Kilo ablaka váratlanul leállt", // kilocode_change
  "Az Kilo nem válaszol", // kilocode_change
  ...
  "Az Kilo telepítése sikertelen", // kilocode_change
  ...
  "Az Kilo nincs telepítve ebben: {{distro}}", // kilocode_change
  "Az Kilo frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}", // kilocode_change
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "A Kilo ingyenes modelljei", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Kilo-ben.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Kilo-ben.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Kilo-ben.", // kilocode_change
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Kilo szerverhez csatlakozzon.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo ellenőrzése...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kilo ellenőrzése a {{distro}}-ben...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo frissítése...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Kilo frissítése a {{distro}}-ben...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Frissítse a Kilo-t a {{distro}}-ben.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Frissítse a Kilo-t", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "A Kilo készen áll a {{distro}}-ben.", // kilocode_change
  "wsl.onboarding.opencodeReady": "A Kilo készen áll.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Telepítse a Kilo-t a {{distro}}-be.", // kilocode_change
  "wsl.onboarding.installOpencode": "Telepítse a Kilo-t", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "A Kilo nincs telepítve", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Kilo hozzáadhasson egy WSL szervert", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Kilo nem tudta ellenőrizni a WSL jelet ezen a gépen.", // kilocode_change
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Kilo programot.", // kilocode_change
  ...
  "help.tabs.introduction": "A Kilo Desktop mostantól lapokra épül.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Kilo ({{version}}) új verziója már telepíthető.", // kilocode_change
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Kilo csapatának", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Kilo még nem támogatja a MCP hitelesítést.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "A Kilo ingyenes modelleket tartalmaz, így azonnal elkezdheti.", // kilocode_change
  ...
  "app.name.desktop": "Kilo asztali számítógép", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Futtassa a Kilo szervert a WSL belsejében a Windows rendszeren.", // kilocode_change
  ...
  "settings.general.row.language.description": "Módosítsa a Kilo kijelző nyelvét", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Kilo az eszközén", // kilocode_change
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Kilo a rendszer, a világos vagy a sötét témát követi-e", // kilocode_change
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Kilo témáját.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "A Kilo indításakor automatikusan ellenőrizze a frissítéseket", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Ön a Kilo legújabb verzióját futtatja.", // kilocode_change
