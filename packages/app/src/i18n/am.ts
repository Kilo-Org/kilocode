export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kilo መጫን አልቻለም", // kilocode_change
  "desktop.recovery.terminated": "Kilo መስኮት በድንገት ተቋርጧል", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo ምላሽ እየሰጠ አይደለም", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kiloመጫኑ አልተሳካም", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo በ{{distro}}] ውስጥ አልተጫነም", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በKilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በKilo ይጠቀሙ።", // kilocode_change
  ...
  "provider.connect.opencodeZen.line1": "Kilo ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በKilo ውስጥ ይጠቀሙ።", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በKilo ይጠቀሙ።", // kilocode_change
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Kilo አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kiloን በ{{distro}} ውስጥ በመፈተሽ ላይ...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Kilo በ{{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "አዘምን Kilo በ{{distro}}።", // kilocode_change
  "wsl.onboarding.updateOpencode": "አዘምን Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo በ{{distro}} ውስጥ ዝግጁ ነው።", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo ዝግጁ ነው።", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "መጫን Kilo በ{{distro}} ውስጥ።", // kilocode_change
  "wsl.onboarding.installOpencode": "ጫን Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kiloአልተጫነም", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Kilo WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Kilo በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።", // kilocode_change
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Kilo።", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የKilo ({{version}}) ስሪት አሁን ለመጫን አለ።", // kilocode_change
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለKilo ቡድን ያሳውቁ", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Kilo እስካሁን MCP ማረጋገጫን አይደግፍም።', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።", // kilocode_change
  ...
  "app.name.desktop": "Kilo ዴስክቶፕ", // kilocode_change
  ...
  "settings.desktop.wsl.description": "የKilo አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።", // kilocode_change
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለKilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Kiloበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ", // kilocode_change
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Kilo ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ", // kilocode_change
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Kilo ገጽታ እንዴት እንደሆነ አብጅ።", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የKilo እትም እያሄዱ ነው።", // kilocode_change
