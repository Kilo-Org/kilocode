export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Kilo", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Menuja Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo nuk u ngarkua", // kilocode_change
  "desktop.recovery.terminated": "Dritarja Kilo u mbyll papritur", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo nuk po përgjigjet", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i Kilo dështoi", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo nuk është i instaluar në {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Kilo përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Ndrysho me cilin server Kilo lidhet ky aplikacion.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon Kilo në {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo po përditësohet...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson Kilo në {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Përditëso Kilo në {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Përditëso Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo është gati në {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo është gati.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Instaloni Kilo në {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instaloni Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo nuk është i instaluar", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Kilo të shtojë një server WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Kilo nuk mund ta verifikonte WSL në këtë makinë.", // kilocode_change
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop tani është ndërtuar rreth skedave.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Kilo ({{version}}) është tani i disponueshëm për t'u instaluar.", // kilocode_change
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Kilo nuk e mbështet ende vërtetimin MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo përfshin modele falas, kështu që mund të filloni menjëherë.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Kilo brenda WSL në Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Kilo në pajisjen tuaj", // kilocode_change
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Kilo ndjek temën e sistemit, të lehtë ose të errët", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Kilo.", // kilocode_change
