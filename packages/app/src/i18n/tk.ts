export const dict = {
  ...
  "desktop.menu.documentation": "Kilo Resminamalar", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo menýusy", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo ýükläp bilmedi", // kilocode_change
  "desktop.recovery.terminated": "Kilo penjiresi garaşylmadyk ýagdaýda bes edildi", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo jogap berenok", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo gurmak şowsuz", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo {{distro}} gurulmady", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo tarapyndan mugt modeller", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Kilo-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Kilo-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Kilo-de ulanmak üçin aşakdaky kody giriziň.", // kilocode_change
  ...
  "dialog.server.description": "Bu programmanyň haýsy Kilo serwerine birikýändigini üýtgediň.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo barlamak ...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Kilo barlanýar...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo täzelenmek ...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de Kilo täzelenmek ...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Kilo-ni {{distro}}-de täzeläň.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo täzeläň", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo {{distro}}-de taýýar.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo taýýar.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de Kilo guruň.", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo guruň", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo gurulmady", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Kilo WSL serwerini goşmazdan ozal talap edilýär", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Kilo bu enjamda WSL barlap bilmedi.", // kilocode_change
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Kilo açyň.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop indi goýmalaryň töwereginde guruldy.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Kilo ({{version}}) -iň täze wersiýasy bar.", // kilocode_change
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Kilo toparyna habar bermegiňizi haýyş edýäris", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Kilo entek MCP tassyklamasyny goldamaýar.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo mugt modelleri öz içine alýar, derrew başlap bilersiňiz.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Kilo serwerini WSL-de Windows-de işlediň.", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo üçin displeý dilini üýtgediň", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Kilo enjamyňyzda nähili görünýändigini düzüň", // kilocode_change
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Kilo ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň", // kilocode_change
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Kilo-iň mowzuklydygyny düzüň.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo işe başlanda täzelenmeleri awtomatiki barlaň", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Kilo-iň iň soňky wersiýasyny işleýärsiňiz.", // kilocode_change
