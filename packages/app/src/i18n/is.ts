...
const desktop = [
  ...
  "Lágmarka",
  "Hámarka",
  "Kilo skjölun", // kilocode_change
  "Aðstoðarspjallborð",
  "Deila ábendingu",
  "Tilkynna villu",
  "Kilo-valmynd", // kilocode_change
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Kilo", // kilocode_change
  "Kilo-glugganum var óvænt lokað", // kilocode_change
  "Kilo svarar ekki", // kilocode_change
  ...
  "Uppsetning Kilo mistókst", // kilocode_change
  ...
  "Kilo er ekki uppsett í {{distro}}", // kilocode_change
  "Uppfærslu Kilo lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}", // kilocode_change
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Skiptu um hvaða Kilo miðlara þetta app tengist.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Athugar Kilo í {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Uppfærir Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Kilo í {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Kilo í {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Uppfærðu Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo er tilbúið í {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo er tilbúinn.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Settu upp Kilo í {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Settu upp Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo ekki uppsett", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Kilo getur bætt við WSL netþjóni", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Kilo gat ekki staðfest WSL á þessari vél.", // kilocode_change
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Kilo aftur.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop er nú byggt í kringum flipa.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Kilo ({{version}}) er nú fáanleg til uppsetningar.", // kilocode_change
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Kilo teymisins", // kilocode_change
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Kilo styður ekki MCP auðkenningu ennþá.", // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo inniheldur ókeypis gerðir svo þú getir byrjað strax.", // kilocode_change
  ...
  "app.name.desktop": "Kilo skjáborð", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Keyrðu Kilo netþjóninn inni í WSL á Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Kilo lítur út á tækinu þínu", // kilocode_change
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Kilo fylgir kerfis-, ljósu eða dökku þema", // kilocode_change
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Kilo er þema.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Kilo ræsir", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Kilo.", // kilocode_change
