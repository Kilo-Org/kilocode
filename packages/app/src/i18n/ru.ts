export const dict = {
  ...
  "desktop.menu.documentation": "Документация Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Kilo", // kilocode_change
  "desktop.recovery.terminated": "Окно Kilo неожиданно завершило работу", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo не отвечает", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить Kilo", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo не установлен в {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Обновление Kilo завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Выберите сервер Kilo, к которому подключается приложение.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Проверка Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Проверка Kilo в {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Обновление Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Обновление Kilo в {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Обновите Kilo в {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Обновить Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo в {{distro}} готов к работе.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo готов к работе.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Установите Kilo в {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Установить Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo не установлен", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Kilo требуется WSL (Подсистема Windows для Linux)", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Kilo не смог проверить WSL на этом компьютере.", // kilocode_change
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Теперь работа в Kilo Desktop организована с помощью вкладок.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Kilo ({{version}}) доступна для установки.", // kilocode_change
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Kilo пока не поддерживает MCP-авторизацию.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo включает бесплатные модели, чтобы вы могли начать сразу.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Запускать сервер Kilo внутри WSL на Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Изменить язык отображения Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Kilo на вашем устройстве", // kilocode_change
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Kilo системной, светлой или тёмной теме", // kilocode_change
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Kilo.", // kilocode_change
