...
export const dict = {
  ...
  "toast.update.description": "Devil'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "settings.desktop.wsl.description": "Devil sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Devil'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Devil'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Devil'un temasını özelleştirin.",
  ...
  "settings.updates.toast.latest.description": "Devil'un en son sürümünü kullanıyorsunuz.",
