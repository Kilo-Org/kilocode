...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kilo yüklenemedi", // kilocode_change
  "desktop.recovery.terminated": "Kilo penceresi beklenmedik şekilde sonlandırıldı", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo yanıt vermiyor", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo kurulamadı", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo, {{distro}} içinde kurulu değil", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo tarafından sunulan ücretsiz modeller", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Kilo'da {{provider}} modellerini kullanmak için API anahtarınızı girin.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Kilo'da {{provider}} modellerini kullanın.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Kilo'da {{provider}} modellerini kullanın.", // kilocode_change
  ...
  "dialog.server.description": "Bu uygulamanın hangi Kilo sunucusuna bağlanacağını değiştirin.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo kontrol ediliyor...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Kilo kontrol ediliyor...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo güncelleniyor...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Kilo güncelleniyor...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Kilo'u güncelleyin.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo'u güncelle", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Kilo hazır.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo hazır.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Kilo'u {{distro}} içine kurun.", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo'u kur", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo kurulu değil", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kilo'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Kilo bu makinede WSL'yi doğrulayamadı.", // kilocode_change
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Kilo'u tekrar açın.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop artık sekmeler üzerine kurulu.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo'un yeni bir sürümü ({{version}}) yüklemeye hazır.", // kilocode_change
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Kilo ekibine", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Kilo henüz MCP kimlik doğrulamasını desteklemiyor.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.", // kilocode_change
  ...
  "app.name.desktop": "Kilo Masaüstü", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Kilo sunucusunu Windows'ta WSL içinde çalıştırın.", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo'un görünüm dilini değiştirin", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Kilo'un cihazınızdaki görünümünü özelleştirin", // kilocode_change
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Kilo'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Kilo'un temasını özelleştirin.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo başladığında otomatik güncelleme kontrolü yap", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Kilo'un en son sürümünü kullanıyorsunuz.", // kilocode_change
