export const dict = {
  ...
  "desktop.menu.documentation": "Kilo دستاویزات", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo مینو", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo لوڈ نہیں ہو سکا", // kilocode_change
  "desktop.recovery.terminated": "Kilo ونڈو غیر متوقع طور پر بند ہو گئی", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo جواب نہیں دے رہا", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo کی تنصیب ناکام ہو گئی", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Kilo انسٹال نہیں ہے", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo کے ذریعہ فراہم کردہ مفت ماڈلز", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Kilo میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Kilo میں {{provider}} ماڈلز استعمال کریں۔", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Kilo میں {{provider}} ماڈلز استعمال کریں۔", // kilocode_change
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Kilo سرور سے منسلک ہے۔", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo چیک کیا جا رہا ہے...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Kilo چیک کیا جا رہا ہے...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo کو اپ ڈیٹ کیا جا رہا ہے...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Kilo کو اپ ڈیٹ کیا جا رہا ہے...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Kilo کو اپ ڈیٹ کریں۔", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo کو اپ ڈیٹ کریں۔", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo {{distro}} میں تیار ہے۔", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo تیار ہے۔", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Kilo انسٹال کریں۔", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo انسٹال کریں۔", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo انسٹال نہیں ہے۔", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Kilo WSL سرور شامل کر سکے۔", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Kilo اس مشین پر WSL کی تصدیق نہیں کر سکا۔", // kilocode_change
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Kilo کو دوبارہ کھولیں۔", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop اب ٹیبز پر مبنی ہے۔", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔", // kilocode_change
  ...
  "error.page.report.prefix": "براہ کرم Kilo ٹیم کو اس غلطی کی اطلاع دیں۔", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Kilo ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔", // kilocode_change
  ...
  "app.name.desktop": "Kilo ڈیسک ٹاپ", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Kilo سرور چلائیں۔", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo کے لیے ڈسپلے کی زبان تبدیل کریں۔", // kilocode_change
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Kilo کیسا لگتا ہے۔", // kilocode_change
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Kilo سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔", // kilocode_change
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Kilo کی تھیم حسب ضرورت بنائیں۔", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "آپ Kilo کا تازہ ترین ورژن چلا رہے ہیں۔", // kilocode_change
