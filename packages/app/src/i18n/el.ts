export const dict = {
  ...
  "desktop.menu.documentation": "Kilo Τεκμηρίωση", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo μενού", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo απέτυχε η φόρτωση", // kilocode_change
  "desktop.recovery.terminated": "Kilo το παράθυρο τερματίστηκε απροσδόκητα", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo δεν αποκρίνεται", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo η εγκατάσταση απέτυχε", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo δεν είναι εγκατεστημένο στο {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Kilo.", // kilocode_change
  ...
  "provider.connect.opencodeZen.line1":
    "Kilo Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Kilo συνδέεται αυτή η εφαρμογή.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Kilo σε {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Kilo σε {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Kilo σε {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Ενημέρωση Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo είναι έτοιμο στο {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo είναι έτοιμο.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Kilo στο {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Εγκατάσταση Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo δεν έχει εγκατασταθεί", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Kilo να προσθέσει έναν διακομιστή WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Kilo δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.", // kilocode_change
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Kilo ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.", // kilocode_change
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Kilo δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.", // kilocode_change
  ...
  "app.name.desktop": "Kilo Επιτραπέζιος υπολογιστής", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Kilo μέσα στο WSL στο Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Kilo στη συσκευή σας", // kilocode_change
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Kilo ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα", // kilocode_change
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Kilo.", // kilocode_change
