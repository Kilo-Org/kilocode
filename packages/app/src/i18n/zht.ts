...
export const dict = {
  ...
  "provider.connect.kiloZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.kiloZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.kiloZen.visit.prefix": "造訪 ",
  "provider.connect.kiloZen.visit.link": "kilo.ai/zen",
  "provider.connect.kiloZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 kilo.json 中設定的外挂程式",
