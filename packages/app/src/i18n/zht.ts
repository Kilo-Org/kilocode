...
export const dict = {
  ...
  "desktop.menu.documentation": "Kilo 文件", // kilocode_change
  "desktop.menu.supportForum": "支援論壇",
  "desktop.menu.shareFeedback": "提供意見回饋",
  "desktop.menu.reportBug": "回報錯誤",
  "desktop.menu.ariaLabel": "Kilo 選單", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo 載入失敗", // kilocode_change
  "desktop.recovery.terminated": "Kilo 視窗意外終止", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo 沒有回應", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo 安裝失敗", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Kilo", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo 提供的免費模型", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Kilo 中使用 {{provider}} 模型。", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Kilo 中使用 {{provider}} 模型。", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Kilo 中使用 {{provider}} 模型。", // kilocode_change
  ...
  "dialog.server.description": "切換此應用程式連線的 Kilo 伺服器。", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Kilo...", // kilocode_change
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Kilo 已就緒。", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo 已就緒。", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Kilo。", // kilocode_change
  "wsl.onboarding.installOpencode": "安裝 Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Kilo", // kilocode_change
  ...
  "wsl.onboarding.wslUnavailable.description": "Kilo 無法確認此電腦上的 WSL。", // kilocode_change
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Kilo。", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop 現在以分頁為核心。", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo 有新版本 ({{version}}) 可安裝。", // kilocode_change
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Kilo 團隊", // kilocode_change
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Kilo 尚不支援 MCP 驗證。", // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo 提供免費模型，你可以立即開始使用。", // kilocode_change
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Kilo 伺服器。", // kilocode_change
  ...
  "settings.general.row.language.description": "變更 Kilo 的顯示語言", // kilocode_change
  ...
  "settings.general.row.appearance.description": "自訂 Kilo 在你的裝置上的外觀", // kilocode_change
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Kilo 要跟隨系統、淺色或深色主題", // kilocode_change
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Kilo 的主題。", // kilocode_change
  ...
  "settings.updates.row.startup.description": "在 Kilo 啟動時自動檢查更新", // kilocode_change
