export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Kilo", // kilocode_change
  "desktop.recovery.terminated": "Okno Kilo zostało nieoczekiwanie zamknięte", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo nie odpowiada", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Kilo", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo nie jest zainstalowany w dystrybucji {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Kilo została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Przełącz serwer Kilo, z którym łączy się ta aplikacja.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Kilo w dystrybucji {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Kilo w dystrybucji {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Kilo w dystrybucji {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Zaktualizuj Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo jest gotowy w dystrybucji {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo jest gotowy.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Kilo w dystrybucji {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Zainstaluj Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo nie jest zainstalowany", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Kilo będzie mógł dodać serwer WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Kilo nie mógł zweryfikować WSL na tym komputerze.", // kilocode_change
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop korzysta teraz z układu opartego na kartach.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Kilo ({{version}}) jest teraz dostępna do instalacji.", // kilocode_change
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Kilo nie obsługuje jeszcze uwierzytelniania MCP.", // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo zawiera darmowe modele, więc możesz zacząć od razu.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Kilo wewnątrz WSL w systemie Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Kilo na swoim urządzeniu", // kilocode_change
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Kilo ma używać motywu systemowego, jasnego czy ciemnego", // kilocode_change
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Kilo.", // kilocode_change
