export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Kilo", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Meniu Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo nu a putut fi încărcat", // kilocode_change
  "desktop.recovery.terminated": "Fereastra Kilo s-a închis neașteptat", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo nu răspunde", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Kilo a eșuat", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo nu este instalat în {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Actualizarea Kilo s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Schimbă serverul Kilo la care se conectează aplicația.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Kilo în {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Se actualizează Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Kilo în {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Actualizează Kilo în {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Actualizează Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo este gata în {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo este gata.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Instalează Kilo în {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instalează Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo nu este instalat", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Kilo să poată adăuga un server WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Kilo nu a putut verifica WSL pe acest calculator.", // kilocode_change
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop este acum construit în jurul filelor.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Kilo ({{version}}) este disponibilă pentru instalare.", // kilocode_change
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Kilo nu suportă încă autentificarea MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo include modele gratuite ca să poți începe imediat.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Rulează serverul Kilo în WSL pe Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Kilo pe dispozitivul tău", // kilocode_change
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Kilo urmează sistemul, tema deschisă sau închisă", // kilocode_change
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Kilo.", // kilocode_change
