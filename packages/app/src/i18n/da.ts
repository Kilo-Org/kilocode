export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Skift hvilken Kilo-server denne app forbinder til.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Kilo i {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Opdaterer Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Kilo i {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Opdater Kilo i {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Opdater Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo er ikke installeret", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Kilo kan tilføje en WSL-server", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Kilo kunne ikke bekræfte WSL på denne maskine.", // kilocode_change
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Kilo igen.", // kilocode_change
  ...
  "toast.update.description": "En ny version af Kilo ({{version}}) er nu tilgængelig til installation.", // kilocode_change
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Kilo-teamet", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Kilo understøtter ikke MCP-godkendelse endnu.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo inkluderer gratis modeller så du kan starte med det samme.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Kør Kilo-serveren inde i WSL på Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Kilo ser ud på din enhed", // kilocode_change
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Kilo skal følge systemtemaet eller bruge et lyst eller mørkt tema", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Kilo starter", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Kilo.", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo kunne ikke indlæses", // kilocode_change
  "desktop.recovery.terminated": "Kilo-vinduet blev uventet afsluttet", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Kilo mislykkedes", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo er ikke installeret i {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Kilo er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop er nu bygget op omkring faner.", // kilocode_change
  "help.tabs.sessions":
