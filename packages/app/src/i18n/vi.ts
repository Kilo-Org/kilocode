export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Không tải được Kilo", // kilocode_change
  "desktop.recovery.terminated": "Cửa sổ Kilo đã bị đóng đột ngột", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo không phản hồi", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Kilo", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo chưa được cài đặt trong {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Kilo nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Kilo cung cấp", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Chuyển máy chủ Kilo mà ứng dụng này kết nối tới.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Kilo trong {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Kilo trong {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Kilo trong {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Cập nhật Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo đã sẵn sàng trong {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo đã sẵn sàng.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Cài đặt Kilo trong {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Cài đặt Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo chưa được cài đặt", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Kilo có thể thêm máy chủ WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Kilo không thể xác minh WSL trên máy này.", // kilocode_change
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop nay được xây dựng xoay quanh các tab.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Kilo ({{version}}) để cài đặt.", // kilocode_change
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Kilo chưa hỗ trợ xác thực MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Kilo bên trong WSL trên Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Kilo trên thiết bị", // kilocode_change
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Kilo tuân theo hệ thống, chủ đề sáng hay tối", // kilocode_change
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Kilo khởi chạy", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Kilo.", // kilocode_change
