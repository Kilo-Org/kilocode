export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Cambia il server Kilo a cui si connette l'app.", // kilocode_change
  ...
  "wsl.onboarding.step.opencode": "Kilo", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Controllo Kilo in {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Aggiornamento Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Kilo in {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Kilo in {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Aggiorna Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo è pronto in {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo è pronto.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Installa Kilo in {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Installa Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo non installato", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Kilo possa aggiungere un server WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Kilo non ha potuto verificare WSL su questa macchina.", // kilocode_change
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop ora è incentrato sulle schede.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Kilo ({{version}}) è ora disponibile per l'installazione.", // kilocode_change
  ...
  "error.page.report.prefix": "Segnala questo errore al team Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Kilo non supporta ancora l\'autenticazione MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo include modelli gratuiti così puoi iniziare immediatamente.", // kilocode_change
  ...
  "app.name.desktop": "Kilo Desktop", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Esegui il server Kilo all'interno di WSL su Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Kilo sul tuo dispositivo", // kilocode_change
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Kilo segue il tema di sistema, chiaro o scuro", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.title": "Kilo è aggiornato", // kilocode_change
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Kilo.", // kilocode_change
  ...
  "desktop.menu.documentation": "Documentazione di Kilo", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Menu Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Kilo", // kilocode_change
  "desktop.recovery.terminated": "La finestra di Kilo si è chiusa in modo imprevisto", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo non risponde", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Kilo non riuscita", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo non è installato in {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Kilo è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}", // kilocode_change
