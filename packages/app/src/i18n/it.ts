export const dict = {
  ...
  "dialog.model.manage.provider.toggle": "Seleziona/deseleziona tutti i modelli {{provider}}",
  ...
  "settings.general.row.showSessionProgressBar.description":
    "Mostra la barra di avanzamento animata in alto nella sessione mentre l'agente lavora",
