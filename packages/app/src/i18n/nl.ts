export const dict = {
  ...
  "desktop.menu.documentation": "Kilo-documentatie", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo kan niet worden geladen", // kilocode_change
  "desktop.recovery.terminated": "Het Kilo-venster is onverwacht beëindigd", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo reageert niet", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Kilo is mislukt", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo is niet geïnstalleerd in {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "De Kilo-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Kilo te gebruiken.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Kilo te gebruiken.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Kilo te gebruiken.", // kilocode_change
  ...
  "dialog.server.description": "Wijzig met welke Kilo-server deze app verbinding maakt.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo controleren...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kilo controleren in {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo bijwerken...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Kilo bijwerken in {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Werk Kilo bij in {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo bijwerken", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo is gereed in {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo is klaar.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Installeer Kilo in {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Installeer Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo niet geïnstalleerd", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Kilo een WSL-server kan toevoegen", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Kilo kan WSL niet verifiëren op deze machine.", // kilocode_change
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Kilo opnieuw.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop is nu opgebouwd rond tabbladen.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Kilo ({{version}}) beschikbaar om te installeren.", // kilocode_change
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Kilo-team", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Kilo ondersteunt nog geen MCP-authenticatie.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo bevat gratis modellen, zodat je direct aan de slag kunt.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Voer de Kilo-server uit in WSL op Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Kilo eruitziet op je apparaat", // kilocode_change
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Kilo het systeemthema, het lichte thema of het donkere thema gebruikt", // kilocode_change
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Kilo aan.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Kilo wordt gestart", // kilocode_change
  ...
  "settings.updates.toast.latest.title": "Kilo is bijgewerkt", // kilocode_change
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Kilo.", // kilocode_change
