export const dict = {
  ...
  "desktop.menu.documentation": "Kilo Skjøl", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Kilo valmynd", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo miseydnaðist at heinta", // kilocode_change
  "desktop.recovery.terminated": "Kilo vindeygað endað óvæntað", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo svarar ikki", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo uppsetingin miseydnaðist", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo er ikki sett upp í {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Skift hvønn Kilo ambætara henda appin hevur samband við.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kanna Kilo í {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Dagføring Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Kilo í {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Dagfør Kilo í {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Dagfør Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo er klárt í {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo er klárt.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Set Kilo upp í {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Set upp Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo ikki innstillað", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Kilo kann leggja ein WSL ambætara til", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Kilo kundi ikki staðfesta WSL á hesi maskinuni.", // kilocode_change
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Kilo aftur.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Skrivaraborð er nú bygt rundan um flikar.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Kilo ({{version}}) er nú tøk at seta upp.", // kilocode_change
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Kilo toymið", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Kilo stuðlar ikki MCP sannroynd enn.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo inniheldur ókeypis modellir so tú kanst byrja beinanvegin.", // kilocode_change
  ...
  "app.name.desktop": "Kilo Skrivaraborð", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Koyr Kilo ambætaran inni í WSL á Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Kilo sær út á tínari eind", // kilocode_change
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Kilo fylgir skipanini, ljósa ella myrka temanum", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Kilo er tema.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Kilo byrjar", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Kilo.", // kilocode_change
