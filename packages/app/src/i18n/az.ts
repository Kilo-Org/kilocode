export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kilo yüklənə bilmədi", // kilocode_change
  "desktop.recovery.terminated": "Kilo pəncərəsinin işi gözlənilmədən dayandı", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo cavab vermir", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo quraşdırılması uğursuz oldu", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo {{distro}} distribütivində quraşdırılmayıb", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo tərəfindən təqdim olunan pulsuz modellər", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Kilo-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Kilo-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Kilo-da {{provider}} modellərindən istifadə edin.", // kilocode_change
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Kilo serverini dəyişdirin.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo yoxlanılır...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Kilo yoxlanılır...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo yenilənir...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Kilo yenilənir...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Kilo-u yeniləyin.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo-u yeniləyin", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo {{distro}}-də hazırdır.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo hazırdır.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Kilo-u {{distro}}-də quraşdırın.", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo quraşdırın", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo quraşdırılmayıb", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kilo WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Kilo bu maşında WSL-i doğrulaya bilmədi.", // kilocode_change
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Kilo-u yenidən açın.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop indi tablar əsasında qurulub.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.", // kilocode_change
  ...
  "error.page.report.prefix": "Bu xətanı Kilo komandasına", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Kilo hələ MCP autentifikasiyasını dəstəkləmir.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Kilo serverini işlət.", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo üçün ekran dilini dəyişdirin", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Kilo-un cihazınızda necə göründüyünü fərdiləşdirin", // kilocode_change
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Kilo-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin", // kilocode_change
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Kilo-un mövzusunu fərdiləşdirin.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo açıldıqda avtomatik yeniləmələri yoxla", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Kilo-un ən son versiyasından istifadə edirsiniz.", // kilocode_change
