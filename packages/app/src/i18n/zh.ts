...
export const dict = {
  ...
  "provider.connect.kiloZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.kiloZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.kiloZen.visit.prefix": "访问 ",
  "provider.connect.kiloZen.visit.link": "kilo.ai/zen",
  "provider.connect.kiloZen.visit.suffix": " 获取你的 API 密钥。",
