...
export const dict = {
  ...
  "desktop.menu.documentation": "Kilo 文档", // kilocode_change
  "desktop.menu.supportForum": "支持论坛",
  "desktop.menu.shareFeedback": "提供反馈",
  "desktop.menu.reportBug": "报告错误",
  "desktop.menu.ariaLabel": "Kilo 菜单", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo 加载失败", // kilocode_change
  "desktop.recovery.terminated": "Kilo 窗口意外终止", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo 未响应", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo 安装失败", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Kilo", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo 提供的免费模型", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Kilo 中使用 {{provider}} 模型。", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Kilo 中使用 {{provider}} 模型。", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Kilo 中使用 {{provider}} 模型。", // kilocode_change
  ...
  "dialog.server.description": "切换此应用连接的 Kilo 服务器。", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "正在更新 Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Kilo...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Kilo。", // kilocode_change
  "wsl.onboarding.updateOpencode": "更新 Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Kilo 已就绪。", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo 已就绪。", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Kilo。", // kilocode_change
  "wsl.onboarding.installOpencode": "安装 Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Kilo", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description": "Kilo 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Kilo 无法验证此设备上的 WSL。", // kilocode_change
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Kilo。", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop 现已采用以标签页为核心的设计。", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo 有新版本 ({{version}}) 可安装。", // kilocode_change
  ...
  "error.page.report.prefix": "请将此错误报告给 Kilo 团队", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Kilo 暂不支持 MCP 认证。', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo 提供免费模型，你可以立即开始使用。", // kilocode_change
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Kilo 服务器。", // kilocode_change
  ...
  "settings.general.row.language.description": "更改 Kilo 的显示语言", // kilocode_change
  ...
  "settings.general.row.appearance.description": "自定义 Kilo 在你的设备上的外观", // kilocode_change
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Kilo 跟随系统、浅色或深色主题", // kilocode_change
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Kilo 的主题。", // kilocode_change
  ...
  "settings.updates.row.startup.description": "在 Kilo 启动时自动检查更新", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Kilo。", // kilocode_change
