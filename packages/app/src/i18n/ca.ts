export const dict = {
  ...
  "desktop.menu.documentation": "Kilo Documentació", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "menú Kilo.", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo no s'ha pogut carregar", // kilocode_change
  "desktop.recovery.terminated": "La finestra Kilo s'ha acabat inesperadament", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo no respon", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Kilo ha fallat", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo no està instal·lat a {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Canvia a quin Kilo servidor es connecta aquesta aplicació.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Kilo a {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Kilo a {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Actualitza Kilo a {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Actualització Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo està llest a {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo està llest.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Instal·leu Kilo a {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instal·la Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo no instal·lat", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Kilo pugui afegir un WSL servidor", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Kilo no ha pogut verificar WSL en aquesta màquina.", // kilocode_change
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo L'escriptori ara està construït al voltant de pestanyes.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Kilo ({{version}}) ja està disponible per instal·lar-la.", // kilocode_change
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Kilo.", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Kilo encara no admet l\'autenticació MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo inclou models gratuïts perquè pugueu començar immediatament.", // kilocode_change
  ...
  "app.name.desktop": "Kilo Escriptori", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Kilo dins de WSL a Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Kilo al teu dispositiu", // kilocode_change
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Kilo segueix el tema del sistema, clar o fosc", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Kilo.", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Kilo.", // kilocode_change
