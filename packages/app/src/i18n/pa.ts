export const dict = {
  ...
  "desktop.menu.documentation": "Kilo دیاں دستاویزاں", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo لوڈ نئیں ہو سکیا", // kilocode_change
  "desktop.recovery.terminated": "Kilo دی ونڈو اچانک بند ہو گئی", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo جواب نئیں دے رہیا", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo دی تنصیب ناکام ہو گئی", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Kilo انسٹال نئیں اے", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kilo دے ذریعہ فراہم کردہ مفت ماڈل", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Kilo وچ {{provider}} ماڈل ورتو۔", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Kilo وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Kilo وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔", // kilocode_change
  ...
  "dialog.server.description": "ایہہ ایپ کس Kilo سرور نال جڑدی اے، اس نوں سوئچ کرو۔", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kilo چیک کر رئے آں...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Kilo دی جانچ پڑتال...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kilo نو اپ ڈیٹ کر رئے آں...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Kilo نو اپ ڈیٹ کر رئے آں...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Kilo نو اپ ڈیٹ کرو۔", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kilo اپ ڈیٹ کرو", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo {{distro}} چ تیار اے۔", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo تیار اے۔", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Kilo انسٹال کرو۔", // kilocode_change
  "wsl.onboarding.installOpencode": "Kilo انسٹال کرو", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo انسٹال نئیں کیتا گیا", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kilo دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Kilo ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔", // kilocode_change
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Kilo دوبارہ کھولو۔", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop ہن ٹیباں دے گرد بنایا گیا اے۔", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kilo ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔", // kilocode_change
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Kilo ٹیم نوں دیو", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Kilo ہلے تک MCP تصدیق دی حمایت نئیں کردا۔', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Kilo سرور چلاؤ۔", // kilocode_change
  ...
  "settings.general.row.language.description": "Kilo لئی ڈسپلے دی بولی بدلو", // kilocode_change
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Kilo کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ", // kilocode_change
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Kilo سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے", // kilocode_change
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Kilo نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔", // kilocode_change
  ...
  "settings.updates.row.startup.description": "جدوں Kilo لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "تسی Kilo دا تازہ ترین ورژن چلا رئے او۔", // kilocode_change
