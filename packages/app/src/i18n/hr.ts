...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za Kilo", // kilocode_change
  "Forum za podršku",
  "Pošalji povratne informacije",
  "Prijavi pogrešku",
  "Izbornik Kilo", // kilocode_change
  ...
  "Nastavi čekati",
  "Izađi",
  "Kilo se nije uspio učitati", // kilocode_change
  "Prozor aplikacije Kilo neočekivano je zatvoren", // kilocode_change
  "Kilo ne reagira", // kilocode_change
  ...
  "Instalacija aplikacije Kilo nije uspjela", // kilocode_change
  ...
  "Kilo nije instaliran u distribuciji {{distro}}", // kilocode_change
  "Ažuriranje aplikacije Kilo je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}", // kilocode_change
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Promijenite na koji se Kilo poslužitelj povezuje ova aplikacija.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Kilo u {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Ažuriranje Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Kilo u {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Kilo u {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Ažurirajte Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo je spreman u {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo je spreman.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Instalirajte Kilo u {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instalirajte Kilo", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Kilo može dodati WSL poslužitelj", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Kilo nije mogao potvrditi WSL na ovom stroju.", // kilocode_change
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Radna površina Kilo sada je izgrađena oko kartica.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Kilo ({{version}}) sada je dostupna za instalaciju.", // kilocode_change
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Kilo timu", // kilocode_change
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Kilo još ne podržava MCP autentifikaciju.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo uključuje besplatne modele tako da možete odmah početi.", // kilocode_change
  ...
  "app.name.desktop": "Kilo Radna površina", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Pokrenite Kilo poslužitelj unutar WSL na Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Kilo izgleda na vašem uređaju", // kilocode_change
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Kilo slijediti sistemsku, svijetlu ili tamnu temu", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Kilo tematiziran.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Kilo pokrene", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Kilo.", // kilocode_change
