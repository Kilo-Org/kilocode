export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Kilo", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Menu do Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Kilo", // kilocode_change
  "desktop.recovery.terminated": "A janela do Kilo foi encerrada inesperadamente", // kilocode_change
  "desktop.recovery.unresponsive": "O Kilo não está respondendo", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Kilo", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Kilo não está instalado em {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "A atualização do Kilo foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Trocar para qual servidor Kilo este aplicativo se conecta.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Kilo em {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Atualizando o Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Kilo em {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Atualize o Kilo em {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Atualizar o Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "O Kilo está pronto em {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "O Kilo está pronto.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Instale o Kilo em {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instalar o Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo não instalado", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Kilo possa adicionar um servidor WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Kilo não conseguiu verificar o WSL neste computador.", // kilocode_change
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Kilo novamente.", // kilocode_change
  ...
  "help.tabs.introduction": "Agora, o Kilo Desktop é organizado em abas.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Kilo ({{version}}) está disponível para instalação.", // kilocode_change
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Kilo ainda não suporta autenticação MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo inclui modelos gratuitos para você começar imediatamente.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Executar o servidor Kilo dentro do WSL no Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Personalize como o Kilo aparece no seu dispositivo", // kilocode_change
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Kilo segue o tema do sistema, claro ou escuro", // kilocode_change
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Kilo é tematizado.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Kilo iniciar", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Kilo.", // kilocode_change
