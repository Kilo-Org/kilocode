export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Kilo ไม่สำเร็จ", // kilocode_change
  "desktop.recovery.terminated": "หน้าต่าง Kilo หยุดทำงานโดยไม่คาดคิด", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo ไม่ตอบสนอง", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง Kilo ล้มเหลว", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง Kilo ใน {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "อัปเดต Kilo เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kilo", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kilo", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kilo", // kilocode_change
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Kilo ที่แอปนี้เชื่อมต่อด้วย", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ Kilo ใน {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต Kilo ใน {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "อัปเดต Kilo ใน {{distro}}", // kilocode_change
  "wsl.onboarding.updateOpencode": "อัปเดต Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo พร้อมใช้งานใน {{distro}} แล้ว", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo พร้อมใช้งานแล้ว", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง Kilo ใน {{distro}}", // kilocode_change
  "wsl.onboarding.installOpencode": "ติดตั้ง Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง Kilo", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Kilo จะเพิ่มเซิร์ฟเวอร์ WSL ได้", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Kilo ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้", // kilocode_change
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Kilo อีกครั้ง", // kilocode_change
  ...
  "help.tabs.introduction": "ตอนนี้ Kilo Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Kilo ({{version}}) พร้อมใช้งานสำหรับติดตั้ง", // kilocode_change
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Kilo ยังไม่รองรับการตรวจสอบสิทธิ์ MCP', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที", // kilocode_change
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Kilo ภายใน WSL บน Windows", // kilocode_change
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Kilo บนอุปกรณ์ของคุณ", // kilocode_change
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Kilo ใช้ธีมตามระบบ สว่าง หรือมืด", // kilocode_change
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Kilo", // kilocode_change
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Kilo เปิดใช้งาน", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Kilo เวอร์ชันล่าสุด", // kilocode_change
