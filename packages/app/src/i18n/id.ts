export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kilo gagal dimuat", // kilocode_change
  "desktop.recovery.terminated": "Jendela Kilo berhenti secara tidak terduga", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo tidak merespons", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Kilo gagal", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo belum terinstal di {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Pembaruan Kilo selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Ganti server Kilo mana yang terhubung dengan aplikasi ini.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Kilo di {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Memperbarui Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Kilo di {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Perbarui Kilo di {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Perbarui Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo siap di {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo siap.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Instal Kilo di {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instal Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo belum terinstal", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Kilo dapat menambahkan server WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Kilo tidak dapat memverifikasi WSL di komputer ini.", // kilocode_change
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop kini dirancang dengan tab sebagai pusatnya.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Kilo ({{version}}) sekarang tersedia untuk diinstal.", // kilocode_change
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Kilo belum mendukung autentikasi MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo menyertakan model gratis sehingga Anda dapat memulai dengan segera.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Jalankan server Kilo di dalam WSL di Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Kilo di perangkat Anda", // kilocode_change
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Kilo mengikuti tema sistem, terang, atau gelap", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Kilo diluncurkan", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Kilo.", // kilocode_change
