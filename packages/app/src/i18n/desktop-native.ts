...
export const DESKTOP_NATIVE_ENGLISH = {
  "desktop.menu.app": "Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo failed to load", // kilocode_change
  "desktop.recovery.terminated": "Kilo window terminated unexpectedly", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo is not responding", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo installation failed", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo is not installed in {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo update finished but {{distro}} still reports {{installed}}; expected {{expected}}", // kilocode_change
