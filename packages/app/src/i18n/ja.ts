export const dict = {
  ...
  "provider.connect.kiloZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.kiloZen.visit.prefix": " ",
  "provider.connect.kiloZen.visit.link": "kilo.ai/zen",
  "provider.connect.kiloZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
