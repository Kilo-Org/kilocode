export const dict = {
  ...
  "desktop.menu.documentation": "Kiloドキュメント", // kilocode_change
  "desktop.menu.supportForum": "サポートフォーラム",
  "desktop.menu.shareFeedback": "フィードバックを送信",
  "desktop.menu.reportBug": "バグを報告",
  "desktop.menu.ariaLabel": "Kiloメニュー", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kiloを読み込めませんでした", // kilocode_change
  "desktop.recovery.terminated": "Kiloのウインドウが予期せず終了しました", // kilocode_change
  "desktop.recovery.unresponsive": "Kiloが応答していません", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kiloのインストールに失敗しました", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはKiloがインストールされていません", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kiloのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Kiloが提供する無料モデル", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Kiloで{{provider}}モデルを使用します。", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してKiloで{{provider}}モデルを使用してください。", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Kiloで{{provider}}モデルを使用してください。", // kilocode_change
  ...
  "dialog.server.description": "このアプリが接続するKiloサーバーを切り替えます。", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kiloを確認中...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のKiloを確認中...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Kiloを更新中...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のKiloを更新中...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のKiloを更新してください。", // kilocode_change
  "wsl.onboarding.updateOpencode": "Kiloを更新", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のKiloの準備ができました。", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kiloの準備ができました。", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "{{distro}}にKiloをインストールしてください。", // kilocode_change
  "wsl.onboarding.installOpencode": "Kiloをインストール", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kiloがインストールされていません", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KiloでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です", // kilocode_change
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Kiloをもう一度開いてください。", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktopでタブを中心とした操作ができるようになりました。", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kiloの新しいバージョン ({{version}}) がインストール可能です。", // kilocode_change
  ...
  "error.page.report.prefix": "このエラーをKiloチームに報告してください: ", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: KiloはまだMCP認証をサポートしていません。', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kiloには無料モデルが含まれているため、すぐに開始できます。", // kilocode_change
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKiloサーバーを実行します。", // kilocode_change
  ...
  "settings.general.row.language.description": "Kiloの表示言語を変更します", // kilocode_change
  ...
  "settings.general.row.appearance.description": "デバイスでのKiloの表示をカスタマイズします", // kilocode_change
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Kiloがシステム、ライト、またはダークテーマに従うかを選択します", // kilocode_change
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Kiloのテーマをカスタマイズします。", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Kilo の起動時に自動でアップデートを確認します", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Kilo は最新バージョンです。", // kilocode_change
