export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Kilo", // kilocode_change
  "desktop.recovery.terminated": "La fenêtre Kilo s'est arrêtée de manière inattendue", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo ne répond pas", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Kilo", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo n'est pas installé dans {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Kilo est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Changez le serveur Kilo auquel cette application se connecte.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Kilo dans {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Kilo dans {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Kilo dans {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Mettre à jour Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo est prêt dans {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo est prêt.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Installez Kilo dans {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Installer Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo non installé", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Kilo puisse ajouter un serveur WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Kilo n'a pas pu vérifier WSL sur cet appareil.", // kilocode_change
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Desktop s'articule désormais autour d'onglets.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Kilo ({{version}}) est maintenant disponible pour installation.", // kilocode_change
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Kilo ne prend pas encore en charge l'authentification MCP.", // kilocode_change
  ...
  "sidebar.gettingStarted.line1":
    "Kilo inclut des modèles gratuits pour que vous puissiez commencer immédiatement.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Kilo dans WSL sur Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Kilo sur votre appareil", // kilocode_change
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Kilo suit le thème système, clair ou sombre", // kilocode_change
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Kilo.", // kilocode_change
