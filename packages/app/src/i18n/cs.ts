export const dict = {
  ...
  "desktop.menu.documentation": "Kilo Dokumentace", // kilocode_change
  ...
  "desktop.menu.ariaLabel": "Nabídka Kilo", // kilocode_change
  ...
  "desktop.recovery.loadFailed": "Kilo se nepodařilo načíst", // kilocode_change
  "desktop.recovery.terminated": "Kilo okno bylo neočekávaně ukončeno", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo nereaguje", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "Kilo instalace se nezdařila", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo není nainstalován v {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "Kilo aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Kilo.", // kilocode_change
  ...
  "dialog.server.description": "Přepněte, ke kterému Kilo serveru se tato aplikace připojuje.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Kilo v {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "Aktualizace Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Kilo v {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Kilo v {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "Aktualizovat Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo je připraveno v {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo je připraven.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Kilo do {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "Instalovat Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo není nainstalováno", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Kilo může přidat server WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Kilo nemohl ověřit WSL na tomto počítači.", // kilocode_change
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "Kilo Plocha je nyní postavena na kartách.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Kilo ({{version}}).", // kilocode_change
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Kilo zatím nepodporuje ověřování MCP.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "Kilo obsahuje bezplatné modely, takže můžete začít okamžitě.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "Spusťte server Kilo uvnitř WSL na Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Kilo na vašem zařízení", // kilocode_change
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Kilo následovat systémové, světlé nebo tmavé téma", // kilocode_change
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Kilo.", // kilocode_change
