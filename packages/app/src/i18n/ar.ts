export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Kilo", // kilocode_change
  "desktop.recovery.terminated": "توقفت نافذة Kilo بشكل غير متوقع", // kilocode_change
  "desktop.recovery.unresponsive": "Kilo لا يستجيب", // kilocode_change
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Kilo", // kilocode_change
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Kilo غير مثبت في {{distro}}", // kilocode_change
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Kilo، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}", // kilocode_change
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Kilo", // kilocode_change
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Kilo.", // kilocode_change
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Kilo.", // kilocode_change
  ...
  "dialog.server.description": "تبديل خادم Kilo الذي يتصل به هذا التطبيق.", // kilocode_change
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Kilo...", // kilocode_change
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Kilo في {{distro}}...", // kilocode_change
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Kilo...", // kilocode_change
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Kilo في {{distro}}...", // kilocode_change
  "wsl.onboarding.updateOpencodeIn": "حدّث Kilo في {{distro}}.", // kilocode_change
  "wsl.onboarding.updateOpencode": "تحديث Kilo", // kilocode_change
  "wsl.onboarding.opencodeReadyIn": "Kilo جاهز في {{distro}}.", // kilocode_change
  "wsl.onboarding.opencodeReady": "Kilo جاهز.", // kilocode_change
  "wsl.onboarding.installOpencodeIn": "ثبّت Kilo في {{distro}}.", // kilocode_change
  "wsl.onboarding.installOpencode": "تثبيت Kilo", // kilocode_change
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kilo غير مثبت", // kilocode_change
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Kilo من إضافة خادم WSL", // kilocode_change
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Kilo التحقق من WSL على هذا الجهاز.", // kilocode_change
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Kilo.", // kilocode_change
  ...
  "help.tabs.introduction": "أصبح Kilo Desktop الآن قائمًا على علامات التبويب.", // kilocode_change
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Kilo ({{version}}) للتثبيت.", // kilocode_change
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Kilo", // kilocode_change
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Kilo لا يدعم مصادقة MCP بعد.', // kilocode_change
  ...
  "sidebar.gettingStarted.line1": "يتضمن Kilo نماذج مجانية حتى تتمكن من البدء فورًا.", // kilocode_change
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Kilo داخل WSL على Windows.", // kilocode_change
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Kilo", // kilocode_change
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Kilo على جهازك", // kilocode_change
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Kilo يتبع سمة النظام أو الفاتح أو الداكن", // kilocode_change
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Kilo.", // kilocode_change
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Kilo", // kilocode_change
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Kilo.", // kilocode_change
