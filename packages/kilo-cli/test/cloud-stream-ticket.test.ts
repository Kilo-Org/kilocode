...
import { createStreamTicketClient, type StreamTicketClient } from "../src/cloud/stream-ticket"
import { parseServiceOrigin } from "../src/cloud/origin"

// Ported from origin/main packages/opencode/test/kilocode/cloud/stream-ticket.test.ts,
// with v1 "@/kilocode/cloud/*" aliases rewritten to relative imports. All responses
// are in-memory stubs; no live endpoint is contacted.
