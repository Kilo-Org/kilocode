...
import { fetchProfile } from "@devilcode/kilo-gateway"
...
export namespace Identity {
  ...
  export async function getMachineId(): Promise<string | undefined> {
    ...
    const override = process.env.DEVIL_MACHINE_ID
    if (override) {
      machineId = override
      return machineId
    }
  ...
  export async function updateFromDevilAuth(token: string | null, accountId?: string): Promise<void> {
